...
public interface IPurchaseRequisitionService
{
    ...
    Task<(bool Success, string Message, string? PrNo)> CreateAsync(CreatePRHeaderDto dto, string createdBy);
    Task<(bool Success, string Message)> UpdateAsync(UpdatePRHeaderDto dto, string modifiedBy);
