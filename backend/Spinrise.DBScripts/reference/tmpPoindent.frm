...
Begin VB.Form tmpPOINDENT 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame FrameItem 
         ...
         Begin VB.Frame dlmdfrm 
            ...
            Begin FPSpreadADO.fpSpread FpSpdIndHead 
               ...
               MaxRows         =   1
               ScrollBars      =   0
               SpreadDesigner  =   "tmpPoindent.frx":0414
               AppearanceStyle =   0
            End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox Combo2 
            DataField       =   "ABCFLG"
            Height          =   315
            ItemData        =   "tmpPoindent.frx":0817
            Left            =   7935
            List            =   "tmpPoindent.frx":0819
   ...
   Begin VB.Frame FooterFrame 
      ...
      Begin TabDlg.SSTab FooterTab 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "Tab 0"
         TabPicture(0)   =   "tmpPoindent.frx":081B
         Tab(0).ControlEnabled=   -1  'True
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":0837
         Height          =   510
         Index           =   0
         Left            =   60
         Picture         =   "tmpPoindent.frx":0B41
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":1316
         Height          =   510
         Index           =   3
         Left            =   1560
         Picture         =   "tmpPoindent.frx":1620
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":19B5
         Height          =   510
         Index           =   6
         Left            =   2595
         Picture         =   "tmpPoindent.frx":1DFF
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":214C
         Height          =   510
         Index           =   5
         Left            =   2070
         Picture         =   "tmpPoindent.frx":2596
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":28FB
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":2FA1
         Height          =   510
         Index           =   1
         Left            =   570
         Picture         =   "tmpPoindent.frx":32AB
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":3625
         Height          =   510
         Index           =   7
         Left            =   3120
         Picture         =   "tmpPoindent.frx":3A6F
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":3DBF
         Height          =   510
         Index           =   11
         Left            =   5805
         Picture         =   "tmpPoindent.frx":4209
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":459E
         Height          =   510
         Index           =   9
         Left            =   4170
         Picture         =   "tmpPoindent.frx":48A8
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":4C4A
         Height          =   510
         Index           =   10
         Left            =   4695
         Picture         =   "tmpPoindent.frx":4F54
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "tmpPoindent.frx":52D0
         Height          =   510
         Index           =   8
         Left            =   3645
         Picture         =   "tmpPoindent.frx":571A
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.CommandButton Command5 
         Caption         =   "&OK"
         DownPicture     =   "tmpPoindent.frx":5A7C
         Height          =   615
         Left            =   2580
         Picture         =   "tmpPoindent.frx":5E62
         Style           =   1  'Graphical
         TabIndex        =   66
         Top             =   1680
         Width           =   975
      ...
      Begin VB.CommandButton Command4 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "tmpPoindent.frx":6228
         Height          =   615
         Left            =   4020
         Picture         =   "tmpPoindent.frx":660A
         Style           =   1  'Graphical
         TabIndex        =   65
         Top             =   1680
         Width           =   975
...
Case 9
        ...
        If Opt = "add" Then
            ...
            adoPrimaryRS("itype") = Text5.Text 'Trim(Combo2.Text)
...
On Error GoTo delmodclick_Error
        ...
        Else
            ...
            adoPrimaryRS.Open "SELECT to_char(h.prno)||'          '||to_char(h.prdate)||'         '|| h.blcode DELMOD,h.blcode ""Blcode"",h.prno ""PR. No."",h.prdate ""Date"",h.depcode ""Department"",d.depname ""Description"",PO_GRP from po_prl l inner join PO_PRH h on h.divcode=l.divcode and h.prno=l.prno and h.prdate=l.prdate left join IN_DEP D on H.DEPCODE = D.DEPCODE  WHERE d.divcode='" & divcode & "' and  isnull(amdflg,' ')<>'Y'  and h.divcode = '" & divcode & "'  AND H.PRDATE  between '" & Format(yfdate, "dd-mmm-yyyy") & "'  and '" & Format(yldate, "dd-mmm-yyyy") & "'  and (QTYIND- isnull(QTYREQD,0)) <> 0  and isnull(cancelflag,'N')<>'Y' " & _
            " group by to_char(h.prno)||'          '||to_char(h.prdate), h.prno,h.prdate,h.depcode,d.depname,h.blcode ORDER BY h.PRNO,h.blcode", db, adOpenStatic, adLockBatchOptimistic
        End If
        DataCombo1.Text = ""
        Frame3.Visible = True
        Frame3.ZOrder
...
On Error GoTo delmodproc_Error
    ...
    Else
        ...
        adoPrimaryRS.Open "SHAPE {select H.DIVCODE,H.PRNO,H.PRDATE,H.DEPCODE,H.REFNO,D.DEPNAME,h.blcode,reqname,scopecode,UserId,H.SubCost,h.PO_GRP,H.budgetBALAMT from  PO_PRH H left join IN_DEP D on  h.depcode = d.depcode where d.divcode='" & divcode & "' and H.DIVCODE = '" & divcode & "' and  h.blcode ='" & C & "' and  H.PRNO = " & val(b) & " and H.PRDATE = '" & Format(Trim(A), "dd-mmm-yyyy") & "' } AS ParentCMD APPEND ({select DIVCODE,PRNO,PRDATE,PRSNO,a.ITEMCODE ""Item"",b.itemname ""Description"",b.uom ""Unit"",b.curstock ""Current Stock"",QTYIND ""Quantity Required"",a.CATCODE ""Category"",CCCODE ""Cost Centre"", BGRPCODE ""Budget Group"",a.MACNO ""Machine Code"",REQDDATE ""Required date"",REMARKS ""Remarks"",a.blcode ""blcode"" from  po_prl a,in_item b where isnull(amdflg,' ')<>'Y' and  a.itemcode=b.itemcode and PRNO = " & val(b) & " Order by PRSNO } AS ChildCMD RELATE DIVCODE TO DIVCODE, blcode TO blcode ,PRNO TO PRNO,PRDATE TO PRDATE) AS ChildCMD", db, adOpenStatic, adLockBatchOptimistic
...
Else
    adoPrimaryRS.Open "SHAPE {select distinct th.DIVCODE,th.prno,th.PRDATE,TH.DEPCODE,D.DEPNAME,th.REFNO,th.blcode,th.itype,th.section,reqname,scopecode,th.PO_GRP from  PO_PRH th, IN_DEP D  where d.divcode='" & divcode & "' and th.DEPCODE  (+)= D.DEPCODE and TH.PRDATE between '" & Format(yfdate, "dd-mmm-yyyy") & "' and '" & Format(yldate, "dd-mmm-yyyy") & "' AND TH.DIVCODE = '" & divcode & "' " & _
    " Order by PRNO} AS ParentCMD  APPEND ({select t.DIVCODE,t.PRNO,t.PRDATE,t.PRSNO ,t.ITEMCODE ""Item"",i.itemname ""Item Description"",i.UOM ""Unit"",s.macdes ""Machine"",t.curstock ""Current Stock"",t.QTYIND ""Quantity Required"",QTYREQD ""Quantity Ordered"",qtyrec ""Quantity Received"",reqddate ""Required Date"",decode(PRSTATUS,'O','ORDERED','E','ENQUIRED','R','RECEIVED','C','RECEIVED','Requested') ""PR. Status"" ,remarks ""Remarks"",t.blcode ""blcode"",remark1 ""REMARKS1"" from  PO_PRL t, IN_ITEM i, IN_MAC S  where  isnull(amdflg,' ')<>'Y' and  t.macno = s.macno(+) and t.itemcode = i.itemcode Order by t.itemcode,t.prsno } AS ChildCMD RELATE DIVCODE TO DIVCODE , blcode TO blcode ,PRNO TO PRNO,PRDATE TO PRDATE) AS ChildCMD", db, adOpenStatic, adLockBatchOptimistic
End If
...
Else
    adoPrimaryRS.Open "SHAPE {select distinct th.DIVCODE,th.prno,th.PRDATE,TH.DEPCODE,D.DEPNAME,th.REFNO,th.blcode,th.itype,th.section,reqname,scopecode,isnull(userid,'')UserId,th.PO_GRP from  PO_PRH th, IN_DEP D  where d.divcode='" & divcode & "' and th.DEPCODE  (+)= D.DEPCODE and TH.PRDATE between '" & Format(yfdate, "dd-mmm-yyyy") & "' and '" & Format(yldate, "dd-mmm-yyyy") & "' AND TH.DIVCODE = '" & divcode & "' and th.blcode ='" & DataCombo3 & "'  and th.prno = " & MDOC & _
                      " Order by PRNO} AS ParentCMD APPEND ({select distinct t.DIVCODE,t.PRNO,t.PRDATE,t.PRSNO ,t.ITEMCODE ""Item"",i.itemname ""Item Description"",i.UOM ""Unit"",s.macdes ""Machine"",t.QTYIND ""Qty Required"",QTYREQD ""Qty Ordered"",qtyrec ""Qty Received"",reqddate ""Required Date"",decode(PRSTATUS,'O','ORDERED','E','ENQUIRED','R','RECEIVED','C','RECEIVED','Requested') ""PR. Status"" ,remarks ""Remarks"",t.blcode ""blcode"" from  PO_PRL t, IN_ITEM i, IN_MAC S  where isnull(amdflg,' ')<>'Y' and  t.macno = s.macno(+) and t.itemcode = i.itemcode Order by t.itemcode } AS ChildCMD RELATE DIVCODE TO DIVCODE ,blcode TO blcode ,PRNO TO PRNO,PRDATE TO PRDATE) AS ChildCMD", db, adOpenStatic, adLockBatchOptimistic
End If
Exit Sub
fnd1_Error:
