...
- Name: kalsofte.spec.ts >> Authentication >> TC-03 | Logout should return to login page
- Location: tests\kalsofte.spec.ts:88:7
...
Call log:
  - waiting for locator('a:has-text("Logout"), button:has-text("Logout"), a:has-text("Sign Out")').first() to be visible
