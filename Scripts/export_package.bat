...
echo. >> "%TXT%"
echo   2. Delete old assets: >> "%TXT%"
echo      rd /s /q "E:\...\spinrise-web\assets" >> "%TXT%"
echo. >> "%TXT%"
echo   3. Copy frontend files: >> "%TXT%"
...
echo   4. Open an existing PR and verify data is correct >> "%TXT%"
echo. >> "%TXT%"
echo ================================================================ >> "%TXT%"
echo  ROLLBACK >> "%TXT%"
echo ================================================================ >> "%TXT%"
...
echo         Re-run merged.sql from the previous package if needed. >> "%TXT%"
echo. >> "%TXT%"
echo ================================================================ >> "%TXT%"
