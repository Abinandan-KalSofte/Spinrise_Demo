...
Begin VB.Form FrmQualparam_LMW_new 
   ...
   Begin VB.CommandButton BUTTON 
      ...
      Index           =   13
      Left            =   5160
      Picture         =   "RMIqualparam_lmw_new.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   369
   ...
   Begin VB.Frame Buttonframe 
      ...
      Width           =   11730
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":0442
         Height          =   510
         Index           =   0
         Left            =   15
         Picture         =   "RMIqualparam_lmw_new.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   111
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   8550
         Picture         =   "RMIqualparam_lmw_new.frx":0ADF
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   4
         Left            =   4665
         Picture         =   "RMIqualparam_lmw_new.frx":0E76
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Print"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   6120
         Picture         =   "RMIqualparam_lmw_new.frx":12B8
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Print"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":16FA
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1020
         Picture         =   "RMIqualparam_lmw_new.frx":1A04
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":1DA0
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   8
         Left            =   3105
         Picture         =   "RMIqualparam_lmw_new.frx":21EA
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":254C
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   10
         Left            =   4140
         Picture         =   "RMIqualparam_lmw_new.frx":2856
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":2BD2
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   9
         Left            =   3630
         Picture         =   "RMIqualparam_lmw_new.frx":2EDC
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":327E
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   11
         Left            =   5670
         Picture         =   "RMIqualparam_lmw_new.frx":36C8
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":3A5D
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   7
         Left            =   2580
         Picture         =   "RMIqualparam_lmw_new.frx":3EA7
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":41F7
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   1
         Left            =   495
         Picture         =   "RMIqualparam_lmw_new.frx":4501
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":487B
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   5
         Left            =   1530
         Picture         =   "RMIqualparam_lmw_new.frx":4CC5
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIqualparam_lmw_new.frx":502A
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   6
         Left            =   2055
         Picture         =   "RMIqualparam_lmw_new.frx":5474
         Style           =   1  'Graphical
         TabIndex        =   4
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "RMIqualparam_lmw_new.frx":57C1
      ...
      TabCaption(1)   =   "Sample"
      TabPicture(1)   =   "RMIqualparam_lmw_new.frx":57DD
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "RMIqualparam_lmw_new.frx":57F9
         Tab(0).ControlEnabled=   -1  'True
         ...
         TabPicture(1)   =   "RMIqualparam_lmw_new.frx":5815
         Tab(1).ControlEnabled=   0   'False
         ...
         TabPicture(2)   =   "RMIqualparam_lmw_new.frx":5831
         ...
         TabPicture(3)   =   "RMIqualparam_lmw_new.frx":584D
         ...
         Tab(3).Control(5)=   "CmdReject"
         Tab(3).Control(6)=   "Txttotalbale"
         Tab(3).Control(6).Enabled=   0   'False
         Tab(3).Control(7)=   "TxtTobaleno"
         Tab(3).Control(7).Enabled=   0   'False
         Tab(3).Control(8)=   "Txtfrombaleno"
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.ComboBox Combo1 
         BackColor       =   &H00FFFFC0&
         Height          =   360
         ItemData        =   "RMIqualparam_lmw_new.frx":5869
         Left            =   1320
         List            =   "RMIqualparam_lmw_new.frx":5873
         TabIndex        =   115
         Top             =   2520
         Visible         =   0   'False
         Width           =   1455
   ...
   End
End
Attribute VB_Name = "FrmQualparam_LMW_new"
...
'    DB.BeginTrans
    ...
    LookUp.Clear = True
    If QualParaMod = False Then
        LookUp.query = "select LOTNO""Lot No."",LOTDT""Lot Date"",plotno""Supplier Lot No."" From rm_lot WHERE  ins_flg='Y' AND LOTYEAR='" & Year(yfdate) & "' AND DIVCODE='" & Divcode & "' AND (isnull(bales,0) - isnull(ISSbal,0)) >0 And (ISNULL(ISSWT,0)+ISNULL(adjwt,0)) = 0 "
    ElseIf QualParaMod = True Then
        LookUp.query = "select LOTNO""Lot No."",LOTDT""Lot Date"",plotno""Supplier Lot No."" From rm_lot WHERE  ins_flg='Y' AND LOTYEAR='" & Year(yfdate) & "' AND DIVCODE='" & Divcode & "'"
    End If
...
'
        ...
        If Opt = "add" Or Opt = "mod" Then
           ...
           '10/04/15
            strSQL = ("update rm_arrival set passed ='Y', passdt ='" & Format(pdate, "yyyy-mm-dd") & _
                 ...
                 "',REMARKS='" & TXTFIELDS(31).Text & "', accallowrtpercandy = " & val(IIf(Trim(TXTFIELDS(25).Text) = "", 0, Trim(TXTFIELDS(25).Text))) & ",avrstrength = " & val(IIf(Trim(TXTFIELDS(11).Text) = "", 0, Trim(TXTFIELDS(11).Text))) & ", corr_strenth = " & val(IIf(Trim(TXTFIELDS(10).Text) = "", 0, Trim(TXTFIELDS(10).Text))) & ", GRADE='" & Trim(TXTFIELDS(53).Text) & "', GTEX= " & val(TXTFIELDS(54).Text) & ", COLOR=" & val(TXTFIELDS(55).Text) & ", yellowtouch=" & val(TXTFIELDS(51).Text) & ",immature=" & val(TXTFIELDS(50).Text) & ", mature= " & val(TXTFIELDS(44).Text) & ",halfmature= " & val(TXTFIELDS(52).Text) & ",MCOEFF= " & val(TXTFIELDS(43).Text) & ", " & _
                 " accallowrtperkg =" & val(TXTFIELDS(26).Text) & ",returnqty=" & val(IIf(Trim(TXTFIELDS(29).Text) = "", 0, Trim(TXTFIELDS(29).Text))) & ",returndate='" & Format(MaskEdBox1(1).Text, "yyyy/mm/dd") & "',lotstatus =" & val(TXTFIELDS(32).Text) & " ,STAPLEN25 = " & val(TXTFIELDS(48).Text) & ",STAPLEN50= " & val(TXTFIELDS(49).Text) & ",TRASH_PER= " & val(TXTFIELDS(16).Text) & ",MICRONAIRE= " & val(TXTFIELDS(13).Text) & ",UNIRATIO=" & val(TXTFIELDS(47).Text) & ",STAPHANDTEST=" & val(TXTFIELDS(59).Text) & ",MOITURE= " & val(TXTFIELDS(42).Text) & ",YARNAPP=" & val(TXTFIELDS(45).Text) & ",AVGCOUNT=" & val(TXTFIELDS(45).Text) & ",csp=" & val(TXTFIELDS(18).Text) & ",tpi=" & val(TXTFIELDS(12).Text) & ", " & _
                 " FAq=" & val(TXTFIELDS(61).Text) & ",sci=" & val(TXTFIELDS(62).Text) & ",bb=" & val(TXTFIELDS(63).Text) & ",rd=" & val(TXTFIELDS(64).Text) & ",SFCN =" & val(IIf(Trim(TXTFIELDS(156).Text) = "", 0, Trim(TXTFIELDS(156).Text))) & ",FINEMTX =" & val(IIf(Trim(TXTFIELDS(157).Text) = "", 0, Trim(TXTFIELDS(157).Text))) & ",NEPSUGM=" & val(IIf(Trim(TXTFIELDS(159).Text) = "", 0, Trim(TXTFIELDS(159).Text))) & ",SCNUGM  =" & val(IIf(Trim(TXTFIELDS(160).Text) = "", 0, Trim(TXTFIELDS(160).Text))) & ",MCOEFF1 =" & val(IIf(Trim(TXTFIELDS(154).Text) = "", 0, Trim(TXTFIELDS(154).Text))) & " where  LOTNO=" & adoPrimaryRS("LOTNO") & " AND arrno=" & adoPrimaryRS("arrno") & " and arrdate='" & Format(adoPrimaryRS("ARRDT"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'")
        ...
        strSQL = "update rm_Lot set Ins_Flg ='Y',SFI=" & val(TXTFIELDS(65).Text) & ",ELG=" & val(TXTFIELDS(66).Text) & "," & _
                 ...
                 " TRGrade=" & val(TXTFIELDS(69).Text) & ",LINT=" & val(TXTFIELDS(70).Text) & "," & _
                 " IVC=" & val(TXTFIELDS(71).Text) & ",SCNeps_g=" & val(TXTFIELDS(72).Text) & ", SPOTPasser = '" & Trim(TXTFIELDS(91).Text) & "',STAPLEN5= " & val(TXTFIELDS(134).Text) & "," & _
                 " SFCN1 =" & val(IIf(Trim(TXTFIELDS(156).Text) = "", 0, Trim(TXTFIELDS(156).Text))) & ",FINEMTX =" & val(IIf(Trim(TXTFIELDS(157).Text) = "", 0, Trim(TXTFIELDS(157).Text))) & ",NEPSUGM=" & val(IIf(Trim(TXTFIELDS(159).Text) = "", 0, Trim(TXTFIELDS(159).Text))) & ",SCNUGM  =" & val(IIf(Trim(TXTFIELDS(160).Text) = "", 0, Trim(TXTFIELDS(160).Text))) & ",MCOEFF1 =" & val(IIf(Trim(TXTFIELDS(154).Text) = "", 0, Trim(TXTFIELDS(154).Text))) & " where  LOTNO=" & adoPrimaryRS("LOTNO") & " AND arrno=" & adoPrimaryRS("arrno") & " " & _
                 " and arrdt='" & Format(adoPrimaryRS("ARRDT"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'"
        ...
        If Opt = "add" Then
            strSQL = ""
            strSQL = "update rm_Lot set ADDUSERNAME ='" & UserName & "'" & _
                 " where  LOTNO=" & adoPrimaryRS("LOTNO") & " AND arrno=" & adoPrimaryRS("arrno") & " " & _
                 " and arrdt='" & Format(adoPrimaryRS("ARRDT"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'"
            DB.Execute strSQL
        ElseIf Opt = "mod" Then
        ...
        strSQL = " UPDATE RM_LOT SET Csp=" & val(TXTFIELDS(18).Text) & ",risi=" & val(TXTFIELDS(77).Text) & "," & _
                ...
                " uniratio=" & val(TXTFIELDS(47).Text) & ",mcoeff=" & val(TXTFIELDS(43).Text) & ",short_fibre=" & val(TXTFIELDS(99).Text) & "" & _
                " where  LOTNO=" & adoPrimaryRS("LOTNO") & " AND arrno=" & adoPrimaryRS("arrno") & " " & _
                " and arrdt='" & Format(adoPrimaryRS("ARRDT"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'"
        DB.Execute strSQL
        ...
        DB.Execute strSQL
           ...
           If Opt = "add" Then
                ...
                rs5.Open "select isnull(iqa,'N') as iqa from rm_param ", DB, DB, adOpenStatic, adLockReadOnly
                If Not Rs.EOF Then
                    If rs5!iqa = "N" Then
                    Set getd = New Recordset
                        getd.Open "Select getdate() as GETDATE ", DB, adOpenStatic, adLockBatchOptimistic
        ...
        'Else
         '   If Opt = "add" Then
         '       strSQL = ""
         ''       strSQL = "update rm_Lot set Fappflg = 'N', FADDUSERNAME   ='" & UserName & "'" & _
          '           " where  LOTNO=" & adoPrimaryRS("LOTNO") & " AND arrno=" & adoPrimaryRS("arrno") & " " & _
          '           " and arrdt='" & Format(adoPrimaryRS("ARRDT"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'"
          '      DB.Execute strSQL
          '  End If
        ...
        DB.Execute ("update rm_LOT set issflg='Y'  where arrno=" & adoPrimaryRS("arrno") & " and arrdt='" & Format(adoPrimaryRS("ArrDt"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'  and lotno=" & adoPrimaryRS("lotno") & " and LotDt='" & Format(adoPrimaryRS("LotDt"), "YYYY-mm-DD") & "' And VarCode ='" & adoPrimaryRS("VarCode") & "' And CatCd ='" & adoPrimaryRS("CatCd") & "'")
...
'''        If val(TXTFIELDS(13).Text) > 0 Then SCI = Round(val(TXTFIELDS(62).Text), 2) ''Round(-364.6 + (2.9 * val(Txtfields(54).Text) - 9.32 * val(Txtfields(13).Text)) + (1.92 * val(Txtfields(48).Text)) + (8.73 * val(Txtfields(47).Text)), 2)
         ...
         DB.Execute ("update rm_lot set FQI=" & FQI & ",SCI=" & SCI & " where lotno = '" & adoPrimaryRS("LOTNO") & "' and catcd = '" & adoPrimaryRS("CATCD") & "' and ARRDT = '" & Format(adoPrimaryRS("ARRdT"), "yyyy-mm-dd") & "' and divcode='" & Divcode & "'")
...
''''        End If
        ...
        DB.Execute ("update rm_LOT set issflg='Y'  where arrno=" & adoPrimaryRS("arrno") & " and arrdt='" & Format(TXTFIELDS(2).Text, "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'  and lotno=" & adoPrimaryRS("lotno") & " and LotDt='" & Format(adoPrimaryRS("LotDt"), "YYYY-mm-DD") & "' And VarCode ='" & adoPrimaryRS("VarCode") & "' And CatCd ='" & adoPrimaryRS("CatCd") & "'")
                        ...
                        If val(TXTFIELDS(23).Text) <= rsa.RecordCount Then
                            ...
                            Do While Not adoGridRS.EOF
                                If adoGridRS("rejected") = "Y" Then
                                    DB.Execute "Update rm_bale set status='RJ',REJFLG='Y',REJDT='" & Format(pdate, "YYYY-MM-DD") & "' where baleno='" & adoGridRS("Bale No.") & "' and lotno='" & val(TXTFIELDS(1).Text) & "' and lotdt ='" & Format(TXTFIELDS(2).Text, "yyyy-mm-dd") & "' AND  DIVCODE='" & Divcode & "'"
                                End If
                                adoGridRS.MoveNext
                            Loop
                        End If
...
If Opt = "del" Then
        ...
        DB.Execute ("update rm_arrival set passed =null, passdt =null, accqty = null, accdt=null , rejqty =null, rejdt=null, accallowqty =null, accallowdt=null,REMARKS=null, accallowrtpercandy = null,avrstrength = null, corr_strenth = null, GRADE=null, GTEX= null, COLOR=null, yellowtouch=null,immature=null, mature= null,halfmature=null,MCOEFF= null,accallowrtperkg =null,returnqty=null,returndate=null,lotstatus =null ,STAPLEN25 = null,STAPLEN50= null,TRASH_PER= null,MICRONAIRE= null,UNIRATIO=null,STAPHANDTEST=null,MOITURE= null,YARNAPP=null,AVGCOUNT= null,csp=null,tpi=null,SFCN=NULL,FINEMTX =NULL,NEPSUGM=NULL,SCNUGM=NULL where arrno=" & ADOSECONDARYRS("arrno") & " and arrdate='" & Format(TXTFIELDS(2).Text, "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'")
...
''         txtFields(91).Text = adoPrimaryRS("mr")
         ...
         '
         TXTFIELDS(154).Text = adoPrimaryRS("MCOEFF1")
         TXTFIELDS(156).Text = adoPrimaryRS("SFCN1")
         TXTFIELDS(157).Text = adoPrimaryRS("FINEMTX")
         TXTFIELDS(159).Text = adoPrimaryRS("NEPSUGM")
         TXTFIELDS(160).Text = adoPrimaryRS("SCNUGM")
...
'                Txtfields(61).Text = "0.00"
            Else
               If val(TXTFIELDS(13).Text) <> 0 Then
                    ...
                    TXTFIELDS(61).Text = Format(Round((val(TXTFIELDS(49).Text) * val(TXTFIELDS(54).Text) * val(TXTFIELDS(43).Text)) / val(TXTFIELDS(13).Text), 2), "0.00")
                    'MsgBox TXTFIELDS(43).Text
