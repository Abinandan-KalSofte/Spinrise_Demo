...
Begin VB.Form Frm_SustainRptType 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   5520
         Picture         =   "Frm_SustainRptType.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":0442
         Height          =   510
         Index           =   6
         Left            =   2820
         Picture         =   "Frm_SustainRptType.frx":088C
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":0BD9
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "Frm_SustainRptType.frx":0EE3
         Style           =   1  'Graphical
         TabIndex        =   0
         ToolTipText     =   "Add"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":1276
         Height          =   510
         Index           =   5
         Left            =   2265
         Picture         =   "Frm_SustainRptType.frx":16C0
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":1A25
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1155
         Picture         =   "Frm_SustainRptType.frx":1D2F
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Delete"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":20CB
         Height          =   510
         Index           =   1
         Left            =   600
         Picture         =   "Frm_SustainRptType.frx":23D5
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Modify"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   1710
         Picture         =   "Frm_SustainRptType.frx":274F
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "List"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":2AE6
         Height          =   510
         Index           =   7
         Left            =   3375
         Picture         =   "Frm_SustainRptType.frx":2F30
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":3280
         Height          =   510
         Index           =   11
         Left            =   6075
         Picture         =   "Frm_SustainRptType.frx":36CA
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Exit"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":3A5F
         Height          =   510
         Index           =   9
         Left            =   4485
         Picture         =   "Frm_SustainRptType.frx":3D69
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Save"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "Frm_SustainRptType.frx":410B
         Height          =   510
         Index           =   10
         Left            =   5040
         Picture         =   "Frm_SustainRptType.frx":4415
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Cancel "
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_SustainRptType.frx":4791
         Height          =   510
         Index           =   8
         Left            =   3930
         Picture         =   "Frm_SustainRptType.frx":4BDB
         Style           =   1  'Graphical
         TabIndex        =   8
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   " "
      TabPicture(0)   =   "Frm_SustainRptType.frx":4F3D
   ...
   End
End
Attribute VB_Name = "Frm_SustainRptType"
...
'addition
        Opt = "add"
         ...
         adoPrimaryRS.Open "select Code 'Code', Description 'Description' from RM_SustainRMType where 1=2", DB, adOpenStatic, adLockBatchOptimistic
         adoPrimaryRS.AddNew
...
'modification
        'Opt = "mod"
        If Record_Exists("RM_SustainRMType", "No Records Found") = False Then Exit Sub
            Opt = "mod"
                Screen.MousePointer = 11
                desc.Caption = "Modification"
                stbar.Panels(2).Text = "Modification"
                DB.BeginTrans
                stbar.Panels(2).Text = "Select Rmi Type Code from the List"
                grdDataGrid.AllowUpdate = True
                 ...
                 adoPrimaryRS.MoveFirst
                    ...
                    Do While Not adoPrimaryRS.EOF
                        ...
                        adoPrimaryRS("Description") = Trim(grdDataGrid.Columns(1).Text)
                            ...
                            TrnLog("Trans_Name") = "Sustainable Report Type"
         ...
         If Opt = "del" Then
          On Error GoTo delerr:
                      a% = MsgBox("Are you sure you want to delete?", vbYesNo, head)
                           If a = 6 Then
                        DB.Execute ("delete from RM_SustainRMType where Code='" & grdDataGrid.Columns(0).Text & "'")
...
Case 12
    ...
    Set Cystalrptbunk.cryRept = Cry_General_Category
            ...
            If ColIndex = 1 Then
                    If grdDataGrid.Columns(1).Text <> Empty Then
                        ...
                        Set Rs = New Recordset
                            Rs.Open "select 'Description'  from RM_SustainRMType where Description ='" & grdDataGrid.Columns(1).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                                If Not Rs.BOF Then
    ...
    grdDataGrid.EditActive = True
            If ColIndex = 0 Then
                    If grdDataGrid.Columns(0).Text <> Empty Then
                        Set Rs = New Recordset
                            Rs.Open "select 'Code'  from RM_SustainRMType where Code ='" & grdDataGrid.Columns(0).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                                If Not Rs.BOF Then
...
On Error GoTo lovok_Click_Error
       ...
       grdDataGrid.Visible = True
       Set adoPrimaryRS = New Recordset
       adoPrimaryRS.Open "select Code,Description from RM_SustainRMType where Code ='" & Ksldesc1.Code & "' Order by Code", DB, adOpenStatic, adLockBatchOptimistic
       Set grdDataGrid.DataSource = adoPrimaryRS
...
intervalMinutes = -1
    If Opt = " " Or Opt = "qry" Then
        ...
        Set adoPrimaryRS = New Recordset
        adoPrimaryRS.Open "select Code 'Code',Description 'Description' from RM_SustainRMType Order by Code", DB, adOpenStatic, adLockOptimistic
        If adoPrimaryRS.RecordCount = 0 Then
   ...
   End If
    ...
    If Opt = "mod" Then
        'Set adoPrimaryRS = New Recordset
        'adoPrimaryRS.Open "select Code,Description from RM_SustainRMType where Code ='" & Trim(Ksldesc1.code) & "' and Description ='" & Trim(Ksldesc1.Description) & "'", db, adOpenStatic, adLockBatchOptimistic
        Call bindcontls
        Call ENABLCONTLS
        grdDataGrid.Columns(0).Locked = True
    End If
...
On Error GoTo header_Error
            ...
            Print #a, Space(5) + "RMIType LISTING  " + Space(20) + "Dt: " & Str + "Pg.:" + Padl(CStr(pg), 3, " ")

            Set Rs = New Recordset
            Rs.Open "select Code,Description from RM_SustainRMType", DB, adOpenStatic, adLockOptimistic
                If Rs.BOF Then
                    MsgBox "No Records Found", vbInformation, head
                    Close #a
                    Exit Sub
...
On Error GoTo MODLOOKUP_Error
    ...
    If LookUp.Cancel = False Then
        If Opt = "mod" Then
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open " select Code 'Code',Description 'Description' from RM_SustainRMType where Code ='" & LookUp.Fields(0) & "'", DB, adOpenStatic, adLockBatchOptimistic
            Set grdDataGrid.DataSource = adoPrimaryRS
            grdDataGrid.AllowAddNew = False
            grdDataGrid.Columns(0).Locked = True
            grdDataGrid.Col = 1
