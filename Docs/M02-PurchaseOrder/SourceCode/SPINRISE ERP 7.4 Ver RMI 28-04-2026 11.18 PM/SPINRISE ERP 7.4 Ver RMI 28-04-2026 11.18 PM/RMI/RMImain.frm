...
Begin VB.MDIForm RMImain 
   ...
   Begin VB.Menu mnuTran 
      ...
      Begin VB.Menu mnuSep 
         Caption         =   "-"
      End
      Begin VB.Menu mnuissuereq 
         Caption         =   "&7. Issue Request"
      ...
      Begin VB.Menu Godowntrans 
         Caption         =   "&8. Godown Transfer"
      End
      Begin VB.Menu mnuadj 
         Caption         =   "&9. Adjustments"
      End
      Begin VB.Menu mnuPurchasebill 
         Caption         =   "&a. Purchase Bills Entry"
         Index           =   0
      End
      Begin VB.Menu mnucottonsales 
         Caption         =   "&b. Raw Material Sales Invoice"
      End
      Begin VB.Menu d 
         Caption         =   "-"
      End
      Begin VB.Menu mnuwissue 
         Caption         =   "&c. Waste Issue"
      End
      Begin VB.Menu mnu_cottonplan 
         Caption         =   "&d. Raw Material Bales Requirement Plan"
         Visible         =   0   'False
      End
      Begin VB.Menu mnutrasStkUpdation 
         Caption         =   "&e. Stock Updation"
      End
      Begin VB.Menu mnuTransConsupUpdation 
         Caption         =   "&f. Consumption Updation"
      End
   ...
   Begin VB.Menu mnu_reports 
      ...
      Begin VB.Menu mnu_period 
         ...
         Begin VB.Menu mnuRptAdjustRegister 
            Caption         =   "&m. Adjustment Register"
         End
         Begin VB.Menu mnu_stock_stat 
            Caption         =   "&n. Stock Statement"
            ...
            Begin VB.Menu mnu_godownwise 
               Caption         =   "&3. Godownwise"
            End
            Begin VB.Menu mnustkstation 
               Caption         =   "&4. Stationwise"
            End
         End
         Begin VB.Menu mnu_stockled 
            Caption         =   "&o. Stock Ledger"
         ...
         Begin VB.Menu mnu_cottonbincard 
            Caption         =   "&p. Raw Material Bin Card"
            Shortcut        =   {F9}
         End
         Begin VB.Menu mnu_Cotton_Reconcilation 
            Caption         =   "&q. Lot wise Loss or Gain Report"
         End
         Begin VB.Menu mnumixingCost 
            Caption         =   "&r. Mixing Cost "
         End
         Begin VB.Menu mnusep17 
            Caption         =   "-"
         End
         Begin VB.Menu mnu_rejectedarr 
            Caption         =   "&s. Raw Material Sales Day Book"
            Index           =   1
         End
         ...
         Begin VB.Menu mnumakrecpt 
            Caption         =   "&v. Market Committee Report"
         End
         Begin VB.Menu mnu_insurancereport 
            Caption         =   "&w. Insurance Report"
         End
         Begin VB.Menu mnuSep18 
            Caption         =   "-"
         End
         Begin VB.Menu mnuNotBillRegister 
            Caption         =   "&x. Pending Bill Receipt"
         End
         Begin VB.Menu mnuPendingBillEntry 
            Caption         =   "&y. Pending Bill Entry Report"
            Index           =   3
         End
      End
   ...
   Begin VB.Menu mnu_Queries 
      ...
      Begin VB.Menu mnuexceptionalreport 
         Caption         =   "&4. Stock Exception"
      End
      Begin VB.Menu mnulothistory 
         Caption         =   "&5. Lot History"
      End
   End
   ...
   Begin VB.Menu mnuSetup 
      ...
      Begin VB.Menu mnuFibreNorms 
         Caption         =   "&n. Fibre Norms"
      End
      Begin VB.Menu mnuSPOT 
         Caption         =   "&o. SPOT Passing Person"
      End
   End
...
Insert:
    ...
    For I = 0 To Me.Controls.Count - 1
        If TypeOf Me.Controls(I) Is Menu Then
            ...
            If MnuName = "mnucomissue" Or MnuName = "mnimixingissue" Then
                grpname = "Purchase Order"
            End If
