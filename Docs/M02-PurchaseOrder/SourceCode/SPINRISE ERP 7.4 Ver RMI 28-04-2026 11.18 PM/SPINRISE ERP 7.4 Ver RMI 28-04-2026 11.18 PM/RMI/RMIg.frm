...
'       Adodc1.Refresh
        ...
        adoprimaryrs.Open "select areacode ""Code"" ,areaname ""Name"" from rm_area where 1=2 order by areacode", db, adOpenStatic, adLockBatchOptimistic
...
'modification
        ...
        scodlist1.table = "rm_area"
        scodlist1.listfield1 = "areacode"
...
'list
    ...
    Call repproc2(rptarea)
        ...
        End If
        dv1.rsCommand1.Open "select areacode,areaname from rm_area   Order by areacode", db, adOpenStatic, adLockOptimistic
...
Private Sub Command3_Click()
  ...
  grddatagrid.Visible = True
    ...
    'Adodc1.Refresh
    Set adoprimaryrs = New Recordset
    adoprimaryrs.Open "select areacode ""Code"" ,areaname ""Name"" from rm_area  where areacode = '" & scodlist1.Code & "' order by areacode", db, adOpenStatic, adLockBatchOptimistic
    Set grddatagrid.DataSource = adoprimaryrs
    'Set grdDataGrid.DataSource = Adodc1.Recordset
    grddatagrid.Columns(0).Width = 1140.095
    grddatagrid.Columns(1).Width = 4164.095
