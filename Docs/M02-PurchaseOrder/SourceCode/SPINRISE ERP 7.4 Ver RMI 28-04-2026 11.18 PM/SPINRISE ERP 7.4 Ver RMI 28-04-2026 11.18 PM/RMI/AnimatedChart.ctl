...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        uColorBars = .ReadProperty("uColorBars", True)
...
Public Sub DrawChart()
    ...
    For X = 0 To cItems.Count - 1
        ...
        If uDisplayXAxis Then
            ...
            yTemp = (UserControl.ScaleHeight - uBottomMargin + UserControl.TextWidth(oChartItem.XAxisDescription) / 1.75) / Screen.TwipsPerPixelY
