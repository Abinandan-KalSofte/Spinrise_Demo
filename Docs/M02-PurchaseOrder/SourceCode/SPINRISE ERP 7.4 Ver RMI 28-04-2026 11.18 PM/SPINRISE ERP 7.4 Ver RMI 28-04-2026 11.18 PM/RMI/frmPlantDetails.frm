...
Begin VB.Form frmPlantDetails 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   5760
         Picture         =   "frmPlantDetails.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":0442
         Height          =   550
         Index           =   4
         Left            =   2160
         Picture         =   "frmPlantDetails.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":0AE1
         Height          =   550
         Index           =   8
         Left            =   4200
         Picture         =   "frmPlantDetails.frx":0F2B
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":128D
         Height          =   550
         Index           =   10
         Left            =   5250
         Picture         =   "frmPlantDetails.frx":1597
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":1913
         Height          =   550
         Index           =   9
         Left            =   4725
         Picture         =   "frmPlantDetails.frx":1C1D
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":1FBF
         Height          =   550
         Index           =   11
         Left            =   6375
         Picture         =   "frmPlantDetails.frx":2409
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":279E
         Height          =   550
         Index           =   7
         Left            =   3675
         Picture         =   "frmPlantDetails.frx":2BE8
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   1620
         Picture         =   "frmPlantDetails.frx":2F38
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":32CF
         Height          =   550
         Index           =   1
         Left            =   570
         Picture         =   "frmPlantDetails.frx":35D9
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":3953
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1095
         Picture         =   "frmPlantDetails.frx":3C5D
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":3FF9
         Height          =   550
         Index           =   5
         Left            =   2625
         Picture         =   "frmPlantDetails.frx":4443
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":47A8
         Height          =   550
         Index           =   0
         Left            =   45
         Picture         =   "frmPlantDetails.frx":4AB2
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmPlantDetails.frx":4E45
         Height          =   550
         Index           =   6
         Left            =   3150
         Picture         =   "frmPlantDetails.frx":528F
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   "        "
      TabPicture(0)   =   "frmPlantDetails.frx":55DC
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command1 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "frmPlantDetails.frx":55F8
         Height          =   615
         Left            =   4710
         Picture         =   "frmPlantDetails.frx":59DA
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   4110
         Width           =   1185
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&OK"
         Default         =   -1  'True
         DownPicture     =   "frmPlantDetails.frx":5DAD
         Height          =   615
         Left            =   3000
         Picture         =   "frmPlantDetails.frx":6193
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   4110
         Width           =   1185
   ...
   End
End
Attribute VB_Name = "frmPlantDetails"
...
openconnection_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure openconnection of Form Plant"
End Sub
...
'addition
        ...
        adoPrimaryRS.Open "select PLCode "" Code"" ,PLName "" Name"" from RM_Plant where 1=2 order by PLCode", DB, adOpenStatic, adLockBatchOptimistic
...
Case 1
    ...
    Rs.Open "select count(*) from RM_Plant", DB
    If Not Rs(0) = 0 Then
        Opt = "mod"
        ...
        DB.BeginTrans
         ...
         LookUp.Clear = True
         LookUp.query = "select PLCode AS ' Code',PLName as ' Name' from RM_Plant "
         ...
         If LookUp.Cancel = False Then
            ...
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open "select PLCode ""Code"" ,PLName "" Name"" from RM_Plant where PLCode = '" & LookUp.Fields(0) & "' order by PLCode", DB, adOpenStatic, adLockBatchOptimistic
            Set grddatagrid.DataSource = adoPrimaryRS
            grddatagrid.Columns(0).Width = 2000
            grddatagrid.Columns(1).Width = 3500
    ...
    If Not Rs(0) = 0 Then
        ...
        DB.BeginTrans
         ...
         If LookUp.Cancel = False Then
            ...
            StatusBar1.Panels(2).Text = ""
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open "select PLCode AS 'Code',PLName as 'Name' from RM_Plant  where PLCode = '" & LookUp.Fields(0) & "'  order by PLCode", DB, adOpenStatic, adLockBatchOptimistic
            Set grddatagrid.DataSource = adoPrimaryRS
            grddatagrid.Columns(0).Width = 2000
            grddatagrid.Columns(1).Width = 3500
...
''        Frame3.ZOrder
        ...
        'BUTTON(10).Enabled = False
        'BUTTON(9).ToolTipText = "Delete"
        StatusBar1.Panels(2).Text = "Select Plant Code from the list"
        Screen.MousePointer = 0
        'Frame3.Visible = True
Case 3
        'list
    ...
    Set Rs = New Recordset
    Rs.Open "select * from RM_Plant Order by PLCode", DB, adOpenStatic
...
'        Set rsP = New Recordset
        ...
        'Open "C:\red.txt" For Output As #1
            ...
            Rs.MoveFirst
            Do While Not Rs.EOF
                Print #1, Space(3); Padr(iCount, 10, " ") + Space(4) + Padr(Rs("PLCode"), 20, " ") + Space(4) + Padr(Rs("PLName"), 41, " ")
                iRow = iRow + 1
                iCount = iCount + 1
                    If iRow > 60 Then
                        Print #1,
...
'Save
      ...
      If grddatagrid.Columns(1).Text = "" Then
        MsgBox " Name Can't be Empty", vbInformation, head
        grddatagrid.Col = 1
        grddatagrid.SetFocus
        Exit Sub
      End If
          ...
          '  If Opt = "add" Then
            ...
            TrnLog("Trans_Name") = "Plant Details"
...
'       End If
     End If
       ...
       If Opt = "del" Then
         ...
         If msg = vbYes Then
            DB.Execute ("delete from RM_Plant where PLCode=" + "'" + grddatagrid.Columns(0) + "'")
...
Case 12
    ...
    Set Cystalrptbunk.cryRept = Cry_Plant
...
Exit Sub
BUTTON_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure BUTTON_Click of Form FrmPlant", vbInformation, head
End Sub
...
Command3_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Command3_Click of Form FrmPlant", vbInformation, head
End Sub
...
Exit Sub
Form_Load_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Load of Form FrmPlant", vbInformation, head
End Sub
...
On Error GoTo GrdDatagrid_AfterColUpdate_Error
        ...
        If ColIndex = 0 Then
            ...
            Else
                Set Rs = New Recordset
                Rs.Open "select 'X'  from RM_Plant where PLCode='" & grddatagrid.Columns(0).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                If Not Rs.BOF Then
        ...
        If ColIndex = 1 Then
            ...
            Else
                Set Rs = New Recordset
                Rs.Open "select 'X'  from RM_Plant where PLName='" & grddatagrid.Columns(1).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                If Not Rs.BOF Then
...
GrdDatagrid_AfterColUpdate_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grddatagrid_AfterColUpdate of Form FrmPlant", vbInformation, head
        End Sub
...
grddatagrid_AfterColEdit_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grdDataGrid_AfterColEdit of Form FrmPlant", vbInformation, head
End Sub
...
GRDDATAGRID_GotFocus_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grdDataGrid_GotFocus of Form FrmPlant", vbInformation, head
Screen.MousePointer = 0
End Sub
...
GrdDatagrid_KeyDown_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grddatagrid_KeyDown of Form FrmPlant", vbInformation, head
Screen.MousePointer = 0
End Sub
...
GrdDatagrid_KeyPress_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure GRDDATAGRID_KeyPress of Form FrmPlant", vbInformation, head
Screen.MousePointer = 0
End Sub
...
On Error GoTo er1
  ...
  'Adodc1.Refresh
  Set adoPrimaryRS = New Recordset
  adoPrimaryRS.Open "select PLCode AS ' Code',PLName as ' Name' from RM_Plant order by PLCode", DB, adOpenStatic, adLockReadOnly
  Set grddatagrid.DataSource = adoPrimaryRS
...
If Opt = "add" Then
   ...
   ElseIf Opt = "mod" Then
     If grddatagrid.Col = 1 Then
          StatusBar1.Panels(2).Text = "Modify  Name"
     End If
End If
...
grdDataGrid_RowColChange_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure GRDDATAGRID_RowColChange of Form FrmPlant", vbInformation, head
End Sub
...
'    Print #1,
    ...
    Print #1, Space(2) & String(80, "-")
    Print #1, Space(2); " Sl No.         Code              Name"
    Print #1, Space(2) & String(80, "-")
End Sub
