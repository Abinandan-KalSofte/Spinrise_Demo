...
Begin VB.Form frm_CreditNoteReceivable 
   Caption         =   "Credit Note received"
   ClientHeight    =   8490
   ClientLeft      =   165
   ClientTop       =   -1995
   ClientWidth     =   11130
   ...
   Begin VB.PictureBox FrameDiscType 
      ...
      Begin FPSpreadADO.fpSpread SPDDiscTypeDet2 
         ...
         SpreadDesigner  =   "frm_CreditNoteReceivable.frx":0000
         AppearanceStyle =   0
      End
      Begin FPSpreadADO.fpSpread SPDDiscTypeDet 
         ...
         ProcessTab      =   -1  'True
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "frm_CreditNoteReceivable.frx":0477
         Appearance      =   2
      End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "frm_CreditNoteReceivable.frx":08F5
         Left            =   2040
         List            =   "frm_CreditNoteReceivable.frx":0905
         TabIndex        =   109
         Text            =   "Purchase Bill"
         Top             =   960
         Width           =   2295
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   13
         Left            =   4800
         Picture         =   "frm_CreditNoteReceivable.frx":0946
         Style           =   1  'Graphical
         TabIndex        =   33
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   4
         Left            =   11295
         Picture         =   "frm_CreditNoteReceivable.frx":0D88
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":111F
         Height          =   510
         Index           =   3
         Left            =   1140
         Picture         =   "frm_CreditNoteReceivable.frx":1429
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   8970
         Picture         =   "frm_CreditNoteReceivable.frx":17BE
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":1C00
         Height          =   510
         Index           =   8
         Left            =   3240
         Picture         =   "frm_CreditNoteReceivable.frx":204A
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":23AC
         Height          =   510
         Index           =   10
         Left            =   4290
         Picture         =   "frm_CreditNoteReceivable.frx":26B6
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":2A32
         Height          =   510
         Index           =   9
         Left            =   3765
         Picture         =   "frm_CreditNoteReceivable.frx":2D3C
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":30DE
         Height          =   510
         Index           =   11
         Left            =   5340
         Picture         =   "frm_CreditNoteReceivable.frx":3528
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":38BD
         Height          =   510
         Index           =   7
         Left            =   2715
         Picture         =   "frm_CreditNoteReceivable.frx":3D07
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":4057
         Height          =   510
         Index           =   5
         Left            =   1665
         Picture         =   "frm_CreditNoteReceivable.frx":44A1
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":4806
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "frm_CreditNoteReceivable.frx":4B10
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":4EA3
         Height          =   510
         Index           =   6
         Left            =   2205
         Picture         =   "frm_CreditNoteReceivable.frx":52ED
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":563A
         Height          =   510
         Index           =   1
         Left            =   6720
         Picture         =   "frm_CreditNoteReceivable.frx":5944
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_CreditNoteReceivable.frx":5CBE
         BeginProperty Font 
            Name            =   "System"
            Size            =   9.75
            Charset         =   0
         ...
         Index           =   2
         Left            =   615
         Picture         =   "frm_CreditNoteReceivable.frx":5FC8
         Style           =   1  'Graphical
         TabIndex        =   14
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpreadADO.fpSpread SpdLCReq 
         ...
         ProcessTab      =   -1  'True
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "frm_CreditNoteReceivable.frx":6364
         Appearance      =   2
      End
      Begin MSMask.MaskEdBox MaskEdBox1 
         DataField       =   "PaidDate"
      ...
      Begin FPSpreadADO.fpSpread SPD_MDISCDETAILS 
         ...
         ProcessTab      =   -1  'True
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "frm_CreditNoteReceivable.frx":67E2
         Appearance      =   2
      End
      Begin VB.Label lblLabels 
         AutoSize        =   -1  'True
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frm_CreditNoteReceivable.frx":6C60
         Left            =   6600
         List            =   "frm_CreditNoteReceivable.frx":6C6D
         TabIndex        =   80
         Text            =   "LRNo"
         Top             =   600
         Width           =   1815
      ...
      Begin FPSpreadADO.fpSpread SPDPO1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frm_CreditNoteReceivable.frx":6C88
         AppearanceStyle =   0
      End
      Begin FPSpreadADO.fpSpread spdPO 
         ...
         EndProperty
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "frm_CreditNoteReceivable.frx":70CA
      End
      Begin FPSpreadADO.fpSpread SPDPO5 
         ...
         ProcessTab      =   -1  'True
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "frm_CreditNoteReceivable.frx":7517
         Appearance      =   2
      End
   ...
   Begin FPUSpreadADO.fpSpread S1pdLCReq1 
      ...
      ProcessTab      =   -1  'True
      ScrollBarExtMode=   -1  'True
      SpreadDesigner  =   "frm_CreditNoteReceivable.frx":7995
      Appearance      =   2
   End
   ...
   Begin VB.Label heading 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Credit Note Receivable"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   15.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_CreditNoteReceivable"
  ...
  If Opt = " " Or Opt = "fnd" Or Opt = "" Then
     ...
     With SpdLCReq
        ...
        Do While Not adoSecondaryRS.EOF
            ...
            .SetText eLCReqDtls.E_PJTC, RW, adoSecondaryRS("pjvtc")
            ...
            .SetText eLCReqDtls.E_BasicRate, RW, adoSecondaryRS("Basic_Rate")
            .SetText eLCReqDtls.E_AgreedRate, RW, adoSecondaryRS("Agreed_Rate")
            .SetText eLCReqDtls.E_Diff_Rate, RW, adoSecondaryRS("Rate_Diff") '
            ...
            .SetText eLCReqDtls.E_InvoiceDate, RW, adoSecondaryRS("Invoicedt")
             ...
             .SetText eLCReqDtls.E_CONTDT, RW, adoSecondaryRS("contdt")
             .SetText eLCReqDtls.E_ContNo, RW, adoSecondaryRS("contno")
             .SetText eLCReqDtls.E_MDocDT, RW, adoSecondaryRS("mdocdt")
             .SetText eLCReqDtls.E_MDocno, RW, adoSecondaryRS("mdocno")

             .SetText eLCReqDtls.E_LotDate, RW, adoSecondaryRS("lotdt")
            ...
            .SetText eLCReqDtls.E_Receivedamt, RW, adoSecondaryRS("Received_Amt")
            .SetText eLCReqDtls.E_Receivable, RW, adoSecondaryRS("Receivable_Amt")

            .SetText eLCReqDtls.E_Diff_Value, RW, adoSecondaryRS("Basic_Amt")
            .SetText eLCReqDtls.E_TotCNDiscReceivable, RW, adoSecondaryRS("TotCN_RecvableAmt")
            .SetText eLCReqDtls.E_TotCNDiscRate, RW, adoSecondaryRS("TotCN_Rate")
            .SetText eLCReqDtls.E_TotCNDiscValue, RW, adoSecondaryRS("TotCN_Amt")
            .SetText eLCReqDtls.E_TaxCode, RW, adoSecondaryRS("TAx_Code")
            .SetText eLCReqDtls.E_TotAssDisc, RW, adoSecondaryRS("TotDisc_Amt")
            .SetText eLCReqDtls.E_TaxCode, RW, adoSecondaryRS("TAx_Code")
            .SetText eLCReqDtls.E_TaxCode, RW, adoSecondaryRS("TAx_Code")
            .SetText eLCReqDtls.E_TaxCode, RW, adoSecondaryRS("TAx_Code")
            .SetText eLCReqDtls.E_TaxCode, RW, adoSecondaryRS("TAx_Code")
            ...
            .SetText eLCReqDtls.E_Remarks, RW, adoSecondaryRS("remarks")
...
'         .Row = nRow
'         If Val(GetText(SpdLCReq, E_BasicRate, nRow)) > 0 Then
'             .SetText E_Value, .Row, Format(Val(GetText(SpdLCReq, E_Amount, nRow)) * Val(txtfields(11).Text), "0.00")
'             nTotalQty = nTotalQty + GetText(SpdLCReq, E_BasicRate, nRow)
'         End If
'     Next
'     End With
...
Case 0
      ...
      ' If Record_Exists("IM_LCType", "Please define LC Type in Setup") = False Then Exit Sub
       ...
       adoPrimaryRS.Open "SELECT Divcode,Docno,Docdt,slcode,Billno,Billdt,MDApp_copy,TotalBales,TotalKgs,Disc_Value,other_amt,GSTCode,GSTPer,GSTAmt,CGSTAmt,SGSTAmt,IGSTAmt,Roff_amt,Total_Amt,Remarks,PJVTC,PJVNO,PJVDT,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,HostID FROM RM_CNReceivedHD WHERE 1=2 Order by DivCode,DocNo", DB, adOpenStatic, adLockBatchOptimistic


       Set adoSecondaryRS = New Recordset
       adoSecondaryRS.Open "SELECT Divcode,Docno,Docdt,DOCSNO,PJVTC,PJVNO,PJVDT,CONTNO,CONTDT,LOTNO,LOTDT,InvoiceNo,InvoiceDT,MDOCNO,MDOCDT,Varcode,Rate,Bales,TotalKgs,inv_Amt,Agreed_Rate,Basic_Rate,Rate_Diff,Basic_Amt,Receivable_Amt,Received_Amt,TotCN_Rate,TotCN_Amt,TotDisc_Amt,TAx_Code,CGSTPER,CGSTAmt,SGSTPER,SGSTAmt,IGSTPER,IGSTAmt,TotalAmt,REMARKS,TotCN_RecvableAmt FROM RM_CNReceivedDT a Where a.divcode='" & Divcode & "' And 1=2 Order by a.DocSNo", DB, adOpenStatic, adLockBatchOptimistic
       ...
       DB.Execute "Delete from RM_CNReceivedtxn where IPADD ='" & LocalIPAdd & "'  and divcode='" & Divcode & "' "


Case 1 'modification
       'If ToValidFinYear = False Then Exit Sub
       If Record_Exists("RM_CNReceivedDT Where Docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' And divcode = '" & Divcode & "'") = False Then Exit Sub
        Opt = "mod"
...
Case 2
       ...
       ' If ToValidFinYear = False Then Exit Sub
        ...
        LookUp.Clear = True
      '  LookUp.query = "SELECT Distinct h.DocNo ""Doc.No."",h.Docdt ""Date"",s.slname ""Party Name"",s.City,h.Slcode ""Party Code"" FROM  RM_CNReceivedHD h,RM_CNReceivedDT l, FA_SLMAS s Where h.divcode = '" & Divcode & "' And h.divcode = l.divcode and h.DocNo = l.DocNo And h.Docdt = l.Docdt and h.Slcode = s.slcode and isnull(FirstFR_AppFlg,'N')<>'Y' and h.Docdt=(select max(Docdt) from RM_CNReceivedHD where divcode='" & Divcode & "') " ''and h.Docdt  between '" & Format(yfdate, "yyyy-mm-dd") & "'  and '" & Format(yldate, "yyyy-mm-dd") & "'
        LookUp.query = "SELECT Distinct h.DocNo ""Doc.No."",h.Docdt ""Date"",s.slname ""Party Name"",s.City,h.Slcode ""Party Code"",Billno 'Bill No.',Billdt 'Bill Date',h.PJVTC,h.PJVNO,h.PJVDT FROM  RM_CNReceivedHD h inner join RM_CNReceivedDT l on  h.divcode = l.divcode and h.DocNo = l.DocNo And h.Docdt = l.Docdt inner join  FA_SLMAS s on h.Slcode = s.slcode " & _
                    " left join fa_purjvhead p on p.vocno=h.pjvno and h.pjvdt=p.vocdt and h.divcode=p.Divcode and p.tc=h.pjvtc Where p.appflg is null and h.divcode = '" & Divcode & "'  and h.Docdt=(select max(Docdt) from RM_CNReceivedHD where divcode='" & Divcode & "') " '' and isnull(FirstFR_AppFlg,'N')<>'Y' and PaidDate is null and h.Docdt  between '" & Format(yfdate, "yyyy-mm-dd") & "'  and '" & Format(yldate, "yyyy-mm-dd") & "'

        LookUp.Caption = "Credit Note Received Listing"
        LookUp.DefCol = "Doc.No."
        LookUp.ALIGN = "1000,1100,5000,1500,0,0,0,0,0,0"
        LookUp.Show vbModal
        If LookUp.Cancel = False Then
...
Case 3
        ...
        LookUp.Clear = True
        qry = "SELECT Distinct h.DocNo ""Doc No."",h.Docdt ""Date"",s.slname ""Party Name"",s.City,h.Slcode ""Party Code"",h.PJVTC,h.PJVNO,h.PJVDT FROM  RM_CNReceivedHD h,RM_CNReceivedDT l, FA_SLMAS s Where h.divcode = '" & Divcode & "'  And h.divcode = l.divcode and h.DocNo = l.DocNo And h.Docdt = l.Docdt and h.Slcode = s.slcode and h.Docdt between '" & Format(yfdate, "yyyy-mm-dd") & "'  and '" & Format(yldate, "yyyy-mm-dd") & "' "
...
'                Rs.Open "SELECT pjvno FROM RM_CNReceivedHD WHERE Docdt BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' and PJVtc='" & val(txtfields(27).Text) & "'  and PJVNO =" & val(txtfields(28).Text), db, adOpenStatic
'                If Rs.EOF = False Then
'                        MsgBox "P.J.V. Number is " & val(txtfields(28).Text), vbInformation, head
'                End If
'
'                Set Rs = New Recordset
'                Rs.Open "SELECT ISNULL(MAX(pjvno),0)+1 FROM fa_purhd WHERE pjvdt BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' and tc='" & val(txtfields(27).Text) & "'", db, adOpenStatic
...
'            End If
        ...
        For nRow = 1 To SpdLCReq.MaxRows
                SpdLCReq.Row = nRow
                SpdLCReq.SetActiveCell E_BasicRate, nRow
                If val(GetText(SpdLCReq, E_PJVNO, nRow)) <> 0 Then
'                    If val(GetText(SpdLCReq, E_Diff_Rate, nRow)) = 0 Then
'                        MsgBox "Freight Approved Amount Cannot be Zero", vbInformation, head
'                        Exit Sub
'                    End If
'
'                    If val(GetText(SpdLCReq, E_AgreedRate, nRow)) = 0 Then
'                        MsgBox "Freight Bill Amount Cannot be Zero", vbInformation, head
'                        Exit Sub
'                    End If
'                    If val(GetText(SpdLCReq, E_Diff_Rate, nRow)) > val(GetText(SpdLCReq, E_AgreedRate, nRow)) Then
          ...
          If Opt = "mod" Then
            If FreightBillEntryType = "S" Then
                If MaskEdBox1(3).Text = "__/__/____" Or IsDate(MaskEdBox1(3).Text) = False Then
                    ...
                    Exit Sub
                End If
               ' db.Execute "update RM_CNReceivedHD set PaidDate='" & Format(MaskEdBox1(3).Text, "YYYY-mm-dd") & "' Where Divcode='" & Divcode & "' And DocNo=" & adoPrimaryRS("DocNo") & " And Docdt='" & Format(adoPrimaryRS("Docdt"), "yyyy-mm-dd") & "' "
...
'            adoPrimaryRS("pjvtc") = Trim(Trim(txtfields(27).Text))
            ...
            adoPrimaryRS("Disc_Value") = Format(val(txtfields(15).Text), "0.00")
...
'            adoPrimaryRS("FreightApp_Amt") = val(txtfields(11).Text)
           ...
           '  adoPrimaryRS("TDS_Amt") = val(txtfields(3).Text)
            ...
            If Opt = "mod" Then
                DB.Execute "Delete From RM_CNReceivedDT Where Divcode='" & Divcode & "' And DocNo=" & adoPrimaryRS("DocNo") & " And Docdt='" & Format(adoPrimaryRS("Docdt"), "yyyy-mm-dd") & "' "
...
'            Dim nSno As Double
            ...
            rsTail.Open "SELECT Divcode,Docno,Docdt,DOCSNO,PJVTC,PJVNO,PJVDT,CONTNO,CONTDT,LOTNO,LOTDT,InvoiceNo,InvoiceDT,MDOCNO,MDOCDT,Varcode,Rate,Bales,TotalKgs,inv_Amt,Agreed_Rate,Basic_Rate,Rate_Diff,Basic_Amt,Receivable_Amt,Received_Amt,TotCN_Rate,TotCN_Amt,TotCN_RecvableAmt,TotDisc_Amt,TAx_Code,CGSTPER,CGSTAmt,SGSTPER,SGSTAmt,IGSTPER,IGSTAmt,TotalAmt,REMARKS,TotCN_RecvableAmt FROM RM_CNReceivedDT a  WHERE divcode='" & Divcode & "' And 1=2", DB, adOpenStatic, adLockBatchOptimistic
            ...
            For nRow = 1 To SpdLCReq.MaxRows
                ...
                If val(GetText(SpdLCReq, E_AgreedRate, nRow)) <> 0 Then
                   ...
                   ' rsTail("LRNo") = Left(Trim(GetText(SpdLCReq, E_LineNo, nRow)), 40)
...
'                    rsTail("Invoicedt") = Format(GetText(SpdLCReq, E_InvoiceDate, nRow), "yyyy/MM/dd")
                    ...
                    rsTail("pjvtc") = Trim(GetText(SpdLCReq, E_PJTC, nRow))
                    ...
                    rsTail("Agreed_Rate") = val(GetText(SpdLCReq, E_AgreedRate, nRow))
                    rsTail("Basic_Rate") = val(GetText(SpdLCReq, E_BasicRate, nRow))
                    rsTail("Rate_Diff") = val(GetText(SpdLCReq, E_Diff_Rate, nRow))

                    rsTail("varcode") = Trim(GetText(SpdLCReq, E_VarCode, nRow))
                    rsTail("contdt") = Format(Trim(GetText(SpdLCReq, E_CONTDT, nRow)), "yyyy/MM/dd")
                    rsTail("MDocdt") = Format(val(GetText(SpdLCReq, E_MDocDT, nRow)), "yyyy/MM/dd")
                    rsTail("MDocno") = val(GetText(SpdLCReq, E_MDocno, nRow))
                    rsTail("lotdt") = Format((GetText(SpdLCReq, E_LotDate, nRow)), "yyyy/MM/dd")
                    rsTail("lotno") = val(GetText(SpdLCReq, E_LOTNO, nRow))
                    rsTail("CONTDT") = Format((GetText(SpdLCReq, E_CONTDT, nRow)), "yyyy/MM/dd")
                    rsTail("CONTNO") = val(GetText(SpdLCReq, E_ContNo, nRow))
                    ...
                    rsTail("Received_Amt") = val(GetText(SpdLCReq, E_Receivedamt, nRow))
                    rsTail("Receivable_Amt") = val(GetText(SpdLCReq, E_Receivable, nRow))
                    rsTail("Basic_Amt") = val(GetText(SpdLCReq, E_Diff_Value, nRow))
                    rsTail("TotCN_Rate") = val(GetText(SpdLCReq, E_TotCNDiscRate, nRow))
                    rsTail("TotCN_Amt") = val(GetText(SpdLCReq, E_TotCNDiscValue, nRow))
                    rsTail("TotCN_RecvableAmt") = val(GetText(SpdLCReq, E_TotCNDiscReceivable, nRow))
                    rsTail("TAx_Code") = Trim(GetText(SpdLCReq, E_TaxCode, nRow))
                    rsTail("TotDisc_Amt") = val(GetText(SpdLCReq, E_TotAssDisc, nRow))
                    ...
                    rsTail("REMARKS") = Trim(GetText(SpdLCReq, E_Remarks, nRow))
                           ...
                           ' TrnLog("TC") = 3
                            ...
                            TrnLog("Trans_Name") = "Credit Note Entry"
                            ...
                            TrnLog("PLCode") = Trim(GetText(SpdLCReq, E_PJTC, nRow))
                            TrnLog("pnetwt") = val(GetText(SpdLCReq, E_Bales, nRow))
                            TrnLog("Arrdt") = Format(GetText(SpdLCReq, E_PJVdate, nRow), "yyyy/MM/dd")
                            TrnLog("CONTNO") = val(GetText(SpdLCReq, E_ContNo, nRow))
                            TrnLog("CONTDT") = Format(GetText(SpdLCReq, E_CONTDT, nRow), "yyyy/MM/dd")
                            ...
                            TrnLog("Adv_AMT") = val(GetText(SpdLCReq, E_AgreedRate, nRow))
                            TrnLog("Oth_Amt") = val(GetText(SpdLCReq, E_BasicRate, nRow))
                            TrnLog("Frg_Amt") = val(GetText(SpdLCReq, E_Diff_Rate, nRow))
...
'                End If
               ...
               ' DB.Execute "Update PO_ORDL Set LCQty=ISNULL(LCQty,0)+" & Val(GetText(SpdLCReq, E_BasicRate, nRow)) & " Where Divcode='" & divcode & "' And invno=" & Val(GetText(SpdLCReq, E_PJVNO, nRow)) & " And invdt='" & Format(GetText(SpdLCReq, E_PJVdate, nRow), "yyyy-mm-dd") & "' And INV_TYPE=" & Val(GetText(SpdLCReq, E_InvoiceNo, nRow)) & " And invamt='" & Trim(GetText(SpdLCReq, E_Value, nRow)) & "'"
...
''
'                Set TrnPURHD = New Recordset
'                TrnPURHD.Open " select DIVCODE,TC,PJVNO,PJVDT,PJVSNO,GLCODE,NARRATION1,QTY,RATE,AMOUNT,CGSTAMT,SGSTAMT,IGSTAMT,CGSTPER,SGSTPER,IGSTPER from fa_purdt WHERE Divcode='" & Divcode & "' and 1=2 ", db, adOpenStatic, adLockBatchOptimistic
'                TrnPURHD.AddNew
'                TrnPURHD("DIVCODE") = Divcode
'
'                TrnPURHD("TC") = val(txtfields(27).Text)
...
'                End If
    ...
    End If
            ...
            If Opt = "add" Then
                MsgBox "Credit Note Entryl for your transaction is " & adoPrimaryRS("DocNo"), vbInformation, head
            Else
                MsgBox "Record Modified Successfully", vbInformation, head
            End If
        ...
        If Opt = "del" Then     'del
            ...
            For nRow = 1 To SpdLCReq.MaxRows
                ...
                If val(GetText(SpdLCReq, E_AgreedRate, nRow)) <> 0 Then
                      ...
                      DB.Execute "update c set c.frtentrapp='N' from rm_arrival c inner join rm_lot a  on a.ARRNO =c.ARRNO and a.arrdt=c.ARRDATE and a.divcode=c.divcode and a.varcode=c.varcode and a.contnum=c.contno and c.CONTDT=a.Contdate " & _
                           ...
                           ' TrnLog("TC") = 3
                            ...
                            TrnLog("CGSTAmt") = val(GetText(SpdLCReq, E_CONTDT, nRow))
                            TrnLog("sGSTPER") = val(GetText(SpdLCReq, E_MDocDT, nRow))
                            TrnLog("sGSTAmt") = val(GetText(SpdLCReq, E_MDocno, nRow))
                ...
                End If
             Next
                DB.Execute ("DELETE FROM RM_CNReceivedDT WHERE Divcode = '" & Divcode & "'  AND DocNo =  " & val(txtfields(2).Text) & " and Docdt = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'")
                DB.Execute ("DELETE FROM RM_CNReceivedHD WHERE DivCode = '" & Divcode & "' And DocNo =  " & val(txtfields(2).Text) & " and Docdt = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'")
                DB.Execute ("DELETE FROM RM_CNReceived WHERE DivCode = '" & Divcode & "' And DocNo =  " & val(txtfields(2).Text) & " and Docdt = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'")
        ...
        With SpdLCReq
            ...
            For lRow = 1 To spdPO.MaxRows
               ...
               If spdPO.value = 1 Then
                    ...
                    .SetText E_LineNo, .Row, Trim(GetText(spdPO, P_ContainerNo, lRow))
                    ...
                    .SetText E_ContNo, .Row, Trim(GetText(spdPO, P_ContNo, lRow))
                    .SetText E_CONTDT, .Row, Trim(GetText(spdPO, P_ContDate, lRow))
                   ...
                   ' .SetText E_BasicRate, .Row, GetText(SPDPO, P_Rate, LRow)
'                    .SetText E_ po.Row, GetText(spdPO, P_ Lrow)
                    ...
                    .SetText E_PJTC, .Row, Trim(GetText(spdPO, P_PJTC, lRow))
                    ...
                    Lrs.Open "select *from VW_RM_FibreDisc_Receivable where pjdt<='" & Format(pdate, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' and supcd='" & Trim(txtfields(7).Text) & "' and pjdt='" & Format(Trim(GetText(spdPO, P_PJVDT, lRow)), "yyyy-mm-dd") & "' and pjno='" & val(GetText(spdPO, P_PJVNO, lRow)) & "' and lotno='" & val(GetText(spdPO, P_Lotno, lRow)) & "' and lotdt='" & Format(Trim(GetText(spdPO, P_LotDate, lRow)), "yyyy-mm-dd") & "'   order by SLNAME,pjdt,pjno", DB, adOpenStatic, 1
                    If Lrs.RecordCount > 0 Then
                        .SetText E_AgreedRate, .Row, Trim(Lrs("RATECY"))
                        .SetText E_BasicRate, .Row, Trim(Lrs("bill_rate"))
                        .SetText E_Diff_Rate, .Row, Trim(Lrs("Basic_Rate_Diff"))
                        .SetText E_MDocDT, .Row, Trim(Lrs("docdate"))
                        .SetText E_MDocno, .Row, Trim(Lrs("docno"))
        ...
        For nRow = 1 To .MaxRows
            ...
            If val(GetText(SpdLCReq, E_PJVNO, nRow)) > 0 Then
               ...
               ' nTotalHrs = nTotalHrs + GetText(SpdLCReq, E_VarCode, nRow)
                ...
                FreightAmtBill = FreightAmtBill + val(GetText(SpdLCReq, E_BasicRate, nRow))
            End If
        Next
        End With
...
If Opt = "" Or Opt = "mod" Or Opt = "fnd" Or Opt = " " Or Opt = "add" Then
    If Combo2.Text = "Purchase Bill" Then
        sFilePath = App.Path & "\RMERPBill" & CustID & "\" & Divcode & "-RM Purchase Bill-" & Trim(GetText(SpdLCReq, E_PJVNO, 1)) + " DT-" + Trim(Format(Trim(GetText(SpdLCReq, E_PJVdate, SpdLCReq.ActiveRow)), "dd-mm-yy")) + "-" + Left(Trim(GetText(SpdLCReq, E_Remarks, SpdLCReq.ActiveRow)), 15) & ".pdf"
        sFile = sFilePath
        If fso.FileExists(sFilePath) Then
        Else
    ...
    ElseIf Combo2.Text = "Supplier Bill" Then
        ...
        If Not FNRs.EOF Then
            sFilePath = App.Path & "\RMSupplierBill" & CustID & "\" & Divcode & "-" & Trim(GetText(SpdLCReq, E_PJVNO, SpdLCReq.ActiveRow)) + "-" + Trim(Format(Trim(GetText(SpdLCReq, E_PJVdate, SpdLCReq.ActiveRow)), "dd-mm-yy")) + "-" + Left(Trim(GetText(SpdLCReq, E_Remarks, SpdLCReq.ActiveRow)), 4) + "--" & FNRs(0)
        Else
            sFilePath = ""
        End If
        sFile = sFilePath
...
'    RsChk.Open "select isnull(count(Pack_NO),0) Pack_NO,Pack_NO from Ig_TMPReceiptPacks where IPADD ='" & LocalIPAdd & "' and Docdate='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and DOCNO='" & val(txtfields(2).Text) & "'  and divcode='" & Divcode & "' AND ITEMCODE='" & Trim(GetText(SpdOrdDetail, eORDDtls.E_ItemCode, SpdOrdDetail.ActiveRow)) & "' group by Pack_NO ", db, adOpenStatic
    ...
    If Not RsChk.EOF Then
        ...
        SpdLCReq.SetText E_TotCNDiscReceivable, SpdLCReq.ActiveRow, RsChk.Fields(0)
...
Private Sub SpdLCReq_BeforeEditMode(ByVal Col As Long, ByVal Row As Long, ByVal UserAction As FPSpreadADO.BeforeEditModeActionConstants, CursorPos As Variant, Cancel As Variant)
    ...
    If SpdLCReq.ActiveCol = E_BasicRate Then
...
If Col = E_AgreedRate Or Col = E_Diff_Rate Then
   lQtyChange = True
   Call TotalCalculation
End If
End Sub
...
With SPDDiscTypeDet
    Set Rs = New Recordset
    Rs.Open "SELECT * from RM_CNReceivedTXN  a left join RM_DiscountType b on a.dtype=b.code where  Varcode='" & Trim(GetText(SpdLCReq, E_VarCode, SpdLCReq.ActiveRow)) & "' and lotno='" & val(GetText(SpdLCReq, E_LOTNO, SpdLCReq.ActiveRow)) & "' and ContNo='" & val(GetText(SpdLCReq, E_ContNo, SpdLCReq.ActiveRow)) & "'  and lotdt='" & Format(GetText(SpdLCReq, E_LotDate, SpdLCReq.ActiveRow), "yyyy-mm-dd") & "' and Contdt='" & Format(GetText(SpdLCReq, E_CONTDT, SpdLCReq.ActiveRow), "yyyy-mm-dd") & "' and supcd='" & Trim(txtfields(7).Text) & "'  and a.divcode='" & Divcode & "' and ipadd='" & LocalIPAdd & "' ", DB, adOpenStatic
    r1 = 0
    If Not Rs.EOF Then
        For I = 1 To Rs.RecordCount
            ...
            .SetText SPDDTLOTNO, r1, Rs.Fields("lotno")
            .SetText SPDDTLOTDT, r1, Format(Rs.Fields("lotdt"), "dd/mm/yyyy")
            .SetText SPDDTDocno, r1, Rs.Fields("docno")
            .SetText SPDDTDOCDT, r1, Format(Rs.Fields("docdt"), "dd/mm/yyyy")
            ...
            .SetText SPDDTinvDiscRate, r1, Rs.Fields("Bill_DRate")
            .SetText SPDDTDRate, r1, Rs.Fields("PO_DRate")
            .SetText SPDDTDiffDiscRate, r1, Rs.Fields("Rate_Diff")
            .SetText SPDDTDValue, r1, Rs.Fields("Receivable_Amt")
            .SetText SPDDTReceivedValue, r1, Rs.Fields("Received_Amt")
            .SetText SPDDTCNFlg, r1, Rs.Fields("FLG")
    ...
    Else
         Set Rs = New Recordset
        Rs.Open "SELECT * from VW_RM_FibreDisc_Receivable a  where  Varcode='" & Trim(GetText(SpdLCReq, E_VarCode, SpdLCReq.ActiveRow)) & "' and lotno='" & val(GetText(SpdLCReq, E_LOTNO, SpdLCReq.ActiveRow)) & "' and ContNo='" & val(GetText(SpdLCReq, E_ContNo, SpdLCReq.ActiveRow)) & "'  and lotdt='" & Format(GetText(SpdLCReq, E_LotDate, SpdLCReq.ActiveRow), "yyyy-mm-dd") & "' and Contdt='" & Format(GetText(SpdLCReq, E_CONTDT, SpdLCReq.ActiveRow), "yyyy-mm-dd") & "' and supcd='" & Trim(txtfields(7).Text) & "'  and a.divcode='" & Divcode & "'  ", DB, adOpenStatic
        r1 = 0
        If Not Rs.EOF Then
        For I = 1 To Rs.RecordCount
            r1 = r1 + 1
            ...
            .SetText SPDDTDISCDESC, r1, Rs.Fields("Description")
            .SetText SPDDTinvDiscRate, r1, Rs.Fields("Inv_DRate")
            .SetText SPDDTDRate, r1, Rs.Fields("PO_DRate")
            .SetText SPDDTDiffDiscRate, r1, Rs.Fields("DRate_Diff")

            .SetText SPDDTDValue, r1, Rs.Fields("Receivable_Value")
            .SetText SPDDTCNFlg, r1, Rs.Fields("RPTFLG")
           ' .SetText SPDDTReceivedValue, r1, Rs.Fields("Received_Amt")

            FbDisRate = FbDisRate + val(Rs.Fields("PO_DRate") & "")
            FBDisvalue = FBDisvalue + val(GetText(SPDDiscTypeDet, SPDDTDValue, r1) & "")
            Rs.MoveNext
        Next
       End If
...
End If
    ...
    With SpdLCReq
        If .ActiveCol = eLCReqDtls.E_Receivedamt Then
            If val(GetText(SpdLCReq, eLCReqDtls.E_Receivable, SpdLCReq.ActiveRow)) < val(GetText(SpdLCReq, eLCReqDtls.E_Receivedamt, SpdLCReq.ActiveRow)) Then
            MsgBox "Received Amount Cannot be Greater than Reeivable Amount", vbInformation, head
            .SetText eLCReqDtls.E_Receivedamt, .ActiveRow, CStr(val(GetText(SpdLCReq, eLCReqDtls.E_Receivable, SpdLCReq.ActiveRow)))
            Exit Sub
            End If

           ' .SetText eLCReqDtls.E_Value, .ActiveRow, CStr(val(GetText(SpdLCReq, eLCReqDtls.E_AgreedRate, SpdLCReq.ActiveRow)) * val(GetText(SpdLCReq, eLCReqDtls.E_BasicRate, SpdLCReq.ActiveRow)))
        End If
           ' End If
...
'            nTotalQty = nTotalQty + Val(GetText(SpdLCReq, E_BasicRate, nRow))
        End If
    Next
    End With
'    txtQty.Text = Format(nTotalQty, "0.000")
...
On Error GoTo Errh
    ...
    adoPrimaryRS.Open " SHAPE {SELECT Divcode,Docno,Docdt,slcode,Billno,Billdt,MDApp_copy,TotalBales,TotalKgs,Disc_Value,other_amt,GSTCode,GSTPer,GSTAmt,CGSTAmt,SGSTAmt,IGSTAmt,Roff_amt,Total_Amt,Remarks,PJVTC,PJVNO,PJVDT,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,HostID FROM RM_CNReceivedHD WHERE DivCode='" & Divcode & "' And docNo = " & val(a) & " and Docdt = '" & Format(B, "yyyy-mm-dd") & "' And Docdt Between '" & Format(yfdate, "yyyy/MM/dd") & "' And '" & Format(yldate, "yyyy/Mm/dd") & "' " & _
                  " Order by DivCode,Docdt,docno} AS ParentCMD APPEND ({SELECT Divcode,Docno,Docdt,DOCSNO,PJVTC,PJVNO,PJVDT,CONTNO,CONTDT,LOTNO,LOTDT,InvoiceNo,InvoiceDT,MDOCNO,MDOCDT,Varcode,Rate,Bales,TotalKgs,inv_Amt,Agreed_Rate,Basic_Rate,Rate_Diff,Basic_Amt,Receivable_Amt,Received_Amt,TotCN_Rate,TotCN_Amt,TotDisc_Amt,TAx_Code,CGSTPER,CGSTAmt,SGSTPER,SGSTAmt,IGSTPER,IGSTAmt,TotalAmt,REMARKS,TotCN_RecvableAmt FROM RM_CNReceivedDT a Where a.divcode='" & Divcode & "' " & _
    ...
    If Opt = "mod" Or Opt = "del" Then
        ...
        Call CreditNoteLoad
        Set adoPrimaryRS = New Recordset
        adoPrimaryRS.Open "SELECT Divcode,Docno,Docdt,slcode,Billno,Billdt,MDApp_copy,TotalBales,TotalKgs,Disc_Value,other_amt,GSTCode,GSTPer,GSTAmt,CGSTAmt,SGSTAmt,IGSTAmt,Roff_amt,Total_Amt,Remarks,PJVTC,PJVNO,PJVDT,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,HostID FROM RM_CNReceivedHD Where DivCode='" & Divcode & "'  And docno = " & val(a) & " and Docdt = '" & Format(B, "yyyy-mm-dd") & "'", DB, adOpenStatic, adLockBatchOptimistic
...
Public Function newdocno()
    ...
    Set Rs = New Recordset
    Rs.Open "Select right(isnull(max(convert(numeric,docno)),0),4) From RM_CNReceivedHD where Divcode = '" & Divcode & "'  and Docdt between '" & v_stdate & "'   and  '" & v_endate & "'", DB, adOpenStatic, adLockReadOnly
...
adoPrimaryRS.Open " SHAPE {SELECT Divcode,Docno,Docdt,slcode,Billno,Billdt,MDApp_copy,TotalBales,TotalKgs,Disc_Value,other_amt,GSTCode,GSTPer,GSTAmt,CGSTAmt,SGSTAmt,IGSTAmt,Roff_amt,Total_Amt,Remarks,PJVTC,PJVNO,PJVDT,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,HostID FROM RM_CNReceivedHD WHERE DivCode='" & Divcode & "' And Docdt Between '" & Format(yfdate, "yyyy/MM/dd") & "' And '" & Format(yldate, "yyyy/Mm/dd") & "' " & _
                  " Order by DivCode,Docdt,docno} AS ParentCMD APPEND ({SELECT Divcode,Docno,Docdt,DOCSNO,PJVTC,PJVNO,PJVDT,CONTNO,CONTDT,LOTNO,LOTDT,InvoiceNo,InvoiceDT,MDOCNO,MDOCDT,Varcode,Rate,Bales,TotalKgs,inv_Amt,Agreed_Rate,Basic_Rate,Rate_Diff,Basic_Amt,Receivable_Amt,Received_Amt,TotCN_Rate,TotCN_Amt,TotDisc_Amt,TAx_Code,CGSTPER,CGSTAmt,SGSTPER,SGSTAmt,IGSTPER,IGSTAmt,TotalAmt,REMARKS,TotCN_RecvableAmt FROM RM_CNReceivedDT a Where a.divcode='" & Divcode & "' " & _
...
On Error GoTo Errh
   ...
   End If
       ...
       If Index = 7 And lSuppSel = False Then  '' Supplier
            ...
            qry = "select distinct a.supcd""Supplier Code"",a.slname""Supplier Name"" from  VW_RM_FibreDisc_Receivable a where supcd='" & Trim(txtfields(7).Text) & "'"
...
'            End If
            ...
            If Not rss.EOF Then
                    ...
                    Text2.Text = rss(1)
            Else
                qry = "select distinct a.supcd""Supplier Code"",a.slname""Supplier Name"" from  VW_RM_FibreDisc_Receivable a where Divcode='" & Divcode & "'"
                LookUp.Clear = True
                LookUp.query = qry
                ...
                Dim STCODE As String
                Set rs1 = New Recordset
                rs1.Open "SELECT isnull(GSTSTATECODE,'0') GSTSTATECODE,isnull(Supptype,'R') Supptype FROM FA_SLMAS   WHERE SLCODE='" & Trim(LookUp.Fields("Supplier Code")) & "' ", DB
                If rs1.EOF Then
                    MsgBox "PLEASE ENTER GST STATE CODE IN MASTER ", vbInformation, head
                    Call BUTTON_Click(10)
                    Exit Sub
  ...
  If Opt = "add" Then
        ...
        Set Lrs = New Recordset
        Lrs.Open "select  Distinct pjno,bales,pjdt,pjtc,Fbillno,bill_rate ,comm_wt,fbillvalue,Fbillno,fbilldt ,contno,contdt,lotno,lotdt from VW_RM_FibreDisc_Receivable where pjdt<='" & Format(pdate, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' and supcd='" & Trim(txtfields(7).Text) & "'  order by pjtc,pjdt,pjno", DB, adOpenStatic, 1
...
'                        Set spdPO.DataSource = Lrs
            ...
            Do While Not Lrs.EOF
                 ...
                 '   spdPO.SetText ePODtls.P_SupplierName, RW, Lrs("slname")
                    spdPO.SetText ePODtls.P_PJTC, RW, Lrs("pjtc")
                    'spdPO.SetText ePODtls.P_PlantName, RW, Lrs("plname")
                    spdPO.SetText ePODtls.P_Rate, RW, Lrs("bill_rate")
                    ...
                    spdPO.SetText ePODtls.P_ContDate, RW, Lrs("contdt")
...
'                            spdPO.ScrollBars = ScrollBarsBoth
                            ...
                            spdPO.SetText ePODtls.P_PJVDT, RW, Lrs("pjdt")
                            spdPO.SetText ePODtls.P_SupplierName, RW, Lrs("slname")
                            spdPO.SetText ePODtls.P_PJTC, RW, Lrs("PlCode")
                            spdPO.SetText ePODtls.P_PlantName, RW, Lrs("plname")
...
On Error GoTo spreadalign_Error
  ...
  '  SetSpreadCol SpdLCReq, E_DivCode, "DivCode", CellTypeStaticText, 8, 0
    ...
    SetSpreadCol2 SpdLCReq, E_PRNo, "Bales", CellTypeNumber, 6, 0, True, True
    ...
    SetSpreadCol2 SpdLCReq, E_PJTC, "Plant Code", CellTypeStaticText, 12, , True, True
    SetSpreadCol2 SpdLCReq, E_PlantName, "Plant", CellTypeStaticText, 12, , True, True
    SetSpreadCol2 SpdLCReq, E_LineNo, "Line No.", CellTypeStaticText, 10, , True, True


    SetSpreadCol2 SpdLCReq, E_ContNo, "Order No.", CellTypeStaticText, 8, , False, True
    SetSpreadCol2 SpdLCReq, E_CONTDT, "Order Date.", CellTypeStaticText, 9, 2, False, True
    SetSpreadCol2 SpdLCReq, E_VarCode, "Varierty", CellTypeStaticText, 8, , False, True
    SetSpreadCol2 SpdLCReq, E_MDocno, "Master Doc.No", CellTypeStaticText, 9, 2, True, True
    SetSpreadCol2 SpdLCReq, E_MDocDT, "Master Doc.SNo", CellTypeStaticText, 8, 2, True, True
    ...
    SetSpreadCol2 SpdLCReq, E_BasicRate, "Basic Price/Kg", CellTypeNumber, 10, 2, False, True
    SetSpreadCol2 SpdLCReq, E_AgreedRate, "Agreed Price/Kg", CellTypeNumber, 10, 2, False, True
    SetSpreadCol2 SpdLCReq, E_Diff_Rate, "Difference in Price/Kg", CellTypeNumber, 10, 2, False, True
    SetSpreadCol2 SpdLCReq, E_Diff_Value, "Difference Value.", CellTypeNumber, 9, 2, False, True
    SetSpreadCol2 SpdLCReq, E_Receivable, "Receivable Amount", CellTypeNumber, 8, 2, False, True
    SetSpreadCol2 SpdLCReq, E_Receivedamt, "Received Amount", CellTypeNumber, 8, 2, False, False

    SetSpreadCol2 SpdLCReq, E_TotCNDiscRate, "CND Rate", CellTypeNumber, 10, 2, False, True
    SetSpreadCol2 SpdLCReq, E_TotCNDiscValue, "CND Value", CellTypeNumber, 10, 2, False, True
    SetSpreadCol2 SpdLCReq, E_TotCNDiscReceivable, "CND Receivable Value.", CellTypeNumber, 10, 2, False, True

    SetSpreadCol2 SpdLCReq, E_TotAssDisc, "Total Discount", CellTypeNumber, 9, 2, False, True
    ...
    SetSpreadCol2 SpdLCReq, E_Remarks, "Remarks", CellTypeEdit, 18, , False, False

    SpdLCReq.MaxCols = E_Remarks
    SpdLCReq.MaxRows = NoofRows
   ' SpdLCReq.SetActiveCell E_BasicRate, 1
...
'    .TypeCheckType = TypeCheckTypeThreeState
    ...
    SetSpreadCol2 spdPO, P_PJTC, "PJV TC", CellTypeStaticText, 10, 2, False, True
    ...
    SetSpreadCol2 spdPO, P_ContNo, "Order No.", CellTypeStaticText, 10, , False, True
    SetSpreadCol2 spdPO, P_ContDate, "Order Date", CellTypeStaticText, 10, , False, True
...
Private Function TrnDateValidation() As Boolean
    ...
    strQry = "Select isnull(MAX(Docdt),'" & Format(pdate, "yyyy-MM-dd") & "') as Ldate from RM_CNReceivedHD  Where DivCode='" & Divcode & "' and Docdt Between '" & Format(yfdate, "yyyy-MM-dd") & "' and '" & Format(yldate, "yyyy-MM-dd") & "'"
...
'            .SetText ePODtls.P_PJTC, RW, indentrs("Varity Code")
...
'
'                        SpdLCReq.SetText eLCReqDtls.E_CONTDT, RW, Val(GetText(SpdLCReq, eLCReqDtls.E_VarCode, RW))
'                    Else
'                        SpdLCReq.SetText eLCReqDtls.E_CONTDT, RW, totrecamt
'
'                    End If
'
'                    totrecamt = totrecamt - Val(GetText(SpdLCReq, eLCReqDtls.E_VarCode, RW))
'                  Else
'                  SpdLCReq.SetText eLCReqDtls.E_CONTDT, RW, 0
'               End If
'        Next
'
'    End If
...
Private Sub TotalCalculation()
    ...
    For nRow = 1 To .MaxRows
        ...
        If val(GetText(SpdLCReq, E_Kgs, nRow)) > 0 Then
            ...
            End If
            .SetText E_TotAssDisc, .Row, Format((val(GetText(SpdLCReq, E_Receivedamt, nRow)) + val(GetText(SpdLCReq, E_TotCNDiscValue, nRow))), "0.00")
          ...
          '  .SetText E_Diff_Value, .Row, Format(Tottaxamt * val(txtfields(14).Text) / 100, "0.00")
            .SetText E_TotalAmt, .Row, Format(val(Tottaxamt) + val(GetText(SpdLCReq, E_TotAssDisc, nRow)), "0.00")


           '  TDSValue = TDSValue + (val(GetText(SpdLCReq, E_Diff_Value, nRow)))

             TotValue = TotValue + (val(GetText(SpdLCReq, E_TotAssDisc, nRow)))
'             FreightAmtBill = FreightAmtBill + (val(GetText(SpdLCReq, E_AgreedRate, nRow)))
'             FreightAmtMill = FreightAmtMill + (val(GetText(SpdLCReq, E_BasicRate, nRow)))
'             FreightAmtApproved = FreightAmtApproved + (val(GetText(SpdLCReq, E_Diff_Rate, nRow)))
