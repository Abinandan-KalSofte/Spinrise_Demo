...
Begin VB.Form frm_IssueRequestBarcode 
   Caption         =   "Issue Request"
   ClientHeight    =   8595
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14505
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_IssueRequestBarcode.frx":0000
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   11
         Left            =   3240
         Picture         =   "frm_IssueRequestBarcode.frx":044A
         Style           =   1  'Graphical
         TabIndex        =   34
         ToolTipText     =   "Exit"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_IssueRequestBarcode.frx":07DF
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   0
         Left            =   45
         Picture         =   "frm_IssueRequestBarcode.frx":0AE9
         Style           =   1  'Graphical
         TabIndex        =   33
         ToolTipText     =   "Add"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_IssueRequestBarcode.frx":0E7C
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   600
         Picture         =   "frm_IssueRequestBarcode.frx":1186
         Style           =   1  'Graphical
         TabIndex        =   32
         ToolTipText     =   "Delete"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_IssueRequestBarcode.frx":1522
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   9
         Left            =   1650
         Picture         =   "frm_IssueRequestBarcode.frx":182C
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "Save"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_IssueRequestBarcode.frx":1BCE
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   10
         Left            =   2175
         Picture         =   "frm_IssueRequestBarcode.frx":1ED8
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "Cancel "
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_IssueRequestBarcode.frx":2254
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   4
         Left            =   1120
         Picture         =   "frm_IssueRequestBarcode.frx":255E
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Find"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   5820
         Picture         =   "frm_IssueRequestBarcode.frx":28F3
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Exit"
         Top             =   120
      ...
      Begin VB.CommandButton CRY 
         ...
         Index           =   0
         Left            =   2730
         Picture         =   "frm_IssueRequestBarcode.frx":2D35
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton CRYTran 
         ...
         Index           =   1
         Left            =   7860
         Picture         =   "frm_IssueRequestBarcode.frx":3177
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Lot Bale Crystal Report Print (Ctrl P)"
         Top             =   90
   ...
   Begin VB.PictureBox FraFabstk 
      ...
      Height          =   9810
      Left            =   120
      Picture         =   "frm_IssueRequestBarcode.frx":35B9
      ScaleHeight     =   9780
      ScaleWidth      =   14340
      TabIndex        =   0
      Top             =   585
      ...
      Begin VB.ComboBox Combo2 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frm_IssueRequestBarcode.frx":38FB
         Left            =   10905
         List            =   "frm_IssueRequestBarcode.frx":3902
         TabIndex        =   61
         Top             =   1080
         Width           =   1740
      End
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frm_IssueRequestBarcode.frx":3910
         Left            =   1560
         List            =   "frm_IssueRequestBarcode.frx":3912
         TabIndex        =   1
         Top             =   720
         Width           =   3135
      End
   ...
   End
End
Attribute VB_Name = "frm_IssueRequestBarcode"
...
'    grdDataGrid.Enabled = True
  ...
  '  db.Execute "ksp_TableExists "TmpRPackDetails" & TLocalIPAdd & ""
    DB.Execute "ksp_TableExists 'TmpBaleISSDetails" & TLocalIPAdd & "'"

    DB.Execute "CREATE TABLE TmpBaleISSDetails" & TLocalIPAdd & " (divcode varchar(2),LotNo numeric(8) ,lotdt Datetime,ArrNo numeric(6),ArrDate datetime,Varcode varchar(15),Varname varchar(100),BaleNo numeric(13),GrossWt numeric(12,3),TAREWT numeric(9,3),NetWt numeric(12,3),LotYear numeric(5),printStatus varchar(2),id int, Catcd varchar(1),Lottype varchar(1))"
...
'        End If
    If Trim(txtfields(5).Text) = "" Then
          MsgBox "Mix Count. cannot be empty", vbInformation, head
          txtfields(5).SetFocus
           Exit Sub
    End If
    
    If Trim(txtfields(8).Text) = "" Then
          MsgBox "MIX Group. cannot be empty", vbInformation, head
...
'        End If
        ...
        Set Rs = New Recordset
        Rs.Open "select* from RM_IssDataBCh where divcode='" & Divcode & "' ", DB, adOpenStatic
        If Rs.RecordCount > 0 Then
            Set Rs = New Recordset
            Rs.Open "select max(docno) from RM_IssDataBCh where divcode='" & Divcode & "' and Docdt  between  '" & Format(yfdate, "YYYY-MM-DD") & "' and '" & Format(yldate, "YYYY-MM-DD") & "'", DB, adOpenStatic
...
'        temp = grdDataGrid.Columns(12).Text
    ...
    If Opt = "add" Then
        ...
        rsa.Open "Select Max(docdt)Date from RM_IssDataBCH  where  divcode='" & Divcode & "' and Docdt  between  '" & Format(yfdate, "YYYY-MM-DD") & "' and '" & Format(yldate, "YYYY-MM-DD") & "'", DB, adOpenStatic
...
'        End If
        ...
        rsnew.Open "select divcode,DocNo,Docdt,entdate,user_id ,ISSTYPE,ISSTO,MIXGRP,cntcd from RM_IssDataBCh where divcode='" & Divcode & "' and 1=2 ", DB, adOpenDynamic, adLockBatchOptimistic
            rsnew.AddNew
            
            rsnew("divcode") = Divcode
            rsnew("isstype") = Left(Combo1.Text, 2)
            rsnew("issto") = Left(Combo2.Text, 1)
            rsnew("User_id").value = usrid
            rsnew("entdate").value = Format(Date, "yyyy-mm-dd")
            rsnew("MIXGRP") = Trim(txtfields(8).Text)
            rsnew("cntcd") = txtfields(5).Text
            rsnew("Docdt").value = Format(DTPicker1.value, "yyyy-mm-dd")
            rsnew("docno") = val(txtfields(1).Text)
            rsnew.UpdateBatch adAffectAllChapters
        

        Set Rs = New Recordset
        Rs.Open "select divcode,DocNo,Docdt,ArrNo,Arrdt ,lotNo,lotdt,catcd,lottype ,varcode,BaleNo,NetWt,GrossWt ,TareWt ,sno,lotyear from RM_IssDataBCL where divcode='" & Divcode & "' and 1=2 ", DB, adOpenDynamic, adLockBatchOptimistic
        tmp = Opt
        Opt = " "
        ...
        If Lv_Sort.ListItems.Item(I).Checked Then
            ...
            Rs("lotNo") = val(Lv_Sort.ListItems(I).SubItems(1))
            Rs("lotdt") = Format((Lv_Sort.ListItems(I).SubItems(2)), "yyyy-mm-dd")
            Rs("varcode") = Trim(Lv_Sort.ListItems(I).SubItems(3))
            
            
            Rs("baleno") = val(Lv_Sort.ListItems(I).SubItems(5))
            ...
            Rs("catcd") = Trim(Lv_Sort.ListItems(I).SubItems(12))
            Rs("lottype") = Trim(Lv_Sort.ListItems(I).SubItems(13))
            Rs("lotyear") = val(Lv_Sort.ListItems(I).SubItems(14))
            
            Rs("ArrNo") = val(Lv_Sort.ListItems(I).SubItems(9))
            Rs("Arrdt") = Format(Trim(Lv_Sort.ListItems(I).SubItems(10)), "yyyy-mm-dd")
...
txtfields(4).SetFocus
 Dim lotno, LOTDT, ProductCode, lotyear, Packdocno, baleno As String
...
If Opt = "add" Then
    If Trim(txtfields(4).Text) <> "" Then
         ...
         rst.Open "select items from dbo.split('" & txtfields(4).Text & "',',')", DB
         inc = 1
        ...
        rsVar.Open "select varname from rm_var where varcode='" & ProductCode & "'", DB
        VarName = ""
      ...
      '  rslot.Open "select *from rm_bale where baleno='" & val(BaleNo) & "' and lotno='" & val(LotNo) & "' and lotdt='" & Format(Lotdt, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' and varcode='" & ProductCode & "' and "
        
        rslot.Open " select a.lotno,a.lotdt,a.arrno,a.arrdt,b.grwt,b.tarewt,b.favaourablewgt Netwt,a.lotyear,b.baleno,a.Catcd,a.Lottype,a.lotyear from rm_lot A inner join RM_BALE B on  A.LOTNO=B.LOTNO AND A.CATCD=B.CATCD and a.arrdt=b.arrdt and a.varcode=b.varcode and a.divcode=b.divcode where  b.baleno='" & val(baleno) & "' and A. VARCODE='" & ProductCode & "' AND  STATUS IN ('AC','AW') AND a.divcode='" & Divcode & "' and a.lotno='" & val(lotno) & "' and a.varcode='" & ProductCode & "' and (ISSUED='N' OR ISSUED IS NULL) and   a.rejflg='N' and a.lotyear='" & Year(yfdate) & "'  and a.lotdt='" & Format(LOTDT, "yyyy-mm-dd") & "' and  isnull(b.rejflg,'N')='N' and baleno not in(" & Balenos & ") ", DB
        If Not rslot.EOF Then
            Balenos = Balenos & "," & rslot!baleno & ""
            DB.Execute "insert into TmpBaleISSDetails" & TLocalIPAdd & "(divcode ,LotNo ,lotdt ,ArrNo ,ArrDate ,Varcode ,Varname ,BaleNo ,GrossWt,TareWt,NetWt,lotyear ,printStatus ,id ,Catcd,Lottype ) values('" & Divcode & "','" & rslot("Lotno") & "', '" & Format(rslot("Lotdt"), "yyyy-mm-dd") & "','" & rslot("arrno") & "', '" & Format(rslot("arrdt"), "yyyy-mm-dd") & "','" & Trim(ProductCode) & "','" & VarName & "','" & rslot("BaleNo") & "','" & rslot("grwt") & "','" & rslot("tarewt") & "','" & rslot("netwt") & "','" & rslot("lotyear") & "', 'Y',1,'" & rslot("Catcd") & "','" & rslot("LOTTYPE") & "')"
        End If
        Lv_Sort.ListItems.Clear
        Set temprs = New Recordset
        temprs.Open "SELECT  *from TmpBaleISSDetails" & TLocalIPAdd & " order by Baleno ", DB, adOpenStatic, adLockReadOnly
        ...
        If temprs.RecordCount > 0 Then
            Do While Not temprs.EOF
                ...
                Lv_Sort.ListItems(Lv_Sort.ListItems.Count).ListSubItems.ADD , , temprs!printStatus
                 Lv_Sort.ListItems(Lv_Sort.ListItems.Count).ListSubItems.ADD , , temprs!catcd
                 
                 Lv_Sort.ListItems(Lv_Sort.ListItems.Count).ListSubItems.ADD , , temprs!lottype
      
                
                Lv_Sort.ListItems(Lv_Sort.ListItems.Count).ListSubItems.ADD , , temprs!lotyear
...
End If
 ...
 If ISSTYPE = "P" Then
        ...
        If Combo2.Text = "D-Dying" Then
            Set rsa = New Recordset
            rsa.Open "Select cntcd,cntname from rm_count where cntcd='" & txtfields(5).Text & "'", DB, adOpenStatic
            If rsa.RecordCount = 0 Then
        ...
        ElseIf Combo2.Text = "M-Mixing" Then
            ...
            rsd.Open "select description from ig_product where product_code='" & txtfields(5).Text & "'", DB
