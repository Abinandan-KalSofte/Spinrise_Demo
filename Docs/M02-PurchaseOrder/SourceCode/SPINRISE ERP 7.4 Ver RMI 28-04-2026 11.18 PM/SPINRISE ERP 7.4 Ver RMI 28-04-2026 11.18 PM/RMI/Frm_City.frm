...
Begin VB.Form Frm_City 
   ...
   Begin VB.Frame Buttonframe 
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":0442
         Height          =   510
         Index           =   6
         Left            =   2670
         Picture         =   "Frm_City.frx":088C
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":0BD9
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "Frm_City.frx":0EE3
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":1276
         Height          =   510
         Index           =   5
         Left            =   2160
         Picture         =   "Frm_City.frx":16C0
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":20CB
         Height          =   510
         Index           =   1
         Left            =   570
         Picture         =   "Frm_City.frx":23D5
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":2AE6
         Height          =   510
         Index           =   7
         Left            =   3195
         Picture         =   "Frm_City.frx":2F30
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":3280
         Height          =   510
         Index           =   11
         Left            =   5805
         Picture         =   "Frm_City.frx":36CA
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":3A5F
         Height          =   510
         Index           =   9
         Left            =   4245
         Picture         =   "Frm_City.frx":3D69
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "Frm_City.frx":410B
         Height          =   510
         Index           =   10
         Left            =   4770
         Picture         =   "Frm_City.frx":4415
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_City.frx":4791
         Height          =   510
         Index           =   8
         Left            =   3720
         Picture         =   "Frm_City.frx":4BDB
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   " "
      TabPicture(0)   =   "Frm_City.frx":4F3D
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton lovcancel 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "Frm_City.frx":4F59
         Height          =   615
         Left            =   4740
         Picture         =   "Frm_City.frx":533B
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   4080
         Width           =   1185
      ...
      Begin VB.CommandButton lovok 
         Caption         =   "&OK"
         Default         =   -1  'True
         DownPicture     =   "Frm_City.frx":570E
         Height          =   615
         Left            =   3000
         Picture         =   "Frm_City.frx":5AF4
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   4080
         Width           =   1185
        ...
        If Opt = "mod" Then
           Set rsval = New Recordset
            ...
            If Not rsval.EOF Then
                MsgBox "You cannot modify the Record!!! dependencies exist", vbInformation, head
                Exit Sub
            End If
