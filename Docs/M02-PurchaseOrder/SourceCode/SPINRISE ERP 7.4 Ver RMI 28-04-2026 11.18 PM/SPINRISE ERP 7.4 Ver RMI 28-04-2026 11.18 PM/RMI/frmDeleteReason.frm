...
Begin VB.Form frmDeleteReason 
   Caption         =   "TXN Delete Reason"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12690
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   5760
         Picture         =   "frmDeleteReason.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":0442
         Height          =   550
         Index           =   4
         Left            =   2160
         Picture         =   "frmDeleteReason.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":0AE1
         Height          =   550
         Index           =   8
         Left            =   4200
         Picture         =   "frmDeleteReason.frx":0F2B
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":128D
         Height          =   550
         Index           =   10
         Left            =   5250
         Picture         =   "frmDeleteReason.frx":1597
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":1913
         Height          =   550
         Index           =   9
         Left            =   4725
         Picture         =   "frmDeleteReason.frx":1C1D
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":1FBF
         Height          =   550
         Index           =   11
         Left            =   6375
         Picture         =   "frmDeleteReason.frx":2409
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":279E
         Height          =   550
         Index           =   7
         Left            =   3675
         Picture         =   "frmDeleteReason.frx":2BE8
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   1620
         Picture         =   "frmDeleteReason.frx":2F38
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":32CF
         Height          =   550
         Index           =   1
         Left            =   570
         Picture         =   "frmDeleteReason.frx":35D9
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":3953
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1095
         Picture         =   "frmDeleteReason.frx":3C5D
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":3FF9
         Height          =   550
         Index           =   5
         Left            =   2625
         Picture         =   "frmDeleteReason.frx":4443
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":47A8
         Height          =   550
         Index           =   0
         Left            =   45
         Picture         =   "frmDeleteReason.frx":4AB2
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDeleteReason.frx":4E45
         Height          =   550
         Index           =   6
         Left            =   3150
         Picture         =   "frmDeleteReason.frx":528F
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   "        "
      TabPicture(0)   =   "frmDeleteReason.frx":55DC
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command1 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "frmDeleteReason.frx":55F8
         Height          =   615
         Left            =   4710
         Picture         =   "frmDeleteReason.frx":59DA
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   4110
         Width           =   1185
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&OK"
         Default         =   -1  'True
         DownPicture     =   "frmDeleteReason.frx":5DAD
         Height          =   615
         Left            =   3000
         Picture         =   "frmDeleteReason.frx":6193
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   4110
         Width           =   1185
   ...
   End
End
Attribute VB_Name = "frmDeleteReason"
...
'addition
        ...
        adoPrimaryRS.Open "select Code "" Code"" ,Description "" Description"" from RM_DelReason where 1=2 order by Code", DB, adOpenStatic, adLockBatchOptimistic
...
Case 1
    ...
    Rs.Open "select count(*) from RM_DelReason", DB
    If Not Rs(0) = 0 Then
        Opt = "mod"
        ...
        DB.BeginTrans
         ...
         If LookUp.Cancel = False Then
            ...
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open "select Code ""Code"" ,Description ""Description"" from RM_DelReason where Code = '" & LookUp.Fields(0) & "' order by Code", DB, adOpenStatic, adLockBatchOptimistic
            Set grdDataGrid.DataSource = adoPrimaryRS
            grdDataGrid.Columns(0).Width = 2000
            grdDataGrid.Columns(1).Width = 3500
    ...
    If Not Rs(0) = 0 Then
        ...
        DB.BeginTrans
         ...
         If LookUp.Cancel = False Then
            ...
            StatusBar1.Panels(2).Text = ""
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open "select Code AS 'Code',Description as 'Description' from RM_DelReason  where Code = '" & LookUp.Fields(0) & "'  order by Code", DB, adOpenStatic, adLockBatchOptimistic
            Set grdDataGrid.DataSource = adoPrimaryRS
            grdDataGrid.Columns(0).Width = 2000
            grdDataGrid.Columns(1).Width = 3500
...
Case 3
    ...
    Set Rs = New Recordset
    Rs.Open "select * from RM_DelReason Order by Code", DB, adOpenStatic
     ...
     End If
       ...
       If Opt = "del" Then
         ...
         If msg = vbYes Then
            ...
            DB.Execute ("delete from RM_DelReason where Code=" + "'" + grdDataGrid.Columns(0) + "'")
...
Case 12
    ...
    Set Cystalrptbunk.cryRept = Cry_TXN_Delete
...
On Error GoTo GrdDatagrid_AfterColUpdate_Error
        ...
        If ColIndex = 0 Then
            ...
            Else
                Set Rs = New Recordset
                Rs.Open "select 'X'  from RM_DelReason where Code='" & grdDataGrid.Columns(0).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                If Not Rs.BOF Then
        ...
        If ColIndex = 1 Then
            ...
            Else
                Set Rs = New Recordset
                Rs.Open "select 'X'  from RM_DelReason where Description='" & grdDataGrid.Columns(1).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                If Not Rs.BOF Then
...
On Error GoTo er1
  ...
  'Adodc1.Refresh
  Set adoPrimaryRS = New Recordset
  adoPrimaryRS.Open "select Code AS ' Code',Description as 'Description' from RM_DelReason order by Code", DB, adOpenStatic, adLockReadOnly
  Set grdDataGrid.DataSource = adoPrimaryRS
