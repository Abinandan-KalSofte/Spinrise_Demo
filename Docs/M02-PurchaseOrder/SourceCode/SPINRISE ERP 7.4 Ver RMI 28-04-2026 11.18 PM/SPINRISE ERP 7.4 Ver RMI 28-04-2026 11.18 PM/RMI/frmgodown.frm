...
Begin VB.Form Frmgodown 
   ...
   Begin VB.Frame Buttonframe 
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":0442
         Height          =   550
         Index           =   4
         Left            =   2160
         Picture         =   "frmgodown.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":0AE1
         Height          =   550
         Index           =   8
         Left            =   4200
         Picture         =   "frmgodown.frx":0F2B
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":128D
         Height          =   550
         Index           =   10
         Left            =   5250
         Picture         =   "frmgodown.frx":1597
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":1913
         Height          =   550
         Index           =   9
         Left            =   4725
         Picture         =   "frmgodown.frx":1C1D
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":1FBF
         Height          =   550
         Index           =   11
         Left            =   6375
         Picture         =   "frmgodown.frx":2409
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":279E
         Height          =   550
         Index           =   7
         Left            =   3675
         Picture         =   "frmgodown.frx":2BE8
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":32CF
         Height          =   550
         Index           =   1
         Left            =   570
         Picture         =   "frmgodown.frx":35D9
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":3953
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":3FF9
         Height          =   550
         Index           =   5
         Left            =   2625
         Picture         =   "frmgodown.frx":4443
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":47A8
         Height          =   550
         Index           =   0
         Left            =   45
         Picture         =   "frmgodown.frx":4AB2
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmgodown.frx":4E45
         Height          =   550
         Index           =   6
         Left            =   3150
         Picture         =   "frmgodown.frx":528F
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   "        "
      TabPicture(0)   =   "frmgodown.frx":55DC
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command1 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "frmgodown.frx":55F8
         Height          =   615
         Left            =   4710
         Picture         =   "frmgodown.frx":59DA
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   4110
         Width           =   1185
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&OK"
         Default         =   -1  'True
         DownPicture     =   "frmgodown.frx":5DAD
         Height          =   615
         Left            =   3000
         Picture         =   "frmgodown.frx":6193
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   4110
         Width           =   1185
...
'       Adodc1.Refresh
        ...
        adoPrimaryRS.Open "select gcode ""Code"" ,gname ""Godown Name"",Capacity ""Capacity"",Godowntype""Godown Type"",DivCode,OpenLoankeyflg ""Open/Key Loan"" from rm_god where 1=2 order by gcode", DB, adOpenStatic, adLockBatchOptimistic
        Else
        adoPrimaryRS.Open "select gcode ""Code"" ,gname ""Godown Name"",Capacity ""Capacity"",Godowntype""Godown Type"",DivCode from rm_god where 1=2 order by gcode", DB, adOpenStatic, adLockBatchOptimistic
        End If
        Set grddatagrid.DataSource = adoPrimaryRS
'       Set grdDataGrid.DataSource = Adodc1.Recordset
        grddatagrid.Columns(0).Width = 1000
        grddatagrid.Columns(1).Width = 3000
        grddatagrid.Columns(2).Width = 1200
        grddatagrid.Columns(3).Width = 1574.929
        grddatagrid.Columns(4).Visible = False
        If Openkeyloanflg = "Y" Then
        grddatagrid.Columns(5).Width = 1574.929
        End If
        DB.BeginTrans
        grddatagrid.AllowAddNew = True
        grddatagrid.AllowUpdate = True
        adoPrimaryRS.AddNew
        grddatagrid.Columns(4).Text = Divcode
...
Case 1
    ...
    If Not Rs(0) = 0 Then
        ...
        DB.BeginTrans
         ...
         LookUp.Clear = True
         LookUp.query = "select Gcode AS 'GodownCode',Gname as 'GodownName' from rm_god where  DivCode = '" & Divcode & "'"
         ...
         If LookUp.Cancel = False Then
            ...
            Set adoPrimaryRS = New Recordset
            If Openkeyloanflg = "Y" Then
            adoPrimaryRS.Open "select gcode ""Code"" ,gname ""Godown Name"",Capacity""Capacity"",Godowntype""Godown Type"",divcode,OpenLoankeyflg ""Open/Key Loan"" from rm_god  where gcode = '" & LookUp.Fields(0) & "' and DivCode = '" & Divcode & "' order by gcode", DB, adOpenStatic, adLockBatchOptimistic
            Else
            adoPrimaryRS.Open "select gcode ""Code"" ,gname ""Godown Name"",Capacity""Capacity"",Godowntype""Godown Type"",divcode from rm_god  where gcode = '" & LookUp.Fields(0) & "' and DivCode = '" & Divcode & "' order by gcode", DB, adOpenStatic, adLockBatchOptimistic
            End If
            Set grddatagrid.DataSource = adoPrimaryRS
            grddatagrid.Columns(0).Width = 1000
            grddatagrid.Columns(1).Width = 3000
...
Case 2
    ...
    If Not Rs(0) = 0 Then
        ...
        DB.BeginTrans
        LookUp.Clear = True
         LookUp.query = "select Gcode AS 'GodownCode',Gname as 'GodownName' from rm_god where 1=1 and DivCode = '" & Divcode & "'"
         LookUp.Caption = "Godown Listing"
         LookUp.DefCol = "GodownName"
         LookUp.ALIGN = "1500,5500"
         LookUp.Show vbModal
...
Case 3
    ...
    End If
        dv1.rsCommand1.Open "select gcode,gname from rm_god  where 1=1 and DivCode = '" & Divcode & "'  Order by gcode", cn, adOpenStatic, adLockOptimistic
...
'Save
      ...
      If grddatagrid.Columns(0).Text = "" Then
        MsgBox "Godown code Can't be Empty", vbInformation, head
        grddatagrid.Col = 0
        grddatagrid.SetFocus
        Exit Sub
      End If
      If grddatagrid.Columns(1).Text = "" Then
        MsgBox "Godown Name Can't be Empty", vbInformation, head
        grddatagrid.Col = 1
        grddatagrid.SetFocus
        Exit Sub
      End If
      If grddatagrid.Columns(3).Text = "" Then
        MsgBox "Godown Type Can't be Empty", vbInformation, head
        grddatagrid.Col = 3
        grddatagrid.SetFocus
        Exit Sub
      End If
    ...
    TrnLog("HSN") = grddatagrid.Columns(3).Text
...
Case 12
    ...
    Set Cystalrptbunk.cryRept = Cry_Godown
...
On Error GoTo Command3_Click_Error
  ...
  grddatagrid.Visible = True
    ...
    'Adodc1.Refresh
    Set adoPrimaryRS = New Recordset
    adoPrimaryRS.Open "select gcode ""Code"" ,gname ""Godown Name"",Godowntype""Godown Type"" from rm_god  where gcode = '" & KSLLIST1.code & "' and DivCode = '" & Divcode & "' order by gcode", DB, adOpenStatic, adLockBatchOptimistic
    Set grddatagrid.DataSource = adoPrimaryRS
    'Set grdDataGrid.DataSource = Adodc1.Recordset
...
StatusBar1.Panels(1).Text = STBARmsg
   ...
   ' sstab1.Tabs.Clear
    ...
    grddatagrid.Columns(3).Width = 1574.929
    If Openkeyloanflg = "Y" Then
    grddatagrid.Columns(4).Width = 1574.929
    End If
Exit Sub
Form_Load_Error:
...
On Error GoTo grddatagrid_AfterColUpdate_Error
        ...
        Else
            Set Rs = New Recordset
            Rs.Open "select 'X'  from rm_god where gcode='" & grddatagrid.Columns(0).Text & "' and DivCode = '" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
            If Not Rs.BOF Then
                MsgBox "Godown Code already defined!", vbInformation, head
...
If KeyCode = vbKeyTab Then
    ...
    If Trim(grddatagrid.Text) = "" Then
        If grddatagrid.Col = 1 Then
            MsgBox ("Godown Name Cannot be empty"), vbInformation, head
            grddatagrid.Col = 1
            grddatagrid.SetFocus
            ST2 = "A"
            Exit Sub
...
ElseIf grddatagrid.Col = 3 Then
    ...
    If Not (KeyAscii = 86 Or KeyAscii = 8 Or KeyAscii = 9 Or KeyAscii = 71 Or KeyAscii = 82 Or KeyAscii = 89 Or KeyAscii = 87) Then   ' G,R,V,Y,W
        KeyAscii = 0
    End If
...
On Error GoTo er1
  ...
  Set adoPrimaryRS = New Recordset
  If Openkeyloanflg = "Y" Then
  adoPrimaryRS.Open "select gcode ""Code"" ,gname ""Godown Name"",Capacity""Capacity"",Godowntype""Godown Type"",OpenLoankeyflg ""Open/Key Loan"" from rm_god where  DivCode = '" & Divcode & "' order by gcode", DB, adOpenStatic, adLockReadOnly
  Else
  adoPrimaryRS.Open "select gcode ""Code"" ,gname ""Godown Name"",Capacity""Capacity"",Godowntype""Godown Type"" from rm_god where  DivCode = '" & Divcode & "' order by gcode", DB, adOpenStatic, adLockReadOnly
  End If
  Set grddatagrid.DataSource = adoPrimaryRS
...
If Opt = "add" Then
   ...
   If Opt = "add" Then
     ...
     If grddatagrid.Col = 2 Then
          StatusBar1.Panels(2).Text = "Enter Integer of 5 Character"
     End If
     If grddatagrid.Col = 3 Then
          StatusBar1.Panels(2).Text = "Enter G-Godown,R-Road Side,V-Varandah,Y-Yarn Godown,W-Waste Godown"
     End If
   ElseIf Opt = "mod" Then
     If grddatagrid.Col = 1 Then
     ...
     End If
     If grddatagrid.Col = 2 Then
          StatusBar1.Panels(2).Text = "Modify Capacity Quantity"
     End If
     If grddatagrid.Col = 3 Then
          StatusBar1.Panels(2).Text = "Enter G-Godown,R-Road Side,V-Varandah,Y-Yarn Godown,W-Waste Godown"
     End If
