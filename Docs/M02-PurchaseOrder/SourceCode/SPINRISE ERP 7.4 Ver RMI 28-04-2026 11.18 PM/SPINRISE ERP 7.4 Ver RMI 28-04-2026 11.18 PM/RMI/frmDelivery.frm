...
Begin VB.Form frmDelivery 
   ...
   Begin VB.Frame Buttonframe 
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":0442
         Height          =   550
         Index           =   4
         Left            =   2160
         Picture         =   "frmDelivery.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":0AE1
         Height          =   550
         Index           =   6
         Left            =   3150
         Picture         =   "frmDelivery.frx":0F2B
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":1278
         Height          =   550
         Index           =   0
         Left            =   45
         Picture         =   "frmDelivery.frx":1582
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":1915
         Height          =   550
         Index           =   5
         Left            =   2625
         Picture         =   "frmDelivery.frx":1D5F
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":20C4
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":276A
         Height          =   550
         Index           =   1
         Left            =   570
         Picture         =   "frmDelivery.frx":2A74
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":3185
         Height          =   550
         Index           =   7
         Left            =   3675
         Picture         =   "frmDelivery.frx":35CF
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":391F
         Height          =   550
         Index           =   11
         Left            =   6375
         Picture         =   "frmDelivery.frx":3D69
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":40FE
         Height          =   550
         Index           =   9
         Left            =   4725
         Picture         =   "frmDelivery.frx":4408
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":47AA
         Height          =   550
         Index           =   10
         Left            =   5250
         Picture         =   "frmDelivery.frx":4AB4
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmDelivery.frx":4E30
         Height          =   550
         Index           =   8
         Left            =   4200
         Picture         =   "frmDelivery.frx":527A
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   "                "
      TabPicture(0)   =   "frmDelivery.frx":55DC
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&OK"
         Default         =   -1  'True
         DownPicture     =   "frmDelivery.frx":55F8
         Height          =   615
         Left            =   3240
         Picture         =   "frmDelivery.frx":59DE
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   4140
         Width           =   1185
      ...
      Begin VB.CommandButton Command1 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "frmDelivery.frx":5DA4
         Height          =   615
         Left            =   4980
         Picture         =   "frmDelivery.frx":6186
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   4140
         Width           =   1185
...
openconnection_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure openconnection of Form Delivery"
End Sub
...
'       Adodc1.Refresh
        ...
        adoPrimaryRS.Open "select Delcode ""Code"" ,DelDesc ""Delivery Name"" from rm_delivery where 1=2 order by Delcode", DB, adOpenStatic, adLockBatchOptimistic
...
Case 1
        ...
        Rs.Open "select count(*) from rm_delivery", DB
    If Not Rs(0) = 0 Then
        Opt = "mod"
...
''''        Frame3.Visible = True
''''        Label15.Caption = "Delivery Type"
''''        KslList1.conn = connectstring
''''        KslList1.table = "rm_delivery"
''''        KslList1.listfield1 = "Delcode"
''''        KslList1.listfield2 = "DelDesc"
''''        Frame3.Visible = True
         LookUp.Clear = True
         LookUp.query = "select Delcode""Delivery Code"",DelDesc""Description"" from rm_delivery"
         ...
         If LookUp.Cancel = False Then
           ...
           '' grdDataGrid.Visible = True
            ...
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open "select Delcode ""Code"" ,DelDesc ""Delivery Name"" from rm_delivery  where Delcode = '" & LookUp.Fields(0) & "' order by Delcode", DB, adOpenStatic, adLockBatchOptimistic
            Set grdDataGrid.DataSource = adoPrimaryRS
            grdDataGrid.Columns(0).Width = 1140.095
            grdDataGrid.Columns(1).Width = 4860.284
        ...
        StatusBar1.Panels(2).Text = "Select Delivery Type Code from the list for modification"
...
'''        Frame3.ZOrder
        ...
        StatusBar1.Panels(2).Text = "Select Delivery Type Code from the list for Deletion"
        Screen.MousePointer = 0
        ''Frame3.Visible = True
    Else
        MsgBox "No Record Found", vbInformation, head
...
Case 3
    ...
    Call repproc2(rptOIL)
        ...
        End If
        dv1.rsCommand1.Open "select Delcode,DelDesc from rm_delivery Order by Delcode", cn, adOpenStatic, adLockOptimistic
        If dv1.rsCommand1.RecordCount <> 0 Then
            Set rptDelivery.DataSource = dv1
            rptDelivery.Show
            desc.Caption = "Query"
        Else
...
'Save
      ...
      If grdDataGrid.Columns(0).Text <> "" And grdDataGrid.Columns(1).Text = "" Then
        MsgBox "Delivery Name Can't be Empty", vbInformation, head
        grdDataGrid.Col = 1
        grdDataGrid.SetFocus
        Exit Sub
      End If
...
'          Exit Sub
           ...
           Opt = tmp
            ...
            TrnLog("Trans_Name") = "Delivery Type"
     ...
     End If
       ...
       If Opt = "del" Then
         ...
         If msg = vbYes Then
            DB.Execute ("delete from rm_delivery where Delcode=" + "'" + grdDataGrid.Columns(0) + "'")
                Set TrnLog = New Recordset
            TrnLog.Open "SELECT Divcode,moduleNo,Trans_Name,Trans_Mod,Trans_Host,Trans_IPADD,Trans_UserId,Trans_date,code ,description FROM RM_Setup_Log  WHERE 1=2 ", DB, adOpenStatic, adLockBatchOptimistic
            TrnLog.AddNew
            TrnLog("DIVCODE") = Divcode
...
Case 12
    ...
    Set Cystalrptbunk.cryRept = Cry_Del_Type
...
Exit Sub
BUTTON_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure BUTTON_Click of Form frmDelivery", vbInformation, head
End Sub
...
On Error GoTo Command3_Click_Error
  ...
  grdDataGrid.Visible = True
    ...
    'Adodc1.Refresh
    Set adoPrimaryRS = New Recordset
    adoPrimaryRS.Open "select Delcode ""Code"" ,DelDesc ""Delivery Name"" from rm_delivery  where Delcode = '" & KslList1.Code & "' order by Delcode", DB, adOpenStatic, adLockBatchOptimistic
    Set grdDataGrid.DataSource = adoPrimaryRS
    'Set grdDataGrid.DataSource = Adodc1.Recordset
    grdDataGrid.Columns(0).Width = 1140.095
    grdDataGrid.Columns(1).Width = 4860.284
...
Command3_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Command3_Click of Form frmDelivery", vbInformation, head
End Sub
...
Exit Sub
Form_Load_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Load of Form frmDelivery", vbInformation, head
End Sub
...
On Error GoTo GrdDatagrid_AfterColUpdate_Error
        ...
        If Trim(grdDataGrid.Columns(0).Text) = Empty Or Trim(grdDataGrid.Columns(0).Text) = "" Then
            MsgBox "Delivery Code cannot be empty!", vbInformation, head
        Else
            Set Rs = New Recordset
            Rs.Open "select 'X'  from rm_delivery where Delcode='" & grdDataGrid.Columns(0).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
            If Not Rs.BOF Then
                MsgBox "Delivery Code already defined!", vbInformation, head
...
GrdDatagrid_AfterColUpdate_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grddatagrid_AfterColUpdate of Form frmDelivery", vbInformation, head
End Sub
...
If KeyCode = vbKeyTab Then
    ...
    If Trim(grdDataGrid.Text) = "" Then
        If grdDataGrid.Col = 1 Then
            MsgBox ("Delivery Name Cannot be empty"), vbInformation, head
            st2 = "A"
            grdDataGrid.Col = 1
            grdDataGrid.SetFocus
            Exit Sub
...
On Error GoTo er1
  ...
  'Adodc1.Refresh
  Set adoPrimaryRS = New Recordset
  adoPrimaryRS.Open "select delCode ""Code"" ,Deldesc ""Delivery Name"" from rm_delivery order by Delcode", DB, adOpenStatic, adLockReadOnly
  Set grdDataGrid.DataSource = adoPrimaryRS
...
If Opt = "add" Then
   ...
   ElseIf Opt = "mod" Then
     If grdDataGrid.Col = 1 Then
          StatusBar1.Panels(2).Text = "Modify the Delivery Type Description"
     End If
End If
...
grdDataGrid_RowColChange_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure GRDDATAGRID_RowColChange of Form frmDelivery", vbInformation, head
