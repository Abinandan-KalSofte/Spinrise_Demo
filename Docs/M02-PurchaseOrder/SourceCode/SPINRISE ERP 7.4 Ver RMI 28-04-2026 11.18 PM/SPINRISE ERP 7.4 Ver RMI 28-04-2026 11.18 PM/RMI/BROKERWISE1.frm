...
Begin VB.Form BROKERWISE1 
   Caption         =   "BROKERWISE-FAX REPORT"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
...
Cmdcancel_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Cmdcancel_Click of Form BROKERWISE1", vbInformation, head
...
''    rs.Open "SELECT DISTINCT L.ARRDT,b.slcode,S.SLNAME SUPPLIER,B.SLNAME BROKER,A.PRNO,L.LOTDT,L.BALES,L.RATECY,A.FREIGHT,L.PLOTNO,L.NETWT,L.PTYWGT,L.LOTNO,L.GRSWGT,L.TAREWT,L.NETWT,L.Ptywgt -L.NETWT AS  SHORTAGE,L.BILLNO,L.BILLDT,L.LOTYEAR,D.AREANAME,L.FNETWT,L.PNETWT FROM RM_ARRIVAL A,RM_LOT L,RM_CONT C,FA_SLMAS B,FA_SLMAS S,pp_divmas p,RM_AREA D WHERE b.Slcode BETWEEN '" & u & "' AND '" & v & "'  AND A.DIVCODE=L.DIVCODE AND L.ARRNO=A.ARRNO AND C.CONTNO=A.CONTNO  and L.AREACD=D.AREACODE AND" & _
''           " C.CONTDT=A.CONTDT  AND l.arrdt=a.arrdate and B.SLCODE=L.BRKCD AND S.SLCODE=L.SUPCD AND L.ARRDT BETWEEN '" & w & "' AND '" & x & "' AND P.DIVCODE='" & Divcode & "' AND OPFLG<>'Y' AND LOTYEAR='" & Year(yfdate) & "' ORDER BY B.SLNAME,L.LOTDT,L.LOTNO,S.SLNAME ", cn, adOpenStatic, adLockBatchOptimistic
           Rs.Open "SELECT DISTINCT L.ARRDT,b.slcode,S.SLNAME SUPPLIER,B.SLNAME BROKER,A.PRNO,L.LOTDT,L.BALES,L.RATECY,A.FREIGHT,L.PLOTNO,L.NETWT,L.PNETWT,L.LOTNO,L.GRSWGT,L.TAREWT,L.NETWT,L.PNETWT -L.NETWT AS  SHORTAGE,L.BILLNO,L.BILLDT,L.LOTYEAR,D.AREANAME,L.FNETWT,L.PNETWT FROM RM_ARRIVAL A,RM_LOT L,RM_CONT C,FA_SLMAS B,FA_SLMAS S,pp_divmas p,RM_AREA D WHERE b.Slcode BETWEEN '" & U & "' AND '" & V & "'  AND A.DIVCODE=L.DIVCODE AND L.ARRNO=A.ARRNO AND C.CONTNO=A.CONTNO  and L.AREACD=D.AREACODE AND" & _
           " C.CONTDT=A.CONTDT  AND l.arrdt=a.arrdate and B.SLCODE=L.BRKCD AND S.SLCODE=L.SUPCD AND L.ARRDT BETWEEN '" & W & "' AND '" & X & "' AND P.DIVCODE='" & Divcode & "' AND OPFLG<>'Y' AND LOTYEAR='" & Year(yfdate) & "' ORDER BY B.SLNAME,L.LOTDT,L.LOTNO,S.SLNAME ", Cn, adOpenStatic, adLockBatchOptimistic
Else
    Set Rs = New Recordset
''    rs.Open "SELECT DISTINCT L.ARRDT,b.slcode,S.SLNAME SUPPLIER,B.SLNAME BROKER,A.PRNO,L.LOTDT,L.BALES,L.RATECY,A.FREIGHT,L.PLOTNO,L.NETWT,L.PTYWGT,L.LOTNO,L.GRSWGT,L.TAREWT,L.NETWT,L.Ptywgt -L.NETWT AS  SHORTAGE,L.BILLNO,L.BILLDT,L.LOTYEAR,D.AREANAME,L.FNETWT,L.PNETWT FROM RM_ARRIVAL A,RM_LOT L,RM_CONT C,FA_SLMAS B,FA_SLMAS S,pp_divmas p,RM_AREA D WHERE b.Slcode BETWEEN '" & u & "' AND '" & v & "'  AND A.DIVCODE=L.DIVCODE AND L.ARRNO=A.ARRNO AND C.CONTNO=A.CONTNO  and L.AREACD=D.AREACODE AND" & _
''           " C.CONTDT=A.CONTDT  AND l.arrdt=a.arrdate and B.SLCODE=L.BRKCD AND S.SLCODE=L.SUPCD AND L.ARRDT BETWEEN '" & w & "' AND '" & x & "' AND P.DIVCODE='" & Divcode & "' and C.DLYTYPE='" & costr & "' AND OPFLG<>'Y' AND LOTYEAR='" & Year(yfdate) & "'   ORDER BY B.SLNAME,L.LOTDT,L.LOTNO,S.SLNAME ", cn, adOpenStatic, adLockBatchOptimistic
...
If TEMP <> Rs("BROKER") Then
Print #a, Chr(27) + "E" + Padr("BROKER NAME :", 15, " ") & Space(2) & Padr(Rs("BROKER"), 50, " ") + Chr(27) + "F"
Print #a,
 Co = Co + 2
End If
If Rs("FNETWT") <> 0 Then
...
End If
        ...
        Print #a, Space(0); Padr(Rs("supplier"), 30, " "); Space(2); Padr(Format(Rs("BILLDT"), "DD/MM/YY"), 8, " "); Space(2); Padl(Rs("BILLNO"), 5, " "); Space(2); Padl(INF(Rs("RATECY"), 0), 8, " "); Space(2); Padl(INF(Rs("FREIGHT"), 2), 9, " "); Space(2); Padl(INF(Rs("PNETWT"), 2), 10, " "); Space(2); Padl(INF(Rs("GRSWGT"), 2), 10, " "); Space(2); Padl(INF(Rs("TAREWT"), 2), 8, " "); Space(2); Padl(INF(Rs("NETWT"), 2), 10, " "); Space(2); Padl(Format(diff, "#0.00"), 8, " ")
        Print #a, Space(3); Padr("Mill.Lot No  : ", 14, " ") & Space(1) & Padl(Rs("LOTNO"), 5, " "); "/"; Padr(Rs("lotyear"), 4, " ") & Space(1) & Space(10); Padr("Party Lot No. :", 15, " ") & Space(1) & Padl(Rs("PLOTNO"), 10, " ")
        Print #a, Space(3); Padr("No.of Bales  :", 14, " ") & Space(1) & Padr(Rs("BALES"), 10, " "); Space(11); Padr("Station       :", 15, " ") & Space(1) & Padr(Rs("AREANAME"), 18, " ")
...
cmdreport_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdreport_Click of Form BROKERWISE1"
End Sub
...
'Chr(27) & "E" & Space(0);
'& Chr(27) & "F"
Print #a, Chr(27) & "E" & Space(0); "Brokerwise List of lots without invoices" & Chr(27) & "F" & Space(1) & "From" & Space(1) & Format(W, "dd/mm/yy") & Space(1) & "to" & Space(1) & Format(X, "dd/mm/yy") & Space(26) & Space(15) & Format(temp2, "dd/mm/yy") & Space(5) & "Pg.:" & Space(1) & Padl(Pg, 3, " ")
Print #a, Space(0); String(124, "-")
Print #a, Space(0); "Supplier Name                   Received   Prov     Candy      Lorry       Party       Mill       Tare       Mill "
...
Exit Sub
header3_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure header3 of Form BROKERWISE1"
End Sub
...
Cn.Open connectstring
    ...
    rss.Open "select distinct a.SLNAME+ ' - ' +A.SLCODE AS SUP from fa_slmas a where  a.slcode like 'C5%' order by sup", Cn, adOpenStatic, adLockBatchOptimistic
    Set Rs = New Recordset
...
Exit Sub
Form_Load_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Load of Form BROKERWISE1"
End Sub
...
'
'
'rs.Open "SELECT DISTINCT L.ARRDT,b.slcode,S.SLNAME SUPPLIER,B.SLNAME BROKER,A.PRNO,L.LOTDT,L.BALES,L.RATECY,A.FREIGHT,L.PLOTNO,L.NETWT,L.PTYWGT,L.LOTNO,L.GRSWGT,L.TAREWT,L.NETWT,L.Ptywgt -L.NETWT AS  SHORTAGE,L.BILLNO,L.BILLDT FROM RM_ARRIVAL A,RM_LOT L,RM_CONT C,FA_SLMAS B,FA_SLMAS S,pp_divmas p WHERE b.Slcode BETWEEN '" & u & "' AND '" & v & "'  AND A.DIVCODE=L.DIVCODE AND L.ARRNO=A.ARRNO AND C.CONTNO=A.CONTNO  and" & _
'       " C.CONTDT=A.CONTDT  AND B.SLCODE=L.BRKCD AND S.SLCODE=L.SUPCD AND L.ARRDT BETWEEN '" & w & "' AND '" & x & "' AND P.DIVCODE='" & Divcode & "' and C.DLYTYPE='" & costr & "' ORDER BY B.SLNAME,S.SLNAME,L.ARRDT ", cn, adOpenStatic, adLockBatchOptimistic
'
...
'Do While rs.EOF = False
'If TEMP <> rs("BROKER") Then
' Print #A, Space(45) + Chr(27) + "E" + Padr("BROKER NAME :", 15, " ") & Space(2) & Padr(rs("BROKER"), 50, " ") + Chr(27) + "F"
' co = co + 1
'End If
'
'        'Print #a, Space(50) + Chr(27) + "E" + Padr("SUPPLIER NAME :", 15, " ") & Space(2) & Padr(rs("SUPPLIER"), 50, " ") + Chr(27) + "F"
...
DTPicker1_Change_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure DTPicker1_Change of Form BROKERWISE1"
End Sub
...
DTPicker2_Change_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure DTPicker2_Change of Form BROKERWISE1"
End Sub
