...
Begin VB.Form Wasteentry1 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":0000
         Enabled         =   0   'False
         Height          =   550
         Index           =   6
         Left            =   2640
         Picture         =   "Wasteentry1.frx":044A
         Style           =   1  'Graphical
         TabIndex        =   51
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":0797
         Height          =   550
         Index           =   0
         Left            =   0
         Picture         =   "Wasteentry1.frx":0AA1
         Style           =   1  'Graphical
         TabIndex        =   50
         ToolTipText     =   "Add"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":0E34
         Enabled         =   0   'False
         Height          =   550
         Index           =   5
         Left            =   2100
         Picture         =   "Wasteentry1.frx":127E
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":15E3
         Enabled         =   0   'False
         Height          =   550
         Index           =   7
         Left            =   3210
         Picture         =   "Wasteentry1.frx":1A2D
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":1D7D
         Height          =   550
         Index           =   11
         Left            =   5340
         Picture         =   "Wasteentry1.frx":21C7
         Style           =   1  'Graphical
         TabIndex        =   47
         ToolTipText     =   "Exit"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":255C
         Height          =   550
         Index           =   9
         Left            =   4260
         Picture         =   "Wasteentry1.frx":2866
         Style           =   1  'Graphical
         TabIndex        =   46
         ToolTipText     =   "Save"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "Wasteentry1.frx":2C08
         Height          =   550
         Index           =   10
         Left            =   4785
         Picture         =   "Wasteentry1.frx":2F12
         Style           =   1  'Graphical
         TabIndex        =   45
         ToolTipText     =   "Cancel "
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":328E
         Enabled         =   0   'False
         Height          =   550
         Index           =   8
         Left            =   3735
         Picture         =   "Wasteentry1.frx":36D8
         Style           =   1  'Graphical
         TabIndex        =   44
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":3A3A
         Height          =   550
         Index           =   4
         Left            =   1575
         Picture         =   "Wasteentry1.frx":3D44
         Style           =   1  'Graphical
         TabIndex        =   43
         ToolTipText     =   "Find"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":40D9
         Height          =   550
         Index           =   1
         Left            =   525
         Picture         =   "Wasteentry1.frx":43E3
         Style           =   1  'Graphical
         TabIndex        =   42
         ToolTipText     =   "Modify"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Wasteentry1.frx":475D
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Enabled         =   0   'False
      TabCaption(0)   =   "                   "
      TabPicture(0)   =   "Wasteentry1.frx":4E03
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox Combo2 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "Wasteentry1.frx":4E1F
            Left            =   1680
            List            =   "Wasteentry1.frx":4E2F
            TabIndex        =   55
            Top             =   1440
            Width           =   1935
         End
         Begin VB.ComboBox Combo1 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "Wasteentry1.frx":4E44
            Left            =   1680
            List            =   "Wasteentry1.frx":4E4E
            TabIndex        =   1
            Top             =   360
            Width           =   1935
         End
