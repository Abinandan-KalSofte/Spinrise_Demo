...
Begin VB.Form frmSPOTPasser 
   ...
   Begin VB.Frame Buttonframe 
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":0442
         Height          =   550
         Index           =   4
         Left            =   2160
         Picture         =   "frmSPOTPass.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":0AE1
         Height          =   550
         Index           =   8
         Left            =   4200
         Picture         =   "frmSPOTPass.frx":0F2B
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":128D
         Height          =   550
         Index           =   10
         Left            =   5250
         Picture         =   "frmSPOTPass.frx":1597
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":1913
         Height          =   550
         Index           =   9
         Left            =   4725
         Picture         =   "frmSPOTPass.frx":1C1D
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":1FBF
         Height          =   550
         Index           =   11
         Left            =   6375
         Picture         =   "frmSPOTPass.frx":2409
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":279E
         Height          =   550
         Index           =   7
         Left            =   3675
         Picture         =   "frmSPOTPass.frx":2BE8
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":32CF
         Height          =   550
         Index           =   1
         Left            =   570
         Picture         =   "frmSPOTPass.frx":35D9
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":3953
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":3FF9
         Height          =   550
         Index           =   5
         Left            =   2625
         Picture         =   "frmSPOTPass.frx":4443
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":47A8
         Height          =   550
         Index           =   0
         Left            =   45
         Picture         =   "frmSPOTPass.frx":4AB2
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frmSPOTPass.frx":4E45
         Height          =   550
         Index           =   6
         Left            =   3150
         Picture         =   "frmSPOTPass.frx":528F
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   "        "
      TabPicture(0)   =   "frmSPOTPass.frx":55DC
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command1 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "frmSPOTPass.frx":55F8
         Height          =   615
         Left            =   4710
         Picture         =   "frmSPOTPass.frx":59DA
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   4110
         Width           =   1185
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&OK"
         Default         =   -1  'True
         DownPicture     =   "frmSPOTPass.frx":5DAD
         Height          =   615
         Left            =   3000
         Picture         =   "frmSPOTPass.frx":6193
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   4110
         Width           =   1185
   ...
   End
End
Attribute VB_Name = "frmSPOTPasser"
...
'addition
        ...
        adoPrimaryRS.Open "select SPCode "" Code"" ,SPName "" Name"" from RM_SpotPass where 1=2 order by SPCode", DB, adOpenStatic, adLockBatchOptimistic
...
Case 1
    ...
    Rs.Open "select count(*) from RM_SpotPass", DB
    If Not Rs(0) = 0 Then
        Opt = "mod"
        ...
        DB.BeginTrans
         ...
         LookUp.Clear = True
         LookUp.query = "select SPCode AS ' Code',SPName as ' Name' from RM_SpotPass "
         ...
         If LookUp.Cancel = False Then
            ...
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open "select SPCode ""Code"" ,SPName "" Name"" from RM_SpotPass where SPCode = '" & LookUp.Fields(0) & "' order by SPCode", DB, adOpenStatic, adLockBatchOptimistic
            Set grdDataGrid.DataSource = adoPrimaryRS
            grdDataGrid.Columns(0).Width = 2000
            grdDataGrid.Columns(1).Width = 3500
    ...
    If Not Rs(0) = 0 Then
        ...
        DB.BeginTrans
         ...
         If LookUp.Cancel = False Then
            ...
            StatusBar1.Panels(2).Text = ""
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open "select SPCode AS 'Code',SPName as 'Name' from RM_SpotPass  where SPCode = '" & LookUp.Fields(0) & "'  order by SPCode", DB, adOpenStatic, adLockBatchOptimistic
            Set grdDataGrid.DataSource = adoPrimaryRS
            grdDataGrid.Columns(0).Width = 2000
            grdDataGrid.Columns(1).Width = 3500
...
Case 3
    ...
    Set Rs = New Recordset
    Rs.Open "select * from RM_SpotPass Order by SPCode", DB, adOpenStatic
...
'        Set rsP = New Recordset
        ...
        'Open "C:\red.txt" For Output As #1
            ...
            Rs.MoveFirst
            Do While Not Rs.EOF
                Print #1, Space(3); Padr(iCount, 10, " ") + Space(4) + Padr(Rs("SPCode"), 20, " ") + Space(4) + Padr(Rs("SPName"), 41, " ")
                iRow = iRow + 1
                iCount = iCount + 1
                    If iRow > 60 Then
                        Print #1,
      ...
      End If
          ...
          End If
           ...
           adoPrimaryRS.UpdateBatch adAffectAllChapters
            ...
            TrnLog("Trans_Name") = "Spot Passing Person"
...
'       End If
     End If
       ...
       If Opt = "del" Then
         ...
         If msg = vbYes Then
            DB.Execute ("delete from RM_SpotPass where SPCode=" + "'" + grdDataGrid.Columns(0) + "'")
            Set TrnLog = New Recordset
            TrnLog.Open "SELECT Divcode,moduleNo,Trans_Name,Trans_Mod,Trans_Host,Trans_IPADD,Trans_UserId,Trans_date,code ,description FROM RM_Setup_Log  WHERE 1=2 ", DB, adOpenStatic, adLockBatchOptimistic
            TrnLog.AddNew
            TrnLog("DIVCODE") = Divcode
...
Case 12
    ...
    Dim CystalrptSpot As New clsCrystal
    Set CystalrptSpot.cryRept = Cry_Setup_SpotPass
    CystalrptSpot.CrystalPrint
...
On Error GoTo GrdDatagrid_AfterColUpdate_Error
        ...
        If ColIndex = 0 Then
            ...
            Else
                Set Rs = New Recordset
                Rs.Open "select 'X'  from RM_SpotPass where SPCode='" & grdDataGrid.Columns(0).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                If Not Rs.BOF Then
        ...
        If ColIndex = 1 Then
            ...
            Else
                Set Rs = New Recordset
                Rs.Open "select 'X'  from RM_SpotPass where SPName='" & grdDataGrid.Columns(1).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                If Not Rs.BOF Then
...
On Error GoTo er1
  ...
  'Adodc1.Refresh
  Set adoPrimaryRS = New Recordset
  adoPrimaryRS.Open "select SPCode AS ' Code',SPName as ' Name' from RM_SpotPass order by SPCode", DB, adOpenStatic, adLockReadOnly
  Set grdDataGrid.DataSource = adoPrimaryRS
