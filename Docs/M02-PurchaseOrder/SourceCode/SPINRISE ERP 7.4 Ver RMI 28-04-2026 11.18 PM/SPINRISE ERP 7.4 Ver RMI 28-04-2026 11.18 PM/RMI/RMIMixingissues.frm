...
Begin VB.Form RMIMixingissues 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "RMIMixingissues.frx":0000
      ...
      TabPicture(1)   =   "RMIMixingissues.frx":001C
      ...
      Tab(1).Control(14)=   "Text11"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "Frame4"
      Tab(1).Control(16)=   "Option1"
      Tab(1).Control(17)=   "Option2"
      Tab(1).Control(18)=   "Frame8"
      Tab(1).Control(19)=   "Frame13"
      Tab(1).Control(20)=   "grid"
      Tab(1).Control(21)=   "Command11"
      Tab(1).Control(22)=   "txtweight"
      Tab(1).Control(23)=   "Command12"
      Tab(1).Control(24)=   "Frame9"
      ...
      Begin ubGridControl.ubGrid grid 
         ...
         FormatString    =   "Bale No. |Gross Weight|Tare Weight |Nett Weight |Act Iss Weight|Issued|GetKG"
      End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpreadADO.fpSpread SpdBales 
            ...
            MaxCols         =   3
            MaxRows         =   0
            SpreadDesigner  =   "RMIMixingissues.frx":0038
            AppearanceStyle =   0
         End
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox Combo1 
            ...
            ForeColor       =   &H00000000&
            Height          =   360
            ItemData        =   "RMIMixingissues.frx":04C7
            Left            =   1320
            List            =   "RMIMixingissues.frx":04C9
            TabIndex        =   12
            Top             =   150
            Width           =   3135
         End
         ...
         Begin VB.ComboBox Combo2 
            ...
            ForeColor       =   &H00000000&
            Height          =   360
            ItemData        =   "RMIMixingissues.frx":04CB
            Left            =   9540
            List            =   "RMIMixingissues.frx":04D2
            TabIndex        =   15
            Top             =   150
            Width           =   1155
         End
         ...
         Begin VB.ComboBox Combo3 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "RMIMixingissues.frx":04E0
            Left            =   90
            List            =   "RMIMixingissues.frx":04E2
            TabIndex        =   85
            Top             =   2490
            Visible         =   0   'False
            Width           =   1215
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   13
         Left            =   5970
         Picture         =   "RMIMixingissues.frx":04E4
         Style           =   1  'Graphical
         TabIndex        =   124
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":0926
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   4
         Left            =   1620
         Picture         =   "RMIMixingissues.frx":0C30
         Style           =   1  'Graphical
         TabIndex        =   118
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   5430
         Picture         =   "RMIMixingissues.frx":0FC5
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":1407
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   6
         Left            =   2685
         Picture         =   "RMIMixingissues.frx":1851
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":1B9E
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   0
         Left            =   30
         Picture         =   "RMIMixingissues.frx":1EA8
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":223B
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   5
         Left            =   2160
         Picture         =   "RMIMixingissues.frx":2685
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":29EA
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1095
         Picture         =   "RMIMixingissues.frx":2CF4
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":3090
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   1
         Left            =   570
         Picture         =   "RMIMixingissues.frx":339A
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   8700
         Picture         =   "RMIMixingissues.frx":3714
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":3AAB
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   7
         Left            =   3240
         Picture         =   "RMIMixingissues.frx":3EF5
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":4245
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   11
         Left            =   6510
         Picture         =   "RMIMixingissues.frx":468F
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":4A24
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   9
         Left            =   4320
         Picture         =   "RMIMixingissues.frx":4D2E
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":50D0
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   10
         Left            =   4875
         Picture         =   "RMIMixingissues.frx":53DA
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIMixingissues.frx":5756
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   8
         Left            =   3780
         Picture         =   "RMIMixingissues.frx":5BA0
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&Cancel"
         DownPicture     =   "RMIMixingissues.frx":5F02
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Height          =   615
         Left            =   4020
         Picture         =   "RMIMixingissues.frx":62E4
         Style           =   1  'Graphical
         TabIndex        =   55
         Top             =   1680
         Width           =   975
      ...
      Begin VB.CommandButton Command2 
         Caption         =   "&OK"
         DownPicture     =   "RMIMixingissues.frx":66B7
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Height          =   615
         Left            =   2580
         Picture         =   "RMIMixingissues.frx":6A9D
         Style           =   1  'Graphical
         TabIndex        =   54
         Top             =   1680
         Width           =   975
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.CommandButton Command6 
            Caption         =   "&OK"
            DownPicture     =   "RMIMixingissues.frx":6E63
            Height          =   495
            Left            =   2760
            Picture         =   "RMIMixingissues.frx":7249
            Style           =   1  'Graphical
            TabIndex        =   63
            Top             =   240
            Width           =   1185
         ...
         Begin VB.CommandButton Command5 
            Caption         =   "&Cancel"
            DownPicture     =   "RMIMixingissues.frx":760F
            Height          =   495
            Left            =   6240
            Picture         =   "RMIMixingissues.frx":79F1
            Style           =   1  'Graphical
            TabIndex        =   64
            Top             =   240
            Width           =   1185
   ...
   End
End
Attribute VB_Name = "RMIMixingissues"
...
''''''''            rsg.Open "SELECT SUM(ISSKGS) FROM RM_ISSB B WHERE  DOCNO=" & Txtfields(0).Text & " AND docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and   lotno='" & rs1(0) & "' and lotdt='" & Format(rs1(1), "yyyy-mm-dd") & "' and catcd='" & rs1(3) & "' AND DIVCODE='" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
''''''''
...
'''''''''            qty = rs2(0)
'''''''''            selbale = rs2(1)
''''''''            DB.Execute ("update rm_lot set isswt = " & val(qty) & " - " & val(rsg(0)) & ",issbal=" & val(selbale) & " - " & val(Rs(0)) & " where  DIVCODE='" & Divcode & "' AND lotno='" & rs1(0) & "' and lotdt='" & Format(rs1(1), "yyyy-mm-dd") & "' and catcd='" & rs1("Catcd") & "' AND DIVCODE='" & Divcode & "' and lotyear='" & Year(yfdate) & "'"), a
''''''''        rs1.MoveNext
''''''''       Loop
''''''''       '*********************  BALE TABLE UPDATION **************************
''''''''
...
''''''''       rs1.MoveFirst
''''''''       Do While Not rs1.EOF
''''''''                DB.Execute "update rm_bale set isqty=isqty-" & val(rs1("isskgs")) & ",actisskgs=actisskgs-" & val(rs1("actisskgs")) & ",issued='N' WHERE STATUS IN ('AC','AW') AND catcd = '" & rs1("catcd") & "' and LOTNO=" & rs1("LotNo") & " and lotdt='" & Format(rs1("lotDt"), "yyyy-mm-dd") & "' and baleno=" & rs1("baleno") & " and lottype = '" & rs1("lottype") & "' and divcode='" & Divcode & "'  and isnull(rejflg,'N')='N'", a
''''''''                DB.Execute "update rm_bale set issued='Y' WHERE STATUS IN ('AC','AW') AND catcd = '" & rs1("catcd") & "' and  LOTNO=" & rs1("LotNo") & " and lotdt='" & Format(rs1("lotDt"), "yyyy-mm-dd") & "' and baleno=" & rs1("baleno") & " and lottype = '" & rs1("lottype") & "' and divcode='" & Divcode & "'  and isnull(rejflg,'N')='N' AND NETWT=ISNULL(ACTISSKGS,0)", a
''''''''                ''This code For Update "N" to Already Set "Y" Bale                DB.Execute "update rm_ISSB set issued='N' WHERE LOTNO=" & rs1("LotNo") & " AND catcd = '" & rs1("catcd") & "' and  and lotdt='" & Format(rs1("lotdt"), "yyyy-mm-dd") & "' and baleno=" & rs1("baleno") & " and lottype = '" & rs1("lottype") & "' and divcode='" & Divcode & "'  and DOCNO<>" & adoPrimaryRS("DOCNO") & " AND DOCDT>='" & Format(adoPrimaryRS("DOCDT"), "YYYY-MM-DD") & "'", a
''''''''            rs1.MoveNext
''''''''        Loop
...
''''''''            'icategory
''''''''             Set rsa = New Recordset
''''''''             rsa.Open "SELECT ARRDT FROM RM_LOT WHERE catcd='" & grddatagrid.Columns(icategory).Text & "' and LOTNO='" & grddatagrid.Columns(ILotNo).Text & "' AND LOTDT='" & Format(grddatagrid.Columns(ILotdt), "yyyy-mm-dd") & "' AND LOTYEAR='" & Year(yfdate) & "' AND DIVCODE='" & Divcode & "'", DB, adOpenStatic
''''''''             If rsa.RecordCount > 0 Then
...
''''''''            DB.Execute "UPDATE RM_ISSH SET VEHICLENO='" & Trim(Txtfields(7).Text) & "' WHERE DOCNO='" & adoPrimaryRS("DOCNO") & "' AND DOCDT='" & Format(adoPrimaryRS("DOCDT"), "YYYY-MM-DD") & "' and divcode='" & Divcode & "' AND RDIVCODE='" & adoPrimaryRS("DOCNO") & "'"
''''''''      End If
''''''''      If Txtisstype.Text = "P" Then
...
''''''''            balers.Open "select baleno ""Baleno"",GRWT ""Gross Weight"",TAREWT""Tare Weight"",NETWT-isnull(actisskgs,0) ""Net Weight"",actisskgs ""AIssKgs"",issued ""Issued"" from rm_bale where Catcd='" & adoSecondaryRS("CATCD") & "'  and STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "'  and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and (issued='N' or issued is null)  and (ltrim(rtrim(openkey))='' or openkey is null or openkey='N') and baleno=" & adoSecondaryRS("BALENO") & " and isnull(rejflg,'N')='N'  and divcode='" & Divcode & "' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
''''''''            Set rs1 = New Recordset
''''''''            rs1.Open "select ISNULL(isqty,0) from rm_bale  where STATUS IN ('AC','AW') AND Catcd='" & adoSecondaryRS("CATCD") & "' and  lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "'  and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & "  and isnull(rejflg,'N')='N' and divcode='" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
''''''''            If rs1.RecordCount > 0 Then
''''''''                If adoSecondaryRS!AIKgs <> Empty Then
''''''''                    If adoSecondaryRS!Issued = "N" Then
''''''''                        DB.Execute ("update rm_bale set isqty= isnull(isqty,0)+" & val(adoSecondaryRS("Issued Kgs")) & ",ActIssKgs=isnull(ActIssKgs,0) + " & val(adoSecondaryRS!AIKgs) & ",ISSUED= '" & adoSecondaryRS!Issued & "'  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "'  and Catcd='" & adoSecondaryRS("CATCD") & "' and  lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & "  and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
''''''''                    Else
''''''''                        DB.Execute ("update rm_bale set isqty=isnull(isqty,0)+ " & adoSecondaryRS("Issued Kgs") & ",ActIssKgs= isnull(ActIssKgs,0) + " & adoSecondaryRS!AIKgs & ",ISSUED= 'Y'  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and Catcd='" & adoSecondaryRS("CATCD") & "' and  lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & " and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
''''''''                    End If
''''''''                    If adoSecondaryRS!Issued = "N" Then
''''''''                        DB.Execute ("update rm_lot set isswt=isnull(isswt,0) + " & val(adoSecondaryRS("Issued Kgs")) & ",issbal=isnull(issbal,0) where lotno='" & adoSecondaryRS("Lot No.") & "' and Catcd='" & adoSecondaryRS("CATCD") & "' and  lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and divcode='" & Divcode & "' and lotyear='" & Year(yfdate) & "'")
''''''''                    Else
''''''''                        DB.Execute ("update rm_lot set isswt=isnull(isswt,0) + " & val(adoSecondaryRS("Issued Kgs")) & ",issbal=isnull(issbal,0)+ " & 1 & " where divcode='" & Divcode & "' and lotno='" & adoSecondaryRS("Lot No.") & "' and Catcd='" & adoSecondaryRS("CATCD") & "' and  lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "'  and lotyear='" & Year(yfdate) & "'")
''''''''                    End If
''''''''                Else
''''''''                    DB.Execute ("update rm_bale set isqty=isnull(isqty,0)+" & val(adoSecondaryRS("Issued Kgs")) & ",ActIssKgs=" & val(adoSecondaryRS(11)) & ",ISSUED= 'Y'  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND Catcd='" & adoSecondaryRS("CATCD") & "' and  BALENO=" & adoSecondaryRS("BALENO") & " and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
''''''''                    DB.Execute ("update rm_lot set isswt=isnull(isswt,0) + " & val(adoSecondaryRS("Issued Kgs")) & ",issbal=isnull(issbal,0)+ " & 1 & " where lotno='" & adoSecondaryRS("Lot No.") & "' and Catcd='" & adoSecondaryRS("CATCD") & "' and  lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and divcode='" & Divcode & "'  and lotyear='" & Year(yfdate) & "'")
''''''''                End If
''''''''            End If
''''''''
''''''''
...
''''''''                    strSQL = "update RM_IssReqB set issued= 'Y' , Isskgs = isnull(Isskgs,0) + 1 where  Catcd='" & adoSecondaryRS("CATCD") & "' and varcode ='" & adoSecondaryRS!Variety & "'  and  DocNo =" & val(iSlipNo) & " and Docdt='" & Format(sSlipDate, "YYYY-MM-DD") & "' and lotno='" & adoSecondaryRS("Lot No.") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and divcode='" & Divcode & "'"
''''''''                    DB.Execute (strSQL)
...
''''''''
''''''''               cnt1 = rsg.RecordCount
''''''''
''''''''                    Set RSKG = New Recordset
''''''''                    RSKG.Open "select isnull(ratekg,0) as ratekg  from rm_lot where Catcd='" & rsg("CATCD") & "' and lotno=" & val(rsg("Lot No.")) & " AND lotdt='" & Format(rsg("DATE"), "YYYY-MM-DD") & "' AND DIVCODE='" & Divcode & "'", DB, adOpenStatic
''''''''
...
''''''''                        DB.Execute "INSERT INTO RM_MixingSTOCK (issno,issdt,catcd,lotno,lotdt,varcode,ratekg,mixkgs,mixbales,ISSTYPE,DIVCODE,isskgs,issbale) VALUES ( " & adoPrimaryRS("DOCNO") & ",'" & Format(adoPrimaryRS("DOCDT"), "YYYY-MM-DD") & "','" & rsg(2) & "'," & rsg("Lot No.") & ",'" & Format(rsg("Date"), "YYYY-MM-DD") & "','" & rsg("Variety") & "'," & ratekg & ",0,0,'" & Left(Combo1.Text, 2) & "','" & Divcode & "',0," & cnt1 & " )"
''''''''                    End If
''''''''
''''''''       End If
''''''''
...
''''''''        DB.BeginTrans
''''''''        adoSecondaryRS.MoveFirst
''''''''        Set rstRtn = New Recordset
''''''''        rstRtn.Open "SELECT DISTINCT DIVCODE, ISSTYPE, DOCNO, DOCDT, CATCD, LOTNO, lotdt, BALENO, ISSKGS, LOTTYPE, ACTISSKGS, arrdt, VARCODE FROM RM_ISSB where docno='" & adoSecondaryRS("docno") & "' and docdt='" & Format(adoSecondaryRS("docdt"), "yyyy-mm-dd") & "' and divcode='" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
''''''''        rstRtn.MoveFirst
''''''''        Do While Not rstRtn.EOF
''''''''             sQry = ""
''''''''             sQry = "INSERT INTO RM_ISSUE_RETURN (DIVCODE, ISSTYPE, DOCNO, DOCDT,ISSDOCNO,ISSDOCDT, CATCD, LOTNO, lotdt, BALENO, ISSKGS, LOTTYPE, ACTISSKGS, arrdt, VARCODE,USERID,MIXGRP)"
''''''''             sQry = sQry & Chr(13) & " VALUES('" & rstRtn("DIVCODE") & "','" & rstRtn("ISSTYPE") & "'," & Rs(0) & ",'" & Format(pdate, "YYYY/MM/DD") & "'," & rstRtn("DOCNO") & ",'" & Format(rstRtn("dOCDT"), "YYYY/MM/DD") & "','" & rstRtn("CATCD") & "'," & rstRtn("LOTNO") & ",'" & Format(rstRtn("LOTDT"), "YYYY/MM/DD") & "'," & rstRtn("BALENO") & "," & rstRtn("ISSKGS") & ",'" & rstRtn("LOTTYPE") & "'," & rstRtn("ACTISSKGS") & ",'" & Format(rstRtn("ARRDT"), "YYYY/MM/DD") & "','" & rstRtn("VARCODE") & "','" & usrid & "','" & Trim(Txtfields(8).Text) & "')"
''''''''
''''''''             DB.Execute sQry
''''''''        rstRtn.MoveNext
''''''''        Loop
...
''''''''        Do While Not Rs.EOF
''''''''            DB.Execute "update rm_bale set isqty=isqty-" & val(Rs("isskgs")) & ",actisskgs=actisskgs-" & val(Rs("actisskgs")) & ",issued='N' WHERE STATUS IN ('AC','AW') AND LOTNO=" & Rs("LotNo") & " and lotdt='" & Format(Rs("Date"), "yyyy-mm-dd") & "' and baleno=" & Rs(0) & " and lottype = '" & Rs("lottype") & "' and divcode='" & Divcode & "'  and isnull(rejflg,'N')='N'", a
...
''''''''            If rs1(0) = "Y" Then
''''''''                strSQL = "update RM_IssReqB set  Isskgs = isnull(Isskgs,0)- 1 where varcode ='" & adoSecondaryRS!catcd & "'  and  varcode ='" & adoSecondaryRS!Variety & "'  and  DocNo =" & val(adoSecondaryRS("ReqDocNO")) & " and Docdt='" & Format(adoSecondaryRS("ReqDocDt"), "YYYY-MM-DD") & "' and lotno='" & adoSecondaryRS("Lot No") & "' and lotdt='" & Format(adoSecondaryRS("lot date"), "yyyy-mm-dd") & "' and divcode='" & Divcode & "'"
''''''''                DB.Execute (strSQL)
''''''''            End If
''''''''
''''''''            Rs.MoveNext
...
''''''''            " (select a.catcd,a.lotno,a.lotdt,A.LOTTYPE,A.VARCODE,a.divcode,Bales,a.Netwt,SUM(b.isskgs) AS ISSWET,count(b.baleno) as issbales,bales-count(b.baleno) as Closingbales, " & _
''''''''            " a.Netwt-sum(b.isskgs) as Closingwt " & _
''''''''            " from rm_lot a ,rm_issb b where a.lotdt<='" & Format(yldate, "yyyy-mm-dd") & "' and (a.rejflg='N' or a.rejdt>'" & Format(yldate, "YYYY-MM-DD") & "') and a.divcode='" & Divcode & "' and lotyear='" & Year(yfdate) & "' " & _
''''''''            " and a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.catcd=b.catcd AND A.VARCODE=B.VARCODE AND A.LOTTYPE=B.LOTTYPE and b.docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' and b.issued='Y' " & _
''''''''            " group by a.catcd,a.lotno,a.lotdt,a.divcode,bales,a.netwt,A.LOTTYPE,A.VARCODE " & _
...
''''''''If UCase(CustID) = "NATURAL" Or UCase(CustID) = "BALKRISHNA" Then
''''''''                            'chck = False
''''''''                            'Do While Not chck = False
''''''''                            '  Com1_OnComm
''''''''                            '  chck = True
''''''''                            'Loop
''''''''
...
''''''''               Dim mtwt() As String
''''''''               If chck = True Then
''''''''                    mtwt = Split(MSCom1.Input, Chr(13))
''''''''                    If UBound(mtwt) > 5 Then
''''''''                        InString = Left$(LTrim(RTrim(mtwt(5))), 10)
...
''''''''                    MScom1_OnComm
''''''''                    MsgBox "Still Port Not readed", vbCritical
''''''''               End If
''''''''
''''''''Else
''''''''  Set Rs = New Recordset
...
''''''''            RSOLD.Open "select SUM(ACTISSKGS) from rm_issb where catcd = '" & adoSecondaryRS("CATCD") & "' and  lotno=" & adoSecondaryRS("Lot No") & " and lotdt='" & Format(adoSecondaryRS("lot date"), "YYYY-MM-DD") & "' AND BALENO='" & adoSecondaryRS("BALE NO.") & "' AND DIVCODE='" & Divcode & "'", DB, adOpenStatic
''''''''
...
''''''''            avilbalers.Open "select a.baleno ""Baleno"",Grwt,TareWt,Favaourablewgt-isnull(actisskgs,0) ""Balance Weight"",isnull(partybaleno,0) as Partybaleno from rm_bale as a,rm_baleisstmp as b  where  a.lotno=b.lotno and a.baleno=b.baleno and b.Transflag='N' and a.lotdt=b.lotdate  and a.DIVCODE='" & Divcode & "' AND a.varcode='" & grddatagrid.Columns(4).Text & "'  and a.STATUS IN ('AC','AW') AND a.lotno='" & Trim(grddatagrid.Columns(0).Text) & "' and OPENKEY='N' and a.lottype ='" & Trim(grddatagrid.Columns(2).Text) & "' and a.lotdt='" & Format(grddatagrid.Columns(1).Text, "yyyy-mm-dd") & "' and a.catcd='" & grddatagrid.Columns(6).Text & "'  and ISNULL(a.ISSUED,'N')='N' AND (isnull(a.netwt,0)-isnull(a.ACTisSKGS,0)) > 0 and isnull(a.rejflg,'N')='N' and a.baleno  not in (" & baleno & ") order by a.baleno ", DB, adOpenDynamic, adLockBatchOptimistic
''''''''            Else
...
''''''''            If sWgtFlg = "M" Then
''''''''            If Openkeyloanflg = "Y" Then
''''''''            avilbalers.Open "select baleno ""Baleno"",Grwt,TareWt,Favaourablewgt-isnull(actisskgs,0) ""Balance Weight"",isnull(partybaleno,0) as Partybaleno from rm_bale where DIVCODE='" & Divcode & "' AND varcode='" & grddatagrid.Columns(4).Text & "'  and STATUS IN ('AC','AW') AND lotno='" & Trim(grddatagrid.Columns(0).Text) & "' and OPENKEY='N' and lottype ='" & Trim(grddatagrid.Columns(2).Text) & "' and lotdt='" & Format(grddatagrid.Columns(1).Text, "yyyy-mm-dd") & "' and catcd='" & grddatagrid.Columns(6).Text & "'  and ISNULL(ISSUED,'N')='N' AND (isnull(netwt,0)-isnull(ACTisSKGS,0)) > 0 and isnull(rejflg,'N')='N' and baleno  not in (" & baleno & ") order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
''''''''            Else
''''''''            avilbalers.Open "select baleno ""Baleno"",Grwt,TareWt,Favaourablewgt-isnull(actisskgs,0) ""Balance Weight"",isnull(partybaleno,0) as Partybaleno from rm_bale where DIVCODE='" & Divcode & "' AND varcode='" & grddatagrid.Columns(4).Text & "'  and STATUS IN ('AC','AW') AND lotno='" & Trim(grddatagrid.Columns(0).Text) & "' and lottype ='" & Trim(grddatagrid.Columns(2).Text) & "' and lotdt='" & Format(grddatagrid.Columns(1).Text, "yyyy-mm-dd") & "' and catcd='" & grddatagrid.Columns(6).Text & "'  and ISNULL(ISSUED,'N')='N' AND (isnull(netwt,0)-isnull(ACTisSKGS,0)) > 0 and isnull(rejflg,'N')='N' and baleno  not in (" & baleno & ") order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
''''''''            End If
''''''''            Else
...
''''''''            LookUp.clear = True
''''''''            If Rs(1) = "Y" Then
''''''''                LookUp.query = "Select  distinct A.LOTNO""Lot No."",A.PLOTNO""Supplier Lot No."",a.Lotdt""Lot Date"",VARNAME""Variety"",a.varcode""Variety Code"",SLNAME""Supplier"",a.catcd AS Category,e.Station,(F.baleno-isnull(isskgs,0)) as ""Req. Qty"" from rm_lot a inner join rm_var b on  a.varcode=b.varcode AND A.CATCD=B.CATCD  inner join FA_SLMAS D on  A.SUPCD=D.SLCODE  inner join rm_area E  on a.areacd=e.areacode inner join RM_IssReqB F on   a.lotno=F.lotno and a.lotdt=f.lotdt and a.lottype=F.lottype and a.Divcode=f.divcode and a.catcd=f.catcd where a.Fappflg='Y' and  A.DIVCODE='" & Divcode & "' AND A.INS_FLG = 'Y' AND (ISNULL(a.bales,0)- ISNULL(a.ISSbal,0)) >0  and F.DocNo=" & val(iSlipNo) & " and DocDt ='" & Format(sSlipDate, "YYYY-MM-DD") & "'and F.Divcode ='" & Divcode & "' and F.baleno > isnull(F.issKgs,0) and isnull(a.issflg,'N')='Y'"
''''''''            Else
''''''''                LookUp.query = "Select A.LOTNO""Lot No."",A.PLOTNO""Supplier Lot No."",a.Lotdt""Lot Date"",VARNAME""Variety"",a.varcode""Variety Code"",SLNAME""Supplier"",a.catcd AS Category,e.Station,(F.baleno-isnull(isskgs,0)) as ""Req. Qty"" from rm_lot a,rm_var b ,FA_SLMAS D,rm_area E ,RM_IssReqB F where a.areacd=e.areacode and A.SUPCD=D.SLCODE and a.varcode=b.varcode AND A.CATCD=B.CATCD AND a.lotno=F.lotno and a.lotdt=f.lotdt and a.lottype=F.lottype and a.Divcode=f.divcode and a.catcd=f.catcd and A.DIVCODE='" & Divcode & "' AND A.INS_FLG = 'Y' AND (ISNULL(a.bales,0)- ISNULL(a.ISSbal,0)) >0  and F.DocNo=" & val(iSlipNo) & " and DocDt ='" & Format(sSlipDate, "YYYY-MM-DD") & "'and F.Divcode ='" & Divcode & "' and F.baleno > isnull(F.issKgs,0) and isnull(a.issflg,'N')='Y'"
''''''''            End If
''''''''        End If
''''''''
''''''''
...
''''''''    Dim ab As Integer
''''''''    Dim mtwt() As String
''''''''    If MSCom1.CommEvent = comEvReceive Then
''''''''      '  MScom1.InputLen = 0
''''''''            If MSCom1.InBufferCount > 33 Then
''''''''                'InString = MScom1.Input
''''''''                mtwt = Split(MSCom1.Input, Chr(13))
''''''''                  chck = True
''''''''                If UBound(mtwt) > 5 Then
''''''''                    InString = Left$(LTrim(RTrim(mtwt(5))), 10)
...
''''''''                MSCom1.CommPort = rst("cport")  ' comm port no.
''''''''                'MScom1.Settings = "1200,e,7,2"
''''''''                MSCom1.Settings = CStr(rst("cbpersec")) & ",n,8,1"
''''''''                rst.Close
''''''''                MSCom1.RThreshold = 1   'no. of chr to recive
''''''''              MSCom1.InputLen = 1  '  no. of chr on which oncomm  event fires
''''''''                txtweight.MaxLength = 18
''''''''                'MScom1.Output = "AT"
''''''''''                Timer1.Enabled = True
''''''''''                Timer1.Interval = 2
''''''''                If MSCom1.PortOpen = False Then  'open comm port
...
'''''''''                        " Order by A.DOCNO DESC} AS ParentCMD APPEND ({SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.Plotno""Supplier Lot No"",VARname""Variety Name"",colorcode ""Color"",a.CATCD""Category"",a.actISSkgs""Issued Kgs"",a.baleno""Bale No.""  FROM RM_ISSb a,rm_lot b,rm_var c  " & _
'''''''''                        " where c.varcode=a.varcode and b.varcode=c.varcode and isnull(b.issbal,0) <> 0 and a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.divcode=b.divcode and DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' " & _
'''''''''                        " order by docno } AS ChildCMD RELATE DOCNO TO DOCNO,DOCDT TO DOCDT,DIVCODE TO DIVCODE,ISSTYPE TO ISSTYPE ) AS ChildCMD"
''''''''      sQry = "SELECT TOP 1 DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_ISSH  " & _
''''''''                        "  where DIVCODE = '" & Divcode & "' and  DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' " & _
...
''''''''         Set adoSecondaryRS = New Recordset
''''''''         adoSecondaryRS.Open " SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.Plotno""Supplier Lot No"",VARname""Variety Name"",colorcode ""Color"",a.CATCD""Category"",a.actISSkgs""Issued Kgs"",a.baleno""Bale No.""  FROM RM_ISSb a,rm_lot b,rm_var c  " & _
''''''''                             " where c.varcode=a.varcode and b.varcode=c.varcode and isnull(b.issbal,0) <> 0 and a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.divcode=b.divcode and DOCDT = '" & Format(adoPrimaryRS("Docdt"), "yyyy-mm-dd") & "' AND Docno= " & adoPrimaryRS("Docno") & " and b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' and a.isstype='" & adoPrimaryRS("Isstype") & "'", DB, adOpenStatic
''''''''
...
''''''''      Rs.Open "select DISTINCT A.lotdt 'Date',A.lottype,A.PLOTNO,A.varcode,A.catcd,isnull(a.bales,0)-isnull(issbal,0),case when weightflg ='M' then ISNULL(a.favaourablewgt - (SELECT isnull(sum(isskgs),0),0) FROM RM_issb B WHERE lotno=" & grddatagrid.Columns(ILotNo).Text & " ) else ISNULL(a.favaourablewgt - (SELECT isnull(sum(isskgs),0),0) FROM RM_issb B WHERE lotno=" & grddatagrid.Columns(ILotNo).Text & " ) end as ClsWgt,a.colorcode,a.arrdt from rm_lot A,RM_BALE B where A. VARCODE='" & Varcode & "' AND  STATUS IN ('AC','AW') AND a.divcode='" & Divcode & "' and a.lotno='" & val(grddatagrid.Columns(ILotNo).Text) & "' and (ISSUED='N' OR ISSUED IS NULL) and  A.LOTNO=B.LOTNO AND A.CATCD=B.CATCD and  a.rejflg='N' and a.lotyear='" & Year(yfdate) & "' and a.arrdt=b.arrdt  and a.lotdt='" & Format(LOTDT, "yyyy-mm-dd") & "' and  isnull(b.rejflg,'N')='N'", DB, adOpenStatic
''''''''    End If
''''''''
''''''''      If Rs.RecordCount = 0 Then
...
''''''''        Else
''''''''        If Openkeyloanflg = "Y" Then
''''''''            ry.Open "select * from rm_bale where divcode='" & Divcode & "' and  catcd= '" & catcd & "' AND VARCODE='" & Varcode & "' AND STATUS IN ('AC','AW') AND (ISSUED='N' OR ISSUED IS NULL) and lotno='" & grddatagrid.Columns(ILotNo).Text & "'  and lotdt='" & Format(Rs("date"), "yyyy-mm-dd") & "'  and isnull(rejflg,'N')='N'  and OPENKEY='N' ", DB, adOpenStatic
''''''''        Else
...
Case 0
 ...
 If ToValidFinYear(Divcode) = False Then Exit Sub
    ...
    End If
'            Set rsd = New Recordset
'            rsd.Open "select description from rm_mixcharthd where product_code='" & Txtfields(1).Text & "'", db
'            If rsd.RecordCount > 0 Then
'                Text5.Text = rsd(0)
'            Else
'            'LookUp.query = "Select Distinct Product_code,Description FROM ig_product"
'            'LookUp.Query = "Select Distinct CntCD, CntName As Description FROM Rm_Count Where DivCode = '" & Divcode & "'"
'            LookUp.query = "Select distinct Docno ,Docdt from rm_mixcharthd where divcode='" & Divcode & "' and isnull(issued,'N')='N' "
'            LookUp.Caption = "Mix Count Listing"
'            LookUp.DefCol = "Mixing Count Name"
'            LookUp.ALIGN = "1600,2600,1600,2600"
'            LookUp.Show vbModal
'            If LookUp.Cancel = False Then
'                Set Rs = New Recordset
'                Rs.Open "Select distinct Docno ,Docdt from rm_mixcharthd where docno='" & LookUp.Fields(0) & "' and docdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "'"
'            Else
'                LookUp.clear = True
'                'lookup.
'                Txtfields(1).SetFocus
...
'
    ...
    If Rs(0) = "Y" Then
        Unbindcontls
        LookUp.clear = True
        LookUp.query = "SELECT dOCNO 'Doc. No.',DOCDT 'Doc. Date',C.issue_code + ' - ' + C.issue_desc AS 'Issue Type' FROM RM_ISSREQH A, rm_issuetype c WHERE A.ISSTYPE=C.ISSUE_CODE AND DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' and (SELECT Sum(isnull(Baleno,0)-isnull(Isskgs,0)) as Qty From RM_issReqB WHERE RM_issReqB.DIVCODE=a.DIVCODE AND RM_issReqB.ISSTYPE=a.ISSTYPE AND RM_issReqB.DOCNO=a.DOCNO AND RM_issReqB.DOCDT=a.DOCDT) > 0 ORDER BY A.DOCDT,a.DOCNO"
        LookUp.Caption = "Issue Requistion Slip No. Listing"
        LookUp.DefCol = "Doc. No."
        LookUp.ALIGN = "2000,2000,3000"
        LookUp.Show vbModal
...
Dim dSoftPer As Double
    ...
    If Opt = "mod" Then
        ...
        adoSecondaryRS.MoveFirst
        Set rs1 = New Recordset
        rs1.Open "select distinct lotno,lotdt,divcode,catcd " & _
                 "  From    rm_issb " & _
                 "  where   DIVCODE =   '" & Divcode & "'" & _
                 "  AND     docno   =   '" & adoSecondaryRS("docno") & "'" & _
                 "  and     docdt   =   '" & Format(adoSecondaryRS("docdt"), "yyyy-mm-dd") & "'" & _
    ...
    If Opt = "add" Then
       ...
       '*********************  BALE UPDATION **************************/
        ...
        Do While Not adoSecondaryRS.EOF
            ...
            Set balers = New Recordset
            balers.Open " select baleno ""Baleno"",GRWT ""Gross Weight"",TAREWT""Tare Weight""," & _
                        " NETWT-isnull(actisskgs,0) ""Net Weight"",actisskgs ""AIssKgs"",Issued " & _
                        " From      rm_bale " & _
                        "   Where   DIVCODE =   '" & Divcode & "'" & _
                        "   AND     Catcd   =   '" & adoSecondaryRS("CATCD") & "' " & _
                        "   AND     STATUS IN ('AC','AW') " & _
                        "   AND     Lotno   =   '" & adoSecondaryRS("Lot No.") & "'" & _
                        "   AND     Lottype =   '" & adoSecondaryRS("lottype") & "'" & _
                        "   AND     Lotdt   =   '" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "'" & _
                        "   AND     (issued='N' or issued is null)  " & _
                        "   AND     (ltrim(rtrim(openkey))='' or openkey is null or openkey='N') " & _
                        "   AND      Baleno=" & adoSecondaryRS("BALENO") & "" & _
                        "   AND      Isnull(rejflg,'N')='N' " & _
                        "   order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
            ...
            If rs1.RecordCount > 0 Then
                If adoSecondaryRS!AIKgs <> Empty Then
                    If adoSecondaryRS!Issued = "N" Then
                        DB.Execute ("update rm_bale " & _
                                    "   set isqty   =   isnull(isqty,0)+" & val(adoSecondaryRS("AIKgs")) & "," & _
                                    "   ActIssKgs   =   isnull(ActIssKgs,0) + " & val(adoSecondaryRS!AIKgs) & "," & _
                                    "   ISSUED      =   '" & adoSecondaryRS!Issued & "'" & _
                                    "   WHERE       DIVCODE =   '" & Divcode & "'" & _
                                    "   AND         STATUS IN ('AC','AW') " & _
                                    "   AND         Lotno   =   '" & adoSecondaryRS("Lot No.") & "'" & _
                                    "   AND         Lottype =   '" & adoSecondaryRS("lottype") & "'" & _
                                    ...
                                    "   AND         Lotdt   =   '" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "'" & _
                                    "   AND         BALENO  =   " & adoSecondaryRS("BALENO") & " " & _
                                    "   AND         isnull(rejflg,'N')='N'")
                    Else
                        DB.Execute ("update rm_bale " & _
                                    " Set isqty     =   isnull(isqty,0)+ " & adoSecondaryRS("AIKgs") & "," & _
                                    " ActIssKgs     =   isnull(ActIssKgs,0) + " & adoSecondaryRS!AIKgs & "," & _
                                    " ISSUED        =   'Y'  " & _
                                    " WHERE         DIVCODE ='" & Divcode & "'" & _
                                    "   AND         STATUS IN ('AC','AW') " & _
                                    "   AND         Lotno       ='" & adoSecondaryRS("Lot No.") & "'" & _
                    ...
                    If adoSecondaryRS!Issued = "N" Then
                        DB.Execute ("update rm_lot " & _
                                      "set isswt    =isnull(isswt,0) + " & val(adoSecondaryRS("AIKgs")) & "," & _
                                      "     issbal  =isnull(issbal,0) " & _
                                      "     where   DIVCODE     ='" & Divcode & "'" & _
                                      "     AND     Lotno       ='" & adoSecondaryRS("Lot No.") & "'" & _
                                      "     AND     Catcd       ='" & adoSecondaryRS("CATCD") & "'" & _
                                      "     AND     Lotdt       ='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "'" & _
                ...
                Else
                    DB.Execute ("update rm_bale " & _
                                "   set isqty       =   Isnull(isqty,0)+" & val(adoSecondaryRS("Issued Kgs")) & "," & _
                                "   ActIssKgs       =   " & val(adoSecondaryRS(11)) & "," & _
                                "   ISSUED          =       'Y'  " & _
                    ...
                    DB.Execute ("update rm_lot " & _
                                "   set isswt   =   Isnull(isswt,0) + " & val(adoSecondaryRS("Issued Kgs")) & "," & _
                                "       Issbal  =   Isnull(issbal,0)+ " & 1 & "" & _
                                " where lotno   =   '" & adoSecondaryRS("Lot No.") & "'" & _
                                "   and Catcd   =   '" & adoSecondaryRS("CATCD") & "'" & _
                                "   and Lotdt   =   '" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "'" & _
                                "   and lottype =   '" & adoSecondaryRS("lottype") & "'" & _
                                "   and Divcode =   '" & Divcode & "'" & _
    ...
    Else
        ...
        If msg = vbYes Then
            ...
            '*********************  LOT TABLE UPDATION **************************/
                ...
                adoSecondaryRS.MoveFirst
                Set rs1 = New Recordset
                rs1.Open "select distinct lotno,lotdt,divcode,catcd,LOTTYPE,varcode" & _
                        " FROM     rm_issb " & _
                        " WHERE    DIVCODE ='" & Divcode & "'" & _
                        "   AND    docno   ='" & adoSecondaryRS("docno") & "'" & _
                        "   AND    docdt   ='" & Format(adoSecondaryRS("docdt"), "yyyy-mm-dd") & "'", DB, adOpenStatic, adLockBatchOptimistic
                rs1.MoveFirst
                Do While Not rs1.EOF
                    Set Rs = New Recordset ''fOR bALES
                    Rs.Open "SELECT count(baleno) FROM RM_ISSB B " & _
                            " WHERE  DIVCODE='" & Divcode & "'" & _
                            " AND    DOCNO   =   " & txtFields(0).Text & "" & _
                            " AND    docdt   =   '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'" & _
                            " AND    lotno   =   '" & rs1(0) & "' " & _
                            " AND    LOTDT   =   '" & Format(rs1(1), "yyyy-mm-dd") & "'" & _
                            " AND    catcd   =   '" & rs1(3) & "'" & _
                            " AND    ISSUED  ='Y'", DB, adOpenStatic, adLockBatchOptimistic
                        
                    Set rsg = New Recordset ''fOR KGS
                    rsg.Open "SELECT SUM(ISNULL(ACTISSKGS,0)) " & _
                             "  FROM RM_ISSB B " & _
                             "  WHERE DIVCODE   =   '" & Divcode & "'" & _
                             "  AND     DOCNO   =   " & txtFields(0).Text & " " & _
                             "  AND     docdt   =   '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'" & _
                             "  AND     lotno   =   '" & NULLCHECK(rs1(0)) & "' " & _
                             "  AND     lotdt   =   '" & Format(rs1(1), "yyyy-mm-dd") & "'" & _
                             "  AND     catcd   =   '" & rs1(3) & "'", DB, adOpenStatic, adLockBatchOptimistic
                
                    Set RS2 = New Recordset
                    RS2.Open "select isnull(isswt,0),isnull(issbal,0) " & _
                            "   FROM    rm_lot " & _
                            "   where   Divcode     =   '" & Divcode & "'" & _
                            "   AND     lottype     =   '" & rs1("LOTTYPE") & "'" & _
                            "   AND     lotno       =   '" & rs1(0) & "'" & _
                            "   and     lotdt       =   '" & Format(rs1(1), "yyyy-mm-dd") & "'" & _
                            "   and     catcd       =   '" & rs1(3) & "'" & _
                            "   and     lotyear     =   '" & Year(yfdate) & "'", DB, adOpenStatic, adLockBatchOptimistic
                    qty = RS2(0)
                    selbale = RS2(1)
                    DB.Execute ("update rm_lot " & _
                            " set   Isswt   =   " & val(qty) & " - " & val(rsg(0)) & "," & _
                            "       Issbal  =   " & val(selbale) & " - " & val(Rs(0)) & " " & _
                            " where DIVCODE =   '" & Divcode & "'" & _
                            " AND   Lottype =   '" & grdDataGrid.Columns(6).Text & "'" & _
                            " AND   Lotno   =   '" & rs1(0) & "'" & _
                            " AND   Lotdt   =   '" & Format(rs1(1), "yyyy-mm-dd") & "'" & _
                            " AND   Catcd   =   '" & rs1(3) & "'" & _
                            " AND   lotyear =   '" & Year(yfdate) & "'"), a
                    rs1.MoveNext
                Loop
               ...
               ''=============== RM_BALE UPDATION ==============================================
                ...
                Set Rs = New Recordset
                Rs.Open "Select distinct baleno,lotdt""Date"",lotno,lottype,actisskgs,ISSKGS,varcode " & _
                    "   FROM    rm_issb " & _
                    "   WHERE   divcode     =   '" & Divcode & "'" & _
                    "   AND     DOCNO       =   " & adoSecondaryRS("DOCNO") & " " & _
                    "   AND     DOCDT       =   '" & Format(adoSecondaryRS("DOCDT"), "yyyy-mm-dd") & "'" & _
                    "   ORDER BY LOTNO,LOTDT,BALENO", DB, adOpenStatic
                    
                Do While Not Rs.EOF
                    
                    DB.Execute " update rm_bale " & _
                               " set isqty      =   isqty-" & val(Rs("actisskgs")) & "," & _
                               "     actisskgs  =   actisskgs-" & val(Rs("actisskgs")) & "," & _
                               "     issued     =   'N' " & _
                               " WHERE  DIVCODE =   '" & Divcode & "'" & _
                               "    AND STATUS IN ('AC','AW') " & _
                               "    AND LOTNO   =   " & Rs("LotNo") & "" & _
                               "    AND Lotdt   =   '" & Format(Rs("Date"), "yyyy-mm-dd") & "'" & _
                               "    AND Baleno  =   " & Rs(0) & " " & _
                               "    AND Lottype = '" & Rs("lottype") & "'" & _
                               "    AND isnull(rejflg,'N')='N'", a
                               
                    DB.Execute " Update RM_BALE set issued='Y' " & _
                               " WHERE DIVCODE  =   '" & Divcode & "'" & _
                               "  AND  STATUS   IN ('AC','AW') " & _
                               "  AND  LOTNO    =   " & Rs("LotNo") & "" & _
                               "  AND  lotdt    =   '" & Format(Rs("Date"), "yyyy-mm-dd") & "'" & _
                               ...
                               "  AND  lottype  = '" & Rs("lottype") & "'" & _
                               "  AND  isnull(rejflg,'N')='N' " & _
                               "  AND  NETWT=ISNULL(ACTISSKGS,0)", a
...
Dim rst As Recordset
    ...
    If Scale_Toledo_1938_ReadWeight_LbsOunces(dblTest, CInt(rst("cport")), CInt(rst("cbpersec")), _
                                            "None", CInt(8), CLng(1), _
                                            "XONXOFF", strErrMsg) Then
    
        txtweight = Trim$(dblTest)
       ' lblErrorMessage = "Messages: "
    Else
        txtweight = "0"
...
'                        " order by docno } AS ChildCMD RELATE DOCNO TO DOCNO,DOCDT TO DOCDT,DIVCODE TO DIVCODE,ISSTYPE TO ISSTYPE ) AS ChildCMD"
      ...
      sQry = "SELECT  DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_ISSH  " & _
                        "  where DIVCODE = '" & Divcode & "' and  DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' " & _
                        " Order by DOCNO DESC"
...
If Rs.RecordCount <> 0 Then
   ...
   End If
         ...
         LookUp.clear = True
         ''''''LookUp.query = "select distinct a.docno,a.docdt,lotno from rm_issh a,rm_issb b where a.divcode=b.divcode and a.docno=b.docno and a.docdt=b.docdt and a.divcode='" & Divcode & "'"
         LookUp.query = "select distinct a.docno""Doc. No."",a.docdt""Doc. Date"",a.isstype""Issue Type"" from rm_issh a where divcode='" & Divcode & "' and docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' and docno not in(select distinct issno  from rm_mixingstock where isnull(mixkgs,0)<>0) and a.docdt =(select max(docdt) from rm_issh a where divcode='" & Divcode & "' and docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "')"
         LookUp.Caption = "Issue Listing"
         LookUp.DefCol = "Doc. No."
         LookUp.ALIGN = "1500,1500,1500"
