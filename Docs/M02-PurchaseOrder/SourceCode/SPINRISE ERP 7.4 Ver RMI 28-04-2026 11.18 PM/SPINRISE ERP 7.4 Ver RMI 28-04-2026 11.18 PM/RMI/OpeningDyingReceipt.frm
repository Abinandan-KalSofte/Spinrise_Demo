...
Begin VB.Form OpeningDyingRec 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   4
         Left            =   1620
         Picture         =   "OpeningDyingReceipt.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":0397
         BeginProperty Font 
            Name            =   "System"
            Size            =   9.75
            Charset         =   0
         ...
         Index           =   2
         Left            =   1095
         Picture         =   "OpeningDyingReceipt.frx":06A1
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":0A3D
         Height          =   510
         Index           =   1
         Left            =   570
         Picture         =   "OpeningDyingReceipt.frx":0D47
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":10C1
         Height          =   510
         Index           =   6
         Left            =   3180
         Picture         =   "OpeningDyingReceipt.frx":150B
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":1858
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "OpeningDyingReceipt.frx":1B62
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":1EF5
         Height          =   510
         Index           =   5
         Left            =   2655
         Picture         =   "OpeningDyingReceipt.frx":233F
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":26A4
         Height          =   510
         Index           =   7
         Left            =   3705
         Picture         =   "OpeningDyingReceipt.frx":2AEE
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":2E3E
         Height          =   510
         Index           =   11
         Left            =   5805
         Picture         =   "OpeningDyingReceipt.frx":3288
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":361D
         Height          =   510
         Index           =   9
         Left            =   4755
         Picture         =   "OpeningDyingReceipt.frx":3927
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":3CC9
         Height          =   510
         Index           =   10
         Left            =   5280
         Picture         =   "OpeningDyingReceipt.frx":3FD3
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":434F
         Height          =   510
         Index           =   8
         Left            =   4230
         Picture         =   "OpeningDyingReceipt.frx":4799
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "OpeningDyingReceipt.frx":4AFB
         Height          =   510
         Index           =   3
         Left            =   2130
         Picture         =   "OpeningDyingReceipt.frx":4E05
         Style           =   1  'Graphical
         TabIndex        =   8
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   " "
      TabPicture(0)   =   "OpeningDyingReceipt.frx":519A
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command5 
         Cancel          =   -1  'True
         Caption         =   "&Cancel"
         DownPicture     =   "OpeningDyingReceipt.frx":51B6
         Height          =   615
         Left            =   4020
         Picture         =   "OpeningDyingReceipt.frx":5598
         Style           =   1  'Graphical
         TabIndex        =   27
         Top             =   1680
         Width           =   975
      ...
      Begin VB.CommandButton Command6 
         Caption         =   "&OK"
         DownPicture     =   "OpeningDyingReceipt.frx":596B
         Height          =   615
         Left            =   2580
         Picture         =   "OpeningDyingReceipt.frx":5D51
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   1680
         Width           =   975
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command1 
         Caption         =   "&OK"
         DownPicture     =   "OpeningDyingReceipt.frx":6117
         Height          =   615
         Left            =   3000
         Picture         =   "OpeningDyingReceipt.frx":64FD
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   4320
         Width           =   1185
      ...
      Begin VB.CommandButton Command2 
         Caption         =   "&Cancel"
         DownPicture     =   "OpeningDyingReceipt.frx":68C3
         Height          =   615
         Left            =   4740
         Picture         =   "OpeningDyingReceipt.frx":6CA5
         Style           =   1  'Graphical
         TabIndex        =   32
         Top             =   4320
         Width           =   1185
   ...
   End
End
Attribute VB_Name = "openingDyingRec"
...
Case 4
        ...
        lno = 7
        Close
        Open "d:\ind.txt" For Output As #a
        Call hdlist
        ...
        Close #a
        Open "d:\ind.bat" For Output As #a
        Print #a, "d:"
        Print #a, "cd\"
        Print #a, "type ind.txt>prn"
        rep.txtfile = "d:\ind.txt"
        rep.Batfile = "d:\ind.bat"
        Close #a
Case 5
       'first
        desc.Caption = "Query"
