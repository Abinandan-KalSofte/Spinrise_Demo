...
Begin VB.Form Frm_VarietyGroup 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   5520
         Picture         =   "Frm_VarietyGroup.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":0442
         Height          =   510
         Index           =   6
         Left            =   2820
         Picture         =   "Frm_VarietyGroup.frx":088C
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":0BD9
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "Frm_VarietyGroup.frx":0EE3
         Style           =   1  'Graphical
         TabIndex        =   0
         ToolTipText     =   "Add"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":1276
         Height          =   510
         Index           =   5
         Left            =   2265
         Picture         =   "Frm_VarietyGroup.frx":16C0
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":1A25
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1155
         Picture         =   "Frm_VarietyGroup.frx":1D2F
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Delete"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":20CB
         Height          =   510
         Index           =   1
         Left            =   600
         Picture         =   "Frm_VarietyGroup.frx":23D5
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Modify"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   1710
         Picture         =   "Frm_VarietyGroup.frx":274F
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "List"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":2AE6
         Height          =   510
         Index           =   7
         Left            =   3375
         Picture         =   "Frm_VarietyGroup.frx":2F30
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":3280
         Height          =   510
         Index           =   11
         Left            =   6075
         Picture         =   "Frm_VarietyGroup.frx":36CA
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Exit"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":3A5F
         Height          =   510
         Index           =   9
         Left            =   4485
         Picture         =   "Frm_VarietyGroup.frx":3D69
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Save"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "Frm_VarietyGroup.frx":410B
         Height          =   510
         Index           =   10
         Left            =   5040
         Picture         =   "Frm_VarietyGroup.frx":4415
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Cancel "
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_VarietyGroup.frx":4791
         Height          =   510
         Index           =   8
         Left            =   3930
         Picture         =   "Frm_VarietyGroup.frx":4BDB
         Style           =   1  'Graphical
         TabIndex        =   8
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   " "
      TabPicture(0)   =   "Frm_VarietyGroup.frx":4F3D
   ...
   End
End
Attribute VB_Name = "Frm_VarietyGroup"
...
'            End If
        ...
        Opt = "add"
         ...
         adoPrimaryRS.Open "select GVarcode 'Code', GVarName 'Variety Name',RptOrderno 'Report Order No' from RM_varGroup where 1=2", DB, adOpenStatic, adLockBatchOptimistic
         adoPrimaryRS.AddNew
...
'            End If
        ...
        End If
        If Record_Exists("RM_varGroup", "No Records Found") = False Then Exit Sub
...
'                        adoPrimaryRS("Variety Name") = Trim(grdDataGrid.Columns(1).Text)
                            ...
                            TrnLog.Open "SELECT Divcode,moduleNo,Trans_Name,Trans_Mod,Trans_Host,Trans_IPADD,Trans_UserId,Trans_date,code ,description,tc FROM RM_Setup_Log  WHERE 1=2 ", DB, adOpenStatic, adLockBatchOptimistic
                            TrnLog.AddNew
                            TrnLog("DIVCODE") = Divcode
                            TrnLog("moduleNo") = ModuleNo
                            TrnLog("Trans_Name") = "Variety Group"
                            ...
                            TrnLog("tc") = val(grddatagrid.Columns(2).Text)
        ...
        RSCHECK.Open "select GVarcode  from RM_var where GVarcode='" & Trim(grddatagrid.Columns(0).Text) & "'", DB, adOpenStatic
...
'            DB.RollbackTrans
        ...
        If UCase(CustID) = "SHRIGIRI" Or UCase(CustID) = "PALLAVA" Or UCase(CustID) = "VSM" Then
            Set RSCHECK = New Recordset
            RSCHECK.Open "select varcode  from RM_var where GVarcode='" & Trim(grddatagrid.Columns(0).Text) & "'", DB, adOpenStatic
            If Not RSCHECK.EOF Then
                MsgBox "You cannot Delete Variety!! Dependencies Exit", vbInformation, head
                Exit Sub
            End If
        End If
                      ...
                      a% = MsgBox("Are you sure you want to delete?", vbYesNo, head)
                           If a = 6 Then
                        DB.Execute ("delete from RM_varGroup where GVarcode='" & grddatagrid.Columns(0).Text & "'")
...
Case 12
    ...
    Set Cystalrptbunk.cryRept = Cry_Variety_Group
            ...
            If ColIndex = 1 Then
                    If grddatagrid.Columns(1).Text <> Empty Then
                        ...
                        Set Rs = New Recordset
                            Rs.Open "select 'Description'  from RM_varGroup where GVarName ='" & Trim(grddatagrid.Columns(1).Text) & "'", DB, adOpenStatic, adLockBatchOptimistic
                                If Not Rs.BOF Then
    ...
    grddatagrid.EditActive = True
            If ColIndex = 0 Then
                    If grddatagrid.Columns(0).Text <> Empty Then
                        Set Rs = New Recordset
                            Rs.Open "select 'Code'  from RM_varGroup where GVarcode ='" & grddatagrid.Columns(0).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                                If Not Rs.BOF Then
   ...
   If Opt = "add" Then
        ...
        On Error Resume Next
            ...
            If LastCol = 1 Then
                    ...
                    End If
                              Set Rs = New Recordset
                    Rs.Open "select GVarcode from RM_varGroup where GVarName ='" & Trim(grddatagrid.Columns(1).Text) & "'", DB, adOpenStatic, adLockBatchOptimistic
...
On Error GoTo lovok_Click_Error
       ...
       grddatagrid.Visible = True
       Set adoPrimaryRS = New Recordset
       adoPrimaryRS.Open "select GVarcode 'Code',GVarName 'Variety Name',RptOrderno 'Report Order No' from RM_varGroup where GVarcode ='" & Ksldesc1.Code & "' Order by GVarcode", DB, adOpenStatic, adLockBatchOptimistic
       Set grddatagrid.DataSource = adoPrimaryRS
...
On Error GoTo GrdDatagrid_AfterColUpdate_Error
    ...
    If Opt = "add" Then
        ...
        temp_1 = grddatagrid.Columns(0).Text
            ...
            End If
            Set Rs = New Recordset
            Rs.Open "select GVarcode from RM_varGroup where GVarcode ='" & Trim(grddatagrid.Columns(0).Text) & "'", DB, adOpenStatic, adLockBatchOptimistic
            If Rs.RecordCount > 0 Then
                MsgBox "Code cannot be repeated", vbInformation, head
                grddatagrid.Row = row1
                grddatagrid.Columns(0).Text = ""
...
intervalMinutes = -1
    If Opt = " " Or Opt = "qry" Then
        ...
        Set adoPrimaryRS = New Recordset
        adoPrimaryRS.Open "select GVarcode 'Code',GVarName 'Variety Name',RptOrderno 'Report Order No' from RM_varGroup Order by GVarcode", DB, adOpenStatic, adLockOptimistic
        If adoPrimaryRS.RecordCount = 0 Then
   ...
   End If
    ...
    If Opt = "mod" Then
        'Set adoPrimaryRS = New Recordset
        'adoPrimaryRS.Open "select Code,Description from RM_varGroup where Code ='" & Trim(Ksldesc1.code) & "' and Description ='" & Trim(Ksldesc1.Description) & "'", db, adOpenStatic, adLockBatchOptimistic
        Call bindcontls
        Call ENABLCONTLS
        grddatagrid.Columns(0).Locked = True
    End If
...
On Error GoTo header_Error
            ...
            Print #a, Space(5) + "RMI Variety Group Listing  " + Space(20) + "Dt: " & Str + "Pg.:" + Padl(CStr(pg), 3, " ")

            Set Rs = New Recordset
            Rs.Open "select GVarcode,GVarName from RM_varGroup", DB, adOpenStatic, adLockOptimistic
                If Rs.BOF Then
                    MsgBox "No Records Found", vbInformation, head
                    Close #a
                    Exit Sub
...
On Error GoTo MODLOOKUP_Error
    ...
    LookUp.Clear = True
    LookUp.query = "SELECT GVarcode""Code"",GVarName""Variety Name"" FROM RM_varGroup "
    ...
    If LookUp.Cancel = False Then
        If Opt = "mod" Then
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open " select GVarcode 'Code',GVarName 'Variety Name',RptOrderno 'Report Order No' from RM_varGroup where GVarcode ='" & LookUp.Fields(0) & "'", DB, adOpenStatic, adLockBatchOptimistic
            Set grddatagrid.DataSource = adoPrimaryRS
            grddatagrid.AllowAddNew = False
            grddatagrid.Columns(0).Locked = True
            grddatagrid.Col = 1
