...
Begin VB.Form Frm_FibreDiscRate 
   Caption         =   "Fibre Discount Rate "
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   Begin VB.PictureBox FrameDiscType 
      ...
      Begin FPSpreadADO.fpSpread SPDDiscTypeDet 
         ...
         SpreadDesigner  =   "Frm_FibreDiscRate.frx":0000
         Appearance      =   2
      End
   ...
   Begin VB.PictureBox FraOrd 
      ...
      Begin FPSpreadADO.fpSpread SpdSIZEORD 
         ...
         EndProperty
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "Frm_FibreDiscRate.frx":047E
      End
   ...
   Begin VB.CommandButton CmdCrystal 
      ...
      Index           =   0
      Left            =   6600
      Picture         =   "Frm_FibreDiscRate.frx":08CB
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":0D0D
         Height          =   510
         Index           =   8
         Left            =   3675
         Picture         =   "Frm_FibreDiscRate.frx":1157
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "Frm_FibreDiscRate.frx":14B9
         Height          =   510
         Index           =   10
         Left            =   4725
         Picture         =   "Frm_FibreDiscRate.frx":17C3
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":1B3F
         Height          =   510
         Index           =   9
         Left            =   4200
         Picture         =   "Frm_FibreDiscRate.frx":1E49
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":21EB
         Height          =   510
         Index           =   11
         Left            =   5280
         Picture         =   "Frm_FibreDiscRate.frx":2635
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":29CA
         Height          =   510
         Index           =   7
         Left            =   3150
         Picture         =   "Frm_FibreDiscRate.frx":2E14
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   7140
         Picture         =   "Frm_FibreDiscRate.frx":3164
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":34FB
         Height          =   510
         Index           =   1
         Left            =   555
         Picture         =   "Frm_FibreDiscRate.frx":3805
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":3B7F
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1065
         Picture         =   "Frm_FibreDiscRate.frx":3E89
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":4225
         Height          =   510
         Index           =   5
         Left            =   2115
         Picture         =   "Frm_FibreDiscRate.frx":466F
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":49D4
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "Frm_FibreDiscRate.frx":4CDE
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_FibreDiscRate.frx":5071
         Height          =   510
         Index           =   6
         Left            =   2640
         Picture         =   "Frm_FibreDiscRate.frx":54BB
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton CmdCrystal 
         ...
         Index           =   1
         Left            =   6360
         Picture         =   "Frm_FibreDiscRate.frx":5808
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton CmdCrystalGP 
         Height          =   510
         Left            =   11040
         Picture         =   "Frm_FibreDiscRate.frx":5C4A
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   4
         Left            =   1590
         Picture         =   "Frm_FibreDiscRate.frx":608C
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "."
      TabPicture(0)   =   "Frm_FibreDiscRate.frx":64BE
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpreadADO.fpSpread SpdEmpAllocation 
            ...
            EndProperty
            ScrollBarExtMode=   -1  'True
            SpreadDesigner  =   "Frm_FibreDiscRate.frx":64DA
         End
      End
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Fibre Discount Rate Entry for Credit Note"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   15.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "Frm_FibreDiscRate"
...
Dim adoSecondaryRS, adoSecondaryRS1, adoSecondaryRS2 As Recordset
...
Private Sub adoPrimaryRS_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    ...
    If Opt = "" Or Opt = "qry" Then
        If Not (adoPrimaryRS.EOF Or adoPrimaryRS.BOF) Then
            ...
            End If
             If IsNull(adoPrimaryRS("RefDocDt")) = False Then
                DTPicker2.value = Format(adoPrimaryRS("RefDocDt"), "dd/mm/yyyy")
            Else
            
            End If
            If IsNull(adoPrimaryRS("fdate")) = False Then
                DTPicker3.value = Format(adoPrimaryRS("Fdate"), "dd/mm/yyyy")
            Else
            
            End If
            If IsNull(adoPrimaryRS("tdate")) = False Then
                DTPicker4.value = Format(adoPrimaryRS("tdate"), "dd/mm/yyyy")
            Else
            ...
            adoSecondaryRS.Open "select a.Divcode,Docno,a.docsno,Docdate,a.supcd,a.CATCD,bb.CATNAME,a.Varcode,c.VARNAME,a.Plant,d.PLName,a.RateUnit,a.CandyRate,a.RATEKG ,r.unitname from RM_FibreDiscCN a inner join rm_cat bb on bb.catcd=a.catcd left join rm_var c on c.varcode=a.varcode left join rm_plant d on d.plcode=a.Plant left join RM_rateunit r on r.unitcode=a.RateUnit where a.DocDate= '" & Format(adoPrimaryRS("DocDate"), "yyyy-MM-dd") & "'  and DocNo='" & adoPrimaryRS("DocNo") & "' Order by a.DocSno", DB, adOpenStatic, adLockBatchOptimistic
            Call SpdLoad
            
            
            Call SETDISCTYPEHead
            Set adoSecondaryRS1 = New Recordset
            adoSecondaryRS1.Open "select a.Divcode,a.Docno,a.Docdate,a.VSno,a.DocSno,a.Varcode,a.DType,b.Description ddesc,a.DRate from RM_FibreDiscCNDRate a left join RM_DiscountType b on a.DType=b.code   where   a.DocDate= '" & Format(adoPrimaryRS("DocDate"), "yyyy-MM-dd") & "' and DocNo='" & adoPrimaryRS("DocNo") & "' Order by a.DocSno", DB, adOpenStatic, adLockBatchOptimistic
            Call SpdLoadvar
...
Private Sub SpdLoadRate()
        ...
        With SpdEmpAllocation
            ...
            .CursorStyle = CursorStyleArrow
            RW = 1
        Do While Not adoSecondaryRS2.EOF
            .MaxRows = .MaxRows + 1
            .SetText SPDRATEEntry.SPDVSNO, RW, adoSecondaryRS2("DOCSNO")
            .SetText SPDRATEEntry.SPDVPlantDesc, RW, adoSecondaryRS2("PLName")
            .SetText SPDRATEEntry.SPDVRateUnit, RW, adoSecondaryRS2("unitname")
            .SetText SPDRATEEntry.SPDVRateUnitCD, RW, adoSecondaryRS2("RateUnit")
            .SetText SPDRATEEntry.SPDVVarcode, RW, adoSecondaryRS2("varcode")
            .SetText SPDRATEEntry.SPDVVarName, RW, adoSecondaryRS2("varname")
            .SetText SPDRATEEntry.SPDVPlant, RW, adoSecondaryRS2("plant")
            .SetText SPDRATEEntry.SPDVRateKG, RW, adoSecondaryRS2("ratekg")
            .SetText SPDRATEEntry.SPDVCATCD, RW, adoSecondaryRS2("CATCD")
            .SetText SPDRATEEntry.SPDVCATNAME, RW, adoSecondaryRS2("catname")
            .SetText SPDRATEEntry.SPDVSUPCD, RW, adoSecondaryRS2("supcd")
            .SetText SPDRATEEntry.SPDVRateCY, RW, adoSecondaryRS2("CandyRate")
...
Select Case Index
    ...
    Case 0
           ...
           ' MaskEdBox2.Text = "__/__/____"
            ...
            adoPrimaryRS.Open "select a.divcode,docno,docdate,supcd,RefDocno,RefDocDt,Fdate,tdate from RM_FibreDiscCN a where    1= 2", DB, adOpenStatic, adLockBatchOptimistic
            Set adoSecondaryRS = New Recordset
            adoSecondaryRS.Open "select a.Divcode,Docno,a.docsno,Docdate,a.supcd,a.CATCD,bb.CATNAME,a.Varcode,c.VARNAME,a.Plant,d.PLName,a.RateUnit,a.CandyRate,a.RATEKG,r.unitname  from RM_FibreDiscCN a inner join rm_cat bb on bb.catcd=a.catcd left join rm_var c on c.varcode=a.varcode left join rm_plant d on d.plcode=a.Plant left join RM_rateunit r on r.unitcode=a.RateUnit where  1 =2 ", DB, adOpenStatic, adLockBatchOptimistic
            Opt = "add"
            adoPrimaryRS.AddNew
            Call bindcontls
            tottot = 0
...
'            TXTFIELDS(7).Visible = True
            ...
            Rstdocno.Open "Select right(isnull(max(convert(numeric,docno)),0),4) as docno from RM_FibreDiscCN where DocDate between '" & Format(yfdate, "dd-MMM-yyyy") & "' and '" & Format(yldate, "dd-MMM-yyyy") & "'", DB
            ...
            DB.Execute "delete from RM_FibreDiscCNTXN where IPAdd='" & LocalIPAdd & "'  "
...
'            SpdEmpAllocation.SetText SPDRATEEntry.SPDVSNO, 1, SpdEmpAllocation.MaxRows
    ...
    Case 1
        If Record_Exists("RM_FibreDiscCN where  DocDate between '" & Format(yfdate, "yyyy-MM-dd") & "' and '" & Format(yldate, "yyyy-MM-dd") & "'") = False Then Exit Sub
        Opt = "mod"
        Set rsk = New Recordset
        FraDespatch.Enabled = True
        rsk.Open "select TOP 1 A.DocNo,DocDate,Convert(numeric(18,0),Docno) as DocNoss from RM_FibreDiscCN A where  DocDate Between '" & Format(yfdate, "yyyy-MM-dd") & "' And '" & Format(yldate, "yyyy-MM-dd") & "' Order By DocNoss Desc", DB, adOpenStatic, adLockReadOnly
        If rsk.RecordCount > 0 Then
            desc.Caption = "Modify"
            LookUp.Clear = True

            LookUp.query = "select distinct a.DocNo 'Doc. No.',a.DocDate 'Date',supcd 'Supplier Code',slname 'Supplier Name' from RM_FibreDiscCN A inner join fa_slmas b on a.supcd=b.slcode   "
        
            LookUp.Caption = "Fibre Rate Listing"
            LookUp.DefCol = "Doc. No."
            LookUp.ALIGN = "1500,1500,0,3500"
           ' LookUp.Alignment = "L,C,L"
            ...
            If LookUp.Cancel = False Then
                ...
                Call adddelmod(BUTTON)
                Set adoPrimaryRS = New Recordset
                adoPrimaryRS.Open "select a.divcode,docno,docdate,supcd,RefDocno,RefDocDt,Fdate,tdate from RM_FibreDiscCN a where   Docno = " & LookUp.Fields(0) & " And DocDate = '" & Format(LookUp.Fields(1), "yyyy-MM-dd") & "' And DocDate between '" & Format(yfdate, "yyyy-MM-dd") & "' And '" & Format(yldate, "yyyy-MM-dd") & "'", DB, adOpenStatic, adLockBatchOptimistic
                If adoPrimaryRS.RecordCount > 0 Then
                    ...
                    Set adoSecondaryRS = New Recordset
                    adoSecondaryRS.Open "select a.Divcode,Docno,a.docsno,Docdate,a.supcd,a.CATCD,bb.CATNAME,a.Varcode,c.VARNAME,a.Plant,d.PLName,a.RateUnit,a.CandyRate,a.RATEKG,r.unitname  from RM_FibreDiscCN a inner join rm_cat bb on bb.catcd=a.catcd left join rm_var c on c.varcode=a.varcode left join rm_plant d on d.plcode=a.Plant left join RM_rateunit r on r.unitcode=a.RateUnit  where DocNo =" & adoPrimaryRS("Docno") & " And DocDate='" & Format(adoPrimaryRS("DocDate"), "yyyy-MM-dd") & "'", DB, adOpenStatic, adLockBatchOptimistic
                    Call SpdLoad
                Else
                ...
                RSDST.Open "select * from RM_FibreDiscCNDRate  where docno='" & adoPrimaryRS("Docno") & "' and docdate='" & Format(DTPicker1.value, "yyyy-mm-dd") & "' and supcd='" & adoPrimaryRS("supcd") & "' ", DB, adOpenStatic
                 Do While Not RSDST.EOF
                        DB.Execute "insert into RM_FibreDiscCNTXN (Divcode,docno,Docdate,VSno,DocSno,Varcode,DType,DRate,IPAdd,supcd)values('" & Divcode & "','" & val(RSDST("docno")) & "','" & Format(DTPicker1.value, "yyyy-mm-dd") & "','" & val(RSDST("vsno")) & "','" & val(RSDST("docsno")) & "','" & RSDST("varcode") & "','" & Trim(RSDST("dtype")) & "','" & val(RSDST("drate")) & "','" & LocalIPAdd & "','" & adoPrimaryRS("supcd") & "')"
                        RSDST.MoveNext
                 Loop
    ...
    Case 2
        ...
        Opt = "del"
        Set rsk = New Recordset
        rsk.Open "select TOP 1 convert(numeric(18,0),A.DocNo)as DocNo ,DocDate from RM_FibreDiscCN A where  DocDate Between '" & Format(yfdate, "yyyy-MM-dd") & "' And '" & Format(yldate, "yyyy-MM-dd") & "' Order By DocDate Desc", DB, adOpenStatic, adLockReadOnly
        If rsk.RecordCount > 0 Then
    ...
    Case 4
        Opt = "fnd"
            ...
            LookUp.query = "select distinct a.DocNo 'Doc. No.',a.DocDate 'Date' from RM_FibreDiscCN A WHERE    a.DocDate between '" & Format(yfdate, "dd-mmm-yyyy") & "' and '" & Format(yldate, "dd-mmm-yyyy") & "'"
    ...
    Case 9
        'Save
            ...
            If Opt = "add" Then
             ...
             Set RSDST = New Recordset
             RSDST.Open "select * from RM_FibreDiscCNTXN where IPAdd='" & LocalIPAdd & "' and docdate='" & Format(DTPicker1.value, "yyyy-mm-dd") & "' and supcd='" & Trim(txtfields(3).Text) & "'   ", DB, adOpenStatic
             If RSDST.EOF Then
...
'
                        ...
                        Set RSDST = New Recordset
                        RSDST.Open "select * from RM_FibreDiscCNTXN where IPAdd='" & LocalIPAdd & "' and docdate='" & Format(DTPicker1.value, "yyyy-mm-dd") & "' and varcode='" & Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVVarcode, RW)) & "' and supcd='" & Trim(txtfields(3).Text) & "'  ", DB, adOpenStatic
                        If RSDST.EOF Then
...
'                TmpRs.Open "Select isnull(max(isnull(convert(numeric(18,0),DocNo),0)),0)+1 AS Last_docno From RM_FibreDiscCN where DocDate Between '" & Format(yfdate, "yyyy-MM-dd") & "' And '" & Format(yldate, "yyyy-MM-dd") & "'", DB, adOpenStatic, adLockBatchOptimistic
             ...
             If docNo = "" Then Exit Sub
              ...
              'adoPrimaryRS("SLCODE") = TXTFIELDS(8).Text
               ...
               ' adoPrimaryRS("EntryDate") = Now
                ...
                UPDRS.Open "select a.Divcode,Docno,a.docsno,Docdate,a.supcd,a.CATCD,a.Varcode,a.Plant,a.RateUnit,a.CandyRate,a.RATEKG,RefDocno,RefDocDt,Fdate,tdate from RM_FibreDiscCN a where 1 =2 ", DB, adOpenStatic, adLockBatchOptimistic
                With SpdEmpAllocation
                    For RW = 1 To .MaxRows
                        .Row = RW
                        If Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVRateUnit, RW)) <> "" And val(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVRateCY, RW)) <> 0 Then
                            ...
                            UPDRS("RefDocDt") = Format(DTPicker2.value, "yyyy-MM-dd")
                            UPDRS("fdate") = Format(DTPicker3.value, "yyyy-MM-dd")
                            UPDRS("tdate") = Format(DTPicker4.value, "yyyy-MM-dd")
                            UPDRS("RefDocno") = val(txtfields(1).Text)
               ...
               ' adoPrimaryRS.UpdateBatch adAffectAllChapters
                UPDRS.UpdateBatch adAffectAllChapters
                 ...
                 Do While Not RSDST.EOF
                        ...
                        DB.Execute "insert into RM_FibreDiscCNDRate(Divcode,docno,Docdate,VSno,DocSno,Varcode,DType,DRate,IPAdd,supcd,Fdate,tdate)values('" & Divcode & "','" & val(docNo) & "','" & Format(DTPicker1.value, "yyyy-mm-dd") & "','" & val(RSDST("vsno")) & "','" & val(RSDST("docsno")) & "','" & RSDST("varcode") & "','" & Trim(RSDST("dtype")) & "','" & val(RSDST("drate")) & "','" & LocalIPAdd & "','" & Trim(txtfields(3).Text) & "','" & Format(DTPicker3.value, "yyyy-mm-dd") & "','" & Format(DTPicker4.value, "yyyy-mm-dd") & "')"
                        RSDST.MoveNext
                 Loop
                DB.CommitTrans
...
'                        End If
                ...
                'Set tmprs = New Recordset
                'tmprs.Open "Select isnull(max(isnull(DocNo,0)),0)+1 AS Last_docno From RM_FibreDiscCN where Divcode ='" & divcode & "' And DocDate Between '" & Format(yfdate, "yyyy-MM-dd") & "' And '" & Format(yldate, "yyyy-MM-dd") & "'", DB, adOpenStatic, adLockBatchOptimistic
            ...
            DB.BeginTrans
             DB.Execute ("Delete From RM_FibreDiscCNDRate WHERE  DocNo = " & val(adoPrimaryRS("DocNo")) & " AND DocDate = '" & Format(adoPrimaryRS("DocDate"), "yyyy-MM-dd") & "' "), xx
             DB.Execute ("Delete From RM_FibreDiscCN  WHERE  DocNo = " & val(adoPrimaryRS("DocNo")) & " AND DocDate = '" & Format(adoPrimaryRS("DocDate"), "yyyy-MM-dd") & "' "), xx
             
           ' Set adoPrimaryRS = New Recordset
'            adoPrimaryRS.Open "select Divcode,DocNo,DocDate,SLCODE,JONo,JODate,DespatchTo,VechicleNo,RemTime,EntryDate,Description from  RM_FibreDiscCN where  1= 2", DB, adOpenStatic, adLockBatchOptimistic
'
'            adoPrimaryRS.ADDNEW
            ...
            Set RSDST = New Recordset
            RSDST.Open "select * from RM_FibreDiscCNTXN where IPAdd='" & LocalIPAdd & "' and docdate='" & Format(DTPicker1.value, "yyyy-mm-dd") & "' and supcd='" & Trim(txtfields(3).Text) & "' and docno='" & val(txtfields(0).Text) & "' ", DB, adOpenStatic
             Do While Not RSDST.EOF

                    DB.Execute "insert into RM_FibreDiscCNDRate(Divcode,docno,Docdate,VSno,DocSno,Varcode,DType,DRate,IPAdd,supcd,Fdate,tdate)values('" & Divcode & "','" & val(txtfields(0).Text) & "','" & Format(DTPicker1.value, "yyyy-mm-dd") & "','" & val(RSDST("vsno")) & "','" & val(RSDST("docsno")) & "','" & RSDST("varcode") & "','" & Trim(RSDST("dtype")) & "','" & val(RSDST("drate")) & "','" & LocalIPAdd & "','" & Trim(txtfields(3).Text) & "','" & Format(DTPicker3.value, "yyyy-mm-dd") & "','" & Format(DTPicker4.value, "yyyy-mm-dd") & "')"
                    RSDST.MoveNext
             Loop
...
Private Sub CmdOrderOk_Click()
    ...
    End With
     FraOrd.Visible = False
     SpdEmpAllocation.Col = SPDRATEEntry.SPDVVarName
...
On Error GoTo fnd1_Error
    ...
    Set adoPrimaryRS = New Recordset
    adoPrimaryRS.Open "SHAPE {select distinct TH.Divcode,TH.DocNo,TH.DocDate,supcd,RefDocno,RefDocDt,Fdate,tdate  from  RM_FibreDiscCN th  where  divcode = '" & Divcode & "'    " & _
    "  AND TH.DIVCODE = '" & Divcode & "'and DOCDT between '" & Format(yfdate, "yyyy-MM-dd") & "' and '" & Format(yldate, "yyyy-MM-dd") & "' " & _
    " and th.DocNo >= " & MDOC & " Order by DOCDT,DOCNO} AS ParentCMD APPEND ({select a.Divcode,Docno,a.docsno,Docdate,a.supcd,a.CATCD,bb.CATNAME,a.Varcode,c.VARNAME,a.Plant,d.PLName,a.RateUnit,a.CandyRate,a.RATEKG,r.unitname  from RM_FibreDiscCN a inner join rm_cat bb on bb.catcd=a.catcd left join rm_var c on c.varcode=a.varcode left join rm_plant d on d.plcode=a.Plant  left join RM_rateunit r on r.unitcode=a.RateUnit WHERE DOCDATE  between '" & Format(yfdate, "yyyy-MM-dd") & "' and '" & Format(yldate, "yyyy-MM-dd") & "' Order by a.DOCDATE ,a.DOCSNO } AS ChildCMD RELATE DIVCODE TO DIVCODE,DOCNO TO DOCNO,DOCDATE TO DOCDATE) AS ChildCMD", DB, adOpenStatic, adLockBatchOptimistic
...
Text2.Text = ""
    With SpdEmpAllocation
                    ...
                    If .ActiveCol = SPDRATEEntry.SPDVRateCY And KeyCode = vbKeyF5 Then
                            ...
                            If val(Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVRateCY, .ActiveRow))) > 0 And Trim(Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVPlant, .ActiveRow))) <> "" Then
                                ...
                                If Opt = "add" Or Opt = "mod" Or Opt = "del" Then
                                    Rs.Open "SELECT * from RM_FibreDiscCNTXN  a left join RM_DiscountType b on a.dtype=b.code and  isnull(RPTFLG,'N')='Y' where  vsno='" & val(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVSNO, .ActiveRow)) & "' and docdate='" & Format(DTPicker1.value, "YYYY-MM-DD") & "' AND Varcode='" & Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVVarcode, .ActiveRow)) & "' ", DB, adOpenStatic
                                Else
                                    Rs.Open "SELECT * from RM_FibreDiscCNDRate  a left join RM_DiscountType b on a.dtype=b.code and  isnull(RPTFLG,'N')='Y' where  vsno='" & val(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVSNO, .ActiveRow)) & "' and docdate='" & Format(DTPicker1.value, "YYYY-MM-DD") & "' AND Varcode='" & Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVVarcode, .ActiveRow)) & "' ", DB, adOpenStatic
                                End If
                                 r1 = 0
                                  With SPDDiscTypeDet
                                     If Not Rs.EOF Then
                                         For I = 0 To Rs.RecordCount
                                          ...
                                          Next
                                          SPDDiscTypeDet.Col = SPDDTDRate
                                          SPDDiscTypeDet.SetFocus
                                    Else
                                    
                                        Set Rs = New Recordset
                                        Rs.Open "SELECT * from  RM_DiscountType where isnull(RPTFLG,'N')='Y' ", DB, adOpenStatic
            ...
            If Opt = "add" Or Opt = "mod" Then
                ...
                If (.ActiveCol = SPDRATEEntry.SPDVPlantDesc) And KeyCode = 9 And Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVPlantDesc, .ActiveRow)) = "" Then
                ...
                If (.ActiveCol = SPDRATEEntry.SPDVRateUnit) And KeyCode = 9 And Trim(GetText(SpdEmpAllocation, SPDRATEEntry.SPDVRateUnit, .ActiveRow)) = "" Then
...
With SpdEmpAllocation
        ...
        .TypeTextWordWrap = True
        .FontBold = True
        SetSpreadCol1 SpdEmpAllocation, SPDRATEEntry.SPDVSNO, "S.No", CellTypeNumber, 4, , True, True    'a
...
'
        ...
        SetSpreadCol1 SpdEmpAllocation, SPDRATEEntry.SPDVPlantDesc, "Plant", CellTypeEdit, 20, , False, True 'd
        
        SetSpreadCol1 SpdEmpAllocation, SPDRATEEntry.SPDVRateUnitCD, "UOM ", CellTypeStaticText, 14, 0, True, True 'e
        SetSpreadCol1 SpdEmpAllocation, SPDRATEEntry.SPDVRateUnit, " UOM ", CellTypeEdit, 15, 0, False, True 'e
        SetSpreadCol1 SpdEmpAllocation, SPDRATEEntry.SPDVRateCY, "Rate/KG", CellTypeNumber, 12, 4, False, True  'i
...
On Error GoTo qry1_Error
    ...
    Set adoPrimaryRS = New Recordset
    adoPrimaryRS.Open "SHAPE {select distinct a.divcode,docno,docdate,supcd,RefDocno,RefDocDt,Fdate,tdate  from RM_FibreDiscCN a where    " & _
    "   DocDate between '" & Format(yfdate, "yyyy-MM-dd") & "' and '" & Format(yldate, "yyyy-MM-dd") & "' " & _
    " Order by DocDate,DOCNO} AS ParentCMD APPEND ({select a.Divcode,Docno,a.docsno,Docdate,a.supcd,a.CATCD,bb.CATNAME,a.Varcode,c.VARNAME,a.Plant,d.PLName,a.RateUnit,a.CandyRate,a.RATEKG,r.unitname  from RM_FibreDiscCN a inner join rm_cat bb on bb.catcd=a.catcd left join rm_var c on c.varcode=a.varcode left join rm_plant d on d.plcode=a.Plant left join RM_rateunit r on r.unitcode=a.RateUnit WHERE  DOCDATE  between '" & Format(yfdate, "yyyy-MM-dd") & "' and '" & Format(yldate, "yyyy-MM-dd") & "'  Order by a.DOCDATE ,a.DOCSNO } AS ChildCMD RELATE DOCNO TO DOCNO,DOCDATE TO DOCDATE) AS ChildCMD", DB, adOpenStatic, adLockBatchOptimistic
...
End If
    If txtfields(8).Text = "" Then
        ...
        LookUp.Clear = True
        LookUp.query = "Select distinct a.catcd 'Category Code',b.Catname 'Category Name' FROM RM_Suppliervariety a inner join vw_VarietyList b on a.varcode=b.varcode and a.catcd=b.catcd  where  b.catcd in (select catcd from rm_fibrerate aa where isnull(appflg,'N')='Y' and  aa.supcd ='" & Trim(txtfields(3).Text) & "') and  A.supcd ='" & Trim(txtfields(3).Text) & "' union all   select Top 1 'A', ' ALL' "
        ...
        If LookUp.Cancel = False Then
           ...
           ' Dim ItmRs As Recordset
            ...
            ItmRs.Open " select * from RM_Suppliervariety a inner join vw_VarietyList b on a.catcd=b.catcd and a.varcode=b.varcode  wHERE (b.catcd='" & Trim(txtfields(8).Text) & "' or '" & txtfields(8).Text & "'='A') and A.supcd ='" & Trim(txtfields(3).Text) & "'  and b.varcode in (select varcode from rm_fibrerate aa where isnull(appflg,'N')='Y' and  aa.supcd ='" & Trim(txtfields(3).Text) & "')   ", DB, adOpenStatic, adLockBatchOptimistic
            RW = 1
...
Case 3
    If txtfields(3).Text = "" And SupSEL = False Then
        LookUp.Clear = True
        LookUp.query = "Select distinct a.docno 'Doc.No.',a.Docdate 'Doc. Date', a.supcd 'Supplier Code',b.slname 'Supplier Name' FROM rm_fibrerate a inner join fa_slmas b on a.supcd=b.slcode where  Effdate in (select max(Effdate) from rm_fibrerate ap where isnull(ap.appflg,'N')='Y' and a.varcode=ap.varcode and ap.supcd=a.supcd ) and  supcd not in (select supcd from RM_FibreDiscCN bb  where bb.docdate='" & Format(DTPicker1.value, "yyyy-mm-dd") & "'  and bb.varcode=a.varcode) and   country='INDIA' " '' union select Top 1 'A', ' ALL'
        
        LookUp.Caption = "Fibre Rate Listing"
        LookUp.DefCol = "Supplier Name"
        LookUp.ALIGN = "1200,1500,1500,5000"
        
        LookUp.Show vbModal
        If LookUp.Cancel = False Then
            txtfields(1).Text = LookUp.Fields(0)
            DTPicker2.value = LookUp.Fields(1)
        
            txtfields(3).Text = LookUp.Fields(2)
            txtfields(2).Text = LookUp.Fields(3)
            
            Call SETDESPATCHHead
            Set adoSecondaryRS2 = New Recordset
            adoSecondaryRS2.Open "select a.Divcode,Docno,a.docsno,Docdate,a.supcd,a.CATCD,bb.CATNAME,a.Varcode,c.VARNAME,a.Plant,d.PLName,a.RateUnit,a.CandyRate,a.RATEKG ,r.unitname from rm_fibrerate a inner join rm_cat bb on bb.catcd=a.catcd left join rm_var c on c.varcode=a.varcode left join rm_plant d on d.plcode=a.Plant left join RM_rateunit r on r.unitcode=a.RateUnit where a.DocDate= '" & Format(DTPicker2.value, "yyyy-MM-dd") & "'  and DocNo='" & val(txtfields(1).Text) & "' Order by a.DocSno", DB, adOpenStatic, adLockBatchOptimistic
            Call SpdLoadRate
