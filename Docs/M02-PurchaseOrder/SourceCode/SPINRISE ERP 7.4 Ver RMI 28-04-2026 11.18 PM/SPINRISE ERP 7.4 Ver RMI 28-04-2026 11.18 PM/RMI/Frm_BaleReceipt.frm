...
Begin VB.Form Frm_BaleReceipt 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   4725
         Picture         =   "Frm_BaleReceipt.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Print"
         Top             =   75
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":0442
         Height          =   510
         Index           =   3
         Left            =   1065
         Picture         =   "Frm_BaleReceipt.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":0AE1
         Height          =   510
         Index           =   6
         Left            =   2115
         Picture         =   "Frm_BaleReceipt.frx":0F2B
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":1278
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "Frm_BaleReceipt.frx":1582
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":1915
         Height          =   510
         Index           =   5
         Left            =   1605
         Picture         =   "Frm_BaleReceipt.frx":1D5F
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":20C4
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   540
         Picture         =   "Frm_BaleReceipt.frx":23CE
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":276A
         Height          =   510
         Index           =   1
         Left            =   11265
         Picture         =   "Frm_BaleReceipt.frx":2A74
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":2DEE
         Height          =   510
         Index           =   7
         Left            =   2640
         Picture         =   "Frm_BaleReceipt.frx":3238
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":3588
         Height          =   510
         Index           =   11
         Left            =   5205
         Picture         =   "Frm_BaleReceipt.frx":39D2
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":3D67
         Height          =   510
         Index           =   9
         Left            =   3675
         Picture         =   "Frm_BaleReceipt.frx":4071
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "Frm_BaleReceipt.frx":4413
         Height          =   510
         Index           =   10
         Left            =   4215
         Picture         =   "Frm_BaleReceipt.frx":471D
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_BaleReceipt.frx":4A99
         Height          =   510
         Index           =   8
         Left            =   3165
         Picture         =   "Frm_BaleReceipt.frx":4EE3
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   4
         Left            =   7710
         Picture         =   "Frm_BaleReceipt.frx":5245
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   " "
      TabPicture(0)   =   "Frm_BaleReceipt.frx":55DC
      ...
      Begin VB.Frame Frame2 
         ...
         Begin FPSpreadADO.fpSpread FpSpdGp 
            ...
            SpreadDesigner  =   "Frm_BaleReceipt.frx":55F8
            ScrollBarStyle  =   3
         End
      End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CommandButton lovok 
            Caption         =   "&OK"
            DownPicture     =   "Frm_BaleReceipt.frx":5A3B
            Height          =   615
            Left            =   2940
            Picture         =   "Frm_BaleReceipt.frx":5E21
            Style           =   1  'Graphical
            TabIndex        =   32
            Top             =   3915
            Width           =   1185
         ...
         Begin VB.CommandButton lovcancel 
            Caption         =   "&Cancel"
            DownPicture     =   "Frm_BaleReceipt.frx":61E7
            Height          =   615
            Left            =   4680
            Picture         =   "Frm_BaleReceipt.frx":65C9
            Style           =   1  'Graphical
            TabIndex        =   31
            Top             =   3915
            Width           =   1185
   ...
   Begin VB.Frame FraIssue 
      ...
      Begin FPSpreadADO.fpSpread FpSpIss 
         ...
         ScrollBarExtMode=   -1  'True
         ScrollBarShowMax=   0   'False
         SpreadDesigner  =   "Frm_BaleReceipt.frx":699C
         ScrollBarStyle  =   3
      End
   ...
   End
End
Attribute VB_Name = "Frm_BaleReceipt"
...
If Opt = "add" Or Opt = "mod" Then
    ...
    Select Case Index
        Case 2
            Set TmpRs = New Recordset
            TmpRs.Open "SELECT issue_code,issue_desc,Isstype FROM rm_issuetype  WHERE Isstype IN('T','R') and Isstype = '" & Trim(txtfields(Index).Text) & "'", DB, adOpenStatic, adLockReadOnly
            If Not TmpRs.EOF Then
...
Sub IssueTypeLookup()
    LookUp.clear = True
    LookUp.query = "select issue_code 'Code',issue_desc 'Description',Isstype 'Issue Type' from Rm_issuetype Where  Isstype IN('T','R')"
