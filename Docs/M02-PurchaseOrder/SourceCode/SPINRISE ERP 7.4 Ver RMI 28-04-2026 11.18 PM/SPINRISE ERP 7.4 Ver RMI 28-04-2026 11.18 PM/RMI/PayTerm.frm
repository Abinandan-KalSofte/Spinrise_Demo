...
Begin VB.Form PayTerm 
   ...
   Begin VB.Frame Buttonframe 
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":0442
         Height          =   510
         Index           =   6
         Left            =   2280
         Picture         =   "PayTerm.frx":088C
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":0BD9
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "PayTerm.frx":0EE3
         Style           =   1  'Graphical
         TabIndex        =   0
         ToolTipText     =   "Add"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":1276
         Height          =   510
         Index           =   5
         Left            =   1715
         Picture         =   "PayTerm.frx":16C0
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":20CB
         Height          =   510
         Index           =   1
         Left            =   600
         Picture         =   "PayTerm.frx":23D5
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Modify"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":2AE6
         Height          =   510
         Index           =   7
         Left            =   2830
         Picture         =   "PayTerm.frx":2F30
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":3280
         Height          =   510
         Index           =   11
         Left            =   5540
         Picture         =   "PayTerm.frx":36CA
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Exit"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":3A5F
         Height          =   510
         Index           =   9
         Left            =   3960
         Picture         =   "PayTerm.frx":3D69
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Save"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "PayTerm.frx":410B
         Height          =   510
         Index           =   10
         Left            =   4520
         Picture         =   "PayTerm.frx":4415
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Cancel "
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "PayTerm.frx":4791
         Height          =   510
         Index           =   8
         Left            =   3390
         Picture         =   "PayTerm.frx":4BDB
         Style           =   1  'Graphical
         TabIndex        =   8
...
'addition
        Opt = "add"
         ...
         adoPrimaryRS.Open "select PayTerm_Code 'Code', PayTerm_Desc 'Description' from Ig_PayTerm where 1=2", DB, adOpenStatic, adLockBatchOptimistic
         adoPrimaryRS.AddNew
...
'modification
        'Opt = "mod"
        If Record_Exists("Ig_PayTerm", "No Records Found") = False Then Exit Sub
            Opt = "mod"
                Screen.MousePointer = 11
                desc.Caption = "Modification"
                stbar.Panels(2).Text = "Modification"
                DB.BeginTrans
                stbar.Panels(2).Text = "Select Pay Code from the List"
                grdDataGrid.AllowUpdate = True
...
'Save
    If Opt = "add" Or Opt = "mod" Then
            ...
            If Trim(grdDataGrid.Columns(1).Text) = "" And Not Trim(grdDataGrid.Columns(0).Text) = "" Then
                MsgBox "Please Enter PayTerm Descsription", vbInformation, head
                grdDataGrid.Col = 1
                grdDataGrid.SetFocus
                Exit Sub
            End If
...
On Error GoTo AddErr
         ...
         If Opt = "del" Then
          On Error GoTo delerr:
                    ...
                    TrnLog("Trans_date") = Format(RSCHECK.Fields(0), "yyyy-mm-dd hh:mm:ss")
                        ...
                        TrnLog.UpdateBatch adAffectAllChapters
                        DB.Execute ("delete from Ig_PayTerm where PayTerm_Code='" & grdDataGrid.Columns(0).Text & "'")
                        DB.CommitTrans
                        Screen.MousePointer = 0
    ...
    End If
delerr:
'    If CStr(Mid$(err.PayTerm_Desc, InStr(err.PayTerm_Desc, "ORA") + 4, 5)) = "02292" Then
        If Opt = "del" Then
...
Case 12
    ...
    Set Cystalrptbunk.cryRept = Cry_Payterm
...
'            Call query_mode
'       Else
'             MsgBox "PayTerm_Desc should not Empty", vbInformation, head
'             grdDataGrid.Col = 1
'             Opt = tmp
'       End If
'        'DB.RollbackTrans
...
Exit Sub
BUTTON_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure BUTTON_Click of Form PayTerm", vbInformation, head
...
BUTTON_KeyDown_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure BUTTON_KeyDown of Form PayTerm", vbInformation, head
...
Exit Sub
Form_KeyDown_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_KeyDown of Form PayTerm", vbInformation, head
            ...
            If ColIndex = 1 Then
                    If grdDataGrid.Columns(1).Text <> Empty Then
                        ...
                        Set Rs = New Recordset
                            Rs.Open "select 'PayTerm_Desc'  from Ig_PayTerm where PayTerm_Desc ='" & grdDataGrid.Columns(1).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                                If Not Rs.BOF Then
                                    MsgBox "Unit PayTerm_Desc cannot be repeated", vbInformation, head
    ...
    grdDataGrid.EditActive = True
            If ColIndex = 0 Then
                    If grdDataGrid.Columns(0).Text <> Empty Then
                        Set Rs = New Recordset
                            Rs.Open "select 'PayTerm_Code'  from Ig_PayTerm where PayTerm_Code ='" & grdDataGrid.Columns(0).Text & "'", DB, adOpenStatic, adLockBatchOptimistic
                                If Not Rs.BOF Then
...
grddatagrid_BeforeColUpdate_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grddatagrid_BeforeColUpdate of Form PayTerm", vbInformation, head
End Sub
...
GRDDATAGRID_GotFocus_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure GRDDATAGRID_GotFocus of Form PayTerm", vbInformation, head
End Sub
...
GrdDatagrid_KeyDown_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grddatagrid_KeyDown of Form PayTerm", vbInformation, head
End Sub
...
On Error GoTo GrdDatagrid_KeyPress_Error
    ...
    Select Case grdDataGrid.Col
        Case 0
                stbar.Panels(2).Text = "Enter a maximum 3 Character"
                If KeyAscii = 32 Then
                    KeyAscii = 9
                End If
                If KeyAscii <> 9 Then
        ...
        Case 1
                stbar.Panels(2).Text = "Enter a maximum 50 Character"
                If Opt = "add" Then
'                If KeyAscii <> 9 Then
...
GrdDatagrid_KeyPress_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grddatagrid_KeyPress of Form PayTerm", vbInformation, head
End Sub
...
'            End If
           ...
           If LastCol = 0 And Opt = "add" Then
                If Trim(grdDataGrid.Columns(0).Text) = "" Then
                    MsgBox "Pay Code cannot be Empty", vbInformation, head
                    grdDataGrid.Col = 0
                    grdDataGrid.SetFocus
                    grdDataGrid.EditActive = True
                    Exit Sub
...
grdDataGrid_RowColChange_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grdDataGrid_RowColChange of Form PayTerm", vbInformation, head
...
lovcancel_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure lovcancel_Click of Form PayTerm", vbInformation, head
End Sub
...
On Error GoTo lovok_Click_Error
       ...
       grdDataGrid.Visible = True
       Set adoPrimaryRS = New Recordset
       adoPrimaryRS.Open "select PayTerm_Code,PayTerm_Desc from Ig_PayTerm where PayTerm_Code ='" & Ksldesc1.Code & "' Order by PayTerm_Code", DB, adOpenStatic, adLockBatchOptimistic
       Set grdDataGrid.DataSource = adoPrimaryRS
...
Exit Sub
lovok_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure lovok_Click of Form PayTerm", vbInformation, head
...
intervalMinutes = -1
    ...
    grdDataGrid.Columns(1).Caption = "Description"
...
Exit Sub
Form_Load_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Load of Form PayTerm", vbInformation, head
End Sub
...
Exit Sub
Form_Unload_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Unload of Form PayTerm", vbInformation, head
End Sub
...
adoPrimaryRS_MoveComplete_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure adoPrimaryRS_MoveComplete of Form PayTerm", vbInformation, head
End Sub
...
GrdDatagrid_AfterColUpdate_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure grddatagrid_AfterColUpdate of Form PayTerm", vbInformation, head
End Sub
...
On Error GoTo er1
    If Opt = " " Or Opt = "qry" Then
        ...
        Set adoPrimaryRS = New Recordset
        adoPrimaryRS.Open "select PayTerm_Code 'Code',PayTerm_Desc 'Description' from Ig_PayTerm Order by PayTerm_Code", DB, adOpenStatic, adLockOptimistic
        If adoPrimaryRS.RecordCount = 0 Then
   ...
   End If
    ...
    If Opt = "mod" Then
        'Set adoPrimaryRS = New Recordset
        'adoPrimaryRS.Open "select PayTerm_Code,PayTerm_Desc from Ig_PayTerm where PayTerm_Code ='" & Trim(Ksldesc1.code) & "' and PayTerm_Desc ='" & Trim(Ksldesc1.PayTerm_Desc) & "'", db, adOpenStatic, adLockBatchOptimistic
        Call bindcontls
        Call ENABLCONTLS
        grdDataGrid.Columns(0).Locked = True
    End If
...
Exit Sub
'bindcontls_Error:
'MsgBox "Error " & err.Number & " (" & err.Description & ") in procedure bindcontls of Form PayTerm", vbInformation, head
End Sub
...
Exit Sub
disablcontls_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure disablcontls of Form PayTerm", vbInformation, head
  End Sub
...
Exit Sub
ENABLCONTLS_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure ENABLCONTLS of Form PayTerm", vbInformation, head
End Sub
...
ksldesc1_GotFocus_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure ksldesc1_GotFocus of Form PayTerm", vbInformation, head
End Sub
...
On Error GoTo header_Error
            ...
            Print #a, Space(5) + "PAYTERM LISTING  " + Space(20) + "Dt: " & Str + "Pg.:" + Padl(CStr(pg), 3, " ")

            Set Rs = New Recordset
            Rs.Open "select PayTerm_Code,PayTerm_Desc from Ig_PayTerm", DB, adOpenStatic, adLockOptimistic
                If Rs.BOF Then
                    MsgBox "No Records Found", vbInformation, head
                    Close #a
                    Exit Sub
...
Exit Sub
header_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure header of Form PayTerm", vbInformation, head
...
Exit Sub
ToAlpha1_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure ToAlpha1 of Form PayTerm", vbInformation, head
End Sub
...
Exit Sub
validlenD_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure validlenD of Form PayTerm", vbInformation, head
End Sub
...
On Error GoTo MODLOOKUP_Error
    ...
    LookUp.Clear = True
    LookUp.query = "SELECT PayTerm_Code""Code"",PayTerm_Desc""Description"" FROM Ig_PayTerm "
    LookUp.DefCol = "Description"
    LookUp.ALIGN = "1000,4000"
    LookUp.Caption = "PAY TERM LISTING"
    
    LookUp.Show vbModal
    If LookUp.Cancel = False Then
        If Opt = "mod" Then
            Set adoPrimaryRS = New Recordset
            adoPrimaryRS.Open " select PayTerm_Code 'Code',PayTerm_Desc 'Description' from Ig_PayTerm where PayTerm_Code ='" & LookUp.Fields(0) & "'", DB, adOpenStatic, adLockBatchOptimistic
            Set grdDataGrid.DataSource = adoPrimaryRS
            grdDataGrid.AllowAddNew = False
            grdDataGrid.Columns(0).Locked = True
            grdDataGrid.Col = 1
...
Exit Sub
MODLOOKUP_Error:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure MODLOOKUP of Form PayTerm", vbInformation, head
End Sub
