...
Begin VB.Form FrmMixingChart 
   ...
   Begin VB.Frame FraIssue 
      ...
      Begin FPSpreadADO.fpSpread FpSpIss 
         ...
         SpreadDesigner  =   "FrmMixingChart.frx":0000
         ScrollBarStyle  =   3
      End
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "FrmMixingChart.frx":0443
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox Combo3 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "FrmMixingChart.frx":045F
            Left            =   90
            List            =   "FrmMixingChart.frx":0461
            TabIndex        =   69
            Top             =   2490
            Visible         =   0   'False
            Width           =   1215
         ...
         Begin VB.ComboBox Combo2 
            ...
            ForeColor       =   &H00000000&
            Height          =   360
            ItemData        =   "FrmMixingChart.frx":0463
            Left            =   9510
            List            =   "FrmMixingChart.frx":046A
            TabIndex        =   61
            Top             =   510
            Width           =   1155
         End
         ...
         Begin VB.ComboBox Combo1 
            ...
            ForeColor       =   &H00000000&
            Height          =   360
            ItemData        =   "FrmMixingChart.frx":0478
            Left            =   1305
            List            =   "FrmMixingChart.frx":047A
            TabIndex        =   53
            Top             =   150
            Width           =   3135
         End
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   13
         Left            =   5355
         Picture         =   "FrmMixingChart.frx":047C
         Style           =   1  'Graphical
         TabIndex        =   112
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":08BE
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   4
         Left            =   1560
         Picture         =   "FrmMixingChart.frx":0BC8
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   8970
         Picture         =   "FrmMixingChart.frx":0F5D
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":139F
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   6
         Left            =   2625
         Picture         =   "FrmMixingChart.frx":17E9
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":1B36
         Enabled         =   0   'False
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
         ...
         Index           =   0
         Left            =   30
         Picture         =   "FrmMixingChart.frx":1E40
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":21D3
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   5
         Left            =   2100
         Picture         =   "FrmMixingChart.frx":261D
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":2982
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1095
         Picture         =   "FrmMixingChart.frx":2C8C
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":3028
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   1
         Left            =   570
         Picture         =   "FrmMixingChart.frx":3332
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   7440
         Picture         =   "FrmMixingChart.frx":36AC
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":3A43
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   7
         Left            =   3180
         Picture         =   "FrmMixingChart.frx":3E8D
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":41DD
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   11
         Left            =   5955
         Picture         =   "FrmMixingChart.frx":4627
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":49BC
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   9
         Left            =   4260
         Picture         =   "FrmMixingChart.frx":4CC6
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":5068
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   10
         Left            =   4815
         Picture         =   "FrmMixingChart.frx":5372
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FrmMixingChart.frx":56EE
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   8
         Left            =   3720
         Picture         =   "FrmMixingChart.frx":5B38
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&Cancel"
         DownPicture     =   "FrmMixingChart.frx":5E9A
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Height          =   615
         Left            =   4020
         Picture         =   "FrmMixingChart.frx":627C
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   1680
         Width           =   975
      ...
      Begin VB.CommandButton Command2 
         Caption         =   "&OK"
         DownPicture     =   "FrmMixingChart.frx":664F
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Height          =   615
         Left            =   2580
         Picture         =   "FrmMixingChart.frx":6A35
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   1680
         Width           =   975
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.CommandButton Command6 
            Caption         =   "&OK"
            DownPicture     =   "FrmMixingChart.frx":6DFB
            Height          =   495
            Left            =   2760
            Picture         =   "FrmMixingChart.frx":71E1
            Style           =   1  'Graphical
            TabIndex        =   30
            Top             =   240
            Width           =   1185
         ...
         Begin VB.CommandButton Command5 
            Caption         =   "&Cancel"
            DownPicture     =   "FrmMixingChart.frx":75A7
            Height          =   495
            Left            =   6240
            Picture         =   "FrmMixingChart.frx":7989
            Style           =   1  'Graphical
            TabIndex        =   31
            Top             =   240
            Width           =   1185
   ...
   End
End
Attribute VB_Name = "FrmMixingChart"
...
Case 13
 ...
 'report call
    ...
    Set clsCryRpt2.cryRept = Cry_ISSUEREQUISITION
   ...
   ' CrystalReport1.SelectionFormula = "{RM_LOT.DIVCODE}='" & Divcode & "' AND {RM_LOT.PJDT} = cdate('" & Format(MaskEdBox1(3), "yyyy-mm-dd") & "') AND {RM_LOT.PJNO}>=  " & Txtfields(304) & " AND {RM_LOT.PJNO} <= " & Txtfields(304) & " "
    ...
    CrystalReport1.ParameterFields(2) = "@ddate;" & Format(MaskEdBox1(0), "yyyy-mm-dd") & ""
...
On Error GoTo SetColoumn_Error
    ...
    adoPrimaryRS.Open "SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,softwaste,ISSUEFLG FROM RM_issReqH  WHERE 1 = 2  order by docno", DB, adOpenStatic, adLockOptimistic
...
'                CNTRS.Open "select description from ig_product where product_code='" & adoPrimaryRS("cntcd") & "'", DB, adOpenStatic, adLockBatchOptimistic
            ...
            End If
               ...
               Set adoSecondaryRS = New Recordset
         adoSecondaryRS.Open " SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.Plotno""Supplier Lot No"",VARname""Variety Name"",a.CATCD""Category"",a.baleno""Quantity""  FROM RM_issReqB a " & _
...
'                        "  where DIVCODE = '" & Divcode & "' and  DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' " & _
'                        " Order by A.DOCNO "
    sQry = "SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste,ISSUEFLG,isnull(AppBy,'') appby FROM RM_issReqH  a " & _
                        "  where DIVCODE = '" & Divcode & "' and  DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' " & _
                        " Order by A.DOCNO "
...
'   adoPrimaryRS.Open "SHAPE {SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_issReqH  " & _
    ...
    adoPrimaryRS.Open "SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste,ISSUEFLG,AppBy FROM RM_issReqH  " & _
                     "  where DIVCODE = '" & Divcode & "' and docno = '" & Trim(txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' " & _
                     " Order by DOCNO", DB, adOpenStatic, adLockBatchOptimistic
   If Not adoPrimaryRS.EOF Then
...
'                          " where b.varcode=c.varcode and  isnull(b.issbal,0) <> 0 and a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.divcode=b.divcode and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' order by a.lotno,a.baleno", DB, adOpenStatic, adLockBatchOptimistic
      ...
      Set adoSecondaryRS = New Recordset
      adoSecondaryRS.Open " SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.plotno""Supplier Lot No."",b.VARCODE""Variety"",c.varname ""Variety Name"",a.CATCD""Category"",a.baleno""Accepted Qty"",a.Rejqty as ""Rejected Qty""  FROM RM_issReqB a,rm_lot b,rm_var c " & _
...
'   BUTTON(10).Enabled = True
   ...
   ''adoPrimaryRS.Open "SHAPE {SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno FROM RM_issReqH  " & _
                     ...
                     " } AS ChildCMD RELATE DOCNO TO DOCNO,DOCDT TO DOCDT,DIVCODE TO DIVCODE,ISSTYPE TO ISSTYPE ) AS ChildCMD", DB, adOpenStatic, adLockBatchOptimistic
adoPrimaryRS.Open "SHAPE {SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste,ISSUEFLG FROM RM_issReqH  " & _
                     "  where DIVCODE = '" & Divcode & "' and docno = '" & Trim(txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' " & _
...
RsMod.Open "SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste,appby FROM RM_issReqH where 1=2", DB, adOpenStatic, adLockBatchOptimistic
        ...
        RSMODS.Open "select Divcode , ISSTYPE, docNo, DOCDT, catcd, LOTNO, LOTDT, baleno, issKgs, LotType, MODUSERID, MODUSRID, ACTISSKGS, ISSUED, arrdt, varcode,Rejqty from RM_issReqB where 1=2", DB, adOpenStatic, adLockBatchOptimistic
