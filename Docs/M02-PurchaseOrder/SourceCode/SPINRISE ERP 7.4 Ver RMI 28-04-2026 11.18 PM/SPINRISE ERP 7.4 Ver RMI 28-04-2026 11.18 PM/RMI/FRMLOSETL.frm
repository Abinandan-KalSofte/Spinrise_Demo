...
Begin VB.Form FRMLOSETL 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":0000
         Height          =   550
         Index           =   4
         Left            =   1545
         Picture         =   "FRMLOSETL.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":0AE1
         Height          =   550
         Index           =   8
         Left            =   3690
         Picture         =   "FRMLOSETL.frx":0F2B
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":128D
         Height          =   550
         Index           =   10
         Left            =   4770
         Picture         =   "FRMLOSETL.frx":1597
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":1913
         Height          =   550
         Index           =   9
         Left            =   4230
         Picture         =   "FRMLOSETL.frx":1C1D
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":1FBF
         Height          =   550
         Index           =   11
         Left            =   5835
         Picture         =   "FRMLOSETL.frx":2409
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":279E
         Height          =   550
         Index           =   7
         Left            =   3165
         Picture         =   "FRMLOSETL.frx":2BE8
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":32CF
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":3975
         Height          =   550
         Index           =   5
         Left            =   2085
         Picture         =   "FRMLOSETL.frx":3DBF
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":4124
         Height          =   550
         Index           =   0
         Left            =   0
         Picture         =   "FRMLOSETL.frx":442E
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":47C1
         Height          =   550
         Index           =   6
         Left            =   2625
         Picture         =   "FRMLOSETL.frx":4C0B
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "FRMLOSETL.frx":4F58
         Height          =   550
         Index           =   1
         Left            =   9315
         Picture         =   "FRMLOSETL.frx":5262
         Style           =   1  'Graphical
         TabIndex        =   37
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      BackColor       =   12632319
      TabCaption(0)   =   " "
      TabPicture(0)   =   "FRMLOSETL.frx":55DC
      ...
      Tab(0).Control(22)=   "TXTFIELDS(16)"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "TXTFIELDS(18)"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "Frame2"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "TXTFIELDS(10)"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "TXTFIELDS(19)"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "TXTFIELDS(20)"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "TXTFIELDS(11)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "TXTFIELDS(15)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "TXTFIELDS(17)"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "TXTFIELDS(25)"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "Frame1"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "TXTFIELDS(27)"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "Text1"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "TXTFIELDS(28)"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "TXTFIELDS(29)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "TXTFIELDS(37)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "TXTFIELDS(38)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "TXTFIELDS(39)"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "TXTFIELDS(40)"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "TXTFIELDS(41)"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "TXTFIELDS(42)"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "TXTFIELDS(43)"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "TXTFIELDS(45)"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "Check1"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "TXTFIELDS(46)"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "TXTFIELDS(47)"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "TXTFIELDS(48)"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "TXTFIELDS(51)"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "TXTFIELDS(50)"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "TXTFIELDS(52)"
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton lovcancel 
         Caption         =   "&Cancel"
         DownPicture     =   "FRMLOSETL.frx":55F8
         Height          =   615
         Left            =   5040
         Picture         =   "FRMLOSETL.frx":59DA
         Style           =   1  'Graphical
         TabIndex        =   45
         Top             =   4920
         Width           =   1185
      ...
      Begin VB.CommandButton lovok 
         Cancel          =   -1  'True
         Caption         =   "&OK"
         DownPicture     =   "FRMLOSETL.frx":5DAD
         Height          =   615
         Left            =   3840
         Picture         =   "FRMLOSETL.frx":6193
         Style           =   1  'Graphical
         TabIndex        =   44
         Top             =   4920
         Width           =   1185
...
'        " left join fa_slmas e on a.supcd=e.slcode where  a.lotno = b.lotno And b.contno = c.contno And b.contdt = c.contdt And a.lotdt = b.lotdt And c.divcode = b.divcode  And c.divcode = b.divcode And g.delcode = c.dlytype and a.brkcd*=f.slcode  and lotyear='" & Year(yfdate) & "'  " & _
'        " and a.lotdt='" & Format(adoPrimaryRS("LOTDT"), "yyyy-mm-dd") & "' and a.lotno='" & adoPrimaryRS("lotno") & "'  order by a.lotdt,a.lotno ", DB, adOpenStatic
        
        RRs.Open " select g.deldesc as dlytype from  rm_lot a " & _
        " left join rm_arrival b on a.lotno = b.lotno And a.lotdt = b.lotdt " & _
        " left join rm_cont c on b.contno = c.contno And b.contdt = c.contdt And c.divcode = b.divcode " & _
        " left join RM_Delivery g on g.delcode = c.dlytype " & _
        " left join fa_slmas e on a.supcd=e.slcode " & _
        " left join fa_slmas f on a.brkcd=f.slcode " & _
        " where opflg='N'  " & _
        " and a.lotdt='" & Format(adoPrimaryRS("LOTDT"), "yyyy-mm-dd") & "' and a.lotno='" & adoPrimaryRS("lotno") & "'  order by a.lotdt,a.lotno ", DB, adOpenStatic
...
''    Frame3.ZOrder
    ...
    If Opt = "del" Or Opt = "mod" Or Opt = "fnd" Then
        If Opt = "del" Then
        LookUp.query = "SELECT C.LOTNO""Lot No."",C.LOTDT""Lot Date"",C.aSNO""Allowance No."",C.adate ""Allowance Date"" ,c.DBNo 'JVNO' FROM RM_LOT A,FA_SLMAS B , RM_LOTALLOWANCE C,fa_jvhead d WHERE c.Dbno=d.vocno and c.DBDT=d.vocdt and d.tc=a.dbtc and d.app_userid is null and  A.DIVCODE=D.DIVCODE and  A.LOTNO=C.LOTNO AND A.LOTDT=C.LOTDT AND A.DIVCODE=C.DIVCODE AND A.SUPCD=B.SLCODE  AND isnull(A.OPFLG,'N')='N' and c.adate between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' AND A.DIVCODE='" & Divcode & "'" ''AND A.LOTYEAR='" & Year(yfdate) & "'
        Else
         LookUp.query = "SELECT C.LOTNO""Lot No."",C.LOTDT""Lot Date"",C.aSNO""Allowance No."",C.adate ""Allowance Date"" ,c.DBNo 'JVNO' FROM RM_LOT A,FA_SLMAS B , RM_LOTALLOWANCE C WHERE  A.LOTNO=C.LOTNO AND A.LOTDT=C.LOTDT AND A.DIVCODE=C.DIVCODE AND A.SUPCD=B.SLCODE  AND A.OPFLG='N' and c.adate between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' AND A.DIVCODE='" & Divcode & "'" ''AND A.LOTYEAR='" & Year(yfdate) & "'
        End If
...
'        LookUp.query = "SELECT A.LOTNO""Lot No."",A.LOTDT""Lot Date"",b.slname 'Supplier' FROM RM_LOT A,FA_SLMAS B WHERE A.SUPCD=B.SLCODE AND  OPFLG='N' AND A.DIVCODE='" & Divcode & "' and lottype='A'  and a.LOTDT BETWEEN DATEADD(s,1,DATEADD(mm, DATEDIFF(m,0,'" & Format(yfdate, "yyyy-mm-d") & "')-3,0))  AND '" & Format(yldate, "YYYY-MM-DD") & "'  " ' AND LOTNO NOT IN (SELECT LOTNO FROM RM_LOTALLOWANCE where lotdt between '" & Format(yfdate, "YYYY-MM-DD") & "' and '" & Format(pdate, "YYYY-MM-DD") & "' ) "
'        ElseIf UCase(CustID) = "JAT" Then
        If UCase(CustID) = "SKS" Then
            LookUp.query = "SELECT A.LOTNO""Lot No."",A.LOTDT""Lot Date"",b.slname 'Supplier' FROM RM_LOT A,FA_SLMAS B WHERE A.SUPCD=B.SLCODE AND OPFLG='N' AND A.DIVCODE='" & Divcode & "' and lottype='A' and lotdt between '" & Format(yfdate - 120, "YYYY-MM-DD") & "' and '" & Format(pdate, "YYYY-MM-DD") & "'  " ' AND LOTNO NOT IN (SELECT LOTNO FROM RM_LOTALLOWANCE where lotdt between '" & Format(yfdate, "YYYY-MM-DD") & "' and '" & Format(pdate, "YYYY-MM-DD") & "' ) "
        Else
        LookUp.query = "SELECT A.LOTNO""Lot No."",A.LOTDT""Lot Date"",b.slname 'Supplier' FROM RM_LOT A,FA_SLMAS B WHERE A.SUPCD=B.SLCODE AND OPFLG='N' AND A.DIVCODE='" & Divcode & "' and lottype='A' and lotdt between '" & Format(yfdate - 120, "YYYY-MM-DD") & "' and '" & Format(pdate, "YYYY-MM-DD") & "'  and isnull(a.pjno,0)>0 " ' AND LOTNO NOT IN (SELECT LOTNO FROM RM_LOTALLOWANCE where lotdt between '" & Format(yfdate, "YYYY-MM-DD") & "' and '" & Format(pdate, "YYYY-MM-DD") & "' ) "
        End If
        
'        Else
'        LookUp.query = "SELECT A.LOTNO""Lot No."",A.LOTDT""Lot Date"",b.slname 'Supplier' FROM RM_LOT A,FA_SLMAS B WHERE A.SUPCD=B.SLCODE AND  OPFLG='N' AND A.DIVCODE='" & Divcode & "' and lottype='A' " ' AND LOTNO NOT IN (SELECT LOTNO FROM RM_LOTALLOWANCE where lotdt between '" & Format(yfdate, "YYYY-MM-DD") & "' and '" & Format(pdate, "YYYY-MM-DD") & "' ) "
'        End If
...
'            adoPrimaryRS.Open "select Lotno,Lotdt,Supcd,Varcode,Grswgt,Tarewt,Netwt,Moiture,Ratecy,Ratekg,Bales,Issbal,Asno,Adate,Pjamt,Totlandcost,Allowance,billno,billdt,isnull(pjamt,0) as pjamt,plotno from rm_lot WHERE DIVCODE='" & Divcode & "' AND OPFLG='N' AND LOTDT BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND LOTYEAR='" & Year(yfdate) & "' AND lotno='" & LookUp.Fields(0) & "' and lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic
           If UCase(CustID) = "COTTON" And UCase(CustID1) <> "SCM" Then
            adoPrimaryRS.Open "SELECT a.arrno,a.arrdt, a.Lotno,a.Lotdt,a.Supcd,a.Varcode,a.Grswgt,a.Tarewt,a.Netwt,a.Moiture,a.Ratecy,a.Ratekg,a.Bales,a.Issbal,a.Asno,a.Adate,a.Pjamt,a.Totlandcost,a.Allowance,a.billno,a.billdt,isnull(a.pjamt,0) as pjamt,a.plotno,b.trashper,b.moisture_per,c.SEASON," & _
                              " round((isnull(b.GROSSWT,0) - isnull(b.TAREWT,0)) * (isnull(b.trashper,0)/100),4) AS trashwt,b.moisture_et,a.cgstper,a.sgstper,a.igstper,A.TCS_PER TCS_PER,c.contno,c.contdt,c.sno  from rm_lot a,RM_ARRIVAL b,RM_CONT c WHERE a.ARRNO=b.arrno AND a.ARRDT=b.arrdate AND a.DIVCODE = c.divcode AND b.divcode=c.DIVCODE AND b.contno=c.CONTNO AND b.contdt=c.contdt and b.varcode=c.varcode and b.supcd=c.supcd and a.varcode=c.varcode AND a.DIVCODE='" & Divcode & "' AND OPFLG='N' AND a.LOTDT BETWEEN '" & Format(Pfydate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "'  AND a.lotno='" & LookUp.Fields(0) & "' and a.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic
           Else
           adoPrimaryRS.Open "SELECT a.arrno,a.arrdt, a.Lotno,a.Lotdt,a.Supcd,a.Varcode,a.Grswgt,a.Tarewt,a.Netwt,a.Moiture,a.Ratecy,a.Ratekg,a.Bales,a.Issbal,a.Asno,a.Adate,a.Pjamt,a.Totlandcost,a.Allowance,a.billno,a.billdt,isnull(a.pjamt,0) as pjamt,a.plotno,b.trashper,b.moisture_per,c.SEASON," & _
                              " round((isnull(b.GROSSWT,0) - isnull(b.TAREWT,0)) * (isnull(b.trashper,0)/100),4) AS trashwt,b.moisture_et,a.cgstper,a.sgstper,a.igstper,A.TCS_PER TCS_PER,c.contno,c.contdt,c.sno  from rm_lot a,RM_ARRIVAL b,RM_CONT c WHERE a.ARRNO=b.arrno AND a.ARRDT=b.arrdate AND a.DIVCODE = c.divcode AND b.divcode=c.DIVCODE AND b.contno=c.CONTNO AND b.contdt=c.contdt and b.varcode=c.varcode and b.supcd=c.supcd and a.varcode=c.varcode AND a.DIVCODE='" & Divcode & "' AND OPFLG='N'   AND a.lotno='" & LookUp.Fields(0) & "' and a.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic '' AND a.LOTDT BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "'
           End If
            If adoPrimaryRS.RecordCount > 0 Then
            ...
            Set rsa = New Recordset
            rsa.Open "select isnull(a.TRASH_PER,0) TRASH_PER from rm_cont a inner join rm_sample b on a.varcode=b.varcode and a.supcd=b.supcode and a.divcode=b.divcode and a.sno=b.sno and b.date between '" & Format(yfdate - 90, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' where  a.varcode='" & adoPrimaryRS("varcode") & "' and a.supcd='" & adoPrimaryRS("supcd") & "' and a.contno='" & adoPrimaryRS("contno") & "'  and a.contdt='" & Format(adoPrimaryRS("contdt"), "yyyy-mm-dd") & "'  ", DB, adOpenStatic
            If rsa.RecordCount > 0 Then
...
'            adoPrimaryRS.Open "select Lotno,Lotdt,Supcd,Varcode,Grswgt,Tarewt,Netwt,Moiture,Ratecy,Ratekg,Bales,Issbal,Asno,Adate,Pjamt,Totlandcost,Allowance,billno,billdt,plotno,isnull(pjamt,0) as pjamt from rm_lot WHERE DIVCODE='" & Divcode & "' AND OPFLG='N' AND LOTDT BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND LOTYEAR='" & Year(yfdate) & "' AND asno='" & LookUp.Fields(2) & "' and adate='" & Format(LookUp.Fields(3), "yyyy-mm-dd") & "' AND lotno='" & LookUp.Fields(0) & "' and lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic
            adoPrimaryRS.Open "select A.Lotno,A.Lotdt,A.Supcd,A.Varcode,A.Grswgt,A.Tarewt,A.Netwt,A.Moiture,A.Ratecy,A.Ratekg,A.Bales,A.Issbal,C.Asno,C.Adate,A.Pjamt,A.Totlandcost,A.Allowance as allow,c.akgs as Allowance,c.dbamt,A.billno,A.billdt,A.plotno,isnull(A.pjamt,0) as pjamt,a.cgstper,a.sgstper,a.igstper,a.cgstper,a.sgstper,a.igstper ,c.cgstamt,c.sgstamt,c.igstamt,c.dbtaxableAmt,c.dbBillNo,c.DBdate,c.roff ,c.ACGSTAMT,c.ASGSTAMT,c.AIGSTAMT,C.TCS_PER,C.TCS_AMT,c.ATCSAMT " & _
                               " FROM RM_LOT A,FA_SLMAS B , RM_LOTALLOWANCE C WHERE A.LOTNO=C.LOTNO AND A.LOTDT=C.LOTDT AND A.DIVCODE=C.DIVCODE AND A.SUPCD=B.SLCODE  AND C.asno='" & LookUp.Fields(2) & "' and C.adate='" & Format(LookUp.Fields(3), "yyyy-mm-dd") & "' and A.DIVCODE='" & Divcode & "' AND OPFLG='N' AND A.LOTDT BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND A.LOTYEAR='" & Year(yfdate) & "' AND A.lotno='" & LookUp.Fields(0) & "' and A.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic   ''AND A.LOTYEAR='" & Year(yfdate) & "'
...
'            TXTFIELDS(23).Text = adoPrimaryRS("Billno")
            ...
            Set RRs = New Recordset
                    RRs.Open " select case when isnull(c.dlytype,'')='S' then 'Spot' when isnull(c.dlytype,'')='M' then 'FOR' else '' end as dlytype from " & _
                    " rm_lot a left join rm_arrival b on a.lotno = b.lotno  And a.lotdt = b.lotdt  left join rm_cont c on b.contno = c.contno and c.contdt=b.contdt left join fa_slmas e on a.supcd=e.slcode  left join fa_slmas f  on a.brkcd=f.slcode " & _
                    " where   " & _
                    " lotyear='" & Year(yfdate) & "'  " & _
                    " and a.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' and a.lotno='" & LookUp.Fields(0) & "'  order by a.lotdt,a.lotno ", DB, adOpenStatic
            If RRs.RecordCount > 0 Then
                txtfields(21).Text = RRs(0)
            Else
...
'                          " WHERE a.lotno='" & LookUp.Fields(0) & "' and a.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' and a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.DIVCODE='" & Divcode & "' AND OPFLG='N' AND A.LOTDT BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND LOTYEAR='" & Year(yfdate) & "' ORDER BY B.ASNO,B.ADATE ", DB, adOpenStatic, adLockBatchOptimistic
            adoPrimaryRS.Open "select A.Lotno,A.Lotdt,A.Supcd,A.Varcode,A.Grswgt,A.Tarewt,A.Netwt,A.Moiture,A.Ratecy,A.Ratekg,A.Bales,A.Issbal,C.Asno,C.Adate,A.Pjamt,A.Totlandcost,A.Allowance as allow,c.akgs as Allowance,c.dbamt,A.billno,A.billdt,A.plotno,isnull(A.pjamt,0) as pjamt,a.cgstper,a.sgstper,a.igstper ,c.cgstamt,c.sgstamt,c.igstamt,c.dbtaxableAmt ,c.dbBillNo,c.DBdate,c.roff ,c.ACGSTAMT,c.ASGSTAMT,c.AIGSTAMT,C.TCS_PER,C.TCS_AMT,c.ATCSAMT  " & _
                            " FROM RM_LOT A,FA_SLMAS B , RM_LOTALLOWANCE C WHERE A.LOTNO=C.LOTNO AND A.LOTDT=C.LOTDT AND A.DIVCODE=C.DIVCODE AND A.SUPCD=B.SLCODE AND C.asno='" & LookUp.Fields(2) & "' and C.adate='" & Format(LookUp.Fields(3), "yyyy-mm-dd") & "' and A.DIVCODE='" & Divcode & "' AND OPFLG='N' AND c.adate BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND A.lotno='" & LookUp.Fields(0) & "' and A.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic  ''  AND A.LOTYEAR='" & Year(yfdate) & "'   ''AND A.LOTYEAR='" & Year(yfdate) & "'
...
Case 3
       ...
       Open KALFOLDERDATA & "\convar.TXT" For Output As #1
        ...
        RS2.Open "select DISTINCT a.Lotno,a.Lotdt,Supcd,slname,varname,v.Varcode,Grswgt,Tarewt,Netwt,Moiture,Ratecy,Ratekg,B.Bales,A.Issbal,B.ASNO,B.Adate,A.Dbno,A.Dbdt,A.DbAmt,A.Dbnarr,a.Aratecy,Akgs,TOTLANDCOST,B.DBAMT,a.roff from rm_lot a,rm_lotallowance b,fa_slmas s,rm_var v " & _
...
Case 9
        ...
        If Opt = "add" Then
            ...
            rrsa.Open "select Divcode,Adate,ASNO,lotno,Lotdt,Bales,AKgs,Dbno,Dbdt,Dbamt,Dbnarr,aRatecy, debitPer, Dbreason,ExTrashPer,ExTrashWgt,ExMoisturePer,ExMoistureWgt,dbtaxableAmt,cgstper,sgstper,igstper,igstamt,cgstamt,sgstamt,dbBillNo,DBdate,roff,ACGSTAMT,ASGSTAMT,AIGSTAMT,TCS_PER,TCS_AMT,ATCSAMT from rm_LotAllowance where 1=2", DB, adOpenStatic, adLockBatchOptimistic
            rrsa.AddNew
...
'            ,c.ACGSTAMT,c.ASGSTAMT,c.AIGSTAMT
            ...
            Else
            rsb.Open "SELECT BILLNO,pjtc FROM RM_LOT WHERE opflg='N' and BILLNO<>'' and lottype='A' AND BILLNO IS NOT NULL AND lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'   ", DB, adOpenStatic  ''lotyear='" & Year(yfdate) & "' and and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'
            End If
            If rsb.RecordCount > 0 Then
                ...
                If FaInstall = "Y" Then
                   ' Commented on 2024-Sep-24 for jat debit note issue by mariyaiya
                   ' a = MsgBox("Do You Want to Raise Debit/Credit Amount", vbYesNo, head)
                   a = 6    ' Added on 2024-Sep-24 for jat debit note issue by mariyaiya
...
'                                       " dbtc=41,Abales= ISNULL(Abales,0) + (" & val(txtfields(16).Text) & "),Allowance=isnull(Allowance,0)+(" & val(txtfields(10).Text) & ") ,Aratecy= ISNULL(ARATECY,0)+(" & val(txtfields(10).Text) & "),ArateKg= ISNULL(ARATEKG,0)+(" & val(txtfields(11).Text) & "),Afratekg= ISNULL(AFRATEKG,0)+(" & val(txtfields(7).Text) & "),Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "'  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'   "
        ...
        ' commented on 19.03.25
'                        DB.Execute "Update rm_lot set dbno='" & Vno & "' ,dbdt='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "',dbamt=ISNULL(dbamt,0) + (" & val(txtfields(20).Text) & "), dbnarr='" & nar1 & "'," & _
'                                       " dbtc=41,Abales= ISNULL(Abales,0) + (" & val(txtfields(16).Text) & "),Allowance=isnull(Allowance,0)+(" & val(txtfields(10).Text) & ") ,Aratecy= ISNULL(ARATECY,0)+(" & val(txtfields(10).Text) & "),ArateKg= ISNULL(ARATEKG,0)+(" & val(txtfields(11).Text) & "),Afratekg= ISNULL(AFRATEKG,0)+(" & val(txtfields(7).Text) & "),Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "'  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "' and opflg='N'  and lotdt between '" & Format(yfdate - 150, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' "
                    ...
                    Else
                        Set adoPrimaryRS = New Recordset
                        adoPrimaryRS.Open "select DISTINCT a.Lotno,a.Lotdt,Supcd,Varcode,Grswgt,Tarewt,Netwt,Moiture,Ratecy,Ratekg,B.Bales,A.Issbal,B.ASNO,B.Adate,A.Dbno,A.Dbdt,A.DbAmt,A.Dbnarr,b.Aratecy,Akgs,TOTLANDCOST,B.DBAMT,ALLOWANCE,a.billno,a.billdt,isnull(a.pjamt,0) as pjamt,b.Debitper,b.dbReason ,a.cgstper,a.sgstper,a.igstper ,b.cgstamt,b.sgstamt,b.igstamt,b.dbtaxableAmt,b.dbBillNo,b.DBdate,b.roff ,B.TCS_PER,B.TCS_AMT  from rm_lot a,rm_lotallowance b" & _
                                          " WHERE a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.DIVCODE='" & Divcode & "' AND OPFLG='N' AND b.adate BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' ORDER BY B.ASNO,B.ADATE ", DB, adOpenStatic, adLockBatchOptimistic
                    End If
                End If
            End If
            ...
            'DB.Execute "Update rm_lot set NETWT=" & val(txtFields(18).Text) & ",pjamt=" & adoPrimaryRS("pjamt") & ",Allowance=isnull(Allowance,0)+" & val(txtFields(10).Text) & " ,Ratekg=" & val(txtFields(19).Text) & ",totlandcost='" & val(txtFields(11).Text) & "',Asno=" & val(txtFields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "'  WHERE lotno='" & txtFields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and lotyear='" & Year(yfdate) & "' and divcode='" & Divcode & "'"
              ' strSQL = "Update rm_lot set NETWT=" & val(txtfields(18).Text) & ",Allowance=isnull(Allowance,0)+" & val(txtfields(10).Text) & " ,Ratekg=" & Round(val(txtfields(25).Text) / val(txtfields(18).Text), 4) & ",totlandcost='" & val(txtfields(25).Text) & "',Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "', dbamt = isnull(dbamt,0)+ " & val(txtfields(20).Text) & "  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and lotyear='" & Year(yfdate) & "' and divcode='" & Divcode & "'"
                ' commented on 19.03.25
             'strSQL = "Update rm_lot set NETWT=" & val(txtfields(18).Text) & ",Allowance=isnull(Allowance,0)+" & val(txtfields(10).Text) & " ,Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "', dbamt = isnull(dbamt,0)+ " & val(txtfields(20).Text) & "  WHERE lotno='" & txtfields(0).Text & "' AND OPFLG='N'  and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and divcode='" & Divcode & "'"
  ...
  ' commented on 19.03.25
  '           strSQL = "Update rm_lot set NETWT= " & val(txtfields(18).Text) & ",Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "' WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' AND OPFLG='N'   and divcode='" & Divcode & "'" '' and lotyear='" & Year(yfdate) & "'

             strSQL = "Update rm_lot set Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "' WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' AND OPFLG='N'   and divcode='" & Divcode & "'" '' and lotyear='" & Year(yfdate) & "'
               DB.Execute strSQL
            End If
            ...
            If val(txtfields(10).Text) > 0 Then
                ...
                TotNetWT = 0
                Set rsb = New Recordset
                rsb.Open "select distinct baleno from rm_bale where isqty is null and lotno ='" & adoPrimaryRS("lotno") & "' and lotdt='" & Format(adoPrimaryRS("lotdt"), "yyyy-mm-dd") & "' and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' order by 1", DB, adOpenStatic
                If rsb.RecordCount > 0 Then
                    Do While rsb.EOF = False
                        If rsb.AbsolutePosition = rsb.RecordCount Then
                            netwt = val(txtfields(10).Text) - TotNetWT
                        End If
                        DB.Execute "Update rm_bale set NETWT=ISNULL(NETWT,0)- " & netwt & ",Allowance=" & netwt & " where baleno=" & rsb("baleno") & " and lotno ='" & adoPrimaryRS("lotno") & "' and lotdt='" & Format(adoPrimaryRS("lotdt"), "yyyy-mm-dd") & "' and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' and divcode='" & Divcode & "'"
        ...
        If Opt = "mod" Then
            ...
            DB.BeginTrans
            Set rsb = New Recordset
            rsb.Open "SELECT BILLNO,pjtc FROM RM_LOT WHERE  opflg='N' and BILLNO<>'' AND BILLNO IS NOT NULL AND lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' ", DB, adOpenStatic '''lotyear='" & Year(yfdate) & "' and
            If rsb.RecordCount > 0 Then
                Set RsDb = New Recordset
                RsDb.Open "Select ISNULL(Fainstal,'N'), ISNULL(Fatfr,'N') FROM In_Para", DB, adOpenStatic
                FaInstall = RsDb(0): FaTfr = RsDb(1)
                If FaInstall = "Y" Then
                    ...
                    If a = 6 Then
                        ...
                        Vno = Raise_DBNoteWithGST(DB, Opt, Trim(txtfields(49).Text), val(txtfields(37).Text), val(txtfields(38).Text), val(txtfields(39).Text), val(txtfields(43).Text), val(rsb("pjtc")), txtfields(1).Text, val(txtfields(20).Text), MaskEdBox2.Text, CStr(nar1), val(txtfields(45).Text), val(txtfields(50).Text))
...
'
           ...
           ' strQry = "Update rm_lot set netwt= grswgt - TAREWT  + " & val(txtfields(10).Text) & ",dbamt= dbamt - " & dblAlAmt & " + (" & val(txtfields(20).Text) & "), Allowance=" & val(txtfields(10).Text) & " ,Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "'  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and lotyear='" & Year(yfdate) & "' and divcode='" & Divcode & "'"
            ...
            strQry = "Update rm_lot set dbamt= dbamt - " & dblAlAmt & " + (" & val(txtfields(20).Text) & "), Allowance=" & val(txtfields(10).Text) & " ,Asno=" & val(txtfields(22).Text) & ",Adate='" & Format(MaskEdBox2.Text, "yyyy-mm-dd") & "'  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and lotyear='" & Year(yfdate) & "' and divcode='" & Divcode & "'"
        ...
        msg = MsgBox("Do you want to delete this record?", vbYesNo, head)
            If msg = vbYes Then
                DB.BeginTrans
                Set rsa = New Recordset
                rsa.Open "select dbno,dbdt,dbtc,isnull(dbamt,0) as dbamt,isnull(totlandcost,0) as totlandcost from rm_lot where dbno is not null and lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and opflg='N'", DB, adOpenStatic  'and lotyear='" & Year(yfdate) & "'
                
                If rsa.RecordCount > 0 Then
                    tlandcost = val(rsa("totlandcost")) - val(rsa("dbamt"))
                    
                Set TmpRs = New Recordset
                TmpRs.Open "select A.Lotno,A.Lotdt,A.Supcd,A.Varcode,A.Grswgt,A.Tarewt,A.Netwt,A.Moiture,A.Ratecy,A.Ratekg,A.Bales,A.Issbal,C.Asno,C.Adate,A.Pjamt,A.Totlandcost,A.Allowance as allow,c.akgs as Allowance,c.dbamt,A.billno,A.billdt,A.plotno,isnull(A.pjamt,0) as pjamt,a.cgstper,a.sgstper,a.igstper ,c.cgstamt,c.sgstamt,c.igstamt,c.dbtaxableAmt ,c.dbBillNo,c.DBdate,c.roff ,c.ACGSTAMT,c.ASGSTAMT,c.AIGSTAMT,C.TCS_PER,C.TCS_AMT,c.ATCSAMT  " & _
                            " FROM RM_LOT A,FA_SLMAS B , RM_LOTALLOWANCE C WHERE A.LOTNO=C.LOTNO AND A.LOTDT=C.LOTDT AND A.DIVCODE=C.DIVCODE AND A.SUPCD=B.SLCODE and C.adate='" & Format(LookUp.Fields(3), "yyyy-mm-dd") & "' and A.DIVCODE='" & Divcode & "' AND OPFLG='N' AND c.adate BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND A.lotno='" & LookUp.Fields(0) & "' and A.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic  ''  AND A.LOTYEAR='" & Year(yfdate) & "'   ''AND A.LOTYEAR='" & Year(yfdate) & "'
                            
                Set tmprs1 = New Recordset
                tmprs1.Open "select sum(c.dbamt),sum(c.dbno) FROM RM_LOT A,FA_SLMAS B , RM_LOTALLOWANCE C WHERE A.LOTNO=C.LOTNO AND A.LOTDT=C.LOTDT AND A.DIVCODE=C.DIVCODE AND A.SUPCD=B.SLCODE and C.adate='" & Format(LookUp.Fields(3), "yyyy-mm-dd") & "' and A.DIVCODE='" & Divcode & "' AND OPFLG='N' AND c.adate BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND A.lotno='" & LookUp.Fields(0) & "' and A.lotdt='" & Format(LookUp.Fields(1), "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic  ''  AND A.LOTYEAR='" & Year(yfdate) & "'   ''AND A.LOTYEAR='" & Year(yfdate) & "'
                            
                If TmpRs.RecordCount > 1 Then
                    DB.Execute "Update rm_lot set dbamt='" & tmprs1(0) - adoPrimaryRS("dbamt") & "',dbno='" & tmprs1(1) - LookUp.Fields(4) & "' WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "' and opflg='N'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' and Divcode ='" & Divcode & "'"
                Else
                  
                    DB.Execute "Update rm_lot set dbno=null ,dbdt=null,dbamt=null, dbnarr=null," & _
                    " dbtc=null,Abales=null,Adate=null,Aratecy=null,ArateKg=null,Afratekg=null WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "' and opflg='N'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' and Divcode ='" & Divcode & "'"
                End If
                Else
                ...
                dbFatc = RsDb(0)
                    ...
                    DB.Execute "delete from Fa_Jvhead where vocno='" & val(txtfields(49).Text) & "' and vocdt='" & Format(MaskEdBox4.Text, "yyyy-mm-dd") & "' and tc='" & dbFatc & "' "
                    DB.Execute "delete from Fa_Jvline where vocno='" & val(txtfields(49).Text) & "' and vocdt='" & Format(MaskEdBox4.Text, "yyyy-mm-dd") & "' and tc='" & dbFatc & "' "
                ...
                Call CalcDebit(CDbl(Ratekg_Cal), CDbl(netwt), adoPrimaryRS("lotno"), adoPrimaryRS("lotdt"))
                  ' commented on 19.03.25
'                  strSQL = "Update rm_lot set ratecy='" & RATECY & "' ,NETWT=" & netwt & ",pjamt=" & val(txtfields(16).Text) & ",Allowance=isnull(Allowance,0)-" & val(txtfields(10).Text) & " ,Ratekg=" & val(txtfields(19).Text) & ",totlandcost='" & val(txtfields(11).Text) & "'  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'   and divcode='" & Divcode & "'"   ''and lotyear='" & Year(yfdate) & "'

               strSQL = "Update rm_lot set Allowance=isnull(Allowance,0)-" & val(txtfields(10).Text) & "   WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'   and divcode='" & Divcode & "'"   ''and lotyear='" & Year(yfdate) & "'
               
               If TmpRs.RecordCount > 1 Then
               ' commented on 19.03.25
                 'DB.Execute "Update rm_lot set ratecy='" & RATECY & "' ,NETWT=" & netwt & ", pjamt=" & val(txtfields(16).Text) & ",Allowance=isnull(Allowance,0)-(" & val(txtfields(10).Text) & ") ,Ratekg=" & val(txtfields(19).Text) & ",totlandcost=" & tlandcost & "  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and opflg='N' and divcode='" & Divcode & "'"

                 DB.Execute "Update rm_lot set Allowance=isnull(Allowance,0)-(" & val(txtfields(10).Text) & ")  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and opflg='N' and divcode='" & Divcode & "'"
               Else
               ' commented on 19.03.25
         '      DB.Execute "Update rm_lot set ratecy='" & RATECY & "' ,NETWT=" & netwt & ",dbno=null ,dbdt=null,dbamt=null, dbnarr=null,dbtc=null,Abales=null,Adate=null,Aratecy=null,ArateKg=null,Afratekg=null,pjamt=" & val(txtfields(16).Text) & ",Allowance=isnull(Allowance,0)-(" & val(txtfields(10).Text) & ") ,Ratekg=" & val(txtfields(19).Text) & ",totlandcost=" & tlandcost & "  WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and opflg='N' and divcode='" & Divcode & "'"

                DB.Execute "Update rm_lot set dbno=null ,dbdt=null,dbamt=null, dbnarr=null,dbtc=null,Abales=null,Adate=null,Aratecy=null,ArateKg=null,Afratekg=null,Allowance=isnull(Allowance,0)-(" & val(txtfields(10).Text) & ")   WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'  and opflg='N' and divcode='" & Divcode & "'"
               End If
...
'                strSQL = "Update rm_bale set Netwt=netwt+(isnull(Allowance,0)*-1) ,Allowance=0 WHERE lotno='" & txtFields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' "
                DB.Execute "Update rm_bale set Netwt=netwt+(isnull(Allowance,0)*-1) ,Allowance=0 WHERE lotno='" & txtfields(0).Text & "' and lotdt ='" & Format(MaskEdBox1.Text, "yyyy-mm-dd") & "'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' "
...
Case "LOTNO"
    ...
    adoPrimaryRS.Open "select Lotno,Lotdt,Supcd,Varcode,Grswgt,Tarewt,Netwt,Moiture,Ratecy,Ratekg,Bales,Issbal,Asno,Adate,isnull(pjamt,0) as pjamt,Totlandcost,Allowance from rm_lot WHERE DIVCODE='" & Divcode & "' AND OPFLG='N' AND LOTDT BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND LOTYEAR='" & Year(yfdate) & "' AND lotno='" & KSLLIST1.Code & "' and lotdt='" & Format(KSLLIST1.Description, "yyyy-mm-dd") & "' ", DB, adOpenStatic, adLockBatchOptimistic
      ...
      Call bindcontls
       Set RRs = New Recordset
            RRs.Open " select case when isnull(c.dlytype,'')='S' then 'Spot' when isnull(c.dlytype,'')='M' then 'FOR' else '' end as dlytype from " & _
            " rm_lot a left join rm_arrival b on a.lotdt = b.lotdt and a.lotno = b.lotno left join  rm_cont c on b.contno = c.contno left join fa_slmas e  on a.supcd=e.slcode left join fa_slmas f on a.brkcd=f.slcode " & _
            " where " & _
            "    lotyear='" & Year(yfdate) & "'  " & _
...
'                    " WHERE a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.DIVCODE='" & Divcode & "' AND OPFLG='N' AND A.LOTDT BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "' AND LOTYEAR='" & Year(yfdate) & "' ORDER BY B.ASNO,B.ADATE ", DB, adOpenStatic, adLockBatchOptimistic
  adoPrimaryRS.Open "select a.Lotno,a.Lotdt,Supcd,Varcode,Grswgt,Tarewt,Netwt,Moiture,Ratecy,Ratekg,B.Bales,A.Issbal,B.ASNO,B.Adate,A.Dbno,A.Dbdt,B.DbAmt,A.Dbnarr,b.Aratecy,Akgs,TOTLANDCOST,B.DBAMT,ALLOWANCE AS aLLOW,B.AKGS AS ALLOWANCE,a.billno,a.billdt,isnull(a.pjamt,0) as pjamt,a.plotno,b.Debitper,b.dbReason,b.ExTrashPer,b.ExTrashWgt,b.ExMoisturePer,b.ExMoistureWgt,a.cgstper,a.sgstper,a.igstper ,b.cgstamt,b.sgstamt,b.igstamt,b.dbtaxableAmt,b.dbBillNo,b.DBdate,b.roff,B.TCS_PER,B.TCS_AMT from rm_lot a INNER JOIN rm_lotallowance b ON a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode WHERE a.DIVCODE='" & Divcode & "' AND OPFLG='N' AND b.adate BETWEEN '" & Format(yfdate, "YYYY-MM-DD") & "' AND '" & Format(yldate, "YYYY-MM-DD") & "'  ", DB, adOpenStatic, adLockBatchOptimistic  ''AND LOTYEAR='" & Year(yfdate) & "'
...
End Select
    ...
    If Index = 10 Or Index = 28 Or Index = 29 Or Index = 43 Then 'Kgs
'        If val(TXTFIELDS(10).Text) <> 0 Then
...
Else
rsa.Open "select CATCD,TOTLANDCOST,isnull(Vatamt,0)+isnull(taxamt,0)+isnull(odint,0)+isnull(freght,0)+isnull(ldgulg,0)+isnull(brkcom,0)+isnull(dnamt1,0)+isnull(dnamt2,0)+isnull(insamt,0)+isnull(bedamt,0)+isnull(spotexp,0) from rm_lot where lotno='" & lotno & "' and lotdt ='" & Format(LOTDT, "yyyy-mm-dd") & "' and opflg='N'  and lotdt between '" & Format(yfdate - 120, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' ", DB, adOpenStatic ''and lotyear='" & Year(yfdate) & "'
End If
If rsa.RecordCount > 0 Then
...
Else
Rs.Open "select ratecy,ratekg from rm_lot where lotno='" & lotno & "' and lotdt='" & Format(LOTDT, "yyyy-MM-dd") & "' and divcode='" & Divcode & "' and opflg='N'", DB, adOpenStatic  ''and lotyear='" & Year(yfdate) & "'
End If
If Rs.RecordCount > 0 Then
