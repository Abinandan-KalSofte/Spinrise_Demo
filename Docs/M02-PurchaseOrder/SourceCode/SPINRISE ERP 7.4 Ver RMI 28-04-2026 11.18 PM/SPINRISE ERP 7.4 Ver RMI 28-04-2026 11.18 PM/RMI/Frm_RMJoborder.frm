...
Begin VB.Form Frm_RMJoborder 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "Tab 0"
         TabPicture(0)   =   "Frm_RMJoborder.frx":0000
      ...
      Begin FPSpreadADO.fpSpread SpdOrdDetail 
         ...
         SpreadDesigner  =   "Frm_RMJoborder.frx":001C
         Appearance      =   2
      End
      Begin VB.Label lblLabels 
         AutoSize        =   -1  'True
   ...
   Begin VB.Frame Frame8 
      ...
      Begin FPSpreadADO.fpSpread spdPO1 
         ...
         EndProperty
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "Frm_RMJoborder.frx":0477
         Appearance      =   1
      End
      Begin FPSpreadADO.fpSpread spdPO 
         ...
         ProcessTab      =   -1  'True
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "Frm_RMJoborder.frx":08A8
         Appearance      =   2
      End
   ...
   Begin VB.Frame FraMain 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "Frm_RMJoborder.frx":0D03
      End
      ...
      Begin FPSpreadADO.fpSpread SPDBALEDETAILS 
         ...
         ProcessTab      =   -1  'True
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "Frm_RMJoborder.frx":1157
         Appearance      =   2
      End
      Begin VB.Label lblLabels 
         AutoSize        =   -1  'True
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   14
         Left            =   7275
         Picture         =   "Frm_RMJoborder.frx":15B2
         Style           =   1  'Graphical
         TabIndex        =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   13
         Left            =   5295
         Picture         =   "Frm_RMJoborder.frx":19F4
         Style           =   1  'Graphical
         TabIndex        =   34
         ToolTipText     =   "G.R.N"
         Top             =   120
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   4
         Left            =   11295
         Picture         =   "Frm_RMJoborder.frx":1E36
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":21CD
         Height          =   510
         Index           =   3
         Left            =   1620
         Picture         =   "Frm_RMJoborder.frx":24D7
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   8970
         Picture         =   "Frm_RMJoborder.frx":286C
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":2CAE
         Height          =   510
         Index           =   8
         Left            =   3720
         Picture         =   "Frm_RMJoborder.frx":30F8
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":345A
         Height          =   510
         Index           =   10
         Left            =   4770
         Picture         =   "Frm_RMJoborder.frx":3764
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":3AE0
         Height          =   510
         Index           =   9
         Left            =   4245
         Picture         =   "Frm_RMJoborder.frx":3DEA
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":418C
         Height          =   510
         Index           =   11
         Left            =   5840
         Picture         =   "Frm_RMJoborder.frx":45D6
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":496B
         Height          =   510
         Index           =   7
         Left            =   3195
         Picture         =   "Frm_RMJoborder.frx":4DB5
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":5105
         Height          =   510
         Index           =   5
         Left            =   2145
         Picture         =   "Frm_RMJoborder.frx":554F
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":58B4
         Height          =   510
         Index           =   0
         Left            =   45
         Picture         =   "Frm_RMJoborder.frx":5BBE
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":5F51
         Height          =   510
         Index           =   6
         Left            =   2685
         Picture         =   "Frm_RMJoborder.frx":639B
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":66E8
         Height          =   510
         Index           =   1
         Left            =   570
         Picture         =   "Frm_RMJoborder.frx":69F2
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "Frm_RMJoborder.frx":6D6C
         BeginProperty Font 
            Name            =   "System"
            Size            =   9.75
            Charset         =   0
         ...
         Index           =   2
         Left            =   1095
         Picture         =   "Frm_RMJoborder.frx":7076
         Style           =   1  'Graphical
         TabIndex        =   16
   ...
   End
End
Attribute VB_Name = "Frm_RMJoborder"
...
'            .SetText eORDDtls.E_SizeinCM, RW, adoSecondaryRS("SizeinCM")
        '    .SetText eORDDtls.E_PRSno, RW, adoSecondaryRS("PRSno")
            ...
            .SetText eORDDtls.E_POQuantity, RW, adoSecondaryRS("POQuantity")
'            .SetText eORDDtls.E_PackPer, RW, adoSecondaryRS("PackPerQty")
'            .SetText eORDDtls.E_ExPcs, RW, adoSecondaryRS("Looseqty")
            .SetText eORDDtls.E_TotPacks, RW, adoSecondaryRS("rolls")
            .SetText eORDDtls.E_Rate, RW, adoSecondaryRS("Rate")
            .SetText eORDDtls.E_InvQty, RW, adoSecondaryRS("POQuantity")
...
'            .SetText BBaleDtls.B_POQuantity, RW, adoSecondaryRS1("POQuantity")
...
'     End With
  ...
  If opt = "" Or opt = " " Or opt = "mod" Or opt = "fnd" Or opt = "del" Then
     If adoPrimaryRS.EOF = False And adoPrimaryRS.BOF = False Then
        ...
        End If
'
'        If IsNull(adoPrimaryRS("LR_Date")) = False Or adoPrimaryRS("LR_Date") = "" Then
'            MaskEdBox1(1).Text = Format(adoPrimaryRS("LR_Date"), "dd/mm/yyyy")
'        Else
'            MaskEdBox1(1).Text = "__/__/____"
'        End If
        
'        If IsNull(adoPrimaryRS("Saleorder_Date")) = False Or adoPrimaryRS("Saleorder_Date") = "" Then
'            MaskEdBox1(5).Text = Format(adoPrimaryRS("Saleorder_Date"), "dd/mm/yyyy")
'        Else
...
Case 0
       ...
       On Error Resume Next
        ...
        adoPrimaryRS.Open "select a.kn_jobordid,a.kn_progid,a.kn_divcode,a.kn_docno,a.kn_docdt,a.kn_prgdocno,a.kn_prgdocdt,a.kn_cust_code,a.VendorID,a.kn_ojcno,a.Remarks,a.ORDREFNO,a.VechicleNo,a.AgentCode,a.uom,a.inv_type,a.inv_no,a.ig_cust_code,a.ig_pono,a.IG_DATE,HostID,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,TotQty,TotPacks,Mat_Amt,Disc_Per,Disc_Amt,Other_Amt,Freight_Amt,ins_Amt,Taxable_Amt,Tax_Amt,CGSTAmt,SGSTAmt,IGSTAmt,TCS_Per,TCS_amt,Roff_amt,TotalAmt from kn_jobordhd a where 1=2 ", DB, adOpenStatic, adLockBatchOptimistic
    
        adoSecondaryRS.Open "select distinct d.kn_sno, d.kn_fabric_code, p.description, d.kn_jobordqty,d.kn_Weight,d.kn_rate, d.kn_deliverydate, d.kn_contsno, d.kn_jobordqtytrn,d.PSNO from kn_joborddt d, kn_productknitted p where  d.kn_FABRIC_CODE=p.CODE  and  1 =2", DB, adOpenStatic, adLockBatchOptimistic
...
Case 1 'modification
       ...
       If Record_Exists("KN_POhd Where Docdate between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' And divcode = '" & Divcode & "'") = False Then Exit Sub
        opt = "mod"
        desc.Caption = "Modification"
        sp = " "
        lSuppSel = True
        LookUp.Clear = True
        LookUp.query = "SELECT Distinct h.docno ""Doc.No."",h.Docdate ""Doc. Date"",s.slname ""Supplier Name"",s.City,h.slcode ""Supplier Code"" ,s.Supptype,isnull(GSTINNO,'0') GSTINNO,isnull(GSTSTATECODE,'0') GSTSTATECODE FROM  KN_POhd h inner join KN_POdt l on h.divcode = l.divcode and h.docno = l.docno And h.docdate = l.docdate inner join FA_SLMAS s on h.slcode = s.slcode  Where h.divcode = '" & Divcode & "'   and h.Docdate  between '" & Format(yfdate, "yyyy-mm-dd") & "'  and '" & Format(yldate, "yyyy-mm-dd") & "' and h.docno not in(select w.docno from KN_POdt w where w.docno=h.docno and w.docdate=h.docdate and w.divcode=h.divcode and isnull(w.RCDQty,0) >0)  and isnull(l.RCDQty,0) =0 and isnull(orderconfirm,'N')<>'Y'"
        LookUp.Caption = "Receipt Listing"
...
Case 2
        'Deletion
       ' If ToValidFinYear = False Then Exit Sub
        If Record_Exists("KN_POdt Where Docdate between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' And divcode = '" & Divcode & "'") = False Then Exit Sub
        opt = "del"
        ...
        LookUp.Clear = True
        'LookUp.query = "SELECT Distinct h.docno ""Doc.No."",h.Docdate ""Doc. Date"",s.slname ""Supplier Name"",s.City,h.slcode ""Supplier Code"" ,s.Supptype,isnull(GSTINNO,'0') GSTINNO,isnull(GSTSTATECODE,'0') GSTSTATECODE FROM  KN_POhd h,fa_purjvhead l, FA_SLMAS s Where h.divcode = '" & divcode & "'  And h.divcode = l.divcode and h.pjno = l.vocno And h.pjdt = l.vocdt and h.pjtc=l.tc and h.slcode = s.slcode and h.Docdate  between '" & Format(yfdate, "yyyy-mm-dd") & "'  and '" & Format(yldate, "yyyy-mm-dd") & "'   and l.appflg is null "
        LookUp.query = "SELECT Distinct h.docno ""Doc.No."",h.Docdate ""Doc. Date"",s.slname ""Supplier Name"",s.City,h.slcode ""Supplier Code"" ,s.Supptype,isnull(GSTINNO,'0') GSTINNO,isnull(GSTSTATECODE,'0') GSTSTATECODE FROM  KN_POhd h inner join KN_POdt l on h.divcode = l.divcode and h.docno = l.docno And h.docdate = l.docdate inner join FA_SLMAS s on h.slcode = s.slcode  Where h.divcode = '" & Divcode & "'   and h.Docdate  between '" & Format(yfdate, "yyyy-mm-dd") & "'  and '" & Format(yldate, "yyyy-mm-dd") & "' and h.docno not in(select w.docno from KN_POdt w where w.docno=h.docno and w.docdate=h.docdate and w.divcode=h.divcode and isnull(w.RCDQty,0) >0)  and isnull(l.RCDQty,0) =0 and isnull(orderconfirm,'N')<>'Y'"
        LookUp.Caption = "Receipt Listing"
        LookUp.DefCol = "Doc.No."
        LookUp.ALIGN = "1000,1100,5000,1500,0"
...
Case 3
        ...
        LookUp.Clear = True
        LookUp.query = "SELECT Distinct h.docno ""OC.No."",h.Docdate ""Date"",s.slname ""Supplier Name"",s.City,h.slcode ""Supplier Code"" FROM  KN_POhd h,KN_POdt l, FA_SLMAS s Where h.divcode = '" & Divcode & "'  And h.divcode = l.divcode and h.docno = l.docno And h.Docdate = l.Docdate and h.slcode = s.slcode and h.Docdate  between '" & Format(yfdate, "yyyy-mm-dd") & "'  and '" & Format(yldate, "yyyy-mm-dd") & "' Order by h.docno"
...
'            End If
            ...
            If Trim(txtfields(13).Text) = "" Then
                MsgBox "Please select Sale Order No.", vbInformation, head
            ...
            With SpdOrdDetail
                For RW = 1 To .MaxRows
                    .Row = RW
                    If val(GetText(SpdOrdDetail, E_POQuantity, RW)) > 0 Then
                        ...
                        If val(GetText(SpdOrdDetail, E_ORDBalQty, RW)) < val(GetText(SpdOrdDetail, E_POQuantity, RW)) Then
                            opt = tmp
                            .Col = E_POQuantity
                            MsgBox "Order Quantity Should Be Less than Balance Qrt. Entered For " & GetText(SpdOrdDetail, E_Itemname, .Row), vbInformation, head
                            SpdOrdDetail.SetActiveCell E_POQuantity, .Row
                            SpdOrdDetail.SetFocus
                            Exit Sub
                        End If
                        
                        If Trim(GetText(SpdOrdDetail, E_Product_code, RW)) = "" And val(GetText(SpdOrdDetail, E_POQuantity, RW)) > 0 Then
                            opt = tmp
                           ' .Col = E_Product_code
...
'
'                    If Val(GetText(SPDBALEDETAILS, B_POQuantity, nRow1)) > 0 And Val(GetText(SPDBALEDETAILS, B_PACKNo, nRow1)) > 0 Then
'                        nBNoofBale = nBNoofBale + 1
'                        nBTotalinvqty = nBTotalinvqty + Val(GetText(SPDBALEDETAILS, B_POQuantity, nRow1))
...
'            txtfields(9).Text = Format(nBTotalGross, "#0.000")
            ...
            For nRow = 1 To SpdOrdDetail.MaxRows
                ...
                If val(GetText(SpdOrdDetail, E_POQuantity, nRow)) > 0 Or val(GetText(SpdOrdDetail, E_TotPacks, nRow)) > 0 Then
                    nPOQuantity = nPOQuantity + val(GetText(SpdOrdDetail, E_POQuantity, nRow))
...
'                            End If
'
'                            If Val(GetText(SpdOrdDetail, E_POQuantity, nRow)) <> nBTotalinvqty Then
...
'                    If Val(GetText(SPDBALEDETAILS, B_POQuantity, nRow)) > 0 And Val(GetText(SPDBALEDETAILS, B_PACKNo, nRow)) > 0 Then
...
'
'
'                If nPOQuantity <> Val(txtfields(12).Text) Then
'
'                    MsgBox "Pack Wise Net weight and Total Net Weight should be matched", vbInformation, head
'                     Opt = tmp
'                    Exit Sub
...
'                    JRS.Open " Select max(pjno) from KN_POhd where divcode = '" & divcode & "'" & _
...
'            If MaskEdBox1(5).Text <> "__/__/____" And IsDate(MaskEdBox1(5).Text) = True Then
'                adoPrimaryRS("Saleorder_Date") = Format(MaskEdBox1(5).Text, "yyyy-mm-dd")
'            End If
'            adoPrimaryRS("Saleorder_Type") = Trim(Trim(txtfields(6).Text))
'            adoPrimaryRS("Saleorder_No") = Trim(Trim(txtfields(13).Text))
          ...
          '  adoPrimaryRS("Vehicle_No") = Trim(txtfields(8).Text)
           ' adoPrimaryRS("TotLooseQty") = Val(txtfields(11).Text)
            ...
            ''================
            If opt = "mod" Then
                DB.Execute "Delete From KN_POdt Where Divcode='" & Divcode & "' And docno=" & adoPrimaryRS("docno") & " And Docdate='" & Format(adoPrimaryRS("Docdate"), "yyyy-mm-dd") & "' "
                Set rsch = New Recordset
                rsch.Open "select psno,POQuantity from KN_POdt Where Divcode='" & Divcode & "' And docno=" & adoPrimaryRS("docno") & " And Docdate='" & Format(adoPrimaryRS("Docdate"), "yyyy-mm-dd") & "' ", DB, adOpenStatic
            ...
            rstail.Open " SELECT a.DivCode,a.DocNo,a.DocDate,a.DocSno,a.product_name,a.Product_code,a.uom,a.Rolls,a.POQuantity,a.Rate,a.Value,a.remarks,a.Disc_Per,a.Disc_Amt,a.Tax_Code,a.Taxable_Amt,a.Cgstper,a.CGSTAmt,a.Sgstper,a.SGSTAmt,a.Igstper,a.IGSTAmt,a.TCS_Per,a.TCS_amt,a.TotalAmt ,ins_Amt,Other_Amt,Freight_Amt,a.hsn,PSNO,NetRate,a.OrdBalQty FROM KN_POdt a  WHERE divcode='" & Divcode & "' And 1=2", DB, adOpenStatic, adLockBatchOptimistic
                        
            nSno = 1
            For nRow = 1 To SpdOrdDetail.MaxRows
                SpdOrdDetail.Row = nRow
                SpdOrdDetail.SetActiveCell E_POQuantity, nRow
                If val(GetText(SpdOrdDetail, E_POQuantity, nRow)) > 0 Then
                    rstail.AddNew
...
'                    rstail("SizeInInch") = Val(GetText(SpdOrdDetail, E_SizeinInch, nRow))
'                    rstail("SizeinCM") = Val(GetText(SpdOrdDetail, E_SizeinCM, nRow))
                    ...
                    rstail("Rolls") = val(GetText(SpdOrdDetail, E_TotPacks, nRow))
...
'                    rstail("Looseqty") = Val(GetText(SpdOrdDetail, E_ExPcs, nRow))
                    ...
                    rstail("POQuantity") = val(GetText(SpdOrdDetail, E_POQuantity, nRow))
                 '   rstail("FavourableWt") = Val(GetText(SpdOrdDetail, E_POQuantity, nRow))
                   ...
                   ' rstail("God_Code") = Trim(Trim(txtfields(13).Text))
                    rstail("NetRate") = val(GetText(SpdOrdDetail, E_Netrate, nRow)) 'Format(Val(GetText(SpdOrdDetail, E_AssValue, nRow)) / Val(GetText(SpdOrdDetail, E_POQuantity, nRow)), "#0.00")
...
'
                    ...
                    DB.Execute "update KN_contdt set  progqty=isnull(progqty,0)+" & val(GetText(SpdOrdDetail, E_POQuantity, nRow)) & " , POQty=isnull(POQty,0)+" & val(GetText(SpdOrdDetail, E_POQuantity, nRow)) & " where  Divcode='" & Divcode & "' and cont_no='" & Trim(txtfields(13).Text) & "' and cont_type='" & Trim(txtfields(6).Text) & "' and psno='" & val(GetText(SpdOrdDetail, E_PSNO, nRow)) & "'"
                    ...
                    TrnLog("Cont_type") = Trim(txtfields(6).Text)
                    TrnLog("ContNo") = Trim(txtfields(13).Text)
                   ' TrnLog("Contdt") = Format(MaskEdBox1(5).Text, "yyyy-MM-dd")
                    ...
                    TrnLog("Quantity") = val(GetText(SpdOrdDetail, E_POQuantity, nRow))
...
'
'            rsTail1.Open " SELECT DivCode,a.DocNo,a.DocDate,a.DocSno,a.PDocSno,a.Product_code,a.uom,a.POQuantity,a.Pack_NO,a.Rate,a.Value FROM RM_ConeReceiptPack a Where DivCode='" & divcode & "' And 1=2", DB, adOpenStatic, adLockBatchOptimistic
'
'            nSno = 1
'            For nRow = 1 To SPDBALEDETAILS.MaxRows
'                SPDBALEDETAILS.Row = nRow
'                SPDBALEDETAILS.SetActiveCell B_PackPerQty, nRow
'                If Val(GetText(SPDBALEDETAILS, B_PACKNo, nRow)) > 0 And Val(GetText(SPDBALEDETAILS, B_POQuantity, nRow)) > 0 Then
'                    rsTail1.AddNew
...
'                    rsTail1("POQuantity") = Val(GetText(SPDBALEDETAILS, B_POQuantity, nRow))
''                    rsTail1("FavourableWt") = Val(GetText(SPDBALEDETAILS, B_POQuantity, nRow))
'
...
'                          rsTail1("rate") = Format(Val(GetText(SpdOrdDetail, E_AssValue, nRow1)) / Val(GetText(SpdOrdDetail, E_POQuantity, nRow1)), "#0.00")
'                        End If
'                    Next
'
'                    rsTail1("value") = Val(GetText(SPDBALEDETAILS, B_POQuantity, nRow)) * Val(rsTail1("rate") & "")
'
'
'              End If
'                    nSno = nSno + 1
...
'
            ...
            If opt = "add" Then
                MsgBox "PO Entry No. for your transaction is " & adoPrimaryRS("docno"), vbInformation, head
            Else
        ...
        If opt = "del" Then     'del
            ...
            If MsgBox("Are You Sure You want to Delete this Record ?", vbYesNo, head) = vbYes Then
               ...
               ' DB.Execute ("DELETE FROM RM_ConeReceiptPack WHERE Divcode = '" & divcode & "'  AND docno =  " & Val(txtfields(2).Text) & " and Docdate = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'")
                DB.Execute ("DELETE FROM KN_POdt WHERE Divcode = '" & Divcode & "'  AND docno =  " & val(txtfields(2).Text) & " and Docdate = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'")
                DB.Execute ("DELETE FROM KN_POhd WHERE DivCode = '" & Divcode & "' And docno =  " & val(txtfields(2).Text) & " and Docdate = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'")
...
Case 13, 14
   ...
   Set POrder.cryRept = Cry_UniconePO
...
'    rsHead.Open " Select Distinct L.DivCode,PRNo,PRDt FROM KN_POdt L, PO_TYPE T" & _
...
Call SpreadAlignBale(0)
    Dim UPBaleno, UPLooseqty, UPPOQuantity, UPPackPerQty, UpLotno, UPMoisture, UpInvWt, TotLooseQty, TotPacks, TOTQty, TotInvWt As Double
...
'                End If
                ...
                UPPOQuantity = Trim(GetText(spdView, 5, RW) & "")
                ...
                SPDBALEDETAILS.SetText BBaleDtls.B_POQuantity, SNO, UPPOQuantity
  ...
  If opt = "add" Then
        ...
        With SpdOrdDetail
            ...
            If .ActiveCol = eORDDtls.E_Itemname And (KeyAscii = 9 Or KeyAscii = 13) Then
             ...
             End If
'            If ((.ActiveCol = eORDDtls.E_PackPer) Or (.ActiveCol = eORDDtls.E_POQuantity)) And (KeyAscii = 9 Or KeyAscii = 13) Then
'               ' .SetText eORDDtls.E_TotPacks, .ActiveRow, CStr(Val(GetText(SpdOrdDetail, eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow)) / Val(GetText(SpdOrdDetail, eORDDtls.E_PackPer, SpdOrdDetail.ActiveRow)))
'            End If
...
totbal = 0: totbal = 0
        If spdPO.ActiveCol = ePODtls.P_Looseqty Or spdPO.ActiveCol = ePODtls.P_PackPerQty Or spdPO.ActiveCol = ePODtls.P_POQuantity Then
              With spdPO
                    For nRow = 1 To .MaxRows
                        .Row = nRow
                      If val(Trim(GetText(spdPO, ePODtls.P_PACKNO, .Row))) > 0 And val(Trim(GetText(spdPO, ePODtls.P_POQuantity, .Row))) > 0 Then
                        totnqty = totnqty + val(Trim(GetText(spdPO, ePODtls.P_POQuantity, .Row)))
                        totbal = totbal + 1
  ...
  With spdPO
      If .ActiveCol = ePODtls.P_POQuantity And val(GetText(SpdOrdDetail, E_TotPacks, SpdOrdDetail.ActiveRow)) <> .MaxRows Then
...
If opt = "add" Or opt = "mod" Then
     If ((Col = ePODtls.P_PackPerQty) Or (Col = ePODtls.P_Looseqty)) Then
                spdPO.SetText ePODtls.P_POQuantity, spdPO.ActiveRow, CStr(val(GetText(spdPO, ePODtls.P_PackPerQty, spdPO.ActiveRow)) - val(GetText(spdPO, ePODtls.P_Looseqty, spdPO.ActiveRow)))
     End If
End If
...
On Error GoTo Errh
    ...
    If opt = "add" Or opt = "mod" Then
        ...
        With SpdOrdDetail
            If .ActiveCol = eORDDtls.E_packTypedec And KeyCode = 9 And opt = "add" Then
                   Set NEWRSs = New Recordset
...
'                     End If
            ...
            If .ActiveCol = eORDDtls.E_ItemDesc And KeyCode = 9 And opt = "add" Then
                   Set NEWRSs = New Recordset

                    NEWRSs.Open "select a.code [Product Code],c.Product_Name [Product Name],b.description [Pack_Type],c.Pack_type [Pack Type],ISNULL(A.HSN ,'') HSN ,c.PSNO from kn_productknitted a inner join KN_contdt c on c.divcode=a.Divcode and c.fabric_code=a.code   left join ig_packtype b on c.pack_type=b.pack_type where c.cont_no='" & Trim(txtfields(13).Text) & "' and c.product_name = '" & Trim(GetText(SpdOrdDetail, eORDDtls.E_ItemDesc, SpdOrdDetail.ActiveRow)) & "' and c.fabric_CODE = '" & Trim(GetText(SpdOrdDetail, eORDDtls.E_Product_code, SpdOrdDetail.ActiveRow)) & "' and c.cont_type='" & Trim(txtfields(6).Text) & "'  and ((c.kgs  )-(isnull(c.QTY_DELIVERED,0)+isnull(c.QTY_CANCEL,0) +isnull(c.POQty ,0)+ISNULL(c.PROGQTY,0)))>0  and  a.divcode='" & Divcode & "'", DB, adOpenStatic, adLockReadOnly
                    ...
                    If NEWRSs.RecordCount > 0 Then
                       ...
                       ' .SetText eORDDtls.E_UOM, .ActiveRow, NEWRSs("uom")
                        .SetText eORDDtls.E_PSNO, .ActiveRow, CStr(Trim(NEWRSs("PSNO")))
                        .Col = E_SIZEINCM
                        .SetFocus
                    Else
                        nBPSNO = ""
                        For nRow1 = 1 To SpdOrdDetail.MaxRows
                            SpdOrdDetail.Row = nRow1
                            If Trim(GetText(SpdOrdDetail, eORDDtls.E_ItemDesc, nRow1)) <> "" Then
                                nBPSNO = nBPSNO + "," + Trim(GetText(SpdOrdDetail, E_PSNO, nRow1))
                            End If
                        Next
                    
                        LookUp.Clear = True
                        LookUp.query = "select a.code [Product Code],c.Product_Name [Product Name],b.description [Pack_Type],c.Pack_type [Pack Type],ISNULL(A.HSN ,'') HSN , ((c.kgs  )-(isnull(c.QTY_DELIVERED,0)+isnull(c.QTY_CANCEL,0) +ISNULL(c.PROGQTY,0))) Balance_Kgs,c.PSNO from kn_productknitted a inner join KN_contdt c on c.divcode=a.Divcode and c.fabric_code=a.code   left join ig_packtype b on c.pack_type=b.pack_type and c.cont_no='" & Trim(txtfields(13).Text) & "' WHERE c.cont_no='" & Trim(txtfields(13).Text) & "' and c.cont_type='" & Trim(txtfields(6).Text) & "' and  ((c.KGS )-(isnull(c.QTY_DELIVERED,0)+isnull(c.QTY_CANCEL,0) +ISNULL(c.PROGQTY,0)))>0  and  a.divcode='" & Divcode & "' and convert(varchar,c.psno) not in (select items from dbo.split('" & nBPSNO & "',','))"
                        LookUp.Caption = "Product Listing"
                        LookUp.DefCol = "Description"
                        LookUp.ALIGN = "1500,4500"
                        LookUp.Show vbModal
                        If LookUp.Cancel = False Then
                            ...
                            .SetText eORDDtls.E_Itemname, .ActiveRow, CStr(Trim(LookUp.Fields(1)))
                            .SetText eORDDtls.E_ItemDesc, .ActiveRow, CStr(Trim(LookUp.Fields(1)))
...
'                            .SetFocus
            ...
            If ((.ActiveCol = eORDDtls.E_POQuantity)) And KeyCode = 9 Then
                If val(GetText(SpdOrdDetail, eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow)) > val(GetText(SpdOrdDetail, eORDDtls.E_ORDBalQty, SpdOrdDetail.ActiveRow)) Then
                ...
                '.SetText eORDDtls.E_POQuantity, .ActiveRow, CStr(Val(GetText(SpdOrdDetail, eORDDtls.E_PackPer, SpdOrdDetail.ActiveRow)) - Val(GetText(SpdOrdDetail, eORDDtls.E_ExPcs, SpdOrdDetail.ActiveRow)))
                'SpdOrdDetail.SetText eORDDtls.E_TotPacks, SpdOrdDetail.ActiveRow, CStr((Val(GetText(SpdOrdDetail, eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow)) / Val(GetText(SpdOrdDetail, eORDDtls.E_PackPer, SpdOrdDetail.ActiveRow))) + Val(GetText(SpdOrdDetail, eORDDtls.E_ExPcs, SpdOrdDetail.ActiveRow)))
            End If
...
'                    .SetText P_POQuantity, r1, Rs.Fields("POQuantity")
...
'    If Col = eORDDtls.E_POQuantity And Val(GetText(SpdOrdDetail, eORDDtls.E_PackPer, SpdOrdDetail.ActiveRow)) > 0 Then
'           ' SpdOrdDetail.SetText eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow, CStr((Val(GetText(SpdOrdDetail, eORDDtls.E_PackPer, SpdOrdDetail.ActiveRow)) * Val(GetText(SpdOrdDetail, eORDDtls.E_TotPacks, SpdOrdDetail.ActiveRow))) + Val(GetText(SpdOrdDetail, eORDDtls.E_ExPcs, SpdOrdDetail.ActiveRow)))
'            SpdOrdDetail.SetText eORDDtls.E_TotPacks, SpdOrdDetail.ActiveRow, CStr((Val(GetText(SpdOrdDetail, eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow)) / Val(GetText(SpdOrdDetail, eORDDtls.E_PackPer, SpdOrdDetail.ActiveRow))) + Val(GetText(SpdOrdDetail, eORDDtls.E_ExPcs, SpdOrdDetail.ActiveRow)))
'    End If
    If (Col = eORDDtls.E_POQuantity) Then
        If val(GetText(SpdOrdDetail, eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow)) > val(GetText(SpdOrdDetail, eORDDtls.E_ORDBalQty, SpdOrdDetail.ActiveRow)) Then
              '  MsgBox "Order Quantity Cannot be greater than Balance Quantity", vbInformation, head
                SpdOrdDetail.SetText eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow, CStr(val(GetText(SpdOrdDetail, eORDDtls.E_ORDBalQty, SpdOrdDetail.ActiveRow)))
                Exit Sub
        End If
    End If
    
    If Col = E_POQuantity Or Col = E_TCSper Or Col = E_Rate Or Col = E_Netrate Or Col = E_Discrate Or Col = E_DiscValue Then
       Call TotalCal
    End If
    ...
    If val(GetText(SpdOrdDetail, eORDDtls.E_TotPacks, SpdOrdDetail.ActiveRow)) = 0 And Col = eORDDtls.E_TotPacks Then
                ...
                Exit Sub
    End If
      If val(GetText(SpdOrdDetail, eORDDtls.E_POQuantity, SpdOrdDetail.ActiveRow)) = 0 And Col = eORDDtls.E_POQuantity Then
                  SpdOrdDetail.Col = E_POQuantity
                Cancel = True
                Exit Sub
    End If
...
'
'    If Col = E_POQuantity Or Col = E_PackPer Then
...
'    End If
'
'       If Col = E_POQuantity And ARRIVALTYPE = "P" Then
'            a = IContno
'            B = IContdt
'            c = IProduct_code
'            Set rsg = New Recordset
...
'            If Opt = "mod" Then
'                Set rsbal = New Recordset
'                rsbal.Open "select PackPerQty from KN_POdt where docno=" & txtfields(2) & " and docdate='" & Format(MaskEdBox1(0), "yyyy-mm-dd") & "' and  Product_code='" & GetText(SpdOrdDetail, E_Product_code, SpdOrdDetail.ActiveRow) & "' and contno='" & GetText(SpdOrdDetail, E_SizeinInch, SpdOrdDetail.ActiveRow) & "' and contdt='" & Format(GetText(SpdOrdDetail, E_SizeinCM, SpdOrdDetail.ActiveRow), "yyyy-mm-dd") & "' and divcode='" & GetText(SpdOrdDetail, E_HSN, SpdOrdDetail.ActiveRow) & "'", DB, adOpenStatic
'                bal = rsbal("PackPerQty")
'            End If
'
...
'    End If
'    End If
''    If Col = IPOQuantity And spdVar.MaxRows = spdVar.ActiveRow Then
''        BUTTON(9).SetFocus
''        Exit Sub
''    End If
'
...
'            RsBalQty.Open "Select Sum(Quantity) As Qty From KN_POdt WHERE Divcode='" & Divcode & "'  And   PRNo=" & GetText(SpdOrdDetail, E_SizeinInch, SpdOrdDetail.ActiveRow) & " AND PRDt='" & Format(GetText(SpdOrdDetail, E_SizeinCM, SpdOrdDetail.ActiveRow), "YYYY-MM-DD") & "' AND Product_code='" & GetText(SpdOrdDetail, E_Product_code, SpdOrdDetail.ActiveRow) & "' And PRSno=" & GetText(SpdOrdDetail, E_PRSno, SpdOrdDetail.ActiveRow) & " and Docdate between '" & Format(yfdate, "yyyy-mm-dd") & "' And '" & Format(yldate, "yyyy-mm-dd") & "' And docno Not in (" & Val(txtfields(2).Text) & ")", DB
'        End If
'
...
'        End If
'
'        If Val(GetText(SpdOrdDetail, E_POQuantity, SpdOrdDetail.ActiveRow)) > Val(PenQty1) Then
'            Cancel = True
'            Exit Sub
'        End If
'
'        If Val(GetText(SpdOrdDetail, E_POQuantity, SpdOrdDetail.ActiveRow)) = 0 Then
'            Cancel = True
'            Exit Sub
'        End If
'
'
'        'Amount Calculation
'        'SpdOrdDetail.SetText E_InvQty, SpdOrdDetail.Row, Format(val(GetText(SpdOrdDetail, E_POQuantity, SpdOrdDetail.Row)) * val(GetText(SpdOrdDetail, E_rate, SpdOrdDetail.Row)), "0.00")
'
...
Case 23
    Set rsa = New Recordset
    rsa.Open "select TDS_TYPE,TDS_DESC AS TDShead from FA_TDS_TYPE where TDS_TYPE='" & Trim(txtfields(23).Text) & "'", DB, adOpenStatic
...
'    TypRs.Open "Select TC,tchead 'TCNAME',PSNO from FA_TCMAS a,FA_PARAM b where    tc between FROMPURTC and TOPURTC And TC =" & Val(txtfields(13).Text) & " ", DB, adOpenStatic, adLockReadOnly
'    If Not TypRs.EOF Then
'        txtfields(13).Text = TypRs(0)
'        Text6.Text = TypRs(1)
'    Else
'     Text6.Text = ""
'
...
'          rsoc.Open "select RefNo from KN_POhd where divcode='" & divcode & "' and RefNo='" & Trim(txtfields(3).Text) & "' ", DB, adOpenStatic
...
On Error GoTo Errh
    ...
    Set adoPrimaryRS = New Recordset
    adoPrimaryRS.Open " SHAPE {SELECT DivCode,docNo,docDate,SLCode,AgentCode,AgentComm,RefNo,RefDate,PaymentTerm,Order_Type,DeliveryDate,DelCode,Trans_Code,HostID,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,TotQty,TotPacks,Mat_Amt,Disc_Per,Disc_Amt,Other_Amt,Freight_Amt,ins_Amt,Taxable_Amt,Tax_Amt,CGSTAmt,SGSTAmt,IGSTAmt,TCS_Per,TCS_amt,Roff_amt,TotalAmt ,saleorder_no,saleorder_Type,Saleorder_Date FROM KN_POhd WHERE DivCode='" & Divcode & "' And docno = " & val(a) & " and docdate = '" & Format(B, "yyyy-mm-dd") & "' And Docdate Between '" & Format(yfdate, "yyyy/MM/dd") & "' And '" & Format(yldate, "yyyy/Mm/dd") & "' " & _
                      " Order by DivCode,docno,Docdate} AS ParentCMD APPEND ({SELECT a.DivCode,a.DocNo,a.DocDate,a.DocSno,a.Product_code,a.uom,a.Rolls,a.POQuantity,a.Rate,a.Value,a.remarks,a.Disc_Per,a.Disc_Amt,a.Tax_Code,a.Taxable_Amt,a.Cgstper,a.CGSTAmt,a.Sgstper,a.SGSTAmt,a.Igstper,a.IGSTAmt,a.TCS_Per,a.TCS_amt,a.TotalAmt ,ins_Amt,Other_Amt,Freight_Amt,a.Product_Name,a.hsn,PSNO,NetRate,a.OrdBalQty ,d.Description Pack_TypeDesc FROM KN_POdt a inner join kn_PRODUCTknitted b on a.Product_code=b.code and a.Divcode=b.Divcode left join IG_PACKTYPE d on d.pack_type=a.uom Where a.divcode='" & Divcode & "' " & _
...
Public Function newDocNo()
    ...
    Set Rs = New Recordset
        ...
        Rstdocno.Open "Select right(isnull(max(convert(numeric,docno)),0),5) as docno from KN_POhd where Divcode = '" & Divcode & "'  and  DocDate between '" & Format(yfdate, "dd-MMM-yyyy") & "' and '" & Format(yldate, "dd-MMM-yyyy") & "'", DB
...
adoPrimaryRS.Open " SHAPE {SELECT DivCode,docNo,docDate,SLCode,AgentCode,AgentComm,RefNo,RefDate,PaymentTerm,Order_Type,DeliveryDate,DelCode,Trans_Code,HostID,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,TotQty,TotPacks,Mat_Amt,Disc_Per,Disc_Amt,Other_Amt,Freight_Amt,ins_Amt,Taxable_Amt,Tax_Amt,CGSTAmt,SGSTAmt,IGSTAmt,TCS_Per,TCS_amt,Roff_amt,TotalAmt,saleorder_no,saleorder_Type,Saleorder_Date FROM KN_POhd WHERE DivCode='" & Divcode & "' And Docdate Between '" & Format(yfdate, "yyyy/MM/dd") & "' And '" & Format(yldate, "yyyy/Mm/dd") & "' " & _
...
If Index = 23 Then
            ...
            If rsCodeName.RecordCount > 0 Then
               txtfields(44).Text = rsCodeName!sLname
            Else

                    LookUp.Clear = True
                    LookUp.query = "select Area_Code,name Area_Name from ig_area "
                    LookUp.Caption = "Delivery listing"
                    LookUp.DefCol = "Slname"
                    LookUp.ALIGN = "1500,5500"
                    LookUp.Show vbModal
                        If LookUp.Cancel = False Then
                            txtfields(23).Text = LookUp.Fields("Area_Code")
...
End If
  ...
  If Index = 10 Then
        ...
        Else
            LookUp.Clear = True
            LookUp.query = "select Distinct Type_code""PurchaseType"",TypName""Name"" from po_type "
      ...
      ' End If
       ...
       If Index = 5 Then
                ...
                Else
                    ...
                    LookUp.Clear = True
                    LookUp.query = "SELECT carrier_code""Transport Code"",name""Transport Name"" FROM ig_carrier"
...
'            End If
       ...
       Exit Sub
            ...
            custgrp = ""
            If globalarrivalorder = "C" Then
                    qry = "select Divocde 'Division',cast(contno as VARCHAR(10)) as 'Order No',contdt 'Order Date',Product_code 'Code',varname 'Variety Name',balqty,candyrate,rateunit,arrivaltype " & _
                          " from(select DISTINCT  Divocde,Contno,Contdt,a.Product_code,varname,ISNULL(Ordqty,0)-(ISNULL(dRECQTY,0)+ISNULL(CANCELBALES,0))""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and A.Product_code=C.Product_code and isnull(a.msdocno,0)>0 AND ordqty>(isnull(recqty,0)+isnull(cancelbales,0)) AND ordqty>(isnull(drecqty,0)+isnull(cancelbales,0))  AND supcd='" & txtfields(7).Text & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "'" & StrAppQry & " AND ISNULL(ARRIVALTYPE,'P')='P' and (DIVCODE='" & Divcode & "' or ((DIVCODE='" & globalimportpo & "' and im_ind='I'))) " & _
                          " UNION ALL select DISTINCT  Divocde,CONTNO,Contdt,a.Product_code,varname,ISNULL(ORDKGS,0)-ISNULL(dRCDKGS,0)+isnull(cancelkgs,0) ""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and  A.Product_code=C.Product_code  and isnull(a.msdocno,0)>0 AND (ISNULL(ORDKGS,0)-ISNULL(dRCDKGS,0)+isnull(cancelkgs,0))>0 AND (ISNULL(ORDKGS,0)-ISNULL(RCDKGS,0)+isnull(cancelkgs,0))>0  AND supcd='" & txtfields(7).Text & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "'" & StrAppQry & "  AND ISNULL(ARRIVALTYPE,'P')='K' and (DIVCODE='" & Divcode & "' or ((DIVCODE='" & globalimportpo & "' and im_ind='I')))" & _
                          " union select DISTINCT  Divocde,CAST(Contno AS VARCHAR(10)) AS Contno,Contdt,a.Product_code,varname,ISNULL(Ordqty,0)-(ISNULL(dRECQTY,0)+ISNULL(CANCELBALES,0))""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and  A.Product_code=C.Product_code and isnull(a.msdocno,0)>0 AND ordqty>(isnull(drecqty,0)+isnull(cancelbales,0)) AND ordqty>(isnull(recqty,0)+isnull(cancelbales,0)) and a.PREFIX='C' AND supcd='" & txtfields(7).Text & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "' " & StrAppQry & " AND ISNULL(ARRIVALTYPE,'P')='P' " & _
            ...
            Else
                    qry = "select Divocde 'Division',cast(contno as VARCHAR(10)) as 'Order No',contdt 'Order Date',Product_code 'Code',varname 'Variety Name',balqty,candyrate,rateunit,arrivaltype " & _
                      " from(select DISTINCT Divocde,Contno,Contdt,a.Product_code,varname,ISNULL(Ordqty,0)-(ISNULL(dRECQTY,0)+ISNULL(CANCELBALES,0))""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and  A.Product_code=C.Product_code and isnull(a.msdocno,0)>0 AND ordqty>(isnull(recqty,0)+isnull(cancelbales,0))  AND ordqty>(isnull(drecqty,0)+isnull(cancelbales,0)) and divcode='" & Divcode & "' AND supcd='" & txtfields(7).Text & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "'" & StrAppQry & " AND ISNULL(ARRIVALTYPE,'P')='P'" & _
                      ...
                      " union select DISTINCT Divocde, CAST(Contno AS VARCHAR(10)) AS Contno,Contdt,a.Product_code,varname,ISNULL(Ordqty,0)-(ISNULL(dRECQTY,0)+ISNULL(CANCELBALES,0))""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and  A.Product_code=C.Product_code and isnull(a.msdocno,0)>0 AND ordqty>(isnull(recqty,0)+isnull(cancelbales,0))  AND ordqty>(isnull(drecqty,0)+isnull(cancelbales,0))  and a.PREFIX='C' AND supcd='" & txtfields(7).Text & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "' " & StrAppQry & " AND ISNULL(ARRIVALTYPE,'P')='P' " & _
                      " UNION ALL select DISTINCT Divocde,CAST(Contno AS VARCHAR(10)) AS CONTNO,Contdt,a.Product_code,varname,ISNULL(ORDKGS,0)-ISNULL(dRCDKGS,0)+isnull(cancelkgs,0)""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and  A.Product_code=C.Product_code and isnull(a.msdocno,0)>0 AND (ISNULL(ORDKGS,0)-ISNULL(RCDKGS,0)+isnull(cancelkgs,0))>0  AND (ISNULL(ORDKGS,0)-ISNULL(dRCDKGS,0)+isnull(cancelkgs,0))>0 and A.PREFIX='C' AND supcd='" & txtfields(7).Text & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "'" & StrAppQry & "  AND ISNULL(ARRIVALTYPE,'P')='K')X order by cast(contno as numeric),contdt "
            End If
...
'                            spdPO.ScrollBars = ScrollBarsBoth
                            spdPO.MaxRows = spdPO.MaxRows + 1
                            spdPO.SetText ePODtls.P_SIZEININCH, RW, Lrs("Contno")
                            spdPO.SetText ePODtls.P_SIZEINCM, RW, Format(Lrs("contdt"), "dd/mm/yyyy")
                            spdPO.SetText ePODtls.P_Product_code, RW, Lrs("Product_code")
...
'
                            ...
                            spdPO.SetText ePODtls.P_PackPerQty, RW, Lrs("Rateunit")
                            spdPO.SetText ePODtls.P_Looseqty, RW, Lrs("BalQty")
                            spdPO.SetText ePODtls.P_POQuantity, RW, Lrs("candyrate")
                            spdPO.SetText ePODtls.P_PDocSno, RW, Lrs!Divcode
                            spdPO.Row = RW
  ...
  If Index = 7 And lSuppSel = False Then  '' Supplier
        ...
        Call GetPartyType("KNFABRICSUPPLIER", "slcode")
        Set rss = New Recordset
        rss.Open "select slcode""Supplier Code"",slname""Supplier Name"",city""City"",BrCode""Agent Code"" ,isnull(GSTSTATECODE,'0') GSTSTATECODE,isnull(GSTINNO,'') GSTINNO,isnull(supptype,'R')  Supptype  from fa_slmas where (SLCODE " & PartyTypeStr & ") and isnull(isACTive,'N')='Y' and slcode='" & Trim(txtfields(7).Text) & "'", DB, adOpenStatic  '
        If Not rss.EOF Then
    ...
    If Not rs4(0) = 0 Then
            StrAppQry = ""
            LookUp.Clear = True
            LookUp.query = " select DISTINCT slcode [Supplier Code],slname [Supplier Name], isnull(City,'') City,isnull(brcode,'') [Agent Code], isnull(GSTSTATECODE,'') GSTSTATECODE, isnull(GSTINNO,'') GSTINNO,isnull(Supptype ,'R') Supptype from fa_slmas where  (SLCODE " & PartyTypeStr & ") and isnull(isACTive,'N')='Y'"
...
'                End If
               ' Exit Sub
                ...
                If globalarrivalorder = "C" Then
                    ...
                    qry = "select DIVCODE,cast(contno as VARCHAR(10)) as contno,contdt,Product_code,varname,balqty,candyrate,rateunit,arrivaltype " & _
                          " from(select DISTINCT  DIVCODE,Contno,Contdt,a.Product_code,varname,ISNULL(Ordqty,0)-(ISNULL(dRECQTY,0)+ISNULL(CANCELBALES,0))""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and A.Product_code=C.Product_code and isnull(a.msdocno,0)>0 AND ordqty>(isnull(recqty,0)+isnull(cancelbales,0)) AND ordqty>(isnull(drecqty,0)+isnull(cancelbales,0))  AND supcd='" & LookUp.Fields(0) & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "'" & StrAppQry & " AND ISNULL(ARRIVALTYPE,'P')='P' and (DIVCODE='" & Divcode & "' or ((DIVCODE='" & globalimportpo & "' and im_ind='I'))) " & _
                 ...
                 Else
                    qry = "select DIVCODE,cast(contno as VARCHAR(10)) as contno,contdt,Product_code,varname,balqty,candyrate,rateunit,arrivaltype " & _
                      " from(select DISTINCT  DIVCODE,Contno,Contdt,a.Product_code,varname,ISNULL(Ordqty,0)-(ISNULL(dRECQTY,0)+ISNULL(CANCELBALES,0))""balqty"",candyrate,rateunit,arrivaltype from rm_cont a,RM_VAR C where isnull(a.Fclosed,'N')<>'Y' and  A.Product_code=C.Product_code and isnull(a.msdocno,0)>0 AND ordqty>(isnull(recqty,0)+isnull(cancelbales,0))  AND ordqty>(isnull(drecqty,0)+isnull(cancelbales,0)) and divcode='" & Divcode & "' AND supcd='" & LookUp.Fields(0) & "'  and a.contdt<='" & Format(pdate, "yyyy-mm-dd") & "'" & StrAppQry & " AND ISNULL(ARRIVALTYPE,'P')='P'" & _
...
'                        Set spdPO.DataSource = Lrs
                        ...
                        Do While Not Lrs.EOF
                            ...
                            spdPO.ScrollBars = ScrollBarsBoth
                            spdPO.MaxRows = spdPO.MaxRows + 1
                            spdPO.SetText ePODtls.P_SIZEININCH, RW, Lrs("Indent No.")
                            spdPO.SetText ePODtls.P_SIZEINCM, RW, Lrs("Indent Date")
                            spdPO.SetText ePODtls.P_Product_code, RW, Lrs("Varity Code")
                            spdPO.SetText ePODtls.P_ITEMNAME, RW, Lrs("Description")
                            spdPO.SetText ePODtls.P_UOM, RW, Lrs("Packtype")
                            spdPO.SetText ePODtls.P_PackPerQty, RW, Lrs("BalQtyKG")
                            spdPO.SetText ePODtls.P_Looseqty, RW, Lrs("BalQty")
                            spdPO.SetText ePODtls.P_POQuantity, RW, Lrs("ename")
                            spdPO.SetText ePODtls.P_PDocSno, RW, Lrs("PrSNo")
                            Lrs.MoveNext
                            RW = RW + 1
...
On Error GoTo spreadalign_Error
   ...
   SetSpreadCol SpdOrdDetail, E_POGrp, "Order No", CellTypeStaticText, 6, , True, True
...
'    SetSpreadCol SpdOrdDetail, E_SizeinCM, "Size in CM", CellTypeNumber, 10, 2, False, False
    ...
    SpdOrdDetail.TypeHAlign = TypeHAlignCenter
    SetSpreadCol SpdOrdDetail, E_PRSno, "Order SNo.", CellTypeNumber, 8, , True, True
        
    SetSpreadCol SpdOrdDetail, E_Product_code, "Product Code", CellTypeStaticText, 10, 0, False, False
   
    If opt = "add" Or opt = "mod" Then
        SetSpreadCol SpdOrdDetail, E_Itemname, "Product Desc", CellTypeStaticText, 30, , True, True
    Else
        SetSpreadCol SpdOrdDetail, E_Itemname, "Product Desc", CellTypeStaticText, 30, , False, True
    End If
    SpdOrdDetail.Col = E_ItemDesc
    ...
    SetSpreadCol SpdOrdDetail, E_ItemDesc, "Product Description", CellTypeEdit, 27, , False, False
    ...
    SetSpreadCol SpdOrdDetail, E_ORDBalQty, "Balance Quantiry With Tolerance", CellTypeNumber, 10, 3, False, True
    ...
    SpdOrdDetail.TypeEditCharCase = TypeEditCharCaseSetNone
    SetSpreadCol SpdOrdDetail, E_POQuantity, "PO Quantity in Kgs", CellTypeNumber, 11, 3, False, False
    ...
    SpdOrdDetail.TypeEditCharSet = TypeEditCharSetNumeric
    SpdOrdDetail.TypeEditCharCase = TypeEditCharCaseSetNone
    SetSpreadCol SpdOrdDetail, E_TotPacks, "No of Rolls", CellTypeNumber, 9, 0, False, False
    ...
    SpdOrdDetail.TypeEditCharSet = TypeEditCharSetNumeric
    SpdOrdDetail.TypeEditCharCase = TypeEditCharCaseSetNone
    SetSpreadCol SpdOrdDetail, E_InvQty, "PO Quantity in Kgs", CellTypeNumber, 11, 0, True, True
    
    
    SetSpreadCol SpdOrdDetail, E_Rate, "Rate/Kgs", CellTypeNumber, 9, 4, False, False
    
    SetSpreadCol SpdOrdDetail, E_Netrate, "Net Rate", CellTypeNumber, 11, 4, True, True
    ...
    SetSpreadCol SpdOrdDetail, E_PSNO, "GL Code", CellTypeStaticText, 15, , True, True
    ...
    SpdOrdDetail.SetActiveCell E_ItemDesc, 1
    SpdOrdDetail.ColsFrozen = E_POQuantity
    
    If Trim(opt) = "" Or opt = "fnd" Or opt = "del" Then
        SetSpreadCol SpdOrdDetail, E_ItemDesc, "Description", CellTypeStaticText, 30, , True, True
        SetSpreadCol SpdOrdDetail, E_POQuantity, "PO Quantity in Kgs", CellTypeNumber, 10, 3, False, True
    End If
    If opt = "mod" Then
...
'         SetSpreadCol SpdOrdDetail, E_SIZEINCM, "Size in CM", CellTypeNumber, 10, 2, True, True
         ...
         SetSpreadCol SpdOrdDetail, E_Itemname, "Description", CellTypeStaticText, 30, , True, True
         SetSpreadCol SpdOrdDetail, E_ItemDesc, "Description", CellTypeStaticText, 30, , False, True
    End If
    Exit Sub
...
With spdPO
        ...
        SetSpreadCol spdPO, P_POQuantity, "Net Wt.", CellTypeNumber, 8, 3, False, False
...
'    spdPO.FontBold = True
    ...
    SetSpreadCol spdPO, P_POQuantity, "Rate KG", CellTypeNumber, 8, 6, False, True
    SetSpreadCol spdPO, P_PDocSno, "PRSno", CellTypeStaticText, 4, , True, True
...
Private Function TrnDateValidation() As Boolean
    ...
    strQry = "Select isnull(MAX(Docdate),'" & Format(pdate, "yyyy-MM-dd") & "') as Ldate from KN_POhd  Where DivCode='" & Divcode & "' and Docdate Between '" & Format(yfdate, "yyyy-MM-dd") & "' and '" & Format(yldate, "yyyy-MM-dd") & "'"
...
'
   ...
   SPDBALEDETAILS.Col = B_POQuantity
   SPDBALEDETAILS.TypeNumberMin = 0
   SPDBALEDETAILS.TypeNumberMax = 99999999.999
   SPDBALEDETAILS.TypeEditCharSet = TypeEditCharSetNumeric
   SPDBALEDETAILS.TypeEditCharCase = TypeEditCharCaseSetNone
   SetSpreadCol SPDBALEDETAILS, B_POQuantity, "Net Wt.", CellTypeNumber, 11, 3, False, False
   ...
   SPDBALEDETAILS.MaxRows = NoofRows
    SPDBALEDETAILS.TypeNumberMax = 99999999.999
   'SPDBALEDETAILS.SetActiveCell E_POQuantity, 1
...
OtherAmt = 0: FreightAmt = 0: InsAmt = 0: AssAmt = 0: Disc_amt = 0: TotTCS_AMT = 0: Taxable_Amt = 0: TCGSTAMT = 0: TFreightAmt = 0
 TSGSTAMT = 0: TIGSTAMT = 0: TotalAmt = 0: TotalLooseQty = 0: totalpacks = 0
    nTotalAmt = 0
    nPOQuantity = 0
    nTotalNet = 0
    tmp = opt
    ...
    With SpdOrdDetail
      For nRow = 1 To .MaxRows
        .Row = nRow
        If val(GetText(SpdOrdDetail, E_POQuantity, nRow)) > 0 Then
            nTotalNet = nTotalNet + val(GetText(SpdOrdDetail, E_POQuantity, nRow))
        End If
      Next
    For nRow = 1 To .MaxRows
        .Row = nRow
        If val(GetText(SpdOrdDetail, E_POQuantity, nRow)) > 0 Then
            SpdOrdDetail.SetText E_OtherAmt, nRow, Format(val(txtfields(46).Text) / nTotalNet * val(GetText(SpdOrdDetail, E_POQuantity, nRow)), "0.00")
            SpdOrdDetail.SetText E_FreightAmt, nRow, Format(val(txtfields(14).Text) / nTotalNet * val(GetText(SpdOrdDetail, E_POQuantity, nRow)), "0.00")
            SpdOrdDetail.SetText E_InsAmt, nRow, Format(val(txtfields(16).Text) / nTotalNet * val(GetText(SpdOrdDetail, E_POQuantity, nRow)), "0.00")
          ...
          '  If Val(GetText(SpdOrdDetail, E_PackPer, nRow)) > 0 Then
                SpdOrdDetail.SetText E_Netrate, nRow, Format(val(GetText(SpdOrdDetail, E_Rate, nRow)), "0.0000") 'Val(GetText(SpdOrdDetail, E_PackPer, nRow))
          '  End If
            SpdOrdDetail.SetText E_VALUE, nRow, Format(val(GetText(SpdOrdDetail, E_POQuantity, nRow)) * val(GetText(SpdOrdDetail, E_Netrate, nRow)), "0.00")
...
'            nTotalAmt = nTotalAmt + Val(GetText(SpdOrdDetail, E_Amount, nRow))
    ...
    End With
    txtQty.Text = Format(nPOQuantity, "0.000")
    txtfields(12).Text = Format(nPOQuantity, "0.000")
