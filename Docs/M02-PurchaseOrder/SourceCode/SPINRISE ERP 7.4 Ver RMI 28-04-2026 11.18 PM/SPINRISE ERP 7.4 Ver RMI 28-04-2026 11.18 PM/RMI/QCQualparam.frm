...
Begin VB.Form FrmQCQualparam 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":0000
         Height          =   510
         Index           =   0
         Left            =   15
         Picture         =   "QCQualparam.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   153
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":12B8
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":195E
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":210A
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":2790
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":2E3C
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":361B
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":3DB5
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":4439
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "QCQualparam.frx":4BE8
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "QCQualparam.frx":537F
      ...
      TabCaption(1)   =   "Sample"
      TabPicture(1)   =   "QCQualparam.frx":539B
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "QCQualparam.frx":53B7
         Tab(0).ControlEnabled=   -1  'True
         ...
         TabPicture(1)   =   "QCQualparam.frx":53D3
         Tab(1).ControlEnabled=   0   'False
         ...
         TabPicture(2)   =   "QCQualparam.frx":53EF
         ...
         TabPicture(3)   =   "QCQualparam.frx":540B
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.ComboBox Combo1 
         BackColor       =   &H00FFFFC0&
         Height          =   360
         ItemData        =   "QCQualparam.frx":5427
         Left            =   1320
         List            =   "QCQualparam.frx":5431
         TabIndex        =   157
         Top             =   2520
         Visible         =   0   'False
         Width           =   1455
   ...
   End
End
Attribute VB_Name = "FrmQCQualparam"
...
'
    ...
    strSQL = "UPDATE RM_LOT SET Csp=" & val(TXTFIELDS(18).Text) & ",risi=" & val(TXTFIELDS(77).Text) & "," & _
            ...
            "uniratio=" & val(TXTFIELDS(47).Text) & ",mcoeff=" & val(TXTFIELDS(43).Text) & ",mcoeff1=" & val(TXTFIELDS(154).Text) & ",short_fibre=" & val(TXTFIELDS(99).Text) & "" & _
           " where  LOTNO=" & adoprimaryrs("LOTNO") & " AND arrno=" & adoprimaryrs("arrno") & " " & _
            " and arrdt='" & Format(adoprimaryrs("ARRDT"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'"
    DB.Execute strSQL
    ...
    'uhml =" & val(TXTFIELDS(94).Text)
    'ui =" & val(TXTFIELDS(96).Text)
    ',ml = " & val(txtFields(95).Text) & "
    ...
    strSQL = "UPDATE RM_LOT SET nepspergm=" & val(TXTFIELDS(92).Text) & ",nepsize=" & val(TXTFIELDS(81).Text) & "," & _
            ...
            "uhml =" & val(TXTFIELDS(48).Text) & ",ml = " & val(TXTFIELDS(49).Text) & " ," & _
            "ui =" & val(TXTFIELDS(47).Text) & ",nepcv = " & val(TXTFIELDS(97).Text) & ",scncv=" & val(TXTFIELDS(98).Text) & " " & _
            " where  LOTNO=" & adoprimaryrs("LOTNO") & " AND arrno=" & adoprimaryrs("arrno") & " " & _
            " and arrdt='" & Format(adoprimaryrs("ARRDT"), "yyyy-mm-dd") & "' and  DIVCODE='" & Divcode & "'"
...
'                        Do While Not rss.EOF
'                            db.Execute "Update rm_bale set status='RJ',REJFLG='Y',REJDT='" & Format(pdate, "YYYY-MM-DD") & "' where baleno='" & rss("baleno") & "' and lotno='" & val(txtfields(1).Text) & "' and lotdt ='" & Format(txtfields(2).Text, "yyyy-mm-dd") & "' AND  DIVCODE='" & divcode & "'"
'                            rss.MoveNext
'                        Loop
''''28/03/2012
''''                        adoGridRS.MoveFirst
...
'                        Next
        ...
        If opt = "add" Or opt = "mod" Then
            ...
            rsnew("MCOEFF1") = Format(val(TXTFIELDS(155)), "0.00")
            ...
            rsnew("scneps_g") = Format(val(TXTFIELDS(122)), "0.00")
            ...
            rsnew("uhml") = Format(Trim(TXTFIELDS(126)), "0.00")
            rsnew("ml") = Format(Trim(TXTFIELDS(127)), "0.00")
            rsnew("ui") = Format(val(TXTFIELDS(125)), "0.00")
'            rsnew("uhml") = Format(val(txtFields(126)), "0.00")
'            rsnew("ml") = Format(val(txtFields(127)), "0.00")
'            rsnew("ui") = Format(val(txtFields(125)), "0.00")
...
Private Sub loadsampledet()
    ...
    If adoPrimaryRS2.RecordCount > 0 Then
        ...
        TXTFIELDS(155).Text = adoPrimaryRS2("MCOEFF1")
...
'        txtFields(118).Text = val(adoPrimaryRS2("uhml"))
'        txtFields(117).Text = adoPrimaryRS2("ml")
'        txtFields(116).Text = adoPrimaryRS2("ui")
        
        TXTFIELDS(118).Text = adoPrimaryRS2("STAPLEN25")
        TXTFIELDS(117).Text = adoPrimaryRS2("STAPLEN50")
        TXTFIELDS(116).Text = adoPrimaryRS2("UNIRATIO")
...
If opt = "add" Or opt = "updat" Or opt = "del" Then
        ...
        adosecondaryrs.Open " select arrdt as arrdate,SUPCD,VARCODE,CNTCODE,Bales as QUANTITY,GRSWGT as GROSSWT,TAREWT, " & _
                ...
                " 0 as rejqty,0 as  prno,'' as prmark,'' as remarks,0 as rejdt, 0 as accallowqty,0 as accallowdt,0 as accallowrtpercandy, " & _
                " 0 as accallowrtperkg,0 as contno,'' as lotsta|us,0 as returnqty, 0 as returndate,CatCd, " & _
...
On Error GoTo txtfields_KeyPress_Error
  ...
  Select Case Index
        Case 48, 54, 13, 99, 16, 49, 47, 43, 154, 42, 65, 66, 72, 63, 84, 85, 94, 134, 135
            Call ToNumber1(TXTFIELDS(Index), 2, KeyAscii, 2, 2)
        Case 126, 132, 113, 133, 127, 125, 123, 155, 138, 124, 137, 122, 136, 121, 120, 118, 153
            Call ToNumber1(TXTFIELDS(Index), 2, KeyAscii, 2, 2)
        Case 61, 62, 64, 92, 90, 98, 114
            Call ToNumber1(TXTFIELDS(Index), 3, KeyAscii, 3, 2)
        Case 141, 140, 139, 130, 119
            Call ToNumber1(TXTFIELDS(Index), 3, KeyAscii, 3, 2)
        Case 49, 77, 71, 74, 75, 53, 64, 73, 59, 76, 50, 44
            Call ToNumber1(TXTFIELDS(Index), 4, KeyAscii, 4, 2)
        Case 94, 95, 96, 97, 117, 116, 115
            Call ToNumber1(TXTFIELDS(Index), 2, KeyAscii, 2, 2)
        Case 52, 69, 67, 68, 70, 81, 82, 72, 90, 83, 84, 85, 86, 87, 86, 89, 46, 11, 18, 12
            Call ToNumber1(TXTFIELDS(Index), 4, KeyAscii, 4, 2)
        Case 88
            Call ToNumber1(TXTFIELDS(Index), 4, KeyAscii, 4, 0)
        Case 7
        ...
        Case 23, 24, 25, 26
            Call tonum(TXTFIELDS(10), 3, KeyAscii)
        Case 49
            Call ToNumber1(TXTFIELDS(49), 5, KeyAscii, 4, 4)
        Case 10
...
If opt = "list" Or opt = "add" Or opt = "del" Then
         ...
         Set adoprimaryrs = New Recordset
         adoprimaryrs.Open "SELECT * FROM rm_lot a WHERE a.LOTYEAR='" & Year(yfdate) & "' AND a.DIVCODE='" & Divcode & "' AND a.Lotno = " & val(DataGrid1.Columns(3).Text) & " AND a.lotdt = '" & Format(DataGrid1.Columns(5).Text, "yyyy-mm-dd") & "'", DB, adOpenStatic
