...
Begin VB.Form RMIContractwithoutsample_withPR 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   840
   ClientWidth     =   11880
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "RMIContractwithoutsample_withPR.frx":0000
      ...
      TabPicture(1)   =   "RMIContractwithoutsample_withPR.frx":001C
      ...
      TabPicture(2)   =   "RMIContractwithoutsample_withPR.frx":0038
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox Combo8 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "RMIContractwithoutsample_withPR.frx":0054
            Left            =   5250
            List            =   "RMIContractwithoutsample_withPR.frx":0064
            TabIndex        =   59
            Text            =   "Immediate"
            Top             =   630
            Width           =   4695
         ...
         Begin VB.ComboBox Combo6 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "RMIContractwithoutsample_withPR.frx":00A4
            Left            =   1920
            List            =   "RMIContractwithoutsample_withPR.frx":00A6
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Combo2 
            ...
            ForeColor       =   &H00000000&
            Height          =   360
            ItemData        =   "RMIContractwithoutsample_withPR.frx":00A8
            Left            =   10680
            List            =   "RMIContractwithoutsample_withPR.frx":00AA
            Style           =   2  'Dropdown List
            TabIndex        =   128
            Top             =   600
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox Combo9 
            ...
            DataField       =   "RATEUNIT"
            Height          =   315
            ItemData        =   "RMIContractwithoutsample_withPR.frx":00AC
            Left            =   8280
            List            =   "RMIContractwithoutsample_withPR.frx":00B6
            Sorted          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   34
            Top             =   2880
         ...
         Begin VB.ComboBox Combo7 
            ...
            ForeColor       =   &H00000000&
            Height          =   315
            ItemData        =   "RMIContractwithoutsample_withPR.frx":00CA
            Left            =   1380
            List            =   "RMIContractwithoutsample_withPR.frx":00D4
            Style           =   2  'Dropdown List
            TabIndex        =   38
            Top             =   3540
            Width           =   1575
         ...
         Begin VB.ComboBox Combo5 
            ...
            DataField       =   "RATEUNIT"
            Height          =   315
            ItemData        =   "RMIContractwithoutsample_withPR.frx":00EF
            Left            =   1380
            List            =   "RMIContractwithoutsample_withPR.frx":00F1
            Sorted          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   29
            Top             =   2550
         ...
         Begin VB.ComboBox Combo3 
            ...
            ForeColor       =   &H00000000&
            Height          =   315
            ItemData        =   "RMIContractwithoutsample_withPR.frx":00F3
            Left            =   1380
            List            =   "RMIContractwithoutsample_withPR.frx":0103
            Style           =   2  'Dropdown List
            TabIndex        =   27
            Top             =   2220
            Width           =   1575
   ...
   Begin VB.ComboBox Combo4 
      ...
      ForeColor       =   &H00000000&
      Height          =   360
      ItemData        =   "RMIContractwithoutsample_withPR.frx":012A
      Left            =   2760
      List            =   "RMIContractwithoutsample_withPR.frx":012C
      TabIndex        =   206
      Top             =   8280
      Visible         =   0   'False
      Width           =   1935
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   9270
         Picture         =   "RMIContractwithoutsample_withPR.frx":012E
         Style           =   1  'Graphical
         TabIndex        =   171
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   13
         Left            =   5659
         Picture         =   "RMIContractwithoutsample_withPR.frx":04C5
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   5150
         Picture         =   "RMIContractwithoutsample_withPR.frx":0907
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":0D49
         Height          =   510
         Index           =   4
         Left            =   1587
         Picture         =   "RMIContractwithoutsample_withPR.frx":1053
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":13E8
         Height          =   510
         Index           =   6
         Left            =   2605
         Picture         =   "RMIContractwithoutsample_withPR.frx":1832
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":1B7F
         Height          =   510
         Index           =   0
         Left            =   60
         Picture         =   "RMIContractwithoutsample_withPR.frx":1E89
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":221C
         Height          =   510
         Index           =   5
         Left            =   2096
         Picture         =   "RMIContractwithoutsample_withPR.frx":2666
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":29CB
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   1078
         Picture         =   "RMIContractwithoutsample_withPR.frx":2CD5
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":3071
         Height          =   510
         Index           =   1
         Left            =   569
         Picture         =   "RMIContractwithoutsample_withPR.frx":337B
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":36F5
         Height          =   510
         Index           =   7
         Left            =   3114
         Picture         =   "RMIContractwithoutsample_withPR.frx":3B3F
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":3E8F
         Height          =   510
         Index           =   11
         Left            =   6165
         Picture         =   "RMIContractwithoutsample_withPR.frx":42D9
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":466E
         Height          =   510
         Index           =   9
         Left            =   4132
         Picture         =   "RMIContractwithoutsample_withPR.frx":4978
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BUTTON 
         ...
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":4D1A
         Height          =   510
         Index           =   10
         Left            =   4641
         Picture         =   "RMIContractwithoutsample_withPR.frx":5024
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":53A0
         Height          =   510
         Index           =   8
         Left            =   3623
         Picture         =   "RMIContractwithoutsample_withPR.frx":57EA
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin VB.ComboBox Combo1 
      ...
      ForeColor       =   &H00000000&
      Height          =   360
      ItemData        =   "RMIContractwithoutsample_withPR.frx":5B4C
      Left            =   11340
      List            =   "RMIContractwithoutsample_withPR.frx":5B59
      Style           =   2  'Dropdown List
      TabIndex        =   141
      Top             =   8040
      Visible         =   0   'False
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.CommandButton Command2 
         Caption         =   "&Cancel"
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":5B6F
         Height          =   615
         Left            =   4020
         Picture         =   "RMIContractwithoutsample_withPR.frx":5F51
         Style           =   1  'Graphical
         TabIndex        =   96
         Top             =   1680
         Width           =   975
      ...
      Begin VB.CommandButton Command1 
         Caption         =   "&OK"
         DownPicture     =   "RMIContractwithoutsample_withPR.frx":6324
         Height          =   615
         Left            =   2580
         Picture         =   "RMIContractwithoutsample_withPR.frx":670A
         Style           =   1  'Graphical
         TabIndex        =   95
         Top             =   1680
         Width           =   975
   ...
   Begin VB.Frame dlmdfrm 
      ...
      Begin FPSpreadADO.fpSpread FpSpdInd 
         ...
         MaxCols         =   1
         MaxRows         =   1
         SpreadDesigner  =   "RMIContractwithoutsample_withPR.frx":6AD0
         AppearanceStyle =   0
      End
      Begin FPSpreadADO.fpSpread FpSpdIndHead 
         ...
         MaxRows         =   1
         ScrollBars      =   0
         SpreadDesigner  =   "RMIContractwithoutsample_withPR.frx":6F5F
         AppearanceStyle =   0
      End
   ...
   End
End
Attribute VB_Name = "RMIContractwithoutsample_withPR"
        ...
        U = MsgBox("Do you want to enter Purchase Order With Sample?", vbYesNo, head)
            ...
            If U = vbYes Then
                 ...
                 If rsa.RecordCount > 0 Then
                    ...
                    LookUp.query = "select Plotno ""Supplier Lot No."",SNO""Mill Sample No."" ,Date""Mill Sample Date"",slname""Supplier Name"",varname""Variety"",a.supcode from rm_sample a,fa_slmas b,rm_var c where a.supcode=b.slcode and a.varcode=c.varcode and divcode='" & Divcode & "' AND DATE BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' "
                    Else
                    ...
                    If UCase(CustID) = UCase("Balkrishna") Then
                    LookUp.ALIGN = "1200,1200,1500,2800,2050,0"
                    Else
                    ...
                    If LookUp.Cancel = False Then
                         ...
                         strQry = "SELECT SNo, DATE,SUPCODE,VARCODE,Prty_sampno,brokercode,Area_code, crop_year FROM RM_sample Where sno = " & val(LookUp.Fields(1)) & " and Date='" & Format(LookUp.Fields(2), "yyyy-mm-dd") & "' AND Divcode = '" & Divcode & "' and supcode='" & LookUp.Fields(5) & "'"
          ...
          End If
            Option4 = True
            If strType = "" Then Option2.value = True
    ...
    If ToValidFinYear(Divcode) = False Then Exit Sub
        ...
        If Not rs4(0) = 0 Then
            ...
            adoprimaryrs.Open "select distinct divcode,contno,contdt,supcd,brkcd,areacode,carcode,cntcode,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd,deladd,contperson,CreditDays,InterestPer,SUPPLIERLOTNOFROM," & _
                                " SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,Terms1,Terms1Days,Terms2,Terms2Days,TransPort,Iprno,prdate,prsno  from rm_cont where divcode='" & Divcode & "' AND ISNULL(aRRIVALTYPE,'P')='P' and ordqty<>isnull(Cancelbales,0) UNION select distinct divcode,contno,contdt,supcd,brkcd,areacode,carcode,cntcode,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd,deladd,contperson,CreditDays,InterestPer,SUPPLIERLOTNOFROM,SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,Terms1,Terms1Days,Terms2,Terms2Days,TransPort,Iprno,prdate,prsno  from rm_cont where divcode='" & Divcode & "' AND ISNULL(aRRIVALTYPE,'P')='K' and  ordkgs<>isnull(Cancelkgs,0) order by contdt", DB, adOpenStatic, adLockOptimistic
            ...
            If LookUp.Cancel = False Then
                Opt = ""
                Set adoprimaryrs = New Recordset
                adoprimaryrs.Open "select distinct divcode,contno,contdt,supcd,brkcd,areacode,carcode,cntcode,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd,deladd,contperson,MILLREFNO,ISNULL(TAX_CHOICE,'SINGLE')TAX_CHOICE,tax_code,taxper,othtaxper,cessper,hscessper,bedper,sedper,cashdisper,tradedisper,insper,CreditDays,InterestPer,SUPPLIERLOTNOFROM,SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,commPer,Terms1,Terms1Days,Terms2,Terms2Days,TransPort ,Iprno,prdate,prsno  from rm_cont where divcode='" & Divcode & "' and contno = '" & LookUp.Fields(0) & "' and contdt='" & Format(LookUp.Fields(1), "yyyy/mm/dd") & "' ", DB, adOpenStatic, adLockOptimistic
    
                Set RsMod = New Recordset
                RsMod.Open "select distinct divcode,contno,contdt,supcd,brkcd,ratekg,varcode,areacode,carcode,cntcode,bbflag,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd,deladd,contperson,candyrate ,ordqty,ordkgs,PTY_CONTNO,sno,STAPLE,season,MILLREFNO,CashDisPer,TradeDisPer,BedPer,SEDPER""EdcessPer"",HsCessPer,CessPer,Tax_Code,TaxPer,OthTaxPer,InsPer,TAX_CHOICE,CreditDays,InterestPer,SUPPLIERLOTNOFROM,SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,CommPer,Terms1,Terms1Days,Terms2,Terms2Days,TransPort,Iprno,prdate,prsno from rm_cont where divcode='" & Divcode & "' and contno = '" & LookUp.Fields(0) & "' and contdt='" & Format(LookUp.Fields(1), "yyyy/mm/dd") & "'", DB, adOpenStatic, adLockOptimistic
                SSTab1.Visible = True
...
' muthu            adoPrimaryRS.Open "select distinct divcode,contno,contdt,supcd,brkcd,areacode,carcode,cntcode,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd,deladd,contperson,CreditDays,InterestPer,SUPPLIERLOTNOFROM,SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,CommPer,Terms1,Terms1Days,Terms2,Terms2Days,TransPort from rm_cont where divcode='" & Divcode & "' and  isnull(recqty,0)=0 and ISNULL(aRRIVALTYPE,'P')='P' and ordqty<>isnull(Cancelbales,0) UNION select distinct divcode,contno,contdt,supcd,brkcd,areacode,carcode,cntcode,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd,deladd,contperson,CreditDays,InterestPer,SUPPLIERLOTNOFROM,SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,CommPer,Terms1,Terms1Days,Terms2,Terms2Days,TransPort,Iprno,prdate,prsno   " & _
            ...
            If LookUp.Cancel = False Then
                ...
                adoprimaryrs.Open "select distinct divcode,contno,contdt,supcd,brkcd,areacode,carcode,cntcode,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd," & _
                                  " deladd,contperson,MILLREFNO,isnull(tax_choice,'SINGLE')TAX_CHOICE,CreditDays,InterestPer,SUPPLIERLOTNOFROM,SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,CommPer,Terms1,Terms1Days,Terms2,Terms2Days,TransPort,Iprno,prdate,prsno from rm_cont where divcode='" & Divcode & "' and contno = '" & LookUp.Fields(0) & "' and contdt='" & Format(LookUp.Fields(1), "yyyy/mm/dd") & "' ", DB, adOpenStatic, adLockOptimistic
     
                Set RsMod = New Recordset
                RsMod.Open "select distinct divcode,contno,contdt,supcd,brkcd,ratekg,varcode,areacode,carcode,cntcode,bbflag,dlytype,paymode,arrivaltype,salcnfno,indentno,duedate,weignment,im_ind,godown,COLORCODE,PAYTERMS,CROPYEAR,acceptance,carcode,plotno,prno,pressmarkno,rateunit,remarks,billadd,deladd,contperson,candyrate ,ordqty,ordkgs,PTY_CONTNO,sno,STAPLE,season,MILLREFNO,CashDisPer,TradeDisPer,BedPer,SEDPER""EdcessPer"",HsCessPer,CessPer,Tax_Code,TaxPer,OthTaxPer,InsPer,CreditDays,InterestPer,SUPPLIERLOTNOFROM,SUPPLIERLOTNOTO,Finalweighment,Prefix,purtype,Iprno,prdate,prsno from rm_cont where divcode='" & Divcode & "' and contno = '" & LookUp.Fields(0) & "' and contdt='" & Format(LookUp.Fields(1), "yyyy/mm/dd") & "'", DB, adOpenStatic, adLockOptimistic
                SSTab1.Visible = True
...
'        End If
        ...
        rscont("weignment") = Trim(txtFields(52).Text)
    ...
    If Opt = "mod" Then
        ...
        RsMod("dlytype") = Trim(txtFields(20).Text)
           ...
           RsMod("weignment") = Trim(txtFields(52).Text)
           ...
           Set RSV = New Recordset
           RSV.Open "select isnull(plotno,'')plotno,isnull(prno,'')prno,isnull(pressmarkno,'')pressmarkno FROM rm_sample where sno=" & IIf(DataGrid1.Columns(0).Text = "", "0", DataGrid1.Columns(0).Text) & " and date between '" & Format(yfdate, "yyyy-mm-dd") & "' and  '" & Format(yldate, "yyyy-mm-dd") & "'", DB, adOpenStatic
...
'    Else
        ...
        ElseIf UCase(CustID) = "SARANYA" Then
            Set clsCryRpt.cryRept = Saranya_RM_Transaction_PO 'Sky_RM_Trans_Order
        ElseIf UCase(CustID) = "BALKRISHNA" Then
            If Trim(divname) = "BALKRISHNA SPINTEX PVT LTD" Then
            Set clsCryRpt.cryRept = RM_Trans_Order_bal1
            Else
            Set clsCryRpt.cryRept = RM_Trans_Order_shiv
            End If
        Else
    ...
    End If
     ...
     If LastCol = 6 Then
        If DataGrid1.Columns(6).Text = "" Then
            ...
            DataGrid1.SetFocus
            Exit Sub
        ElseIf DataGrid1.Columns(6).Text = 0 Then
            MsgBox "Rate cannot Zero!", vbInformation, head
            DataGrid1.Row = DataGrid1.Row
            DataGrid1.Col = 6
            DataGrid1.SetFocus
            Exit Sub
    ...
    With FpSpdInd
        ...
        For SpRW = 1 To IndxRows.Count
            ...
            If .value = True Then
                ...
                MsqlStr = ""
                MsqlStr = MsqlStr + " SELECT a.PRNO ,a.PRDATE ,A.varcode, VarName ,Packtype,"
...
On Error GoTo SetSpdIndentHead
    With FpSpdInd
        ...
        SetSpreadCol_RMI FpSpdInd, E_SpdIndent.SprdBalQtykg, "Balance Qty in Kgs.", CellTypeNumber, 10, 3
