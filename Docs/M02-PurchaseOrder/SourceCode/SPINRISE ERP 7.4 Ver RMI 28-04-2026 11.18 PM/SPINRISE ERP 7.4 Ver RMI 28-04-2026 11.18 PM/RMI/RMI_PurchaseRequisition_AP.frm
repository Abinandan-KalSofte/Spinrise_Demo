...
Begin VB.Form RMI_PurchaseRequisition_AP 
   Caption         =   "Purchase Requisition Approval (PRA)"
   ClientHeight    =   8190
   ClientLeft      =   165
   ClientTop       =   -1995
   ClientWidth     =   11400
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   " "
      TabPicture(0)   =   "RMI_PurchaseRequisition_AP.frx":0000
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "RMI_PurchaseRequisition_AP.frx":001C
         Tab(0).ControlEnabled=   -1  'True
         ...
         Begin VB.Frame Frame2 
            ...
            Begin FPSpreadADO.fpSpread SpdIndent 
               ...
               SpreadDesigner  =   "RMI_PurchaseRequisition_AP.frx":0038
               Appearance      =   2
               ScrollBarStyle  =   3
            End
         End
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   13
         Left            =   4730
         Picture         =   "RMI_PurchaseRequisition_AP.frx":04A8
         Style           =   1  'Graphical
         TabIndex        =   48
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":08EA
         Height          =   510
         Index           =   0
         Left            =   8460
         Picture         =   "RMI_PurchaseRequisition_AP.frx":0BF4
         Style           =   1  'Graphical
         TabIndex        =   0
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   6510
         Picture         =   "RMI_PurchaseRequisition_AP.frx":0F87
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":13C9
         Height          =   510
         Index           =   3
         Left            =   1035
         Picture         =   "RMI_PurchaseRequisition_AP.frx":16D3
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":1A68
         Height          =   510
         Index           =   6
         Left            =   2070
         Picture         =   "RMI_PurchaseRequisition_AP.frx":1EB2
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":21FF
         Height          =   510
         Index           =   5
         Left            =   1545
         Picture         =   "RMI_PurchaseRequisition_AP.frx":2649
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":29AE
         Height          =   510
         Index           =   2
         Left            =   525
         Picture         =   "RMI_PurchaseRequisition_AP.frx":2CB8
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":3054
         Height          =   510
         Index           =   1
         Left            =   0
         Picture         =   "RMI_PurchaseRequisition_AP.frx":335E
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":36D8
         Height          =   510
         Index           =   7
         Left            =   2595
         Picture         =   "RMI_PurchaseRequisition_AP.frx":3B22
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":3E72
         Height          =   510
         Index           =   11
         Left            =   5220
         Picture         =   "RMI_PurchaseRequisition_AP.frx":42BC
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":4651
         Height          =   510
         Index           =   9
         Left            =   3660
         Picture         =   "RMI_PurchaseRequisition_AP.frx":495B
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":4CFD
         Height          =   510
         Index           =   10
         Left            =   4170
         Picture         =   "RMI_PurchaseRequisition_AP.frx":5007
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "RMI_PurchaseRequisition_AP.frx":5383
         Height          =   510
         Index           =   8
         Left            =   3120
         Picture         =   "RMI_PurchaseRequisition_AP.frx":57CD
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "RMI_PurchaseRequisition_AP"
...
Case 0
    ...
    adoPrimaryRS.Open "select DIVCODE,PRNO,PRDATE,REFNO,ITYPE,reqname,userId,Appflg,appUSRID from  rm_prh where 1= 2", DB, adOpenStatic, adLockBatchOptimistic
...
Case 1      'Modification
    ...
    DTPicker1.Enabled = True
    LookUp.Clear = True
    LookUp.query = "SELECT h.prno 'PR.No.',h.prdate 'Date',h.reqname 'Requester Code',d.ename 'Requester Name' from rm_prl l inner join  rm_prH h on h.divcode=l.divcode and h.prno=l.prno and h.prdate=l.prdate inner join  pr_emp D on d.divcode = h.divcode  AND H.reqname = D.empno WHERE  h.appflg is  null and  h.divcode = '" & Divcode & "' AND  H.PRDATE  between '" & Format(yfdate, "yyyy/mm/dd") & "' And '" & Format(yldate, "yyyy/mm/dd") & "' AND H.APPFLG IS NULL  group by  h.prno,h.prdate,h.REQNAME,d.ename"
 ...
 Case 2 'Deletion
    ...
    LookUp.Clear = True
    LookUp.query = "SELECT h.prno 'PR.No.',h.prdate 'Date',h.reqname 'Requester Code',d.ename 'Requester Name' from rm_prl l inner join  rm_prH h on h.divcode=l.divcode and h.prno=l.prno and h.prdate=l.prdate inner join  pr_emp D on d.divcode = h.divcode  AND H.reqname = D.empno WHERE  h.divcode = '" & Divcode & "' AND  H.PRDATE  between '" & Format(yfdate, "yyyy/mm/dd") & "' And '" & Format(yldate, "yyyy/mm/dd") & "' and appflg is not null and isnull(qtyrec,0)=0 and ISNULL(QTYORD,0)=0 group by  h.prno,h.prdate,h.REQNAME,d.ename"
    LookUp.Caption = "Purchase Requisition Listing"
    LookUp.DefCol = "PR.No."
    LookUp.ALIGN = "700,1000,1500,4500"
    LookUp.Alignment = "dbgright,dbgcenter,dbgleft,dbgleft"
...
Case 3 'Find
    ...
    'BUTTON(12).Enabled = False
    desc.Caption = "Find"
    If Record_Exists("rm_prH where divcode = '" & Divcode & "' and prdate between '" & Format(yfdate, "dd-mmm-yyyy") & "' and '" & Format(yldate, "dd-mmm-yyyy") & "' and appflg is not null ") = False Then Exit Sub
    ...
    If LookUp.Cancel = False Then
        ...
        '                " Order by PRNO", DB, adOpenStatic, adLockBatchOptimistic
         ...
         adoPrimaryRS.Open "select H.DIVCODE,H.PRNO,H.PRDATE,H.REFNO,H.ITYPE,H.reqname,d.ename,isNull(h.userid,'')userId ,isnull(appflg,'N') appflg from rm_prH H inner join  pr_emp D on h.divcode= d.divcode and h.reqname =d.empno where H.DIVCODE = '" & Divcode & "' AND  H.PRNO = " & val(c) & " and H.PRDATE = '" & Format(b, "dd-mmm-yyyy") & "'", DB, adOpenStatic, adLockBatchOptimistic
...
'''                        Rs("IP") = LocalHostID
                       ...
                       ' TrnLog("TC") = 3
                        ...
                        TrnLog("Trans_Name") = "Purchase Requisition Approval"
                        ...
                        TrnLog("PRNO") = val(txtfields(1).Text)
...
'            End If
            ...
            If Option3.value Then
                adoPrimaryRS("appflg") = "A"
            Else
                adoPrimaryRS("appflg") = "C"
            End If
''            adoprimaryrs("Note") = Trim(Txtfields(5).Text)
''            adoprimaryrs("PurPose") = Trim(Txtfields(6).Text)
''            adoprimaryrs("Category") = catcode
            adoPrimaryRS("appUSRID") = usrid
            adoPrimaryRS("appdate") = Now
...
'''''                                Rs("prsno").value = SNos
'''''                                Rs("varcode").value = GetText(SpdIndent, Sprdvarcode, RW)
'''''                                Rs("Pack Type").value = GetText(SpdIndent, Sprdpack, RW)
'''''                                Rs("Quantity Required").value = val(Replace(GetText(SpdIndent, SprdQtyInd, RW), ",", ""))
'''''                                Rs("Quantity Required in KG").value = val(Replace(GetText(SpdIndent, SprdQtyIndkg, RW), ",", ""))
...
'''''                                Rs("CurStock") = GetText(SpdIndent, SprdCurStk, RW)
'''''            '''                    Rs("LRMI_PONO") = IIf(GetText(SpdIndent, SprdLpoNo, RW) = "", 0, GetText(SpdIndent, SprdLpoNo, RW))
'''''            '''                    Rs("LRMI_DATE") = IIf(GetText(SpdIndent, SprdLpoDate, RW) = "", Null, Format(GetText(SpdIndent, SprdLpoDate, RW), "yyyy-mm-dd"))
...
'''''                        End With
            ...
            If Opt = "mod" Then MsgBox "Record(s) Approved Successfully", vbInformation, head
...
'            End If
            ...
            DB.Execute ("Update  rm_prH set appflg = Null,appUSRID = Null,appdate = Null WHERE DIVCODE = '" & adoPrimaryRS("divcode") & "' AND prno = " & val(adoPrimaryRS("prno")) & " AND PRDATE = '" & Format(adoPrimaryRS("prdate"), "dd-mmm-yyyy") & "'")
    ...
    Select Case .ActiveCol
     Case Sprdpack
            If KeyCode = 13 Or KeyCode = 9 Then
                If CStr(GetText(SpdIndent, Sprdpack, .ActiveRow)) = "" And Len(CStr(Trim(GetText(SpdIndent, Sprdpack, .ActiveRow)))) > 2 Then
                    MsgBox "Please Enter the unit B-Bale(or)H-Halfpress bale(or)R-Borah", vbInformation, head
                    SpdSetFocus SpdIndent, Sprdpack, .ActiveRow
                End If
            End If
        Case SprdQtyInd
            If KeyCode = 13 Or KeyCode = 9 Then
...
With SpdIndent
    Select Case .ActiveCol
        ...
        Case E_SpdIndent.Sprdpack
            stbar.Panels(2).Text = "Enter the unit B-Bale(or)H-Halfpress bale(or)R-Borah"
...
MsqlStr = MsqlStr + " where th.appflg is not null and TH.PRDATE between '" & Format(yfdate, "dd-mmm-yyyy") & "' and '" & Format(yldate, "dd-mmm-yyyy") & "' AND  TH.DIVCODE = '" & Divcode & "'  Order by PRdate desc,prno asc"
...
MsqlStr = MsqlStr + " th.IType , refno, appflg,th.reqname "
MsqlStr = MsqlStr + " from  rm_prH th INNER JOIN  pr_emp d ON th.REQNAME = d.empno   and  th.divcode = d.divcode"
MsqlStr = MsqlStr + " where Tth.appflg is not null and  H.PRDATE between '" & Format(yfdate, "dd-mmm-yyyy") & "' and '" & Format(yldate, "dd-mmm-yyyy") & "' AND  TH.DIVCODE = '" & Divcode & "'  Order by PRNO"
MsqlStr = MsqlStr + "} AS ParentCMD APPEND ({select distinct t.DIVCODE,t.PRNO,t.PRDATE,t.PRSNO ,t.varcode ""VarityCode"",i.Varname ""Description"",t.curstock ""Current Stock"",t.curbale ""Current Stock Bales"",t.QTYIND ""Quantity Required"",t.QTYINDKG ""Quantity Required"",reqddate ""Required Date"" "
MsqlStr = MsqlStr + "  from  rm_prL t inner join   rm_Var i on  t.varcode = i.varcode   inner join rm_prH h on t.divcode=h.divcode and  t.prno=h.prno and t.prdate=h.prdate    where "
MsqlStr = MsqlStr + " t.divcode ='" & Divcode & "' and t.Prdate Between '" & Format(yfdate, "dd-mmm-yyyy") & "' and '" & Format(yldate, "dd-mmm-yyyy") & "' Order by t.prsno } AS ChildCMD RELATE DIVCODE TO DIVCODE,PRNO TO PRNO,PRDATE TO PRDATE) AS ChildCMD"
adoPrimaryRS.Open MsqlStr, DB, adOpenStatic, adLockBatchOptimistic
...
LookUp.Clear = True
LookUp.query = "select  varname as [Varity Name],varcode as [Varity Code] from RM_VAR "
...
With SpdIndent
    ...
    If Opt = "add" Or Opt = "mod" Then
        ...
        SetSpreadCol_RMI SpdIndent, E_SpdIndent.Sprdpack, "Pack Type", CellTypeEdit, 8, , False, False
    ...
    ElseIf Opt = "" Or Opt = " " Or Opt = "qry" Then
       ...
       ' .TypeDateFormat = TypeDateFormatDDMMYYYY
        SetSpreadCol_RMI SpdIndent, E_SpdIndent.SprdReqdDt, "Required Date", CellTypeStaticText, 12, , False, True
        .Col = SprdReqdDt
        .TypeHAlign = TypeHAlignCenter
...
On Error GoTo SpdLoad_Error
    ...
    Call SetGridHead
        ...
        Do While Not adoSecondaryRS.EOF
          ...
          '  SpdIndent.SetText E_SpdIndent.Sprdpack, RW, adoSecondaryRS("Packtype")
...
If Opt = "add" Or Opt = "mod" Or Opt = "qry" Or Opt = "" Or Opt = "fnd" Then
...
'   End If
           ...
           Dim oRpt As Craxdrt.Report
            ...
            Set oRpt = CrApp.OpenReport(KALFOLDERDATA & "RepRMI.rpt", 0)
