...
Begin VB.Form frm_issuereturn 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frm_issuereturn.frx":0000
      ...
      TabPicture(1)   =   "frm_issuereturn.frx":001C
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox Combo3 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frm_issuereturn.frx":0038
            Left            =   90
            List            =   "frm_issuereturn.frx":003A
            TabIndex        =   78
            Top             =   2490
            Visible         =   0   'False
            Width           =   1215
         ...
         Begin VB.ComboBox Combo2 
            ...
            ForeColor       =   &H00000000&
            Height          =   315
            ItemData        =   "frm_issuereturn.frx":003C
            Left            =   9540
            List            =   "frm_issuereturn.frx":0043
            TabIndex        =   73
            Top             =   150
            Width           =   1155
         End
         ...
         Begin VB.ComboBox Combo1 
            ...
            ForeColor       =   &H00000000&
            Height          =   315
            ItemData        =   "frm_issuereturn.frx":0051
            Left            =   1320
            List            =   "frm_issuereturn.frx":0053
            TabIndex        =   71
            Top             =   150
            Width           =   3135
         End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpreadADO.fpSpread SpdBales 
            ...
            MaxCols         =   3
            MaxRows         =   0
            SpreadDesigner  =   "frm_issuereturn.frx":0055
            AppearanceStyle =   0
         End
      ...
      Begin ubGridControl.ubGrid grid 
         ...
         FormatString    =   "Bale No. |Gross Weight|Tare Weight |Nett Weight |Act Ret Weight|Returned"
      End
      Begin MSDataGridLib.DataGrid grddatagrid 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "Lotwise Issue Return  Details"
         ColumnCount     =   2
         BeginProperty Column00 
            DataField       =   ""
            Caption         =   ""
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.CommandButton Command5 
            Caption         =   "&Cancel"
            DownPicture     =   "frm_issuereturn.frx":044D
            Height          =   495
            Left            =   6240
            Picture         =   "frm_issuereturn.frx":082F
            Style           =   1  'Graphical
            TabIndex        =   140
            Top             =   240
            Width           =   1185
         ...
         Begin VB.CommandButton Command6 
            Caption         =   "&OK"
            DownPicture     =   "frm_issuereturn.frx":0C02
            Height          =   495
            Left            =   2760
            Picture         =   "frm_issuereturn.frx":0FE8
            Style           =   1  'Graphical
            TabIndex        =   139
            Top             =   240
            Width           =   1185
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton Command2 
         Caption         =   "&OK"
         DownPicture     =   "frm_issuereturn.frx":13AE
         Height          =   615
         Left            =   2580
         Picture         =   "frm_issuereturn.frx":1794
         Style           =   1  'Graphical
         TabIndex        =   128
         Top             =   1680
         Width           =   975
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "&Cancel"
         DownPicture     =   "frm_issuereturn.frx":1B5A
         Height          =   615
         Left            =   4020
         Picture         =   "frm_issuereturn.frx":1F3C
         Style           =   1  'Graphical
         TabIndex        =   127
         Top             =   1680
         Width           =   975
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":230F
         Height          =   550
         Index           =   8
         Left            =   3315
         Picture         =   "frm_issuereturn.frx":2759
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":2ABB
         Height          =   550
         Index           =   10
         Left            =   4410
         Picture         =   "frm_issuereturn.frx":2DC5
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":3141
         Height          =   550
         Index           =   9
         Left            =   3855
         Picture         =   "frm_issuereturn.frx":344B
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":37ED
         Height          =   550
         Index           =   11
         Left            =   5490
         Picture         =   "frm_issuereturn.frx":3C37
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":3FCC
         Height          =   550
         Index           =   7
         Left            =   2775
         Picture         =   "frm_issuereturn.frx":4416
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   3
         Left            =   8640
         Picture         =   "frm_issuereturn.frx":4766
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":4AFD
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Index           =   2
         Left            =   570
         Picture         =   "frm_issuereturn.frx":4E07
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":51A3
         Height          =   550
         Index           =   5
         Left            =   1695
         Picture         =   "frm_issuereturn.frx":55ED
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":5952
         Height          =   550
         Index           =   0
         Left            =   30
         Picture         =   "frm_issuereturn.frx":5C5C
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":5FEF
         Height          =   550
         Index           =   6
         Left            =   2220
         Picture         =   "frm_issuereturn.frx":6439
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   12
         Left            =   9120
         Picture         =   "frm_issuereturn.frx":6786
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":6BC8
         Height          =   550
         Index           =   4
         Left            =   1035
         Picture         =   "frm_issuereturn.frx":6ED2
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton BUTTON 
         ...
         Index           =   13
         Left            =   4965
         Picture         =   "frm_issuereturn.frx":7267
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "frm_issuereturn.frx":76A9
         Height          =   550
         Index           =   1
         Left            =   570
         Picture         =   "frm_issuereturn.frx":79B3
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   End
End
Attribute VB_Name = "frm_issuereturn"
...
'    CrystalReport1.ReportFileName = Mid$(App.Path, 1, InStrRev(App.Path, "\", Len(App.Path))) & "Report\RMI\IssueReturn.rpt"
               Dim crygatenew As New clsCrystal
            Set crygatenew.cryRept = Cry_Issue_Return_New 'Cry_Issue_return
            crygatenew.CrystalPrint
            CrystalReport1.Reset
...
'
    ...
    CrystalReport1.ParameterFields(2) = "@Isstype;" & Left(Combo1.Text, 2)
    CrystalReport1.ParameterFields(3) = "@date;" & Format(MaskEdBox1(2).Text, "yyyy-MM-dd")
    CrystalReport1.ParameterFields(4) = "@dcno;" & Txtfields(15).Text
...
If ToValidFinYear(Divcode) = False Then Exit Sub
    ...
    rsz.Open "select max(Docdt) from rm_issrtnh where divcode='" & Divcode & "'", DB, adOpenStatic
...
'    Command8.Default = True
  ...
  '  Opt
    ...
    If Rs.RecordCount <> 0 Then
        StatusBar1.Panels(2).Text = "Select Any Document Number For Return"
   
         LookUp.Clear = True
         
         
'         LookUp.Query = "select distinct a.docno""Doc. No."",a.docdt""Doc. Date"",a.isstype""Issue Type"" from rm_issb a,RM_BALE c,RM_ISSH H where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.LOTTYPE=c.lottype AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.BALENO AND c.ISSUED='Y' and a.divcode='" & Divcode & "' and a.docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'" & _
'                        " and H.DIVCODE =A.DIVCODE AND H.ISSTYPE=A.ISSTYPE AND H.DOCNO=A.DOCNO AND H.DOCDT =A.DOCDT AND H.DOCNO NOT IN (SELECT BO_NO FROM RM_CINVHD WHERE DIVCODE='" & Divcode & "' AND  BO_DT between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "') "
        If issretprpflg = "Y" Or (UCase(CustID) = "SHRIGIRI" And Divcode = "01") Then
            LookUp.query = "select distinct a.docno""Doc. No."",a.docdt""Doc. Date"",a.isstype""Issue Type"" from rm_issb a,RM_BALE c,RM_ISSH H ,PRP_MixingRecRethd r where a.divcode=r.divcode and r.issueno=h.docno and r.issuedt=h.docdt and a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.LOTTYPE=c.lottype AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.BALENO  and a.divcode='" & Divcode & "' and a.docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'" & _
                        " and H.DIVCODE =A.DIVCODE AND H.ISSTYPE=A.ISSTYPE AND H.DOCNO=A.DOCNO AND H.DOCDT =A.DOCDT AND A.ISSTYPE='IS' and isnull(a.ISSKGS,0)-ISNULL(c.Return_kgs,0)>0  "
        Else
        
        If UCase(CustID) <> "SHRIGIRI" And UCase(CustID) <> "PALLAVA" Then
            LookUp.query = "select distinct a.docno""Doc. No."",a.docdt""Doc. Date"",a.isstype""Issue Type"" from rm_issb a,RM_BALE c,RM_ISSH H,rm_issuetype b  where b.issue_code=a.isstype and a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.LOTTYPE=c.lottype AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.BALENO  and a.divcode='" & Divcode & "' and a.docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'" & _
                        " and H.DIVCODE =A.DIVCODE AND H.ISSTYPE=A.ISSTYPE AND H.DOCNO=A.DOCNO AND H.DOCDT =A.DOCDT AND b.ISSTYPE='P' and isnull(a.ISSKGS,0)-ISNULL(c.Return_kgs,0)>0  "
        Else
            LookUp.query = "select distinct a.docno""Doc. No."",a.docdt""Doc. Date"",a.isstype""Issue Type"" from rm_issb a,RM_BALE c,RM_ISSH H  where   a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.LOTTYPE=c.lottype AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.BALENO  and a.divcode='" & Divcode & "' and a.docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'" & _
                        " and H.DIVCODE =A.DIVCODE AND H.ISSTYPE=A.ISSTYPE AND H.DOCNO=A.DOCNO AND H.DOCDT =A.DOCDT AND A.ISSTYPE='IS' and isnull(a.ISSKGS,0)-ISNULL(c.Return_kgs,0)>0  "
        End If
...
'                adoPrimaryRS.Open "SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,issno,issdt,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_ISSrtnH  " & _
'                     "  where DIVCODE = '" & Divcode & "' and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' Order by A.DOCNO", DB, adOpenStatic, adLockBatchOptimistic
                'adoPrimaryRS.AddNew
                Set adoPrimaryRS1 = New Recordset
                adoPrimaryRS1.Open "SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_ISSH  " & _
                     "  where DIVCODE = '" & Divcode & "' and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' Order by DOCNO", DB, adOpenStatic, adLockBatchOptimistic
                Set rsa = New Recordset
                rsa.Open "select isstype from rm_issuetype where issue_code='" & adoPrimaryRS1("isstype") & "'", DB, adOpenStatic
                Txtisstype = rsa(0)
                If rsa(0) = "S" Or rsa(0) = "J" Or rsa(0) = "R" Then
                    Txtfields(13).Text = adoPrimaryRS1!driver
                    If Not (IsNull(invdate)) Then
                        If invdate <> Empty Then
                    ...
                    CNTRS.Open "select slname from fa_slmas where slcode='" & adoPrimaryRS1("slcode") & "'", DB, adOpenStatic, adLockBatchOptimistic
                    If CNTRS.RecordCount > 0 Then
                        If IsNull(adoPrimaryRS1("slcode")) = False Then
                            Txtfields(1).Text = adoPrimaryRS1("slcode")
                            Text5.Text = CNTRS(0)
                        Else
                            Txtfields(1).Text = ""
                            Text5.Text = ""
                ...
                Else
                    ...
                    CNTRS.Open "select * from rm_count where cntcd='" & adoPrimaryRS1("cntcd") & "'", DB, adOpenStatic
                    If CNTRS.RecordCount > 0 Then
                        Txtfields(1).Text = adoPrimaryRS1("cntcd")
                        Text5.Text = CNTRS(0)
                    Else
                        Txtfields(1).Text = ""
                    End If
                End If
                Set CNTRS = New Recordset
                CNTRS.Open "select mixgrpname from rm_mixgrp where mixgrpcd='" & adoPrimaryRS1("mixgrp") & "'", DB, adOpenStatic, adLockBatchOptimistic
                If CNTRS.RecordCount > 0 Then
                    Txtfields(8).Text = adoPrimaryRS1("mixgrp")
                     Text12.Text = CNTRS(0)
                End If
                
                If IsNull(adoPrimaryRS1("invdate")) = False Then
                    MaskEdBox1(1).Mask = adoPrimaryRS1("invdate")
                    MaskEdBox1(1).Text = MaskEdBox1(1).Mask
                End If
                
                
                Set CNTRS = New Recordset
                CNTRS.Open "select divname from pp_divmas where divcode='" & adoPrimaryRS1("rdivcode") & "'", DB, adOpenStatic, adLockBatchOptimistic
    '            If CNTRS.RecordCount > 0 Then
    '                txtfields(1).Text = adoPrimaryRS("rdivcode")
    '                 Text5.Text = CNTRS(0)
    '            End If
    '            TXTFIELDS(13).Text = ""
                Txtfields(0).Text = adoPrimaryRS1("docno")
                If Txtisstype = "T" Or Txtisstype = "S" Or Txtisstype.Text = "J" Then
                    Txtfields(13).Text = adoPrimaryRS1("DRIVER")
                ElseIf Txtisstype = "P" Then
                    If Not IsNull(adoPrimaryRS1("ORDNO")) Then
                        Txtfields(13).Text = adoPrimaryRS1("ORDNO")
                    End If
                End If
...
Case 3
    ...
    Print #f, Space(5) & "Return List " & Space(39) + Space(39) + SR + Space(3) + "Pg. : " & Padl(pg, 3, " ")
    Print #f, Space(5) & String(110, "-")
    Print #f, Space(5) & "Docno       Docdt          Issue Type       Count                   Return Weight         Actual Weight "
    Print #f, Space(5) & String(110, "-")
    co = 8
    'Call headn(CInt(pg))
    Set Rs = New Recordset
    ...
    Rs.Open " select a.docno,a.docdt,a.cntcd,a.isstype,a.VEHICLENO,sum(b.isskgs) iskgs, sum(b.actisskgs) actKgs from rm_issrtnh a, RM_ISSrtnB b " & _
...
Dim dSoftPer As Double
    ...
    If Opt = "add" Then
        ...
        If rsz.RecordCount > 0 Then
            If IsDate(rsz(0)) = True Then
                If CDate(MaskEdBox1(2).Text) < CDate(rsz(0)) Then
                    MsgBox "Return Document Date must be after or equal to Last Return Date", vbInformation, head
        ...
        End If
        If Opt = "add" Then
            If CDate(MaskEdBox1(2).Text) < CDate(pdate) Then
                MsgBox "Return Document Date must be equal to Processing Issue Date", vbInformation, head
                MaskEdBox1(2).SetFocus
                Exit Sub
            End If
        End If
        ...
        dSoftPer = IIf(IsNull(Rs(0)), 0, Rs(0))
         ...
         If Txtisstype.Text = "P" Then
            ...
            If val(TxtActWt) > 0 Then dSoftWaste = (val(Txtfields(14).Text) / val(TxtActWt)) * 100 Else dSoftWaste = 0
...
'       rs1.Open "select distinct lotno,lotdt,divcode,catcd from rm_issrtnb where docno='" & adoSecondaryRS("docno") & "' and docdt='" & Format(adoSecondaryRS("docdt"), "yyyy-mm-dd") & "' and divcode='" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
'       rs1.MoveFirst
...
'    End If
    ...
    If Opt = "add" Then
        Set Rs = New Recordset
        Rs.Open "SELECT ISNULL(MAX(docno),0)+1 FROM rm_issrtnH WHERE  docdt BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "'  and divcode='" & Divcode & "' ", DB, adOpenStatic, adLockBatchOptimistic
       ...
       End If
        ...
        adoPrimaryRS("docdt") = Format(MaskEdBox1(2).Text, "yyyy-mm-dd")
        adoPrimaryRS("divcode") = Divcode
        adoPrimaryRS("isstype") = Left(Combo1.Text, 2)
        adoPrimaryRS("issto") = Left(Combo2.Text, 1)
        adoPrimaryRS("docno") = Txtfields(15).Text
        adoPrimaryRS("issno") = Txtfields(0).Text
        ...
        Opt = ""
            ...
            Loop
            If updSECONDARYRS.RecordCount > 0 Then
                updSECONDARYRS.MoveFirst
            End If
'        opt1 = Opt
'        Opt = ""
...
'        rsdet.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,DOCNO,DOCDT,issno,issdt,a.LOTNO,a.LOTDT,a.varcode,BALENO,ISSKGS ""Issued Weight"",Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a  where 1=2", DB, adOpenStatic, adLockBatchOptimistic
       Do While Not adoSecondaryRS.EOF
            adoSecondaryRS!Divcode = Divcode
            adoSecondaryRS!ISSTYPE = Left(Combo1.Text, 2)
            adoSecondaryRS("issno") = Txtfields(0).Text
            adoSecondaryRS("issdT") = Format(MaskEdBox1(0).Text, "yyyy-mm-dd")
            adoSecondaryRS!docNo = val(Txtfields(15).Text)
            adoSecondaryRS("docdT") = Format(MaskEdBox1(2).Text, "yyyy-mm-dd")
            If Option2.value = True Then
                adoSecondaryRS("Issued Weight") = adoSecondaryRS("AIKgs")
            End If
            If Option1.value = True Then
                If adoSecondaryRS("Issued Weight") > adoSecondaryRS("AIKgs") Then
                    adoSecondaryRS("Issued Weight") = adoSecondaryRS("AIKgs")
                End If
            End If
            
            Set rsa = New Recordset
            rsa.Open "SELECT ARRDT FROM RM_LOT WHERE varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype='" & grdDataGrid.Columns(ilottype).Text & "' AND LOTNO='" & grdDataGrid.Columns(ILotNo).Text & "' AND LOTDT='" & Format(grdDataGrid.Columns(ILotdt), "yyyy-mm-dd") & "' AND LOTYEAR='" & Year(yfdate) & "' AND DIVCODE='" & Divcode & "'", DB, adOpenStatic
            ...
            End If
                 ...
                 Set TrnLog = New Recordset
                   ...
                   ' TrnLog("TC") = 3
                    ...
                    TrnLog("Trans_Name") = "Issue Return"
                    ...
                    TrnLog("IRNo") = val(Txtfields(0).Text)
                    TrnLog("IRdate") = Format(MaskEdBox1(0).Text, "yyyy-mm-dd hh:mm:ss.m")
                    TrnLog("docno") = val(Txtfields(15).Text)
                    TrnLog("docdt") = Format(MaskEdBox1(2).Text, "yyyy-mm-dd hh:mm:ss.m")
                    TrnLog("lotno") = adoSecondaryRS("Lot No.")
                    TrnLog("lotdt") = Format((adoSecondaryRS("Date")), "YYYY-MM-DD")
                    TrnLog("varcode") = Trim(adoSecondaryRS("Variety"))
                    TrnLog("Isstype") = Left(Combo1.Text, 2)
                    TrnLog("CNTCoDe") = grdDataGrid.Columns(icategory).Text
                    TrnLog("mixgrp") = Trim(Txtfields(8).Text)
                    TrnLog("ordqty") = adoSecondaryRS("BALENO")
                    TrnLog("ordkgs") = val(adoSecondaryRS("AIKgs"))
    ...
    End If
      ...
      If Txtisstype.Text = "T" Or Txtisstype.Text = "S" Or Txtisstype.Text = "J" Or Txtisstype.Text = "R" Then
            DB.Execute "UPDATE RM_ISSrtnH SET VEHICLENO='" & Txtfields(7).Text & "' WHERE DOCNO='" & adoPrimaryRS("DOCNO") & "' AND DOCDT='" & Format(adoPrimaryRS("DOCDT"), "YYYY-MM-DD") & "' and divcode='" & Divcode & "'"
      End If
      If Txtisstype.Text = "P" Then
            DB.Execute "UPDATE RM_ISSrtnH SET Mixgrp='" & Trim(Txtfields(8).Text) & "',cntcd='" & Txtfields(1).Text & "' WHERE divcode='" & Divcode & "' and  DOCNO='" & adoPrimaryRS("DOCNO") & "' AND DOCDT='" & Format(adoPrimaryRS("DOCDT"), "YYYY-MM-DD") & "'"
      ...
      End If
       ...
       Do While Not adoSecondaryRS.EOF
        ...
        balers.Open "select baleno ""Baleno"",GRWT ""Gross Weight"",TAREWT""Tare Weight"",NETWT-isnull(actisskgs,0) ""Net Weight"",actisskgs ""AIssKgs"",issued ""Issued"" from rm_bale where STATUS IN ('AC','AW') AND varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype='" & Trim(adoSecondaryRS("lottype")) & "' and  lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "'  and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and (issued='Y')  and (ltrim(rtrim(openkey))='' or openkey is null or openkey='N') and baleno=" & adoSecondaryRS("BALENO") & " and isnull(rejflg,'N')='N'  and divcode='" & Divcode & "' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
        Set rs1 = New Recordset
        rs1.Open "select ISNULL(isqty,0) from rm_bale  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "'  and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND varcode='" & Trim(adoSecondaryRS("Variety")) & "' and BALENO=" & adoSecondaryRS("BALENO") & "  and isnull(rejflg,'N')='N' and divcode='" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
        If rs1.RecordCount > 0 Then
            If adoSecondaryRS!AIKgs <> Empty Then
                If adoSecondaryRS!Issued = "N" Then
                    DB.Execute ("update rm_bale set isqty= isnull(isqty,0)-" & val(adoSecondaryRS("Issued Weight")) & ",ActIssKgs=isnull(ActIssKgs,0) - " & val(adoSecondaryRS!AIKgs) & ",ISSUED= 'Y'  where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & "  and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
                    DB.Execute ("update rm_bale set return_kgs= isnull(return_kgs,0)+" & val(adoSecondaryRS("Issued Weight")) & "  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype = '" & adoSecondaryRS("lottype") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & "  and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
                Else
                    DB.Execute ("update rm_bale set isqty=isnull(isqty,0)- " & adoSecondaryRS("Issued Weight") & ",ActIssKgs= isnull(ActIssKgs,0) - " & adoSecondaryRS!AIKgs & ",ISSUED= 'N'  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype = '" & adoSecondaryRS("lottype") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & " and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
                    DB.Execute ("update rm_bale set return_kgs= isnull(return_kgs,0)+" & val(adoSecondaryRS("Issued Weight")) & "  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype = '" & adoSecondaryRS("lottype") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & "  and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
                End If
                If adoSecondaryRS!Issued = "N" Then
                    DB.Execute ("update rm_lot set isswt=isnull(isswt,0) - " & val(adoSecondaryRS("Issued Weight")) & ",issbal=isnull(issbal,0) where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lotno='" & adoSecondaryRS("Lot No.") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and divcode='" & Divcode & "' and lotyear='" & Year(yfdate) & "'")
                Else
                    DB.Execute ("update rm_lot set isswt=isnull(isswt,0) - " & val(adoSecondaryRS("Issued Weight")) & ",issbal=isnull(issbal,0)- " & 1 & " where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and divcode='" & Divcode & "' and lotno='" & adoSecondaryRS("Lot No.") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "'  and lotyear='" & Year(yfdate) & "'")
                End If
                
                Set rs5 = New Recordset
                If Format(adoSecondaryRS("date"), "dd/mm/yyyy") > yfdate Then
                    rs5.Open "select count(*)  from RM_BALE where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype = '" & adoSecondaryRS("lottype") & "' and LOTNO='" & adoSecondaryRS("Lot No.") & "'  and DIVCODE='" & Divcode & "' and LOTDT='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and isnull(ISSUED,'N')='Y' ", DB, adOpenStatic, adLockBatchOptimistic
                Else
                    rs5.Open "select count(*)  from RM_BALE where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype = '" & adoSecondaryRS("lottype") & "' and LOTNO='" & adoSecondaryRS("Lot No.") & "'  and DIVCODE='" & Divcode & "' and LOTDT='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and isnull(ISSUED,'N')='Y' and lot_year='" & Year(yfdate) & "' ", DB, adOpenStatic, adLockBatchOptimistic
                End If
                If Not rs5.EOF Then
                    DB.Execute ("update rm_lot set issbal= " & rs5(0) & " where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lotno='" & adoSecondaryRS("Lot No.") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and divcode='" & Divcode & "'  and lotyear='" & Year(yfdate) & "'")
                End If
                
            Else
                DB.Execute ("update rm_bale set isqty=isnull(isqty,0)-" & val(adoSecondaryRS("Issued Weight")) & ",ActIssKgs=" & val(adoSecondaryRS("AIKgs")) & ",ISSUED= 'N'  where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & " and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
                DB.Execute ("update rm_bale set return_kgs= isnull(return_kgs,0)+" & val(adoSecondaryRS("Issued Weight")) & "  where STATUS IN ('AC','AW') AND lotno='" & adoSecondaryRS("Lot No.") & "' and varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lottype = '" & adoSecondaryRS("lottype") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' AND BALENO=" & adoSecondaryRS("BALENO") & "  and divcode='" & Divcode & "' and isnull(rejflg,'N')='N'")
                DB.Execute ("update rm_lot set isswt=isnull(isswt,0) - " & val(adoSecondaryRS("Issued Weight")) & ",issbal=isnull(issbal,0)- " & 1 & " where varcode='" & Trim(adoSecondaryRS("Variety")) & "' and lotno='" & adoSecondaryRS("Lot No.") & "' and lotdt='" & Format(adoSecondaryRS("date"), "yyyy-mm-dd") & "' and lottype = '" & adoSecondaryRS("lottype") & "' and divcode='" & Divcode & "'  and lotyear='" & Year(yfdate) & "'")
       ...
       DB.CommitTrans
       MsgBox "IssueReturn Details Saved!", vbInformation, head
       MsgBox "Doc Number is " & Txtfields(15).Text, vbInformation, head
       'SSTab1.Enabled = False
       Frame1.Enabled = False
       Frame4.Enabled = False
       Frame7.Enabled = False
 ...
 If Opt = "del" Then
    ...
    If msg = vbYes Then
        ...
        'db.BeginTrans
           adoSecondaryRS.MoveFirst
           Set rs1 = New Recordset
          rs1.Open "select distinct lotno,lotdt,divcode,catcd,LOTTYPE,varcode from rm_issrtnb where docno='" & adoSecondaryRS("docno") & "' and docdt='" & Format(adoSecondaryRS("docdt"), "yyyy-mm-dd") & "' and divcode='" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
           rs1.MoveFirst
           Do While Not rs1.EOF
                Set Rs = New Recordset ''fOR bALES
                Rs.Open "SELECT count(baleno) FROM RM_ISSrtnB B WHERE  DOCNO=" & Txtfields(15).Text & " AND docdt='" & Format(MaskEdBox1(2).Text, "yyyy-mm-dd") & "' and varcode='" & rs1("varcode") & "' and lottype='" & rs1("lottype") & "' and lotno='" & rs1(0) & "' and lotdt='" & Format(rs1(1), "yyyy-mm-dd") & "' and catcd='" & rs1(3) & "' AND DIVCODE='" & Divcode & "' AND ISSUED='Y'", DB, adOpenStatic, adLockBatchOptimistic
                Set rsg = New Recordset ''fOR KGS
                rsg.Open "SELECT SUM(IssKgs) FROM RM_ISSrtnB B WHERE  DOCNO=" & Txtfields(15).Text & " AND docdt='" & Format(MaskEdBox1(2).Text, "yyyy-mm-dd") & "' and varcode='" & rs1("varcode") & "' and lottype='" & rs1("lottype") & "' and lotno='" & rs1(0) & "' and lotdt='" & Format(rs1(1), "yyyy-mm-dd") & "' and catcd='" & rs1(3) & "' AND DIVCODE='" & Divcode & "'", DB, adOpenStatic, adLockBatchOptimistic
                
                Set rs2 = New Recordset
                rs2.Open "select isnull(isswt,0),isnull(issbal,0) from rm_lot where lottype = '" & rs1("LOTTYPE") & "'  and varcode='" & rs1("varcode") & "' and  lotno='" & rs1(0) & "' and lotdt='" & Format(rs1(1), "yyyy-mm-dd") & "' and catcd='" & rs1(3) & "' AND DIVCODE='" & Divcode & "' and lotyear='" & Year(yfdate) & "'", DB, adOpenStatic, adLockBatchOptimistic
                QTY = rs2(0)
                selbale = rs2(1)
                DB.Execute ("update rm_lot set isswt = " & val(QTY) & " + " & val(rsg(0)) & ",issbal=" & val(selbale) & " + " & val(Rs(0)) & " where varcode='" & rs1("varcode") & "' and  lottype = '" & grdDataGrid.Columns(6).Text & "' and  DIVCODE='" & Divcode & "' AND lotno='" & rs1(0) & "' and lotdt='" & Format(rs1(1), "yyyy-mm-dd") & "' and catcd='" & rs1(3) & "' AND DIVCODE='" & Divcode & "' and lotyear='" & Year(yfdate) & "'"), a
                
'
'                Set rs5 = New Recordset
'                If Format(rs1(1), "dd/mm/yyyy") > yfdate Then
'                    rs5.Open "select count(*)  from RM_BALE where LOTNO='" & rs1(0) & "'  and DIVCODE='" & Divcode & "' and LOTDT='" & Format(rs1(1), "yyyy-mm-dd") & "' and isnull(ISSUED,'N')='Y' ", DB, adOpenStatic, adLockBatchOptimistic
'                Else
'                    rs5.Open "select count(*)  from RM_BALE where LOTNO='" & rs1(0) & "'  and DIVCODE='" & Divcode & "' and LOTDT='" & Format(rs1(1), "yyyy-mm-dd") & "' and isnull(ISSUED,'N')='Y' and lot_year='" & Year(yfdate) & "' ", DB, adOpenStatic, adLockBatchOptimistic
'                End If
'                If Not rs5.EOF Then
'                    DB.Execute ("update rm_lot set issbal= " & rs5(0) & " where lotno='" & rs1(0) & "' and lotdt='" & Format(rs1(1), "yyyy-mm-dd") & "' and lottype = '" & grddatagrid.Columns(6).Text & "' and divcode='" & Divcode & "'  and lotyear='" & Year(yfdate) & "'")
'                End If
           ...
           '' Do While Not adoSecondaryRS.EOF
             ...
             ''   rs.Open "Select distinct baleno,lotdt""Date"",lotno,lottype,actisskgs,ISSKGS from rm_issb where LOTNO=" & adoSecondaryRS("Lot No") & " and lotdt='" & Format(adoSecondaryRS("Date"), "yyyy-mm-dd") & "' and DOCNO=" & adoSecondaryRS("DOCNO") & " and DOCDT='" & Format(adoSecondaryRS("DOCDT"), "yyyy-mm-dd") & "' and lottype = '" & grddatagrid.Columns(6).Text & "' and divcode='" & Divcode & "'", DB, adOpenStatic
                Rs.Open "Select distinct baleno,lotdt""Date"",lotno,lottype,actisskgs,ISSKGS,varcode from rm_issrtnb where DOCNO=" & adoSecondaryRS("DOCNO") & " and DOCDT='" & Format(adoSecondaryRS("DOCDT"), "yyyy-mm-dd") & "' and divcode='" & Divcode & "' ORDER BY LOTNO,LOTDT,BALENO", DB, adOpenStatic
                Do While Not Rs.EOF
                    DB.Execute "update rm_bale set isqty=isqty+" & val(Rs("ISSKGS")) & ",actisskgs=actisskgs+" & val(Rs("actisskgs")) & " WHERE STATUS IN ('AC','AW') AND LOTNO=" & Rs("LotNo") & " and lotdt='" & Format(Rs("Date"), "yyyy-mm-dd") & "' and baleno=" & Rs(0) & " and lottype = '" & Rs("lottype") & "' and divcode='" & Divcode & "'  and varcode='" & Rs("varcode") & "' and  isnull(rejflg,'N')='N'", a
                    DB.Execute "update rm_bale set issued='Y' WHERE varcode='" & Rs("varcode") & "' and  STATUS IN ('AC','AW') AND LOTNO=" & Rs("LotNo") & " and lotdt='" & Format(Rs("Date"), "yyyy-mm-dd") & "' and baleno=" & Rs(0) & " and lottype = '" & Rs("lottype") & "' and divcode='" & Divcode & "'  and isnull(rejflg,'N')='N' AND NETWT=ISNULL(ACTISSKGS,0)", a
                    DB.Execute ("update rm_bale set return_kgs= isnull(return_kgs,0)-" & val(Rs("ISSKGS")) & "  where STATUS IN ('AC','AW') AND lotno='" & Rs("LotNo") & "' and lottype = '" & Rs("lottype") & "' and lotdt='" & Format(Rs("date"), "yyyy-mm-dd") & "' AND BALENO=" & Rs("BALENO") & "  and divcode='" & Divcode & "' and varcode='" & Rs("varcode") & "' and  isnull(rejflg,'N')='N'")
                    ''This code For Update "N" to Already Set "Y" Bale
                    DB.Execute "update rm_ISSrtnB set issued='N' WHERE LOTNO=" & Rs("LotNo") & " and lotdt='" & Format(Rs("Date"), "yyyy-mm-dd") & "' and baleno=" & Rs(0) & " and lottype = '" & Rs("lottype") & "' and divcode='" & Divcode & "'  and DOCNO<>" & adoPrimaryRS("DOCNO") & " AND varcode='" & Rs("varcode") & "' and  DOCDT>='" & Format(adoPrimaryRS("DOCDT"), "YYYY-MM-DD") & "'", a
                   ...
                   ' TrnLog("TC") = 3
                    ...
                    TrnLog("docno") = val(Txtfields(15).Text)
                    TrnLog("docdt") = Format(MaskEdBox1(2).Text, "yyyy-mm-dd hh:mm:ss.m")
                    TrnLog("lotno") = Rs("LotNo")
                    TrnLog("lotdt") = Format(Rs("Date"), "yyyy-mm-dd")
                   
                    TrnLog("varcode") = Trim(Rs("varcode"))
                    TrnLog("Isstype") = Left(Combo1.Text, 2)
                  '  TrnLog("CNTCD") = grddatagrid.Columns(icategory).Text
                    TrnLog("mixgrp") = Trim(Txtfields(8).Text)
                    TrnLog("ordqty") = val(Rs(0))
                    TrnLog("ordkgs") = val(Rs("ISSKGS"))
                    TrnLog.UpdateBatch adAffectAllChapters
            ...
            ''    adoSecondaryRS.MoveNext
           '' Loop
            DB.Execute ("delete from rm_issrtnb where docno =" & Trim(Txtfields(15).Text) & " and docdt ='" & Format(MaskEdBox1(2).Text, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' ")
            DB.Execute ("delete from rm_issrtnh where docno =" & Trim(Txtfields(15).Text) & " and docdt ='" & Format(MaskEdBox1(2).Text, "yyyy-mm-dd") & "' and divcode='" & Divcode & "' ")
...
intervalMinutes = -1
    Set adoPrimaryRS = New Recordset
    adoPrimaryRS.Open "SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,ISSNO,ISSDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,softwaste FROM RM_ISSRTNH  WHERE 1 = 2  order by docno", DB, adOpenStatic, adLockOptimistic
    Set adoSecondaryRS = New Recordset
    'adoSecondaryRS.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,DOCNO,DOCDT,a.LOTNO""Lot No."" ,a.LOTDT""Date"",b.plotno ""Supplier lot No."",a.varcode ""Variety"",COLORCODE ""Color"",'            ' ""Closing Bales"",'            '""Closing Weight"",ISSKGS""Issued Kgs"",Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a,rm_lot b  where a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.catcd=b.catcd and 1=2 ", DB, adOpenStatic, adLockBatchOptimistic
    adoSecondaryRS.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,DOCNO,DOCDT,issno,issdt,a.LOTNO""Lot No."" ,a.LOTDT""Date"",b.plotno ""Supplier lot No."",a.varcode ""Variety"",COLORCODE ""Color"",BALENO ""Issued Bales"",ISSKGS ""Issued Weight"",Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a,rm_lot b  where a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.catcd=b.catcd and 1=2", DB, adOpenStatic, adLockBatchOptimistic
   'adoSecondaryRS.Open "SELECT A.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No."",a.LOTDT""Date"",b.LotType,b.plotno""Supplier Lot No."",b.VARCODE""Variety"",colorcode ""Color"",a.CATCD,BALENO ""Issued Bales"",a.actisskgs ""Issued Weight"",a.baleno""BaleNo"",a.arrdt,a.isskgs""Aikgs"",a.issued FROM RM_ISSRTNb a,rm_lot b where  a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.divcode=b.divcode and 1=2", db, adOpenStatic, adLockBatchOptimistic
    ...
    With updSECONDARYRS
           ...
           .Fields.Append "Variety Name", adVarChar, 150
           ...
           .Fields.Append "Issued Weights", adDouble
           .Fields.Append "Return Bales", adSmallInt
           .Fields.Append "Return Kgs", adDouble
    End With
    updSECONDARYRS.Open
    Set grdDataGrid.DataSource = updSECONDARYRS
    Set UPDRS = New Recordset
           UPDRS.Fields.Append "Rtn Kgs", adDouble, 10
           UPDRS.Fields.Append "Rtn bales", adSmallInt, 10
    ...
    grdDataGrid.Columns(10).Width = 1230
     ...
     Set Cnn = New Connection
        Cnn.Open connectstring
          Dim grandtotal As Integer
            ...
            'select distinct A.LotNo,A.LotDt,B.VARCODE, c.isstype from rm_issb A,RM_LOT B, rm_issuetype c where a.isstype=c.issue_code and A.LOTNO=B.LOTNO AND A.LOTDT=B.LOTDT AND a.divcode=b.divcode and docNo=213 AND a.ISSTYPE='P2' and a.divcode='1' AND DOCDT BETWEEN '2007-04-01' AND '2008-03-31' order by A.lotno
            ResultRs.Open "select distinct A.LotNo,A.LotDt,B.VARCODE, c.isstype  from rm_issrtnb A,RM_LOT B, rm_issuetype c where a.isstype=c.issue_code and A.LOTNO=B.LOTNO AND A.LOTDT=B.LOTDT AND a.divcode=b.divcode and docNo=" & val(LtN) & _
            ...
            Do While Not ResultRs.EOF
                ...
                RESULT.Open "select distinct a.LotNo,a.LotDt,grwt,b.tarewt,isnull(b.moiSture_ET,0) as moiture,b.netwt,isnull(b.IsQty,0)'IsQty',isnull(C.ActIssKgs,0) 'AIKgs',isnull(C.ActIssKgs,0)-isnull(b.IsQty,0) 'Excess',c.Baleno,c.actisskgs  from rm_lot a,rm_bale b,rm_issrtnb c, rm_issuetype d where a.divcode=b.divcode and a.divcode=c.divcode and a.divcode='" & Divcode & "' and d.isstype ='" & typeflg & "' and c.docno = " & LtN & " and a.LotNo=b.LotNo  AND A.LOTDT=B.LOTDT AND B.LOTDT=C.LOTDT and b.LotNo=c.LotNo and b.baleno=c.baleno and a.LotNo=" & ResultRs("lotno") & " and a.lotdt = '" & Format(ResultRs("lotdt"), "yyyy-mm-dd") & "' and a.rejflg='N' and a.lotyear='" & Year(yfdate) & "' order by c.baleno", DB, adOpenStatic
                Else
                Set RESULT = New Recordset
                RESULT.Open "select distinct a.LotNo,a.LotDt,grwt,b.tarewt,isnull(b.moiSture_ET,0) as moiture,b.netwt,isnull(b.IsQty,0)'IsQty',isnull(C.ActIssKgs,0) 'AIKgs',isnull(C.ActIssKgs,0)-isnull(b.IsQty,0) 'Excess',c.Baleno,c.actisskgs from rm_lot a,rm_bale b,rm_issrtnb c where a.divcode=b.divcode and a.divcode=c.divcode and c.isstype in ('P','Q') and c.docno = " & LtN & " and a.LotNo=b.LotNo  AND A.LOTDT=B.LOTDT AND B.LOTDT=C.LOTDT and b.LotNo=c.LotNo and b.baleno=c.baleno and a.LotNo=" & ResultRs("lotno") & " and a.lotdt = '" & Format(ResultRs("lotdt"), "yyyy-mm-dd") & "'  and a.rejflg='N' and a.lotyear='" & Year(yfdate) & "' and a.divcode='" & Divcode & "' order by c.baleno", DB, adOpenStatic
                End If
            ...
            dTotalWgt = 0
            Set Rs = New Recordset
            Rs.Open "select sum(a.actisskgs) AS IssKgs,count(a.baleno) AS Bales from rm_issrtnb A, " & _
                     "rm_issuetype c where a.isstype=c.issue_code " & _
                     "and docNo=" & val(LtN) & " AND c.ISSTYPE='" & typeflg & "' and a.divcode='" & Divcode & "' AND DOCDT BETWEEN '" & Format(yfdate, "yyyy-MM-dd") & "' AND '" & Format(yldate, "yyyy-MM-dd") & "'", DB, adOpenStatic
            If Rs.EOF = False Then
                dTotalWgt = Rs(0)
            End If
            Dim dRatio As Double
            Set Rs = New Recordset
            Rs.Open "select d.varname, c.isstype, sum(a.actisskgs) AS IssKgs,count(a.baleno) AS Bales from rm_issrtnb A, " & _
                     "rm_issuetype c,rm_var d where a.varcode = d.varcode and a.isstype=c.issue_code and " & _
                     "docNo=" & val(LtN) & " AND c.ISSTYPE='" & typeflg & "' and a.divcode='" & Divcode & "' AND DOCDT BETWEEN '" & Format(yfdate, "yyyy-MM-dd") & "' AND '" & Format(yldate, "yyyy-MM-dd") & "' " & _
...
'    BUTTON(10).Enabled = True
    ...
    If Opt = "add" Then
        ...
        If s = val(grdDataGrid.Columns(8).value) Or ChkEx = val(grdDataGrid.Columns(8).value) Then
           adoPrimaryRS("docdt") = Format(MaskEdBox1(2).Text, "yyyy-mm-d")
           adoPrimaryRS("divcode") = Divcode
           adoPrimaryRS("isstype") = Left(Combo1.Text, 2)
           adoPrimaryRS("issto") = Left(Combo2.Text, 1)
           adoPrimaryRS("docno") = Rs(0)
           adoPrimaryRS("issno") = Txtfields(0).Text
           adoPrimaryRS("issdt") = Format(MaskEdBox1(0).Text, "yyyy-mm-d")
    ...
    End If
        ...
        '         balers.Bookmark = grid.RowBookmark(I)
                If grid.TextMatrix(I, 1) <> "" Then
                 ...
                 adoSecondaryRS("Issued Weight") = val(grid.TextMatrix(I, 4))
...
Else
      ...
      For I = 1 To grid.Rows
         ...
         End If
         If Opt = "mod" Then
            adoSecondaryRS("Issued Weight") = val(grid.TextMatrix(I, 5))
         End If
...
End If
   ...
   If vbYes = MsgBox("Do you want to enter more Lot details?", vbYesNo, head) Then
      ...
      If Opt = "add" Then
        UPDRS.AddNew
        UPDRS("RTN Kgs") = val(Text4.Text)
        UPDRS("RTN bales") = val(Text3.Text)
...
If ChkCount = TotalBale Then
        ...
        For RW = 1 To SpdBales.MaxRows
            ...
            If SpdBales.value = True Then
                ...
                chrs.Open "select awt_flg from rm_lot where  DIVCODE='" & Divcode & "' AND lotno='" & Trim(grdDataGrid.Columns(0).Text) & "' and lottype ='" & Trim(grdDataGrid.Columns(2).Text) & "' and lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' and catcd='" & grdDataGrid.Columns(6).Text & "' and varcode='" & grdDataGrid.Columns("Variety").Text & "' ", DB, adOpenDynamic, adLockBatchOptimistic
    ...
    If Opt = "add" Or Opt = "mod" Then
        ...
        Else
           ...
           ' Frame7.Visible = False
            ...
            grid.Rows = grid.Rows + 1
           ' On Error Resume Next
            'DB.Execute "IF (SELECT COUNT(*) FROM SYSOBJECTS WHERE NAME='VW_RMTmpIssueRTNWT' AND TYPE='V')>0 DROP VIEW VW_RMTmpIssueRTNWT"
            'Con.Execute "CREATE VIEW VW_RMTmpIssueWT AS Select Baleno, NETWT-ISNULL(ActIssKgs,0) From Rm_Bale Where Lotno = '" & List1.Text & "' and Catcd = '" & catcode & "' and ISNULL(Issued,'N') = 'N' and lotdt='" & Format(lotdt, "yyyy-mm-dd") & "'"
            
'            If Opt = "add" Then
'                DB.Execute "CREATE VIEW VW_RMTmpIssueRTNWT AS Select Baleno,Grwt,Tarewt,Netwt,NETWT-ISNULL(ActIssKgs,0)AIsskgs From Rm_Bale Where STATUS IN ('AC','AW') AND Lotno = '" & Trim(grddatagrid.Columns(ILotNo).Text) & "' and Catcd = '" & grddatagrid.Columns(icategory).Text & "' and ISNULL(Issued,'N') = 'Y' and lotdt='" & Format(grddatagrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "' and isnull(rejflg,'N')='N' and divcode='" & Divcode & "'"
'            Else
'                DB.Execute "CREATE VIEW VW_RMTmpIssueWT AS Select Baleno,Grwt,Tarewt,Netwt,NETWT-ISNULL(ActIssKgs,0)AIsskgs From Rm_Bale Where baleno not in (" & gbaleno & ") and STATUS IN ('AC','AW') AND Lotno = '" & Trim(grddatagrid.Columns(ILotNo).Text) & "' and Catcd = '" & grddatagrid.Columns(icategory).Text & "' and ISNULL(Issued,'N') = 'Y' and lotdt='" & Format(grddatagrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "' and isnull(rejflg,'N')='N' and divcode='" & Divcode & "'"
'            End If
            twt = 0
            Set balers = New Recordset
            'balers.Open "Select * from VW_RMTmpIssueRTNWT order by cast(baleno as decimal(5))", DB, adOpenStatic
            If Opt = "add" Then
                '''hide by Siva 06.03.12
                ''balers.Open "Select a.Baleno,a.Grwt,a.Tarewt,a.Netwt,ISNULL(a.ISQTY,0)AIsskgs From Rm_Bale a,rm_issb c Where a.LOTNO=c.lotno AND a.lotdt=c.lotdt AND a.lottype=c.lottype AND a.CATCD=c.catcd AND a.VARCODE=c.varcode AND a.BALENO=c.baleno AND c.docno='" & txtfields(0).Text & "' AND c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and a.STATUS IN ('AC','AW') AND a.Lotno = '" & Trim(grddatagrid.Columns(ILotNo).Text) & "' and a.Catcd = '" & grddatagrid.Columns(icategory).Text & "' and ISNULL(a.Issued,'N') = 'Y' and a.lotdt='" & Format(grddatagrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "' and isnull(a.rejflg,'N')='N' and a.divcode='" & Divcode & "' order by cast(a.baleno as decimal(5))", DB, adOpenStatic
                balers.Open "Select a.Baleno,a.Grwt,a.Tarewt,a.Netwt,ISNULL(C.Actisskgs,0)AIsskgs From Rm_Bale a,rm_issb c Where a.LOTNO=c.lotno AND a.lotdt=c.lotdt AND a.lottype=c.lottype AND a.CATCD=c.catcd AND a.VARCODE=c.varcode AND a.BALENO=c.baleno AND c.docno='" & Txtfields(0).Text & "' AND c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and a.STATUS IN ('AC','AW') AND a.Lotno = '" & Trim(grdDataGrid.Columns(ILotNo).Text) & "' and a.Catcd = '" & grdDataGrid.Columns(icategory).Text & "'  and ISNULL(C.Actisskgs,0) >0  and a.lotdt='" & Format(grdDataGrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "' and isnull(a.rejflg,'N')='N' and a.divcode='" & Divcode & "' order by cast(a.baleno as decimal(5))", DB, adOpenStatic
                
                
            Else
                balers.Open "Select a.Baleno,a.Grwt,a.Tarewt,a.Netwt,ISNULL(a.ISQTY,0)AIsskgs From Rm_Bale a,rm_issb c Where a.LOTNO=c.lotno AND a.lotdt=c.lotdt AND a.lottype=c.lottype AND a.CATCD=c.catcd AND a.VARCODE=c.varcode AND a.BALENO=c.baleno AND c.docno='" & Txtfields(0).Text & "' AND c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and a.baleno not in (" & gbaleno & ") and a.STATUS IN ('AC','AW') AND a.Lotno = '" & Trim(grdDataGrid.Columns(ILotNo).Text) & "' and a.Catcd = '" & grdDataGrid.Columns(icategory).Text & "' and ISNULL(a.Issued,'N') = 'Y' and a.lotdt='" & Format(grdDataGrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "' and isnull(a.rejflg,'N')='N' and a.divcode='" & Divcode & "' order by cast(a.baleno as decimal(5))", DB, adOpenStatic
            End If
            If balers.RecordCount > 0 Then
                balers.MoveFirst
                ...
                t1actisskgs = 0
                t1bales = 0
                While Not balers.EOF And TEMP > 0 And balers.RecordCount > 0
                    ...
                    If balers(4) > TEMP Then
                        ...
                        grid.TextMatrix(grid.Rows - 1, 6) = "Y" 'issued
...
'SetColoumn
    Set Rs = New Recordset
    Rs.Open "Select isnull(issretprpflg,'N') issretprpflg  from rm_param ", DB, adOpenStatic
    issretprpflg = Rs("issretprpflg")
...
'        End If
        ...
        '----------------ANBU---------------
        Set adoSecondaryRS = New Recordset
         adoSecondaryRS.Open "SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.plotno""Supplier Lot No"",b.VARCODE""Variety"",colorcode ""Color"",a.CATCD""Category"",a.actisskgs ""Issued Kgs"",a.baleno""Bale No."",a.arrdt,a.isskgs""Aikgs"",a.issued  FROM RM_ISSRTNb a,rm_lot b " & _
                     " where  a.DIVCODE = '" & Divcode & "' and  a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.divcode=b.divcode  and a.varcode=b.varcode  and docno = '" & Trim(adoPrimaryRS("docno")) & "' and DOCDT = '" & Format(adoPrimaryRS("docdt"), "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' order by a.lotno,a.baleno", DB, adOpenStatic, adLockBatchOptimistic
...
'         grddatagrid.Columns(10).Alignment = dbgRight
        ...
        Dim balers As Recordset
        Set balers = New Recordset
        balers.Open "Select Count(Baleno) as Baleno,Sum(IssKgs) as IssueKgs,SUM(ActIssKgs) as ActIssKgs from RM_ISSB where  DIVCODE = '" & Divcode & "' and DocNo='" & adoPrimaryRS!docNo & "' and docdt='" & Format(adoPrimaryRS("docdt"), "yyyy-MM-dd") & "'", DB
...
Txtfields(15).Text = adoPrimaryRS("docno")
...
MaskEdBox1(0).Text = Format(adoPrimaryRS("ISSDT"), "dd/mm/yyyy")
...
If Opt = "add" And IssFlg = "Balewise" Then
        ...
        SSTab1.Visible = True
        Set chrs = New Recordset
        chrs.Open "select awt_flg from rm_lot where DIVCODE='" & Divcode & "' AND lotno='" & Trim(grdDataGrid.Columns(0).Text) & "' and lottype ='" & Trim(grdDataGrid.Columns(2).Text) & "' and lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' and varcode='" & adoSecondaryRS("Variety") & "' and catcd='" & grdDataGrid.Columns(6).Text & "'", DB, adOpenDynamic, adLockBatchOptimistic
        If IsNull(chrs(0)) Then
            chrs(0) = ""
        End If
        Set balers = New Recordset
        balers.Open "select baleno ""Baleno"",GRWT ""Gross Weight"",TAREWT""Tare Weight"",NETWT-isnull(actisskgs,0) ""Net Weight"",actisskgs ""AIssKgs"",issued ""Issued"" from rm_bale where DIVCODE='" & Divcode & "' AND STATUS IN ('AC','AW') and varcode='" & adoSecondaryRS("Variety") & "' AND lotno='" & Trim(grdDataGrid.Columns(0).Text) & "' and lottype ='" & Trim(grdDataGrid.Columns(2).Text) & "' and lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' and catcd='" & grdDataGrid.Columns(6).Text & "'  and (NETWT-isnull(actisskgs,0))>0 and baleno='" & grdData.Columns(0).Text & "'  and isnull(rejflg,'N')='N' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
        If balers.RecordCount = 0 Then
            Set issrs = New Recordset
            issrs.Open "select Baleno,docno,docdt from rm_issb where lotno='" & Trim(grdDataGrid.Columns(0).Text) & "' and lottype ='" & Trim(grdDataGrid.Columns(2).Text) & "' and lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' and varcode='" & adoSecondaryRS("Variety") & "' and catcd='" & grdDataGrid.Columns(6).Text & "' and issued='Y' and baleno='" & Text7.Text & "' AND DIVCODE='" & Divcode & "'", DB, adOpenDynamic, adLockBatchOptimistic
            MsgBox "This baleno " & issrs(0) & "  Already issued on  " & issrs(2) & "  and issue document number is  " & issrs(1) & ""
        End If
        If balers.RecordCount > 0 Then
            For I = 1 To grid.Rows
...
If ColIndex = 9 Then
    ...
    If val(grdDataGrid.Columns(9).Text) > val(grdDataGrid.Columns(7).Text) Then
        MsgBox "Return bales must be less than or equal to Issued bales", vbInformation, head
        grdDataGrid.Col = 9
        grdDataGrid.SetFocus
        Exit Sub
    End If
   ...
   Else
      ...
      lbl_bale.Caption = "No. of bales returned " & s
          If Opt = "add" Then
            ILotNo = 0
            ILotdt = 1
            ilottype = 2
    ...
    .CellNoteIndicator = CellNoteIndicatorDoNotShowAndDoNotFireEvent
     Set avilbalers = New Recordset
        ...
        If Opt = "add" Then
            ...
            rslotcheck.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,a.DOCNO,a.DOCDT,a.LOTNO""Lot No."" ,a.LOTDT""Date"",B.PLOTNO ""Supplier Lot No."",a.varcode ""Variety"",COLORCODE ""Color"",'            ' ""Closing Bales"",'            '""Closing Weight"",ISSKGS""Issued Kgs"",a.Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a,rm_lot b , PRP_MixingRecRetdt rc  where   rc.issueno=a.docno and rc.issuedt=a.docdt and rc.divcode=a.divcode and rc.lotno=a.lotno and rc.lotdate=a.lotdt and rc.baleno=a.baleno and a.varcode=b.varcode and a.varcode=rc.varcode and a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.catcd=b.catcd and 1=2", DB, adOpenStatic
            Else
            rslotcheck.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,a.DOCNO,a.DOCDT,a.LOTNO""Lot No."" ,a.LOTDT""Date"",B.PLOTNO ""Supplier Lot No."",a.varcode ""Variety"",COLORCODE ""Color"",'            ' ""Closing Bales"",'            '""Closing Weight"",ISSKGS""Issued Kgs"",a.Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a,rm_lot b   where     a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.varcode=b.varcode and a.catcd=b.catcd and 1=2", DB, adOpenStatic
            End If
            ...
            If adoSecondaryRS.RecordCount > 0 Then
                adoSecondaryRS.MoveFirst
            End If
            'avilbalers.Open "select distinct a.baleno ""Baleno"",a.Grwt,a.TareWt,a.isqty ""Issued Weight"",isnull(a.partybaleno,0) as Partybaleno from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.baleno=c.baleno and a.lotno='" & grddatagrid.Columns(0).Text & "' and a.DIVCODE='" & Divcode & "' AND a.BALEno=c.BALENO AND c.docno='" & txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND a.ISSUED='Y' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
            'avilbalers.Open "select distinct a.baleno ""Baleno"",a.Grwt,a.TareWt,(ISNULL(c.actisskgs,0)-isnull(a.return_kgs,0))  ""Issued Weight"",isnull(a.partybaleno,0) as Partybaleno from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.baleno=c.baleno and a.lotno='" & grddatagrid.Columns(0).Text & "' and a.DIVCODE='" & Divcode & "' AND a.BALEno=c.BALENO AND c.docno='" & txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'  and (ISNULL(c.actisskgs,0)-isnull(a.return_kgs,0)) > 0  order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
'              avilbalers.Open "select distinct a.baleno ""Baleno"",a.Grwt,a.TareWt,(ISNULL(c.actisskgs,0))  ""Issued Weight"",isnull(a.partybaleno,0) as Partybaleno from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.baleno=c.baleno and a.lotno='" & grddatagrid.Columns(0).Text & "' and a.DIVCODE='" & Divcode & "' AND a.BALEno=c.BALENO AND c.docno='" & txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'  order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic

            If issretprpflg = "Y" Or (UCase(CustID) = "SHRIGIRI" And Divcode = "01") Then
                avilbalers.Open "SELECT   distinct a.baleno ""Baleno"",c.Grwt,c.TareWt,(ISNULL(c.isskgs,0)-isnull(d.Returnkgs,0)) ""Issued Weight"",isnull(c.partybaleno,0) as Partybaleno FROM RM_ISSB AS a INNER JOIN RM_BALE AS c ON a.DIVCODE = c.DIVCODE AND a.CATCD = c.CATCD AND a.LOTNO = c.LOTNO AND a.lotdt = c.lotdt AND a.LOTTYPE = c.lottype AND a.Varcode = c.Varcode And a.baleno = c.baleno inner join  PRP_MixingRecRetDT rc on rc.issueno=a.docno and rc.issuedt=a.docdt and rc.divcode=a.divcode and rc.lotno=a.lotno and rc.lotdate=a.lotdt and rc.baleno=a.baleno and a.varcode=rc.varcode  LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE,SUM(ACTISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT ='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS d  on " & _
                           "a.DIVCODE = d.DIVCODE AND a.LOTNO = d.LOTNO And a.LOTDT = d.LOTDT And a.baleno = d.baleno And a.Varcode = d.Varcode  WHERE    a.lotno='" & grdDataGrid.Columns(0).Text & "' and a.DIVCODE='" & Divcode & "' AND a.docno='" & Txtfields(0).Text & "' and a.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and (ISNULL(c.actisskgs,0)-isnull(d.Returnkgs,0)) > 0    order by a.BALENO", DB, adOpenDynamic, adLockBatchOptimistic
            Else
            
                avilbalers.Open "SELECT   distinct a.baleno ""Baleno"",c.Grwt,c.TareWt,(ISNULL(a.isskgs,0)-isnull(d.Returnkgs,0)) ""Issued Weight"",isnull(c.partybaleno,0) as Partybaleno FROM RM_ISSB AS a INNER JOIN RM_BALE AS c ON a.DIVCODE = c.DIVCODE AND a.CATCD = c.CATCD AND a.LOTNO = c.LOTNO AND a.lotdt = c.lotdt AND a.LOTTYPE = c.lottype AND a.Varcode = c.Varcode And a.baleno = c.baleno  LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE,SUM(ISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT ='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS d  on " & _
                           "a.DIVCODE = d.DIVCODE AND a.LOTNO = d.LOTNO And a.LOTDT = d.LOTDT And a.baleno = d.baleno And a.Varcode = d.Varcode  WHERE    a.lotno='" & grdDataGrid.Columns(0).Text & "' and a.DIVCODE='" & Divcode & "' AND a.docno='" & Txtfields(0).Text & "' and a.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and (ISNULL(c.actisskgs,0)-isnull(d.Returnkgs,0)) > 0    order by a.BALENO", DB, adOpenDynamic, adLockBatchOptimistic
      ...
      If avilbalers.RecordCount = 0 Then
        MsgBox "No Bales available to return", vbInformation, head
        Call BUTTON_Click(10)
        Exit Sub
      End If
      If avilbalers.RecordCount > 0 Then
      ...
      Do While Not avilbalers.EOF
          ...
          .SetText E_SpdBal.sprdBalanceWt, RW, Format(avilbalers("issued Weight"), "0.000")
  ...
  OptSequence.value = True
      ...
      If Opt = "add" Then
        ...
        If avilbalers.RecordCount > 0 Then
           ...
           If issretprpflg = "Y" Or (UCase(CustID) = "SHRIGIRI" And Divcode = "01") Then
            balers.Open "select a.baleno ""Baleno"",a.GRWT ""Gross Weight"",a.TAREWT""Tare Weight"",a.favaourablewgt ""Net Weight"",c.actisskgs ""AIssKgs"",a.issued ""Issued"" from rm_bale a,rm_issb c ,PRP_MixingRecRetDT rc where  rc.issueno=a.docno and rc.issuedt=a.docdt and rc.divcode=a.divcode and rc.lotno=a.lotno and rc.lotdate=a.lotdt and rc.baleno=a.baleno and a.varcode=rc.varcode and a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.baleno and a.DIVCODE='" & Divcode & "' AND  c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND c.LOTNO='" & grdDataGrid.Columns(0).Text & "' AND c.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "'  AND a.ISSUED='Y' order by a.baleno ", DB, adOpenDynamic, adLockBatchOptimistic
           Else
            balers.Open "select a.baleno ""Baleno"",a.GRWT ""Gross Weight"",a.TAREWT""Tare Weight"",a.favaourablewgt ""Net Weight"",c.actisskgs ""AIssKgs"",a.issued ""Issued"" from rm_bale a,rm_issb c  where  a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.baleno and a.DIVCODE='" & Divcode & "' AND  c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND c.LOTNO='" & grdDataGrid.Columns(0).Text & "' AND c.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "'  AND a.ISSUED='Y' order by a.baleno ", DB, adOpenDynamic, adLockBatchOptimistic
           End If
            ...
            While Not avilbalers.EOF
                ...
                Set chrs = New Recordset
                chrs.Open "select awt_flg from rm_lot where  DIVCODE='" & Divcode & "' AND lotno='" & Trim(grdDataGrid.Columns(0).Text) & "' and lottype ='" & Trim(grdDataGrid.Columns(2).Text) & "' and lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' and catcd='" & grdDataGrid.Columns(6).Text & "' and varcode='" & adoSecondaryRS("Variety") & "'", DB, adOpenDynamic, adLockBatchOptimistic
                If IsNull(chrs(0)) Then
                    chrs(0) = ""
                End If
...
ElseIf ColIndex = 10 Then
    ...
    TotalBale = val(grdDataGrid.Columns(10).Text)
    If val(grdDataGrid.Columns(10).Text) > val(grdDataGrid.Columns(8).Text) Then
        MsgBox "Return Kgs must be less than or equal to Issued Kgs", vbInformation, head
        grdDataGrid.Col = 10
        grdDataGrid.SetFocus
        Exit Sub
    End If
   If val(grdDataGrid.Columns(10).Text) > val(grdDataGrid.Columns(8).Text) Then
      ...
      grdDataGrid.Col = 10
      grdDataGrid.SetFocus
      TxtNetWt.Text = val(grdDataGrid.Columns(10).Text)
      Exit Sub
   Else
      TxtNetWt.Text = val(grdDataGrid.Columns(10).Text)
      'lblctrl.Visible = True
      ...
      grid.ColAllowEdit(5) = False
      If Opt = "add" Then
        s = val(grdDataGrid.Columns(10).Text)
      End If
      lbl_bale.Visible = True
      lbl_bale.Caption = "No. of Kgs Returned " & s
          If Opt = "add" Then
            ILotNo = 0
            ILotdt = 1
            ilottype = 2
    ...
    .CellNoteIndicator = CellNoteIndicatorDoNotShowAndDoNotFireEvent
     Set avilbalers = New Recordset
        ...
        If Opt = "add" Then
            Set rslotcheck = New Recordset
            If issretprpflg = "Y" Or (UCase(CustID) = "SHRIGIRI" And Divcode = "01") Then
                rslotcheck.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,a.DOCNO,a.DOCDT,a.LOTNO""Lot No."" ,a.LOTDT""Date"",B.PLOTNO ""Supplier Lot No."",a.varcode ""Variety"",COLORCODE ""Color"",'            ' ""Issued Bales"",'            '""Issued Weight"",ISSKGS""Return Kgs"",a.Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a,rm_lot b ,PRP_MixingRecRetDT rc where  rc.issueno=a.docno and rc.issuedt=a.docdt and rc.divcode=a.divcode and rc.lotno=a.lotno and rc.lotdate=a.lotdt and rc.baleno=a.baleno and a.varcode=b.varcode and a.varcode=rc.varcode and a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.catcd=b.catcd and 1=2", DB, adOpenStatic
            Else
                erslotcheck.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,a.DOCNO,a.DOCDT,a.LOTNO""Lot No."" ,a.LOTDT""Date"",B.PLOTNO ""Supplier Lot No."",a.varcode ""Variety"",COLORCODE ""Color"",'            ' ""Issued Bales"",'            '""Issued Weight"",ISSKGS""Return Kgs"",a.Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a,rm_lot b   where  a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.varcode=b.varcode and a.catcd=b.catcd and 1=2", DB, adOpenStatic
            End If
            Set rslotcheck.DataSource = adoSecondaryRS
            ...
            '''Hide by siva 06-03-12
            '''avilbalers.Open "select distinct a.baleno ""Baleno"",a.Grwt,a.TareWt,a.isqty ""Issued Weight"",isnull(a.partybaleno,0) as Partybaleno from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.baleno=c.baleno and a.lotno='" & grddatagrid.Columns(0).Text & "' and a.DIVCODE='" & Divcode & "' AND a.BALEno=c.BALENO AND c.docno='" & txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND a.ISSUED='Y' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
             avilbalers.Open "select distinct a.baleno ""Baleno"",a.Grwt,a.TareWt,C.Actisskgs ""Issued Weight"",isnull(a.partybaleno,0) as Partybaleno from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.baleno=c.baleno and a.lotno='" & grdDataGrid.Columns(0).Text & "' and a.DIVCODE='" & Divcode & "' AND a.BALEno=c.BALENO AND c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND ISNULL(c.ACTISSKGS,0)>0  order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
        Else
            If Opt = "mod" Then
             Set rsg = New Recordset
            ...
            avilbalers.Open "select baleno ""Baleno"",Grwt,TareWt,isnull(actisskgs,0) ""Balance Weight"",isnull(partybaleno,0) as Partybaleno from rm_bale where   baleno not in (" & gbaleno & ") and DIVCODE='" & Divcode & "' AND varcode='" & Trim(grdDataGrid.Columns(4).Text) & "'  and STATUS IN ('AC','AW') AND lotno='" & Trim(grdDataGrid.Columns(ILotNo).Text) & "' and lottype ='" & Trim(grdDataGrid.Columns(ilottype).Text) & "' and lotdt='" & Format(grdDataGrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "' and catcd='" & Trim(grdDataGrid.Columns(icategory).Text) & "'  and ISNULL(ISSUED,'N')='Y' AND (isnull(netwt,0)-isnull(actisskgs,0)) > 0 and isnull(rejflg,'N')='N' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
  ...
  OptSequence.value = True
      ...
      If Opt = "add" Then
        ...
        If avilbalers.RecordCount > 0 Then
           Set balers = New Recordset
           'balers.Open "select baleno ""Baleno"",GRWT ""Gross Weight"",TAREWT""Tare Weight"",NETWT-isnull(actisskgs,0) ""Net Weight"",actisskgs ""AIssKgs"",issued ""Issued"" from rm_bale where  DIVCODE='" & Divcode & "' AND varcode='" & grddatagrid.Columns(4).Text & "'  and STATUS IN ('AC','AW') AND lotno='" & Trim(grddatagrid.Columns(0).Text) & "' and lottype ='" & Trim(grddatagrid.Columns(2).Text) & "' and lotdt='" & Format(grddatagrid.Columns(1).Text, "yyyy-mm-dd") & "' and catcd='" & grddatagrid.Columns(6).Text & "'  and ISNULL(ISSUED,'N')='N' AND (isnull(netwt,0)-isnull(isqty,0)) > 0 and isnull(rejflg,'N')='N' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
           balers.Open "select a.baleno ""Baleno"",a.GRWT ""Gross Weight"",a.TAREWT""Tare Weight"",a.NETWT ""Net Weight"",c.actisskgs ""AIssKgs"",a.issued ""Issued"" from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.baleno and a.DIVCODE='" & Divcode & "' AND  c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND c.LOTNO='" & grdDataGrid.Columns(0).Text & "' AND c.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "'  AND a.ISSUED='Y' order by a.baleno ", DB, adOpenDynamic, adLockBatchOptimistic
            tgwt = 0
            tnwt = 0
            rec_cnt = 1
            Call ubgridalign
...
'                If cnt = 1 Then db.BeginTrans
                ...
                ActRs.Open "Select IssKgs,actISSkgs from RM_Issb where divcode='" & Divcode & "' and DocNo='" & adoSecondaryRS("DocNo") & "' and DocDt='" & Format(adoSecondaryRS("DocDt"), "yyyy-MM-dd") & "' and CatCd='" & adoSecondaryRS("Category") & "' and LotNo='" & adoSecondaryRS("Lot No") & "' and LotDt='" & Format(adoSecondaryRS("lot Date"), "yyyy-MM-dd") & "' and BaleNo='" & adoSecondaryRS("Bale No.") & "' and varcode='" & adoSecondaryRS("Variety") & "'", DB
                ...
                DB.Execute "Delete from RM_Issb where divcode='" & Divcode & "' and DocNo='" & adoSecondaryRS("DocNo") & "' and DocDt='" & Format(adoSecondaryRS("DocDt"), "yyyy-MM-dd") & "' and CatCd='" & adoSecondaryRS("Category") & "' and LotNo='" & adoSecondaryRS("Lot No") & "' and LotDt='" & Format(adoSecondaryRS("lot Date"), "yyyy-MM-dd") & "' and varcode='" & adoSecondaryRS("Variety") & "' and BaleNo='" & adoSecondaryRS("Bale No.") & "'"
                DB.Execute "Update RM_Lot set IssWt= IssWt - " & adoSecondaryRS("Issued Kgs") & ",IssBal= IssBal - 1 where divcode='" & Divcode & "' and  Varcode='" & adoSecondaryRS("Variety") & "' and LotNo='" & adoSecondaryRS("Lot No") & "' and LotDt='" & Format(adoSecondaryRS("lot Date"), "yyyy-MM-dd") & "' and varcode='" & adoSecondaryRS("Variety") & "' and CatCd='" & adoSecondaryRS("Category") & "' "
                DB.Execute "Update RM_Bale Set IsQty= NULL , ActIssKgs = NULL,ISSUED='N' where divcode='" & Divcode & "' and BaleNo='" & adoSecondaryRS("Bale No.") & "' and LotNo='" & adoSecondaryRS("Lot No") & "' and LotDt='" & Format(adoSecondaryRS("lot Date"), "yyyy-MM-dd") & "' and varcode='" & adoSecondaryRS("Variety") & "'and CatCd='" & adoSecondaryRS("Category") & "' "
                iCount = iCount + 1
                ...
                If Rs(0) = "Y" Then
                    Set rs1 = New Recordset
                    rs1.Open "Select top 1 Docno,DocDate,Varcode,RowNo From Rm_RequisitionSlip Where divcode='" & Divcode & "' and Varcode='" & adoSecondaryRS!Variety & "' AND ISNULL(ISSQTY,0)<>0 ORDER BY DOCNO DESC,DOCDATE", DB, adOpenStatic
                    If rs1.EOF = False Then
                        Idocno = rs1(0)
                        sDocDate = Format(rs1(1), "YYYY-MM-DD")
                        sVarcode = rs1(2)
                        iRowNo = rs1(3)
                        strSQL = "Update RM_ReQuisitionSlip Set IssQty=IssQty-1 where divcode='" & Divcode & "' and Issued='Y' and RowNo='" & rs1("Rowno") & "' and Docno='" & rs1("DocNo") & "' and DocDate='" & Format(rs1("DocDate"), "yyyy-MM-dd") & "' and varcode='" & rs1("Varcode") & "' "
                        DB.Execute strSQL
                    End If
                End If
...
If Opt = "add" Then
    If (KeyAscii = 13 Or KeyAscii = 9) And grdDataGrid.Col = 9 And Option4.value = True Then
        ...
        Txtissbale.Text = ""
         MaskEdBox1(0).Enabled = False
'        TxtIsskgs.SetFocus
        If OptSequence.Visible = True Then
...
If Opt = "add" Then
   If LastCol = 0 Then
        If Len(Trim(grdDataGrid.Columns(0).Text)) > 0 Then
            Set rslotcheck = New Recordset
            rslotcheck.Open "Select A.LOTNO""Lot No."",A.PLOTNO""Supplier Lot No."",a.Lotdt""Lot Date"",VARNAME""Variety"",a.varcode""Variety Code"",SLNAME""Supplier"", ISNULL(count(r.baleno),0) 'Bal Bales',ISNULL(sum(r.isskgs),0) 'Bal KGs',a.catcd AS Category,e.Station from rm_lot a,rm_var b ,FA_SLMAS D,rm_area E,RM_ISSB r where a.LOTNO=r.LOTNO AND a.LOTDT=r.lotdt AND a.LOTTYPE=r.LOTTYPE AND a.CATCD=r.CATCD AND a.VARCODE=r.VARCODE AND a.DIVCODE=r.DIVCODE AND a.areacd=e.areacode and A.SUPCD=D.SLCODE  and a.varcode=b.varcode AND A.CATCD=B.CATCD and lotyear='" & Year(yfdate) & "' AND A.DIVCODE='" & Divcode & "' AND A.INS_FLG = 'Y' AND r.DOCNO=" & Txtfields(0).Text & " AND r.DOCDT='" & Format(MaskEdBox1(0).Text, "YYYY-MM-DD") & "'  and a.lotno='" & grdDataGrid.Columns(ILotNo).Text & "' and lotyear='" & Year(yfdate) & "' and A.lotdt>='" & Format(yfdate, "yyyy-MM-dd") & "' GROUP BY a.LOTNO,a.PLOTNO,a.LOTDT,b.VARNAME,a.VARCODE,D.slname,a.CATCD,E.STATION", DB, adOpenStatic, adLockBatchOptimistic
...
LotLookUp:
            LookUp.Clear = True
            'LookUp.Query = "Select A.LOTNO""Lot No."",A.PLOTNO""Supplier Lot No."",a.Lotdt""Lot Date"",VARNAME""Variety"",a.varcode""Variety Code"",SLNAME""Supplier"", ISNULL(count(c.baleno),0) 'Issued Bales',ISNULL(sum(c.isqty),0) 'Issued KGs',a.catcd AS Category,e.Station from rm_lot a,rm_var b ,FA_SLMAS D,rm_area E,RM_ISSB r,rm_bale c where a.divcode=c.divcode and a.LOTNO=c.LOTNO AND r.BALENO=c.BALENO AND a.LOTDT=c.lotdt AND a.LOTTYPE=c.lottype AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.LOTNO=r.LOTNO AND a.LOTDT=r.lotdt AND a.LOTTYPE=r.LOTTYPE AND a.CATCD=r.CATCD AND a.VARCODE=r.VARCODE AND a.DIVCODE=r.DIVCODE AND a.areacd=e.areacode and A.SUPCD=D.SLCODE  and a.varcode=b.varcode AND A.CATCD=B.CATCD and lotyear='" & Year(yfdate) & "' AND A.DIVCODE='" & Divcode & "' AND A.INS_FLG = 'Y' AND r.DOCNO='" & txtfields(0).Text & "' AND r.DOCDT='" & Format(MaskEdBox1(0).Text, "YYYY-MM-DD") & "' and c.issued='Y' GROUP BY a.LOTNO,a.PLOTNO,a.LOTDT,b.VARNAME,a.VARCODE,D.slname,a.CATCD,E.STATION"
'            LookUp.Query = "Select A.LOTNO""Lot No."",A.PLOTNO""Supplier Lot No."",a.Lotdt""Lot Date"",VARNAME""Variety"",a.varcode""Variety Code"",SLNAME""Supplier"", ISNULL(count(c.baleno),0) 'Issued Bales',ISNULL(sum(r.ACTISSKGS),0) 'Issued KGs',a.catcd AS Category,e.Station from rm_lot a,rm_var b ,FA_SLMAS D,rm_area E,RM_ISSB r,rm_bale c where a.divcode=c.divcode and a.LOTNO=c.LOTNO AND r.BALENO=c.BALENO AND a.LOTDT=c.lotdt AND a.LOTTYPE=c.lottype AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.LOTNO=r.LOTNO AND a.LOTDT=r.lotdt AND a.LOTTYPE=r.LOTTYPE AND a.CATCD=r.CATCD AND a.VARCODE=r.VARCODE AND a.DIVCODE=r.DIVCODE AND a.areacd=e.areacode and A.SUPCD=D.SLCODE  and a.varcode=b.varcode AND A.CATCD=B.CATCD and lotyear='" & Year(yfdate) & "' AND A.DIVCODE='" & Divcode & "' AND A.INS_FLG = 'Y' AND r.DOCNO=" & txtfields(0).Text & " AND r.DOCDT='" & Format(MaskEdBox1(0).Text, "YYYY-MM-DD") & "'  and isnull(a.isswt,0) <> 0   and (ISNULL(r.actisskgs,0)-isnull(c.return_kgs,0)) > 0  " & _
'                           "GROUP BY a.LOTNO,a.PLOTNO,a.LOTDT,b.VARNAME,a.VARCODE,D.slname,a.CATCD,E.STATION"
             If Txtfields(0).Text = "" Then
             Exit Sub
             End If
            If issretprpflg = "Y" Or (UCase(CustID) = "SHRIGIRI" And Divcode = "01") Then
            LookUp.query = "SELECT a.LOTNO AS [Lot No.], a.PLOTNO AS [Supplier Lot No.], a.LOTDT AS [Lot Date]," & _
                           " b.VARNAME AS Variety, a.VARCODE AS [Variety Code],D.slname AS Supplier, " & _
                           " ISNULL(count(r.baleno),0) 'Issued Bales',ISNULL(SUM(r.ISSKGS), 0) AS 'Issued KGs', " & _
                           " a.CATCD AS Category, E.STATION, c.Returnkgs,(isnull(Sum(isnull(R.ISSKGS,0)),0)-isnull(sum(isnull(c.Returnkgs,0)),0))BalanceKgs " & _
                           " FROM RM_LOT AS a INNER JOIN RM_ISSB AS r ON " & _
                           " a.LOTNO = r.LOTNO AND a.LOTDT = r.lotdt AND a.LOTTYPE = r.LOTTYPE " & _
                           " AND a.CATCD = r.CATCD AND a.VARCODE = r.VARCODE " & _
                           " AND a.DIVCODE = r.DIVCODE inner join  PRP_MixingRecRetdt rc on rc.issueno=r.docno and rc.issuedt=r.docdt and rc.divcode=r.divcode and rc.lotno=r.lotno and rc.lotdate=r.lotdt and rc.baleno=r.baleno and r.varcode=rc.varcode " & _
                           " INNER JOIN RM_AREA AS E ON a.AREACD = E.AREACODE " & _
                           " INNER JOIN FA_SLMAS AS D ON a.SUPCD = D.slcode " & _
                           " INNER JOIN RM_VAR AS b ON a.VARCODE = b.VARCODE AND a.CATCD = b.CATCD " & _
                           " LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE, " & _
                           " SUM(ACTISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE ='" & Divcode & "' " & _
                           " AND ISSNO = " & Txtfields(0).Text & " " & _
                           " AND ISSDT = '" & Format(MaskEdBox1(0).Text, "YYYY-MM-DD") & "'" & _
                           " GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE)as C " & _
                           " ON r.DIVCODE = c.DIVCODE AND r.LOTNO = c.LOTNO AND r.lotdt = c.lotdt " & _
                           " AND r.BALENO = c.BALENO AND r.VARCODE = c.VARCODE " & _
                           " WHERE a.LOTYEAR = '" & Year(yfdate) & "' " & _
                           "   AND a.DIVCODE ='" & Divcode & "' AND a.Ins_Flg = 'Y' " & _
                           "   AND r.DOCNO = " & Txtfields(0).Text & " " & _
                           "   AND r.DOCDT = '" & Format(MaskEdBox1(0).Text, "YYYY-MM-DD") & "'" & _
                           "   AND ISNULL(a.ISSWT, 0) <> 0 " & _
                           "   AND (ISNULL(r.ISSKGS, 0) - ISNULL(c.Returnkgs, 0) > 0)" & _
                           "   GROUP BY a.LOTNO, a.PLOTNO, a.LOTDT, b.VARNAME, a.VARCODE, D.slname,a.CATCD,E.STATION,c.Returnkgs"
...
'            LookUp.Query = "Select A.LOTNO""Lot No."",A.PLOTNO""Supplier Lot No."",a.Lotdt""Lot Date"",VARNAME""Variety"",a.varcode""Variety Code"",SLNAME""Supplier"", ISNULL(count(c.baleno),0) 'Issued Bales',ISNULL(sum(r.ACTISSKGS),0) 'Issued KGs',a.catcd AS Category,e.Station from rm_lot a,rm_var b ,FA_SLMAS D,rm_area E,RM_ISSB r,rm_bale c where a.divcode=c.divcode and a.LOTNO=c.LOTNO AND r.BALENO=c.BALENO AND a.LOTDT=c.lotdt AND a.LOTTYPE=c.lottype AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.LOTNO=r.LOTNO AND a.LOTDT=r.lotdt AND a.LOTTYPE=r.LOTTYPE AND a.CATCD=r.CATCD AND a.VARCODE=r.VARCODE AND a.DIVCODE=r.DIVCODE AND a.areacd=e.areacode and A.SUPCD=D.SLCODE  and a.varcode=b.varcode AND A.CATCD=B.CATCD and lotyear='" & Year(yfdate) & "' AND A.DIVCODE='" & Divcode & "' AND A.INS_FLG = 'Y' AND r.DOCNO=" & txtfields(0).Text & " AND r.DOCDT='" & Format(MaskEdBox1(0).Text, "YYYY-MM-DD") & "'  and isnull(a.isswt,0) <> 0    " & _
                           "GROUP BY a.LOTNO,a.PLOTNO,a.LOTDT,b.VARNAME,a.VARCODE,D.slname,a.CATCD,E.STATION"

            
            LookUp.Caption = "Lot Listing"
            LookUp.ALIGN = "750,1350,1000,1100,0,2500,900,1200,1200"
            LookUp.DefCol = "Lot No."
            LookUp.Show vbModal
            If LookUp.Cancel = False Then
                               
                grdDataGrid.Columns(0).Text = CStr(LookUp.Fields(0))
                Call Lotdisplay(CStr(LookUp.Fields(4)), CStr(LookUp.Fields(2)), LookUp.Fields(8))
                LookUp.Clear = True
...
If Opt = "add" Or Opt = "mod" Then
   ...
   If grdDataGrid.Col = 8 Then
      StatusBar1.Panels(2).Text = "Enter Issued Weights"
   End If
   If grdDataGrid.Col = 9 Then
      StatusBar1.Panels(2).Text = "Enter Returned Bales"
   End If
   If grdDataGrid.Col = 10 Then
      StatusBar1.Panels(2).Text = "Enter Returned Kgs"
   End If
End If
If Opt = "add" Then
    ...
    If grdDataGrid.Enabled = True Then
        If val(grdDataGrid.Columns(9).Text) > val(grdDataGrid.Columns(7).Text) Then
            MsgBox "Returned bales must be less than or equal to Issued bales", vbInformation, head
            grdDataGrid.SetFocus
            Exit Sub
        End If
    End If
...
End Select
'     If MaskEdBox1(1).Text <> pdate Then
...
On Error Resume Next
    TotalBale = val(grdDataGrid.Columns("return Bales"))
    EBaleNo = (val(Text13.Text) + val(grdDataGrid.Columns("return Bales"))) - 1
    Text14.Text = EBaleNo
'    Text14.Locked = True
    If Text14.Enabled = True And Text14.Visible = True Then Text14.SetFocus
    'Exit Sub
'    'Text13.SetFocus
        ...
        If Opt = "add" Or Opt = "mod" Then
            If val(Text14.Text) <> 0 And val(Text13.Text) <> 0 Then
                If val(Text14.Text) >= val(Text13.Text) Then
                    ...
                    If adoSecondaryRS.RecordCount > 0 Then
                        Set rslotcheck = New Recordset
                        rslotcheck.Open "SELECT a.DIVCODE,ISSTYPE,a.CATCD,DOCNO,DOCDT,a.LOTNO""Lot No."" ,a.LOTDT""Date"",B.PLOTNO ""Supplier Lot No."",a.varcode ""Variety"",COLORCODE ""Color"",'            ' ""Issued Bales"",'            '""Issued Weight"",ISSKGS""Returned Kgs"",Baleno,a.lottype,a.ACTISSKGS ""AIKgs"",ISSUED,a.arrdt FROM RM_ISSRTNB a,rm_lot b  where a.lotno=b.lotno and a.lotdt=b.lotdt and a.divcode=b.divcode and a.catcd=b.catcd and a.varcode=b.varcode and 1=2", DB, adOpenStatic
                        Set rslotcheck.DataSource = adoSecondaryRS
                        ...
                        If adoSecondaryRS.RecordCount > 0 Then
                            adoSecondaryRS.MoveFirst
                        End If
                        avilbalers1.Open "select a.baleno ""Baleno"",a.ISQTY ""Issued Weight"" from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.DIVCODE='" & Divcode & "' AND a.BALEno=c.BALENO AND c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and a.baleno  not in (" & baleno & ") and a.baleno between " & val(Text13.Text) & " and " & val(Text14.Text) & " and a.lotno='" & grdDataGrid.Columns(0).Text & "' AND a.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
                    Else
                        avilbalers1.Open "select a.baleno ""Baleno"",a.ISQTY ""Issued Weight"" from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE and a.DIVCODE='" & Divcode & "' AND a.BALEno=c.BALENO AND c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and a.baleno between " & val(Text13.Text) & " and " & val(Text14.Text) & " and a.lotno='" & grdDataGrid.Columns(0).Text & "' AND a.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' order by baleno ", DB, adOpenDynamic, adLockBatchOptimistic
                    End If
                    ...
                    If avilbalers1.RecordCount > 0 Then
                        Set balers = New Recordset
                        balers.Open "select a.baleno ""Baleno"",a.GRWT ""Gross Weight"",a.TAREWT""Tare Weight"",a.favaourablewgt ""Net Weight"",a.ISQTY ""AIssKgs"",a.issued ""Issued"" from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.baleno and a.DIVCODE='" & Divcode & "' AND  c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND c.LOTNO='" & grdDataGrid.Columns(0).Text & "' AND c.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "'   order by a.baleno ", DB, adOpenDynamic, adLockBatchOptimistic
                        ...
                        Do While Not avilbalers.EOF
                            Set balers = New Recordset
                            balers.Open "select a.baleno ""Baleno"",a.GRWT ""Gross Weight"",a.TAREWT""Tare Weight"",a.favaourablewgt ""Net Weight"",A.Isqty ""AIssKgs"",a.issued ""Issued"" from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.baleno and a.DIVCODE='" & Divcode & "' AND  c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND c.LOTNO='" & grdDataGrid.Columns(0).Text & "' AND c.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "' and a.baleno='" & avilbalers1("Baleno") & "' order by a.baleno ", DB, adOpenDynamic, adLockBatchOptimistic
                            ...
                            grid.TextMatrix(rec_cnt, 5) = IIf(val(Text8) = 0, Format(balers("AIssKgs"), "0.000"), Text8)
                            ...
                            taisswt = taisswt + grid.TextMatrix(rec_cnt, 5)
                            Text4.Text = Format(val(taisswt), "0.000")
                            grid.TextMatrix(rec_cnt, 5) = IIf(val(Text8) = 0, balers("AIssKgs"), Text8)
...
balers.Open "select a.baleno ""Baleno"",a.GRWT ""Gross Weight"",a.TAREWT""Tare Weight"",a.NETWT ""Net Weight"",c.actisskgs ""AIssKgs"",a.issued ""Issued"" from rm_bale a,rm_issb c where a.DIVCODE=c.DIVCODE AND a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.lottype=c.LOTTYPE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.baleno and a.DIVCODE='" & Divcode & "' AND  c.docno='" & Txtfields(0).Text & "' and c.docdt='" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' AND c.LOTNO='" & grdDataGrid.Columns(0).Text & "' AND c.lotdt='" & Format(grdDataGrid.Columns(1).Text, "yyyy-mm-dd") & "'  AND a.ISSUED='Y' and a.baleno='" & Text7.Text & "' order by a.baleno ", DB, adOpenDynamic, adLockBatchOptimistic
If balers.RecordCount > 0 Then
    Label25.Caption = balers("net weight")
Else
...
'    grddatagrid.Columns(8).Width = 1500
'    grddatagrid.Columns(9).Width = 1500
'    grddatagrid.Columns(10).Width = 1200
'    grddatagrid.Columns(11).Width = 1200
'    grddatagrid.Columns(12).Width = 1000
'    grddatagrid.Columns(13).Width = 1000
'    grddatagrid.Columns(12).NumberFormat = "#######.000"
'    grddatagrid.Columns(12).Alignment = dbgRight
...
'   lblctrl.Visible = False
   ...
   If Opt <> "mod" Then
     Dim sQry As String
     sQry = "SHAPE {SELECT top 10 DIVCODE,ISSTYPE,DOCNO,DOCDT,issno,issdt,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_ISSrtnH  " & _
                        "  where DIVCODE = '" & Divcode & "' and  DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' " & _
                        " Order by DOCNO desc} AS ParentCMD APPEND ({SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,issno,issdt,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.Plotno""Supplier Lot No"",VARname""Variety Name"",colorcode ""Color"",a.CATCD""Category"",a.actISSkgs""IssueRet Kgs"",a.baleno""Bale No.""  FROM RM_ISSrtnb a,rm_lot b,rm_var c  " & _
                        " where c.varcode=a.varcode and b.varcode=c.varcode and isnull(b.issbal,0) <> 0 and a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.divcode=b.divcode and  a.DIVCODE = '" & Divcode & "' and DOCDT BETWEEN '" & Format(yfdate, "yyyy-mm-dd") & "' AND '" & Format(yldate, "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' " & _
                        " order by docno } AS ChildCMD RELATE DOCNO TO DOCNO,DOCDT TO DOCDT,ISSNO TO ISSNO,ISSDT TO ISSDT,DIVCODE TO DIVCODE,ISSTYPE TO ISSTYPE ) AS ChildCMD"
      ...
      If Not adoPrimaryRS.BOF Then
       ' adoPrimaryRS.MoveLast
        ...
        End If
         ...
         Set adoSecondaryRS = New Recordset
         adoSecondaryRS.Open "SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.plotno""Supplier Lot No"",b.VARCODE""Variety"",colorcode ""Color"",a.CATCD""Category"",a.actisskgs ""IssueRet Kgs"",a.baleno""Bale No."",a.arrdt,a.isskgs""Aikgs"",a.issued  FROM RM_ISSRTNb a,rm_lot b " & _
                     " where  a.lotno=b.lotno and a.lotdt=b.lotdt and a.varcode=b.varcode and a.catcd=b.catcd and a.divcode=b.divcode and docno = '" & Trim(adoPrimaryRS("docno")) & "' and DOCDT = '" & Format(adoPrimaryRS("docdt"), "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' order by a.lotno,a.baleno", DB, adOpenStatic, adLockBatchOptimistic
...
''                  Loop
        ...
        Dim balers As Recordset
        Set balers = New Recordset
        balers.Open "Select Count(Baleno) as Baleno,Sum(IssKgs) as IssueKgs,SUM(ActIssKgs) as ActIssKgs from RM_ISSB where DocNo='" & Trim(Txtfields(0).Text) & "' and docdt='" & Format(IIf(IsDate(MaskEdBox1(1).Text), MaskEdBox1(1).Text, pdate), "yyyy-MM-dd") & "' ", DB
        If Not balers.EOF Then
            TxtTotBales.Text = balers!baleno
            TxtNetWt.Text = Format(balers!IssueKgs, "0.000")
            TxtActWt.Text = Format(balers!ActIssKgs, "0.000")
...
Set Rs = New Recordset
Rs.Open "select a.docno,a.docdt from rm_issrtnh a where    a.divcode='" & Divcode & "' and a.docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'", DB, adOpenStatic, adLockBatchOptimistic
If Rs.RecordCount <> 0 Then
   If Opt = "mod" Then
   ...
   End If
         ...
         LookUp.query = "select distinct a.docno""Doc. No."",a.docdt""Doc. Date"",a.isstype""Issue Type"" from rm_issrtnh a where divcode='" & Divcode & "' and docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "'"
         LookUp.Caption = "Issue Listing"
         LookUp.DefCol = "Doc. No."
         LookUp.ALIGN = "1500,1500,1500"
         LookUp.Show vbModal
         If LookUp.Cancel = False Then
            'If Opt = "del" Then deltype = InputBox(" Enter Delete type " & vbCrLf & vbCrLf & "  1 - Line Deletion " & vbCrLf & "  2 - Complete Deletion " & vbCrLf & head + "Delete type", head)
                ...
                Txtfields(0).Text = LookUp.Fields(0)
                MaskEdBox1(0).Text = Format(LookUp.Fields(1), "dd/mm/yyyy")
                MaskEdBox1(0).Text = MaskEdBox1(0).Text
                a = Txtfields(0).Text
                b = MaskEdBox1(0).Text
                Text1.Text = ""
                ...
                If Opt = "del" Then
                     ...
                     TmpRs.Open "SELECT DIVCODE,ISSTYPE,DOCNO, DOCDT,BALENO,LOTNO,lotdt,LOTTYPE FROM RM_ISSRTNB WHERE DIVCODE='" & Divcode & "' and DocNo ='" & a & "' and  DocDt ='" & Format(b, "yyyy-mm-dd") & "'", DB, adOpenStatic, adLockReadOnly
                     Do While Not TmpRs.EOF
                         Set Rs = New Recordset
                         Rs.Open "Select Sum(isnull(NetWt,0))NetWt, Sum(Isnull(ActIssKgs,0))ActIssKgs from Rm_Bale Where Divcode ='" & Divcode & "' And LotNo =" & TmpRs("LOTNO") & " And LotDt='" & Format(TmpRs("LOTDT"), "yyyy-mm-dd") & "' And BaleNo =" & TmpRs("baleno") & " Group by BaleNo ", DB, adOpenStatic, adLockReadOnly
                         If Not Rs.EOF Then
                             BALENETWT = Rs("NetWt")
                             BaleActkgs = Rs("ActIssKgs")
                         Else
                             BALENETWT = 0
                             BaleActkgs = 0
                         End If
                         Set rs1 = New Recordset
                         rs1.Open "Select Sum(Isnull(IssKgs,0))IssRetKgs from RM_ISSRTNB Where Divcode ='" & Divcode & "' And LotNo =" & TmpRs("LOTNO") & " And LotDt='" & Format(TmpRs("LOTDT"), "yyyy-mm-dd") & "' And BaleNo =" & TmpRs("baleno") & " ", DB, adOpenStatic, adLockReadOnly
                         If Not rs1.EOF Then
                             IssRetnKgs = rs1("IssRetKgs")
                         Else
                             IssRetnKgs = 0
                         End If
                         If BALENETWT < (BaleActkgs + IssRetnKgs) Then
                             MsgBox "Deletion not possible ", vbInformation, head
                             Opt = ""
                             Call query_mode
                             Exit Sub
                         End If
...
If Opt = "mod" Then
   Set adoPrimaryRS = New Recordset
   adoPrimaryRS.Open "SHAPE {SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,issno,issdt,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_ISSRTNH  " & _
                     "  where DIVCODE = '" & Divcode & "' and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' " & _
                     " Order by A.DOCNO} AS ParentCMD APPEND ({SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,issno,issdt,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.plotno""Supplier Lot No."",b.VARCODE""Variety"",colorcode ""Color"",a.CATCD""Category"",a.actisskgs ""Issued Kgs"",a.baleno""Bale No."",a.arrdt,a.isskgs""Aikgs"",a.issued  FROM RM_ISSRTNb a,rm_lot b " & _
                     " where  isnull(b.issbal,0) <> 0 and a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.varcode=b.varcode and a.divcode=b.divcode and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' order by a.lotno,a.baleno" & _
                     " } AS ChildCMD RELATE DOCNO TO DOCNO,DOCDT TO DOCDT,ISSNO TO ISSNO,ISSDT TO ISSDT,DIVCODE TO DIVCODE,ISSTYPE TO ISSTYPE ) AS ChildCMD", DB, adOpenStatic, adLockBatchOptimistic
   If Not adoPrimaryRS.EOF Then
      Call bindcontls
      If adoPrimaryRS("isstype") = "PR" Then
         Combo1.Text = "PR-Production"
...
adoPrimaryRS.Open "SHAPE {SELECT DIVCODE,ISSTYPE,DOCNO,DOCDT,ISSNO,ISSDT,slcode,OILCODE,OILWT,OILCODE1,OILWT1,WTRWT,cntcd,TINT,MODUSRID,ISSTO,ordno,vehicleno,MIXGRP,RDIVCODE,Driver,InvoiceNo,InvDate,TimeOut,Form,Formno,SoftWaste FROM RM_ISSRTNH  " & _
                     "  where DIVCODE = '" & Divcode & "' and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' " & _
                     " Order by DOCNO} AS ParentCMD APPEND ({SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,ISSNO,ISSDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.plotno""Supplier Lot No"",b.VARCODE""Variety"",colorcode ""Color"",a.CATCD""Category"",a.actisskgs ""Issued Kgs"",a.baleno""Bale No."",a.arrdt,a.isskgs""Aikgs"",a.issued  FROM RM_ISSRTNb a,rm_lot b " & _
                     " where  isnull(b.issbal,0) <> 0 and a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.varcode=b.varcode and a.lottype=b.lottype and a.divcode=b.divcode and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' order by a.lotno,a.baleno" & _
                     " } AS ChildCMD RELATE DOCNO TO DOCNO,DOCDT TO DOCDT,ISSNO TO ISSNO,ISSDT TO ISSDT,DIVCODE TO DIVCODE,ISSTYPE TO ISSTYPE ) AS ChildCMD", DB, adOpenStatic, adLockBatchOptimistic
                     
Set adoSecondaryRS = New Recordset
adoSecondaryRS.Open "SELECT DISTINCT a.DIVCODE,ISSTYPE,DOCNO,DOCDT,a.LOTNO""Lot No"",a.LOTDT""Lot Date"",b.LotType""Lot Type"",b.plotno""Supplier Lot No"",b.VARCODE""Variety"",colorcode ""Color"",a.CATCD""Category"",a.actisskgs ""Issued Kgs"",a.baleno""Bale No."",a.arrdt,a.isskgs""Aikgs"",a.issued  FROM RM_ISSRTNb a,rm_lot b " & _
                     " where  a.lotno=b.lotno and a.lotdt=b.lotdt and a.catcd=b.catcd and a.varcode=b.varcode and a.divcode=b.divcode and a.lottype=b.lottype and docno = '" & Trim(Txtfields(0).Text) & "' and DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' and  b.rejflg='N' and b.lotyear='" & Year(yfdate) & "' order by a.lotno,a.baleno", DB, adOpenStatic, adLockBatchOptimistic
...
Private Sub Txtissbale_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub TxtIsskgs_LostFocus()
    ...
    'DB.Execute "IF (SELECT COUNT(*) FROM SYSOBJECTS WHERE NAME='VW_RMTmpIssueRTNWT' AND TYPE='V')>0 DROP VIEW VW_RMTmpIssueRTNWT"
    'DB.Execute "CREATE VIEW VW_RMTmpIssueRTNWT AS Select Baleno,Grwt,Tarewt,Netwt,ISNULL(ISQTY,0) AIsskgs From Rm_Bale Where STATUS IN ('AC','AW') AND Lotno = '" & Trim(grddatagrid.Columns(ILotNo).Text) & "' and Catcd = '" & grddatagrid.Columns(icategory).Text & "' and ISNULL(Issued,'N') = 'Y' and lotdt='" & Format(grddatagrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "'  and isnull(rejflg,'N')='N' and divcode='" & Divcode & "'"
    twt = 0
    TEMP = val(TxtIsskgs.Text)
    Set balers = New Recordset
    balers.Open "Select Baleno,Grwt,Tarewt,Netwt,ISNULL(ISQTY,0) AIsskgs From Rm_Bale Where STATUS IN ('AC','AW') AND Lotno = '" & Trim(grdDataGrid.Columns(ILotNo).Text) & "' and Catcd = '" & grdDataGrid.Columns(icategory).Text & "' and ISNULL(Issued,'N') = 'Y' and lotdt='" & Format(grdDataGrid.Columns(ILotdt).Text, "yyyy-mm-dd") & "'  and isnull(rejflg,'N')='N' and divcode='" & Divcode & "' order by cast(baleno as decimal(5))", DB, adOpenStatic
    If balers.RecordCount > 0 Then
        balers.MoveFirst
        t1bales = 0
        Do While Not balers.EOF And TEMP > 0
            If balers(4) > TEMP Then
                t1bales = t1bales + 1
                TEMP = TEMP - val(TxtIsskgs.Text)
            Else
...
Public Sub gatepass(pg1 As Integer)
    ...
    Print #a,
    Set Rs = New Recordset
    Rs.Open "select distinct slname,add3,a.isstype from rm_issb a,rm_lot c,fa_slmas b where a.lotno=c.lotno and a.lotdt=c.lotdt and a.lotype=c.lottype and a.varcode=c.varcode and c.supcd=b.slcode and a.divcode=c.divcode  and c.divcode = '" & Divcode & "'   AND docdt between '" & Format(yfdate, "yyyy-mm-dd") & "' and '" & Format(yldate, "yyyy-mm-dd") & "' and  docno = " & Trim(val(Txtfields(0).Text)) & "  Order by slname ", DB, adOpenStatic
...
Public Sub CottRecnHeader(pg1 As Integer, co As Integer, LDT As String)
    ...
    Print #z, Space(5) & CENTRE("Return Weight Details ", 80, " ")
    Print #z,
    Print #z, Space(5) & "Mixing Count : " & Padr(Text5.Text, 40, " ") + Space(5) + "Rtn. No  : " & Padr(Txtfields(15).Text, 5, " ")
    Print #z, Space(5) & "Mixing Group : " & Padr(Text12.Text, 40, " ") + Space(5) + "Rtn. Date: " & Padr(Format(MaskEdBox1(2).Text, "dd/mm/yy"), 8, " ")
    ...
    Print #z, Space(5) & "Bale No.               Gross Wt.      Tare Wt    Moist.Wt    Net.Wt.  Actret Kgs"
    Print #z, Space(5) & String(80, "-")
    co = co + 9
End Sub
           ...
           Set rslotcheck.DataSource = adoSecondaryRS
            ...
            For I = 1 To rslotcheck.RecordCount
                If rslotcheck("Lot No.") = grdDataGrid.Columns(ILotNo).Text And rslotcheck("Date") = CDate(LOTDT) And rslotcheck(2) = catcd And rslotcheck("Variety") = Varcode Then
                    baleno = baleno + 1
                    issKgs = issKgs + rslotcheck("Returned Kgs")
                End If
                rslotcheck.MoveNext
            Next
    Else
...
End If
    ...
    End If
        ...
        Rs.Open "SELECT a.LOTDT 'Date',A.lottype,A.PLOTNO,A.varcode,A.catcd,count(r.BALENO),SUM(isnull(r.ISSKGS,0))-SUM(isnull(c.Returnkgs,0))BalanceKgs ,A.COLORCODE FROM RM_LOT AS a INNER JOIN RM_ISSB AS r ON a.LOTNO = r.LOTNO AND a.LOTDT = r.lotdt AND a.LOTTYPE = r.LOTTYPE AND a.CATCD = r.CATCD AND a.VARCODE = r.VARCODE AND a.DIVCODE = r.DIVCODE  INNER JOIN PRP_MixingRecRetDT AS rc ON rc.issueno=r.docno and rc.issuedt=r.docdt and rc.LOTNO = r.LOTNO AND rc.LOTDaTe = r.lotdt AND rc.VARCODE = r.VARCODE AND rc.DIVCODE = r.DIVCODE and rc.baleno=r.baleno " & _
                " INNER JOIN RM_AREA AS E ON a.AREACD = E.AREACODE INNER JOIN FA_SLMAS AS D ON a.SUPCD = D.slcode INNER JOIN RM_VAR AS b ON a.VARCODE = b.VARCODE AND a.CATCD = b.CATCD LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE, SUM(ISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS c ON r.DIVCODE = c.DIVCODE AND r.LOTNO = c.LOTNO AND r.lotdt = c.lotdt AND r.BALENO = c.BALENO AND r.VARCODE = c.VARCODE WHERE a.LOTYEAR = " & Year(yfdate) & " " & _
                " AND a.DIVCODE = '" & Divcode & "' AND a.Ins_Flg = 'Y' AND r.DOCNO =  '" & Txtfields(0).Text & "' " & _
                " AND r.DOCDT =  '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'  AND ISNULL(a.ISSWT, 0) <> 0 AND (ISNULL(r.ISSKGS, 0) - ISNULL(c.Returnkgs, 0) > 0) AND R.lotno='" & grdDataGrid.Columns(ILotNo).Text & "' AND r.lotDT='" & Format(LOTDT, "yyyy-mm-dd") & "' AND A.LOTYEAR='" & Year(yfdate) & "' GROUP BY a.LOTNO,A.lottype, a.PLOTNO, a.LOTDT, a.VARCODE, a.CATCD,c.Returnkgs,A.COLORCODE", DB, adOpenStatic, adLockBatchOptimistic
        Else
         Rs.Open "SELECT a.LOTDT 'Date',A.lottype,A.PLOTNO,A.varcode,A.catcd,count(r.BALENO),SUM(isnull(r.ISSKGS,0))-SUM(isnull(c.Returnkgs,0))BalanceKgs ,A.COLORCODE FROM RM_LOT AS a INNER JOIN RM_ISSB AS r ON a.LOTNO = r.LOTNO AND a.LOTDT = r.lotdt AND a.LOTTYPE = r.LOTTYPE AND a.CATCD = r.CATCD AND a.VARCODE = r.VARCODE AND a.DIVCODE = r.DIVCODE   " & _
                " INNER JOIN RM_AREA AS E ON a.AREACD = E.AREACODE INNER JOIN FA_SLMAS AS D ON a.SUPCD = D.slcode INNER JOIN RM_VAR AS b ON a.VARCODE = b.VARCODE AND a.CATCD = b.CATCD LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE, SUM(ISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS c ON r.DIVCODE = c.DIVCODE AND r.LOTNO = c.LOTNO AND r.lotdt = c.lotdt AND r.BALENO = c.BALENO AND r.VARCODE = c.VARCODE WHERE a.LOTYEAR = " & Year(yfdate) & " " & _
                " AND a.DIVCODE = '" & Divcode & "' AND a.Ins_Flg = 'Y' AND r.DOCNO =  '" & Txtfields(0).Text & "' " & _
                " AND r.DOCDT =  '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "'  AND ISNULL(a.ISSWT, 0) <> 0 AND (ISNULL(r.ISSKGS, 0) - ISNULL(c.Returnkgs, 0) > 0) AND R.lotno='" & grdDataGrid.Columns(ILotNo).Text & "' AND r.lotDT='" & Format(LOTDT, "yyyy-mm-dd") & "' AND A.LOTYEAR='" & Year(yfdate) & "' GROUP BY a.LOTNO,A.lottype, a.PLOTNO, a.LOTDT, a.VARCODE, a.CATCD,c.Returnkgs,A.COLORCODE", DB, adOpenStatic, adLockBatchOptimistic
        End If
      ...
      Else
        ...
        If Opt = "mod" Then
            ...
            rsg.MovePrevious
            Opt = opt1
'           ry.Open "select * from rm_bale a,RM_BALE c where a.LOTNO=c.LOTNO AND a.lotdt=c.lotdt AND a.LOTTYPE=c.lottype AND a.DIVCODE=c.DIVCODE AND a.CATCD=c.CATCD AND a.VARCODE=c.VARCODE AND a.BALENO=c.BALENO and a.baleno not in (" & gbaleno & ") and isnull(a.actisskgs,0)=0 and  a.VARCODE='" & Varcode & "' AND a.STATUS IN ('AC','AW') AND ISSUED='Y'  and lotno='" & grddatagrid.Columns(ILotNo).Text & "'  and lotdt='" & Format(Rs("date"), "yyyy-mm-dd") & "'  and isnull(rejflg,'N')='N' and divcode='" & Divcode & "' ", DB, adOpenStatic

        If issretprpflg = "Y" Or (UCase(CustID) = "SHRIGIRI" And Divcode = "01") Then
             ry.Open " SELECT *  FROM RM_ISSB AS a INNER JOIN PRP_MixingRecRetDT AS rc ON rc.issueno=a.docno and rc.issuedt=a.docdt and rc.LOTNO = a.LOTNO AND rc.LOTDaTe = a.lotdt AND rc.VARCODE = a.VARCODE AND rc.DIVCODE = a.DIVCODE and rc.baleno=a.baleno " & _
                      " INNER JOIN RM_BALE AS c ON a.DIVCODE = c.DIVCODE AND a.CATCD = c.CATCD AND a.LOTNO = c.LOTNO AND a.lotdt = c.lotdt AND a.LOTTYPE = c.lottype AND a.VARCODE = c.VARCODE AND a.baleno = c.baleno  LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE, SUM(ACTISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS d ON a.DIVCODE = d.DIVCODE AND a.LOTNO = d.LOTNO AND a.lotdt = d.lotdt AND a.BALENO = d.BALENO AND a.VARCODE = d.VARCODE WHERE  (a.CATCD = '" & catcd & "') AND (a.VARCODE = '" & Varcode & "') AND (a.DOCNO = '" & Txtfields(0).Text & "') AND (a.DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "')" & _
                      " AND a.LOTNO='" & grdDataGrid.Columns(ILotNo).Text & "' AND a.lotdt='" & Format(Rs("date"), "yyyy-mm-dd") & "'  and a.divcode='" & Divcode & "'  and (ISNULL(a.actisskgs,0)-isnull(d.Returnkgs,0)) > 0 "
        Else
         ry.Open " SELECT *  FROM RM_ISSB AS a " & _
                      " INNER JOIN RM_BALE AS c ON a.DIVCODE = c.DIVCODE AND a.CATCD = c.CATCD AND a.LOTNO = c.LOTNO AND a.lotdt = c.lotdt AND a.LOTTYPE = c.lottype AND a.VARCODE = c.VARCODE AND a.baleno = c.baleno  LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE, SUM(ACTISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS d ON a.DIVCODE = d.DIVCODE AND a.LOTNO = d.LOTNO AND a.lotdt = d.lotdt AND a.BALENO = d.BALENO AND a.VARCODE = d.VARCODE WHERE  (a.CATCD = '" & catcd & "') AND (a.VARCODE = '" & Varcode & "') AND (a.DOCNO = '" & Txtfields(0).Text & "') AND (a.DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "')" & _
                      " AND a.LOTNO='" & grdDataGrid.Columns(ILotNo).Text & "' AND a.lotdt='" & Format(Rs("date"), "yyyy-mm-dd") & "'  and a.divcode='" & Divcode & "'  and (ISNULL(a.actisskgs,0)-isnull(d.Returnkgs,0)) > 0 "
        End If
        ...
        If issretprpflg = "Y" Or (UCase(CustID) = "SHRIGIRI" And Divcode = "01") Then
            ry.Open " SELECT *  FROM RM_ISSB AS a INNER JOIN PRP_MixingRecRetDT AS rc ON rc.issueno=a.docno and rc.issuedt=a.docdt and rc.LOTNO = a.LOTNO AND rc.LOTDaTe = a.lotdt AND rc.VARCODE = a.VARCODE AND rc.DIVCODE = a.DIVCODE and rc.baleno=a.baleno " & _
                " INNER JOIN RM_BALE AS c ON a.DIVCODE = c.DIVCODE AND a.CATCD = c.CATCD AND a.LOTNO = c.LOTNO AND a.lotdt = c.lotdt AND a.LOTTYPE = c.lottype AND a.VARCODE = c.VARCODE AND a.baleno = c.baleno  LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE, SUM(ACTISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS d ON a.DIVCODE = d.DIVCODE AND a.LOTNO = d.LOTNO AND a.lotdt = d.lotdt AND a.BALENO = d.BALENO AND a.VARCODE = d.VARCODE WHERE  (a.CATCD = '" & catcd & "') AND (a.VARCODE = '" & Varcode & "') AND (a.DOCNO = '" & Txtfields(0).Text & "') AND (a.DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "')" & _
                    " AND a.LOTNO='" & grdDataGrid.Columns(ILotNo).Text & "' AND a.lotdt='" & Format(Rs("date"), "yyyy-mm-dd") & "'  and a.divcode='" & Divcode & "'  and (ISNULL(a.actisskgs,0)-isnull(d.Returnkgs,0)) > 0 ", DB, adOpenStatic
        Else
               ry.Open " SELECT *  FROM RM_ISSB AS a  " & _
                " INNER JOIN RM_BALE AS c ON a.DIVCODE = c.DIVCODE AND a.CATCD = c.CATCD AND a.LOTNO = c.LOTNO AND a.lotdt = c.lotdt AND a.LOTTYPE = c.lottype AND a.VARCODE = c.VARCODE AND a.baleno = c.baleno  LEFT OUTER JOIN (SELECT DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE, SUM(ACTISSKGS) AS Returnkgs FROM RM_ISSRTNB AS f WHERE DIVCODE = '" & Divcode & "' AND ISSNO = '" & Txtfields(0).Text & "' AND ISSDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "' GROUP BY DIVCODE, ISSNO, ISSDT, LOTNO, lotdt, BALENO, VARCODE) AS d ON a.DIVCODE = d.DIVCODE AND a.LOTNO = d.LOTNO AND a.lotdt = d.lotdt AND a.BALENO = d.BALENO AND a.VARCODE = d.VARCODE WHERE  (a.CATCD = '" & catcd & "') AND (a.VARCODE = '" & Varcode & "') AND (a.DOCNO = '" & Txtfields(0).Text & "') AND (a.DOCDT = '" & Format(MaskEdBox1(0).Text, "yyyy-mm-dd") & "')" & _
                    " AND a.LOTNO='" & grdDataGrid.Columns(ILotNo).Text & "' AND a.lotdt='" & Format(Rs("date"), "yyyy-mm-dd") & "'  and a.divcode='" & Divcode & "'  and (ISNULL(a.actisskgs,0)-isnull(d.Returnkgs,0)) > 0 ", DB, adOpenStatic
       ...
       End If
        ...
        If gvar = Varcode Then
         ...
         If xx1 - baleno <= 0 Then
            ...
            grdDataGrid.Col = 0
            grdDataGrid.Columns(ILotNo).Text = 0
            grdDataGrid.SetFocus
            Exit Sub
         End If
...
'            End If
           ...
           Set rsa = New Recordset
           rsa.Open "SELECT ARRDT FROM RM_LOT WHERE LOTNO='" & grdDataGrid.Columns(ILotNo).Text & "' and varcode='" & adoSecondaryRS("Variety") & "' AND LOTDT='" & Format(grdDataGrid.Columns(ILotdt), "yyyy-mm-dd") & "' AND LOTYEAR='" & Year(yfdate) & "' AND DIVCODE='" & Divcode & "'", DB, adOpenStatic
           If rsa.RecordCount > 0 Then
