...
Begin VB.Form Dy_Dets 
   ...
   Begin VB.Frame Buttonframe 
      ...
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":0000
         Height          =   510
         Index           =   6
         Left            =   2625
         Picture         =   "DyDetails.frx":044A
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":0797
         Height          =   510
         Index           =   0
         Left            =   0
         Picture         =   "DyDetails.frx":0AA1
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Add"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":0E34
         Height          =   510
         Index           =   5
         Left            =   2100
         Picture         =   "DyDetails.frx":127E
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":15E3
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":1C89
         Height          =   510
         Index           =   1
         Left            =   525
         Picture         =   "DyDetails.frx":1F93
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Modify"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":26A4
         Height          =   510
         Index           =   7
         Left            =   3150
         Picture         =   "DyDetails.frx":2AEE
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":2E3E
         Height          =   510
         Index           =   11
         Left            =   5250
         Picture         =   "DyDetails.frx":3288
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Exit"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":361D
         Height          =   510
         Index           =   9
         Left            =   4200
         Picture         =   "DyDetails.frx":3927
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Save"
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":3CC9
         Height          =   510
         Index           =   10
         Left            =   4725
         Picture         =   "DyDetails.frx":3FD3
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Cancel "
         Top             =   120
      ...
      End
      Begin VB.CommandButton BUTTON 
         DownPicture     =   "DyDetails.frx":434F
         Height          =   510
         Index           =   8
         Left            =   3675
         Picture         =   "DyDetails.frx":4799
         Style           =   1  'Graphical
         TabIndex        =   12
...
openconnection_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure openconnection of Form Dy_Dets"
End Sub
...
Case 1
        ...
        Rs.Open "select count(*) from rm_dyingdet where 1=1 and DivCode ='" & Divcode & "'", DB
...
'        Frame3.ZOrder
            ...
            LookUp.Caption = "Dying Rate Listing"
...
Exit Sub
BUTTON_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure BUTTON_Click of Form Dy_Dets"
End Sub
...
Command1_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure Command1_Click of Form Dy_Dets"
End Sub
...
Case "Slcode"
    ...
    If Opt = "mod" Then
          ...
          StatusBar1.Panels(2).Text = ""
          Set adoPrimaryRS = New Recordset
          adoPrimaryRS.Open "select a.slcode  ""Party Code"" ,b.slname ""Party Name"",a.Varcode  ""Variety Code"",a.colorcode  ""Colour Code"",a.Rate  ""Rate/Kg"",a.eff_date ""Effective Date""  from rm_dyingdet a,fa_slmas b where a.slcode = b.slcode and a.slcode ='" & KslList1.Code & "' and a.varcode ='" & KslList1.description & "' and a.DivCode ='" & Divcode & "' order by a.slcode", DB, adOpenStatic, adLockBatchOptimistic
          Set grddatagrid.DataSource = adoPrimaryRS
          Set grddatagrid.DataSource = adoPrimaryRS
          grddatagrid.SetFocus
    End If
...
Command3_Click_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure Command3_Click of Form Dy_Dets"
End Sub
...
Exit Sub
Form_Load_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure Form_Load of Form Dy_Dets"
...
adoPrimaryRS_MoveComplete_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure adoPrimaryRS_MoveComplete of Form Dy_Dets"
End Sub
...
grdDataGrid_AfterColEdit_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure grdDataGrid_AfterColEdit of Form Dy_Dets"
End Sub
...
grddatagrid_AfterColUpdate_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure grddatagrid_AfterColUpdate of Form Dy_Dets"
End Sub
...
grddatagrid_KeyDown_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure grddatagrid_KeyDown of Form Dy_Dets"
End Sub
...
GRDDATAGRID_KeyPress_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure GRDDATAGRID_KeyPress of Form Dy_Dets"
End Sub
...
''        Frame3.ZOrder
            ...
            LookUp.Caption = "Party Rate Listing"
...
GRDDATAGRID_RowColChange_Error:
    MsgBox "Error " & Err.Number & " (" & Err.description & ") in procedure GRDDATAGRID_RowColChange of Form Dy_Dets"
End Sub
