...
export default function RequisitionV3NewPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#f5f5f3' }}>
      ...
      <PRDocBand savedPrNo={savedPrNo} prStatus={prStatus} variant="Variant C" />
      ...
      <div style={{
        ...
        <PRVariantBadge label="Variant C" sub="Sidebar Split Layout" />
        <TbSep />
        <TbBtn
          variant="primary"
      ...
      {/* ── Split body: sidebar left + content right ─────────────────────── */}
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'row' }}>

        {/* Left sidebar — header fields */}
        <Skeleton active loading={!lookupsLoaded && !lookupsError} style={{ width: 264, padding: 16, flexShrink: 0 }}>
          <PRHeaderV3
            form={headerForm}
        ...
        {/* Right content — KPI strip + grid stacked */}
