...
- Name: purchase-requisition\pr-security.spec.ts >> PR Security — Authentication Guard >> should redirect to login when accessing PR list unauthenticated
- Location: e2e\tests\purchase-requisition\pr-security.spec.ts:195:3
...
- banner:
  - img "Kalsofte"
  - text: SpinRise ERP Platform 14 May 2026 | 03:43:05 PM
- main:
