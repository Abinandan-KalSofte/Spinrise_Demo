...
BEGIN
    ...
    SELECT
        ...
        CASE
            ...
            WHEN ISNULL(h.APPFLG,     '') = 'Y' THEN 'APPROVED'
            ELSE 'OPEN'
        END                                                             AS PrStatus,
    ...
    WHERE h.divcode = @DivCode
      ...
      AND (
            ...
            OR (@Status = 'APPROVED'  AND ISNULL(h.APPFLG,'')     = 'Y'
...
-- ksp_PR_GetById -- Fixed By Abinandan
...
BEGIN
    ...
    (
        divcode, prno, prdate, prsno, itemcode, macno, qtyind, reqddate,
